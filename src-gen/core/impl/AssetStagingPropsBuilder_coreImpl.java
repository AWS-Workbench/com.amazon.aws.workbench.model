...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Asset Staging Props Builder core</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link core.impl.AssetStagingPropsBuilder_coreImpl#getSourcePath_java_lang_String_ <em>Source Path java lang String </em>}</li>
 *   <li>{@link core.impl.AssetStagingPropsBuilder_coreImpl#getExtraHash_java_lang_String_ <em>Extra Hash java lang String </em>}</li>
 *   <li>{@link core.impl.AssetStagingPropsBuilder_coreImpl#getExclude_java_lang_String_AsList <em>Exclude java lang String As List</em>}</li>
 *   <li>{@link core.impl.AssetStagingPropsBuilder_coreImpl#getFollow_software_amazon_awscdk_core_SymlinkFollowMode_ <em>Follow software amazon awscdk core Symlink Follow Mode </em>}</li>
 *   <li>{@link core.impl.AssetStagingPropsBuilder_coreImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link core.impl.AssetStagingPropsBuilder_coreImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link core.impl.AssetStagingPropsBuilder_coreImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link core.impl.AssetStagingPropsBuilder_coreImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AssetStagingPropsBuilder_coreImpl extends MinimalEObjectImpl.Container
		implements AssetStagingPropsBuilder_core {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.core.AssetStagingProps";
	 ...
	 * @generated
	 */
	protected AssetStagingPropsBuilder_coreImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.ASSET_STAGING_PROPS_BUILDER_CORE;
	}
	...
	public void setSourcePath_java_lang_String_(String newSourcePath_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.ASSET_STAGING_PROPS_BUILDER_CORE__SOURCE_PATH_JAVA_LANG_STRING_,
	...
	public void setExtraHash_java_lang_String_(String newExtraHash_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.ASSET_STAGING_PROPS_BUILDER_CORE__EXTRA_HASH_JAVA_LANG_STRING_,
	...
	public void setExclude_java_lang_String_AsList(String newExclude_java_lang_String_AsList) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.ASSET_STAGING_PROPS_BUILDER_CORE__EXCLUDE_JAVA_LANG_STRING_AS_LIST,
	...
	public void setFollow_software_amazon_awscdk_core_SymlinkFollowMode_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.ASSET_STAGING_PROPS_BUILDER_CORE__FOLLOW_SOFTWARE_AMAZON_AWSCDK_CORE_SYMLINK_FOLLOW_MODE_,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.ASSET_STAGING_PROPS_BUILDER_CORE__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.ASSET_STAGING_PROPS_BUILDER_CORE__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.ASSET_STAGING_PROPS_BUILDER_CORE__ADDITIONAL_CODE, oldAdditionalCode, additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CorePackage.ASSET_STAGING_PROPS_BUILDER_CORE__SOURCE_PATH_JAVA_LANG_STRING_:
			return getSourcePath_java_lang_String_();
		case CorePackage.ASSET_STAGING_PROPS_BUILDER_CORE__EXTRA_HASH_JAVA_LANG_STRING_:
			return getExtraHash_java_lang_String_();
		case CorePackage.ASSET_STAGING_PROPS_BUILDER_CORE__EXCLUDE_JAVA_LANG_STRING_AS_LIST:
			return getExclude_java_lang_String_AsList();
		case CorePackage.ASSET_STAGING_PROPS_BUILDER_CORE__FOLLOW_SOFTWARE_AMAZON_AWSCDK_CORE_SYMLINK_FOLLOW_MODE_:
			return getFollow_software_amazon_awscdk_core_SymlinkFollowMode_();
		case CorePackage.ASSET_STAGING_PROPS_BUILDER_CORE__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case CorePackage.ASSET_STAGING_PROPS_BUILDER_CORE__VAR_NAME:
			return getVarName();
		case CorePackage.ASSET_STAGING_PROPS_BUILDER_CORE__IDENTIFIER:
			return getIdentifier();
		case CorePackage.ASSET_STAGING_PROPS_BUILDER_CORE__ADDITIONAL_CODE:
...
} //AssetStagingPropsBuilder_coreImpl
