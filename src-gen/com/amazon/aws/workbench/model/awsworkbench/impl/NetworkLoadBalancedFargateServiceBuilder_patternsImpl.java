...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Network Load Balanced Fargate Service Builder patterns</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkLoadBalancedFargateServiceBuilder_patternsImpl#getCloudMapOptionsWithCloudMapOptions_software_amazon_awscdk_services_ecs_CloudMapOptions_AsReference <em>Cloud Map Options With Cloud Map Options software amazon awscdk services ecs Cloud Map Options As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkLoadBalancedFargateServiceBuilder_patternsImpl#getClusterWithICluster_software_amazon_awscdk_services_ecs_ICluster_AsReference <em>Cluster With ICluster software amazon awscdk services ecs ICluster As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkLoadBalancedFargateServiceBuilder_patternsImpl#getDesiredCount_java_lang_Number_ <em>Desired Count java lang Number </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkLoadBalancedFargateServiceBuilder_patternsImpl#getDomainName_java_lang_String_ <em>Domain Name java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkLoadBalancedFargateServiceBuilder_patternsImpl#getDomainZoneWithIHostedZone_software_amazon_awscdk_services_route53_IHostedZone_AsReference <em>Domain Zone With IHosted Zone software amazon awscdk services route53 IHosted Zone As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkLoadBalancedFargateServiceBuilder_patternsImpl#getEnableEcsManagedTags_java_lang_Boolean_ <em>Enable Ecs Managed Tags java lang Boolean </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkLoadBalancedFargateServiceBuilder_patternsImpl#getHealthCheckGracePeriodWithDuration_software_amazon_awscdk_core_Duration_AsReference <em>Health Check Grace Period With Duration software amazon awscdk core Duration As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkLoadBalancedFargateServiceBuilder_patternsImpl#getListenerPort_java_lang_Number_ <em>Listener Port java lang Number </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkLoadBalancedFargateServiceBuilder_patternsImpl#getLoadBalancerWithINetworkLoadBalancer_software_amazon_awscdk_services_elasticloadbalancingv2_INetworkLoadBalancer_AsReference <em>Load Balancer With INetwork Load Balancer software amazon awscdk services elasticloadbalancingv2 INetwork Load Balancer As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkLoadBalancedFargateServiceBuilder_patternsImpl#getMaxHealthyPercent_java_lang_Number_ <em>Max Healthy Percent java lang Number </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkLoadBalancedFargateServiceBuilder_patternsImpl#getMinHealthyPercent_java_lang_Number_ <em>Min Healthy Percent java lang Number </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkLoadBalancedFargateServiceBuilder_patternsImpl#getPropagateTags_software_amazon_awscdk_services_ecs_PropagatedTagSource_ <em>Propagate Tags software amazon awscdk services ecs Propagated Tag Source </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkLoadBalancedFargateServiceBuilder_patternsImpl#getPublicLoadBalancer_java_lang_Boolean_ <em>Public Load Balancer java lang Boolean </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkLoadBalancedFargateServiceBuilder_patternsImpl#getServiceName_java_lang_String_ <em>Service Name java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkLoadBalancedFargateServiceBuilder_patternsImpl#getTaskImageOptionsWithNetworkLoadBalancedTaskImageOptions_software_amazon_awscdk_services_ecs_patterns_NetworkLoadBalancedTaskImageOptions_AsReference <em>Task Image Options With Network Load Balanced Task Image Options software amazon awscdk services ecs patterns Network Load Balanced Task Image Options As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkLoadBalancedFargateServiceBuilder_patternsImpl#getVpcWithIVpc_software_amazon_awscdk_services_ec2_IVpc_AsReference <em>Vpc With IVpc software amazon awscdk services ec2 IVpc As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkLoadBalancedFargateServiceBuilder_patternsImpl#getAssignPublicIp_java_lang_Boolean_ <em>Assign Public Ip java lang Boolean </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkLoadBalancedFargateServiceBuilder_patternsImpl#getCpu_java_lang_Number_ <em>Cpu java lang Number </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkLoadBalancedFargateServiceBuilder_patternsImpl#getMemoryLimitMiB_java_lang_Number_ <em>Memory Limit Mi Bjava lang Number </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkLoadBalancedFargateServiceBuilder_patternsImpl#getPlatformVersion_software_amazon_awscdk_services_ecs_FargatePlatformVersion_ <em>Platform Version software amazon awscdk services ecs Fargate Platform Version </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkLoadBalancedFargateServiceBuilder_patternsImpl#getTaskDefinitionWithFargateTaskDefinition_software_amazon_awscdk_services_ecs_FargateTaskDefinition_AsReference <em>Task Definition With Fargate Task Definition software amazon awscdk services ecs Fargate Task Definition As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkLoadBalancedFargateServiceBuilder_patternsImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkLoadBalancedFargateServiceBuilder_patternsImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkLoadBalancedFargateServiceBuilder_patternsImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkLoadBalancedFargateServiceBuilder_patternsImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NetworkLoadBalancedFargateServiceBuilder_patternsImpl extends MinimalEObjectImpl.Container
		implements NetworkLoadBalancedFargateServiceBuilder_patterns {
	/**
	...
	/**
	 * The default value of the '{@link #getLoadBalancerWithINetworkLoadBalancer_software_amazon_awscdk_services_elasticloadbalancingv2_INetworkLoadBalancer_AsReference() <em>Load Balancer With INetwork Load Balancer software amazon awscdk services elasticloadbalancingv2 INetwork Load Balancer As Reference</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected static final String LOAD_BALANCER_WITH_INETWORK_LOAD_BALANCER_SOFTWARE_AMAZON_AWSCDK_SERVICES_ELASTICLOADBALANCINGV2_INETWORK_LOAD_BALANCER_AS_REFERENCE_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getLoadBalancerWithINetworkLoadBalancer_software_amazon_awscdk_services_elasticloadbalancingv2_INetworkLoadBalancer_AsReference() <em>Load Balancer With INetwork Load Balancer software amazon awscdk services elasticloadbalancingv2 INetwork Load Balancer As Reference</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getLoadBalancerWithINetworkLoadBalancer_software_amazon_awscdk_services_elasticloadbalancingv2_INetworkLoadBalancer_AsReference()
	 * @generated
	 * @ordered
	 */
	protected String loadBalancerWithINetworkLoadBalancer_software_amazon_awscdk_services_elasticloadbalancingv2_INetworkLoadBalancer_AsReference = LOAD_BALANCER_WITH_INETWORK_LOAD_BALANCER_SOFTWARE_AMAZON_AWSCDK_SERVICES_ELASTICLOADBALANCINGV2_INETWORK_LOAD_BALANCER_AS_REFERENCE_EDEFAULT;
	...
	/**
	 * The default value of the '{@link #getTaskImageOptionsWithNetworkLoadBalancedTaskImageOptions_software_amazon_awscdk_services_ecs_patterns_NetworkLoadBalancedTaskImageOptions_AsReference() <em>Task Image Options With Network Load Balanced Task Image Options software amazon awscdk services ecs patterns Network Load Balanced Task Image Options As Reference</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected static final String TASK_IMAGE_OPTIONS_WITH_NETWORK_LOAD_BALANCED_TASK_IMAGE_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_ECS_PATTERNS_NETWORK_LOAD_BALANCED_TASK_IMAGE_OPTIONS_AS_REFERENCE_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getTaskImageOptionsWithNetworkLoadBalancedTaskImageOptions_software_amazon_awscdk_services_ecs_patterns_NetworkLoadBalancedTaskImageOptions_AsReference() <em>Task Image Options With Network Load Balanced Task Image Options software amazon awscdk services ecs patterns Network Load Balanced Task Image Options As Reference</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getTaskImageOptionsWithNetworkLoadBalancedTaskImageOptions_software_amazon_awscdk_services_ecs_patterns_NetworkLoadBalancedTaskImageOptions_AsReference()
	 * @generated
	 * @ordered
	 */
	protected String taskImageOptionsWithNetworkLoadBalancedTaskImageOptions_software_amazon_awscdk_services_ecs_patterns_NetworkLoadBalancedTaskImageOptions_AsReference = TASK_IMAGE_OPTIONS_WITH_NETWORK_LOAD_BALANCED_TASK_IMAGE_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_ECS_PATTERNS_NETWORK_LOAD_BALANCED_TASK_IMAGE_OPTIONS_AS_REFERENCE_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.ecs.patterns.NetworkLoadBalancedFargateService";
	 ...
	 * @generated
	 */
	protected NetworkLoadBalancedFargateServiceBuilder_patternsImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AwsworkbenchPackage.Literals.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS;
	}
	...
	public void setCloudMapOptionsWithCloudMapOptions_software_amazon_awscdk_services_ecs_CloudMapOptions_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__CLOUD_MAP_OPTIONS_WITH_CLOUD_MAP_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_ECS_CLOUD_MAP_OPTIONS_AS_REFERENCE,
	...
	public void setClusterWithICluster_software_amazon_awscdk_services_ecs_ICluster_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__CLUSTER_WITH_ICLUSTER_SOFTWARE_AMAZON_AWSCDK_SERVICES_ECS_ICLUSTER_AS_REFERENCE,
	...
	public void setDesiredCount_java_lang_Number_(int newDesiredCount_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__DESIRED_COUNT_JAVA_LANG_NUMBER_,
	...
	public void setDomainName_java_lang_String_(String newDomainName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__DOMAIN_NAME_JAVA_LANG_STRING_,
	...
	public void setDomainZoneWithIHostedZone_software_amazon_awscdk_services_route53_IHostedZone_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__DOMAIN_ZONE_WITH_IHOSTED_ZONE_SOFTWARE_AMAZON_AWSCDK_SERVICES_ROUTE53_IHOSTED_ZONE_AS_REFERENCE,
	...
	public void setEnableEcsManagedTags_java_lang_Boolean_(Boolean newEnableEcsManagedTags_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__ENABLE_ECS_MANAGED_TAGS_JAVA_LANG_BOOLEAN_,
	...
	public void setHealthCheckGracePeriodWithDuration_software_amazon_awscdk_core_Duration_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__HEALTH_CHECK_GRACE_PERIOD_WITH_DURATION_SOFTWARE_AMAZON_AWSCDK_CORE_DURATION_AS_REFERENCE,
	...
	public void setListenerPort_java_lang_Number_(int newListenerPort_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__LISTENER_PORT_JAVA_LANG_NUMBER_,
	 ...
	 */
	@Override
	public String getLoadBalancerWithINetworkLoadBalancer_software_amazon_awscdk_services_elasticloadbalancingv2_INetworkLoadBalancer_AsReference() {
		return loadBalancerWithINetworkLoadBalancer_software_amazon_awscdk_services_elasticloadbalancingv2_INetworkLoadBalancer_AsReference;
	}
	 ...
	 */
	@Override
	public void setLoadBalancerWithINetworkLoadBalancer_software_amazon_awscdk_services_elasticloadbalancingv2_INetworkLoadBalancer_AsReference(
			String newLoadBalancerWithINetworkLoadBalancer_software_amazon_awscdk_services_elasticloadbalancingv2_INetworkLoadBalancer_AsReference) {
		String oldLoadBalancerWithINetworkLoadBalancer_software_amazon_awscdk_services_elasticloadbalancingv2_INetworkLoadBalancer_AsReference = loadBalancerWithINetworkLoadBalancer_software_amazon_awscdk_services_elasticloadbalancingv2_INetworkLoadBalancer_AsReference;
		loadBalancerWithINetworkLoadBalancer_software_amazon_awscdk_services_elasticloadbalancingv2_INetworkLoadBalancer_AsReference = newLoadBalancerWithINetworkLoadBalancer_software_amazon_awscdk_services_elasticloadbalancingv2_INetworkLoadBalancer_AsReference;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__LOAD_BALANCER_WITH_INETWORK_LOAD_BALANCER_SOFTWARE_AMAZON_AWSCDK_SERVICES_ELASTICLOADBALANCINGV2_INETWORK_LOAD_BALANCER_AS_REFERENCE,
					oldLoadBalancerWithINetworkLoadBalancer_software_amazon_awscdk_services_elasticloadbalancingv2_INetworkLoadBalancer_AsReference,
	...
	public void setMaxHealthyPercent_java_lang_Number_(int newMaxHealthyPercent_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__MAX_HEALTHY_PERCENT_JAVA_LANG_NUMBER_,
	...
	public void setMinHealthyPercent_java_lang_Number_(int newMinHealthyPercent_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__MIN_HEALTHY_PERCENT_JAVA_LANG_NUMBER_,
	...
	public void setPropagateTags_software_amazon_awscdk_services_ecs_PropagatedTagSource_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__PROPAGATE_TAGS_SOFTWARE_AMAZON_AWSCDK_SERVICES_ECS_PROPAGATED_TAG_SOURCE_,
	...
	public void setPublicLoadBalancer_java_lang_Boolean_(Boolean newPublicLoadBalancer_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__PUBLIC_LOAD_BALANCER_JAVA_LANG_BOOLEAN_,
	...
	public void setServiceName_java_lang_String_(String newServiceName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__SERVICE_NAME_JAVA_LANG_STRING_,
	 ...
	 */
	@Override
	public String getTaskImageOptionsWithNetworkLoadBalancedTaskImageOptions_software_amazon_awscdk_services_ecs_patterns_NetworkLoadBalancedTaskImageOptions_AsReference() {
		return taskImageOptionsWithNetworkLoadBalancedTaskImageOptions_software_amazon_awscdk_services_ecs_patterns_NetworkLoadBalancedTaskImageOptions_AsReference;
	}
	 ...
	 */
	@Override
	public void setTaskImageOptionsWithNetworkLoadBalancedTaskImageOptions_software_amazon_awscdk_services_ecs_patterns_NetworkLoadBalancedTaskImageOptions_AsReference(
			String newTaskImageOptionsWithNetworkLoadBalancedTaskImageOptions_software_amazon_awscdk_services_ecs_patterns_NetworkLoadBalancedTaskImageOptions_AsReference) {
		String oldTaskImageOptionsWithNetworkLoadBalancedTaskImageOptions_software_amazon_awscdk_services_ecs_patterns_NetworkLoadBalancedTaskImageOptions_AsReference = taskImageOptionsWithNetworkLoadBalancedTaskImageOptions_software_amazon_awscdk_services_ecs_patterns_NetworkLoadBalancedTaskImageOptions_AsReference;
		taskImageOptionsWithNetworkLoadBalancedTaskImageOptions_software_amazon_awscdk_services_ecs_patterns_NetworkLoadBalancedTaskImageOptions_AsReference = newTaskImageOptionsWithNetworkLoadBalancedTaskImageOptions_software_amazon_awscdk_services_ecs_patterns_NetworkLoadBalancedTaskImageOptions_AsReference;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__TASK_IMAGE_OPTIONS_WITH_NETWORK_LOAD_BALANCED_TASK_IMAGE_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_ECS_PATTERNS_NETWORK_LOAD_BALANCED_TASK_IMAGE_OPTIONS_AS_REFERENCE,
					oldTaskImageOptionsWithNetworkLoadBalancedTaskImageOptions_software_amazon_awscdk_services_ecs_patterns_NetworkLoadBalancedTaskImageOptions_AsReference,
					taskImageOptionsWithNetworkLoadBalancedTaskImageOptions_software_amazon_awscdk_services_ecs_patterns_NetworkLoadBalancedTaskImageOptions_AsReference));
	}
	...
	public void setVpcWithIVpc_software_amazon_awscdk_services_ec2_IVpc_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__VPC_WITH_IVPC_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_IVPC_AS_REFERENCE,
	...
	public void setAssignPublicIp_java_lang_Boolean_(Boolean newAssignPublicIp_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__ASSIGN_PUBLIC_IP_JAVA_LANG_BOOLEAN_,
	...
	public void setCpu_java_lang_Number_(int newCpu_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__CPU_JAVA_LANG_NUMBER_,
	...
	public void setMemoryLimitMiB_java_lang_Number_(int newMemoryLimitMiB_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__MEMORY_LIMIT_MI_BJAVA_LANG_NUMBER_,
	...
	public void setPlatformVersion_software_amazon_awscdk_services_ecs_FargatePlatformVersion_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__PLATFORM_VERSION_SOFTWARE_AMAZON_AWSCDK_SERVICES_ECS_FARGATE_PLATFORM_VERSION_,
	...
	public void setTaskDefinitionWithFargateTaskDefinition_software_amazon_awscdk_services_ecs_FargateTaskDefinition_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__TASK_DEFINITION_WITH_FARGATE_TASK_DEFINITION_SOFTWARE_AMAZON_AWSCDK_SERVICES_ECS_FARGATE_TASK_DEFINITION_AS_REFERENCE,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__VAR_NAME, oldVarName,
					varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__IDENTIFIER,
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__ADDITIONAL_CODE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__LOAD_BALANCER_WITH_INETWORK_LOAD_BALANCER_SOFTWARE_AMAZON_AWSCDK_SERVICES_ELASTICLOADBALANCINGV2_INETWORK_LOAD_BALANCER_AS_REFERENCE:
			return getLoadBalancerWithINetworkLoadBalancer_software_amazon_awscdk_services_elasticloadbalancingv2_INetworkLoadBalancer_AsReference();
		...
		case AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__TASK_IMAGE_OPTIONS_WITH_NETWORK_LOAD_BALANCED_TASK_IMAGE_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_ECS_PATTERNS_NETWORK_LOAD_BALANCED_TASK_IMAGE_OPTIONS_AS_REFERENCE:
			return getTaskImageOptionsWithNetworkLoadBalancedTaskImageOptions_software_amazon_awscdk_services_ecs_patterns_NetworkLoadBalancedTaskImageOptions_AsReference();
	...
	public void eSet(int featureID, Object newValue) {
		...
		case AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__LISTENER_PORT_JAVA_LANG_NUMBER_:
			...
			return;
		case AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__LOAD_BALANCER_WITH_INETWORK_LOAD_BALANCER_SOFTWARE_AMAZON_AWSCDK_SERVICES_ELASTICLOADBALANCINGV2_INETWORK_LOAD_BALANCER_AS_REFERENCE:
			setLoadBalancerWithINetworkLoadBalancer_software_amazon_awscdk_services_elasticloadbalancingv2_INetworkLoadBalancer_AsReference(
					(String) newValue);
			return;
		case AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__MAX_HEALTHY_PERCENT_JAVA_LANG_NUMBER_:
		...
		case AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__SERVICE_NAME_JAVA_LANG_STRING_:
			...
			return;
		case AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__TASK_IMAGE_OPTIONS_WITH_NETWORK_LOAD_BALANCED_TASK_IMAGE_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_ECS_PATTERNS_NETWORK_LOAD_BALANCED_TASK_IMAGE_OPTIONS_AS_REFERENCE:
			setTaskImageOptionsWithNetworkLoadBalancedTaskImageOptions_software_amazon_awscdk_services_ecs_patterns_NetworkLoadBalancedTaskImageOptions_AsReference(
					(String) newValue);
			return;
		case AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__VPC_WITH_IVPC_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_IVPC_AS_REFERENCE:
	...
	public void eUnset(int featureID) {
		...
		case AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__LOAD_BALANCER_WITH_INETWORK_LOAD_BALANCER_SOFTWARE_AMAZON_AWSCDK_SERVICES_ELASTICLOADBALANCINGV2_INETWORK_LOAD_BALANCER_AS_REFERENCE:
			setLoadBalancerWithINetworkLoadBalancer_software_amazon_awscdk_services_elasticloadbalancingv2_INetworkLoadBalancer_AsReference(
					LOAD_BALANCER_WITH_INETWORK_LOAD_BALANCER_SOFTWARE_AMAZON_AWSCDK_SERVICES_ELASTICLOADBALANCINGV2_INETWORK_LOAD_BALANCER_AS_REFERENCE_EDEFAULT);
			return;
		case AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__MAX_HEALTHY_PERCENT_JAVA_LANG_NUMBER_:
	...
	public boolean eIsSet(int featureID) {
		...
		case AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__LOAD_BALANCER_WITH_INETWORK_LOAD_BALANCER_SOFTWARE_AMAZON_AWSCDK_SERVICES_ELASTICLOADBALANCINGV2_INETWORK_LOAD_BALANCER_AS_REFERENCE:
			return LOAD_BALANCER_WITH_INETWORK_LOAD_BALANCER_SOFTWARE_AMAZON_AWSCDK_SERVICES_ELASTICLOADBALANCINGV2_INETWORK_LOAD_BALANCER_AS_REFERENCE_EDEFAULT == null
					? loadBalancerWithINetworkLoadBalancer_software_amazon_awscdk_services_elasticloadbalancingv2_INetworkLoadBalancer_AsReference != null
					: !LOAD_BALANCER_WITH_INETWORK_LOAD_BALANCER_SOFTWARE_AMAZON_AWSCDK_SERVICES_ELASTICLOADBALANCINGV2_INETWORK_LOAD_BALANCER_AS_REFERENCE_EDEFAULT
							.equals(loadBalancerWithINetworkLoadBalancer_software_amazon_awscdk_services_elasticloadbalancingv2_INetworkLoadBalancer_AsReference);
		case AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__MAX_HEALTHY_PERCENT_JAVA_LANG_NUMBER_:
		...
		case AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__TASK_IMAGE_OPTIONS_WITH_NETWORK_LOAD_BALANCED_TASK_IMAGE_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_ECS_PATTERNS_NETWORK_LOAD_BALANCED_TASK_IMAGE_OPTIONS_AS_REFERENCE:
			return TASK_IMAGE_OPTIONS_WITH_NETWORK_LOAD_BALANCED_TASK_IMAGE_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_ECS_PATTERNS_NETWORK_LOAD_BALANCED_TASK_IMAGE_OPTIONS_AS_REFERENCE_EDEFAULT == null
					? taskImageOptionsWithNetworkLoadBalancedTaskImageOptions_software_amazon_awscdk_services_ecs_patterns_NetworkLoadBalancedTaskImageOptions_AsReference != null
					: !TASK_IMAGE_OPTIONS_WITH_NETWORK_LOAD_BALANCED_TASK_IMAGE_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_ECS_PATTERNS_NETWORK_LOAD_BALANCED_TASK_IMAGE_OPTIONS_AS_REFERENCE_EDEFAULT
							.equals(taskImageOptionsWithNetworkLoadBalancedTaskImageOptions_software_amazon_awscdk_services_ecs_patterns_NetworkLoadBalancedTaskImageOptions_AsReference);
		case AwsworkbenchPackage.NETWORK_LOAD_BALANCED_FARGATE_SERVICE_BUILDER_PATTERNS__VPC_WITH_IVPC_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_IVPC_AS_REFERENCE:
...
} //NetworkLoadBalancedFargateServiceBuilder_patternsImpl
