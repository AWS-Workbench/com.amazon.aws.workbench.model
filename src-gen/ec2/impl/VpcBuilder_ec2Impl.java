 ...
 * </p>
 * <ul>
 *   <li>{@link ec2.impl.VpcBuilder_ec2Impl#getCidr_java_lang_String_ <em>Cidr java lang String </em>}</li>
 *   <li>{@link ec2.impl.VpcBuilder_ec2Impl#getDefaultInstanceTenancy_software_amazon_awscdk_services_ec2_DefaultInstanceTenancy_ <em>Default Instance Tenancy software amazon awscdk services ec2 Default Instance Tenancy </em>}</li>
 *   <li>{@link ec2.impl.VpcBuilder_ec2Impl#getEnableDnsHostnames_java_lang_Boolean_ <em>Enable Dns Hostnames java lang Boolean </em>}</li>
 *   <li>{@link ec2.impl.VpcBuilder_ec2Impl#getEnableDnsSupport_java_lang_Boolean_ <em>Enable Dns Support java lang Boolean </em>}</li>
 *   <li>{@link ec2.impl.VpcBuilder_ec2Impl#getFlowLogs_java_lang_String__software_amazon_awscdk_services_ec2_FlowLogOptions_AsMap <em>Flow Logs java lang String software amazon awscdk services ec2 Flow Log Options As Map</em>}</li>
 *   <li>{@link ec2.impl.VpcBuilder_ec2Impl#getGatewayEndpoints_java_lang_String__software_amazon_awscdk_services_ec2_GatewayVpcEndpointOptions_AsMap <em>Gateway Endpoints java lang String software amazon awscdk services ec2 Gateway Vpc Endpoint Options As Map</em>}</li>
 *   <li>{@link ec2.impl.VpcBuilder_ec2Impl#getMaxAzs_java_lang_Number_ <em>Max Azs java lang Number </em>}</li>
 *   <li>{@link ec2.impl.VpcBuilder_ec2Impl#getNatGatewayProviderWithNatProvider_software_amazon_awscdk_services_ec2_NatProvider_AsReference <em>Nat Gateway Provider With Nat Provider software amazon awscdk services ec2 Nat Provider As Reference</em>}</li>
 *   <li>{@link ec2.impl.VpcBuilder_ec2Impl#getNatGateways_java_lang_Number_ <em>Nat Gateways java lang Number </em>}</li>
 *   <li>{@link ec2.impl.VpcBuilder_ec2Impl#getNatGatewaySubnetsWithSubnetSelection_software_amazon_awscdk_services_ec2_SubnetSelection_AsReference <em>Nat Gateway Subnets With Subnet Selection software amazon awscdk services ec2 Subnet Selection As Reference</em>}</li>
 *   <li>{@link ec2.impl.VpcBuilder_ec2Impl#getSubnetConfiguration_software_amazon_awscdk_services_ec2_SubnetConfiguration_AsList <em>Subnet Configuration software amazon awscdk services ec2 Subnet Configuration As List</em>}</li>
 *   <li>{@link ec2.impl.VpcBuilder_ec2Impl#getVpnConnections_java_lang_String__software_amazon_awscdk_services_ec2_VpnConnectionOptions_AsMap <em>Vpn Connections java lang String software amazon awscdk services ec2 Vpn Connection Options As Map</em>}</li>
 *   <li>{@link ec2.impl.VpcBuilder_ec2Impl#getVpnGateway_java_lang_Boolean_ <em>Vpn Gateway java lang Boolean </em>}</li>
 *   <li>{@link ec2.impl.VpcBuilder_ec2Impl#getVpnGatewayAsn_java_lang_Number_ <em>Vpn Gateway Asn java lang Number </em>}</li>
 *   <li>{@link ec2.impl.VpcBuilder_ec2Impl#getVpnRoutePropagation_software_amazon_awscdk_services_ec2_SubnetSelection_AsList <em>Vpn Route Propagation software amazon awscdk services ec2 Subnet Selection As List</em>}</li>
 *   <li>{@link ec2.impl.VpcBuilder_ec2Impl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link ec2.impl.VpcBuilder_ec2Impl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link ec2.impl.VpcBuilder_ec2Impl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link ec2.impl.VpcBuilder_ec2Impl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VpcBuilder_ec2Impl extends MinimalEObjectImpl.Container implements VpcBuilder_ec2 {
	/**
	...
	protected EClass eStaticClass() {
		return Ec2Package.Literals.VPC_BUILDER_EC2;
	}
	...
	public void setCidr_java_lang_String_(String newCidr_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.VPC_BUILDER_EC2__CIDR_JAVA_LANG_STRING_,
					oldCidr_java_lang_String_, cidr_java_lang_String_));
	}
	...
	public void setDefaultInstanceTenancy_software_amazon_awscdk_services_ec2_DefaultInstanceTenancy_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPC_BUILDER_EC2__DEFAULT_INSTANCE_TENANCY_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_DEFAULT_INSTANCE_TENANCY_,
	...
	public void setEnableDnsHostnames_java_lang_Boolean_(Boolean newEnableDnsHostnames_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPC_BUILDER_EC2__ENABLE_DNS_HOSTNAMES_JAVA_LANG_BOOLEAN_,
	...
	public void setEnableDnsSupport_java_lang_Boolean_(Boolean newEnableDnsSupport_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPC_BUILDER_EC2__ENABLE_DNS_SUPPORT_JAVA_LANG_BOOLEAN_,
	...
	public void setFlowLogs_java_lang_String__software_amazon_awscdk_services_ec2_FlowLogOptions_AsMap(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPC_BUILDER_EC2__FLOW_LOGS_JAVA_LANG_STRING_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_FLOW_LOG_OPTIONS_AS_MAP,
	...
	public void setGatewayEndpoints_java_lang_String__software_amazon_awscdk_services_ec2_GatewayVpcEndpointOptions_AsMap(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPC_BUILDER_EC2__GATEWAY_ENDPOINTS_JAVA_LANG_STRING_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_GATEWAY_VPC_ENDPOINT_OPTIONS_AS_MAP,
	...
	public void setMaxAzs_java_lang_Number_(int newMaxAzs_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.VPC_BUILDER_EC2__MAX_AZS_JAVA_LANG_NUMBER_,
					oldMaxAzs_java_lang_Number_, maxAzs_java_lang_Number_));
	}
	...
	public void setNatGatewayProviderWithNatProvider_software_amazon_awscdk_services_ec2_NatProvider_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPC_BUILDER_EC2__NAT_GATEWAY_PROVIDER_WITH_NAT_PROVIDER_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_NAT_PROVIDER_AS_REFERENCE,
	...
	public void setNatGateways_java_lang_Number_(int newNatGateways_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPC_BUILDER_EC2__NAT_GATEWAYS_JAVA_LANG_NUMBER_, oldNatGateways_java_lang_Number_,
	...
	public void setNatGatewaySubnetsWithSubnetSelection_software_amazon_awscdk_services_ec2_SubnetSelection_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPC_BUILDER_EC2__NAT_GATEWAY_SUBNETS_WITH_SUBNET_SELECTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_SUBNET_SELECTION_AS_REFERENCE,
	...
	public void setSubnetConfiguration_software_amazon_awscdk_services_ec2_SubnetConfiguration_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPC_BUILDER_EC2__SUBNET_CONFIGURATION_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_SUBNET_CONFIGURATION_AS_LIST,
	...
	public void setVpnConnections_java_lang_String__software_amazon_awscdk_services_ec2_VpnConnectionOptions_AsMap(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPC_BUILDER_EC2__VPN_CONNECTIONS_JAVA_LANG_STRING_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_VPN_CONNECTION_OPTIONS_AS_MAP,
	...
	public void setVpnGateway_java_lang_Boolean_(Boolean newVpnGateway_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPC_BUILDER_EC2__VPN_GATEWAY_JAVA_LANG_BOOLEAN_, oldVpnGateway_java_lang_Boolean_,
	...
	public void setVpnGatewayAsn_java_lang_Number_(int newVpnGatewayAsn_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPC_BUILDER_EC2__VPN_GATEWAY_ASN_JAVA_LANG_NUMBER_, oldVpnGatewayAsn_java_lang_Number_,
					vpnGatewayAsn_java_lang_Number_));
	}
	...
	public void setVpnRoutePropagation_software_amazon_awscdk_services_ec2_SubnetSelection_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPC_BUILDER_EC2__VPN_ROUTE_PROPAGATION_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_SUBNET_SELECTION_AS_LIST,
	...
	public void setVarName(String newVarName) {
		...
		varName = newVarName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.VPC_BUILDER_EC2__VAR_NAME, oldVarName,
					varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.VPC_BUILDER_EC2__IDENTIFIER, oldIdentifier,
					identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.VPC_BUILDER_EC2__ADDITIONAL_CODE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Ec2Package.VPC_BUILDER_EC2__CIDR_JAVA_LANG_STRING_:
			return getCidr_java_lang_String_();
		case Ec2Package.VPC_BUILDER_EC2__DEFAULT_INSTANCE_TENANCY_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_DEFAULT_INSTANCE_TENANCY_:
			return getDefaultInstanceTenancy_software_amazon_awscdk_services_ec2_DefaultInstanceTenancy_();
		case Ec2Package.VPC_BUILDER_EC2__ENABLE_DNS_HOSTNAMES_JAVA_LANG_BOOLEAN_:
			return getEnableDnsHostnames_java_lang_Boolean_();
		case Ec2Package.VPC_BUILDER_EC2__ENABLE_DNS_SUPPORT_JAVA_LANG_BOOLEAN_:
			return getEnableDnsSupport_java_lang_Boolean_();
		case Ec2Package.VPC_BUILDER_EC2__FLOW_LOGS_JAVA_LANG_STRING_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_FLOW_LOG_OPTIONS_AS_MAP:
			return getFlowLogs_java_lang_String__software_amazon_awscdk_services_ec2_FlowLogOptions_AsMap();
		case Ec2Package.VPC_BUILDER_EC2__GATEWAY_ENDPOINTS_JAVA_LANG_STRING_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_GATEWAY_VPC_ENDPOINT_OPTIONS_AS_MAP:
			return getGatewayEndpoints_java_lang_String__software_amazon_awscdk_services_ec2_GatewayVpcEndpointOptions_AsMap();
		case Ec2Package.VPC_BUILDER_EC2__MAX_AZS_JAVA_LANG_NUMBER_:
			return getMaxAzs_java_lang_Number_();
		case Ec2Package.VPC_BUILDER_EC2__NAT_GATEWAY_PROVIDER_WITH_NAT_PROVIDER_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_NAT_PROVIDER_AS_REFERENCE:
			return getNatGatewayProviderWithNatProvider_software_amazon_awscdk_services_ec2_NatProvider_AsReference();
		case Ec2Package.VPC_BUILDER_EC2__NAT_GATEWAYS_JAVA_LANG_NUMBER_:
			return getNatGateways_java_lang_Number_();
		case Ec2Package.VPC_BUILDER_EC2__NAT_GATEWAY_SUBNETS_WITH_SUBNET_SELECTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_SUBNET_SELECTION_AS_REFERENCE:
			return getNatGatewaySubnetsWithSubnetSelection_software_amazon_awscdk_services_ec2_SubnetSelection_AsReference();
		case Ec2Package.VPC_BUILDER_EC2__SUBNET_CONFIGURATION_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_SUBNET_CONFIGURATION_AS_LIST:
			return getSubnetConfiguration_software_amazon_awscdk_services_ec2_SubnetConfiguration_AsList();
		case Ec2Package.VPC_BUILDER_EC2__VPN_CONNECTIONS_JAVA_LANG_STRING_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_VPN_CONNECTION_OPTIONS_AS_MAP:
			return getVpnConnections_java_lang_String__software_amazon_awscdk_services_ec2_VpnConnectionOptions_AsMap();
		case Ec2Package.VPC_BUILDER_EC2__VPN_GATEWAY_JAVA_LANG_BOOLEAN_:
			return getVpnGateway_java_lang_Boolean_();
		case Ec2Package.VPC_BUILDER_EC2__VPN_GATEWAY_ASN_JAVA_LANG_NUMBER_:
			return getVpnGatewayAsn_java_lang_Number_();
		case Ec2Package.VPC_BUILDER_EC2__VPN_ROUTE_PROPAGATION_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_SUBNET_SELECTION_AS_LIST:
			return getVpnRoutePropagation_software_amazon_awscdk_services_ec2_SubnetSelection_AsList();
		case Ec2Package.VPC_BUILDER_EC2__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case Ec2Package.VPC_BUILDER_EC2__VAR_NAME:
			return getVarName();
		case Ec2Package.VPC_BUILDER_EC2__IDENTIFIER:
			return getIdentifier();
		case Ec2Package.VPC_BUILDER_EC2__ADDITIONAL_CODE:
