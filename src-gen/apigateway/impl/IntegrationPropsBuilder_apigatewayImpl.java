...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Integration Props Builder apigateway</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link apigateway.impl.IntegrationPropsBuilder_apigatewayImpl#getType_software_amazon_awscdk_services_apigateway_IntegrationType_ <em>Type software amazon awscdk services apigateway Integration Type </em>}</li>
 *   <li>{@link apigateway.impl.IntegrationPropsBuilder_apigatewayImpl#getIntegrationHttpMethod_java_lang_String_ <em>Integration Http Method java lang String </em>}</li>
 *   <li>{@link apigateway.impl.IntegrationPropsBuilder_apigatewayImpl#getOptionsWithIntegrationOptions_software_amazon_awscdk_services_apigateway_IntegrationOptions_AsReference <em>Options With Integration Options software amazon awscdk services apigateway Integration Options As Reference</em>}</li>
 *   <li>{@link apigateway.impl.IntegrationPropsBuilder_apigatewayImpl#getUri_java_lang_Object_ <em>Uri java lang Object </em>}</li>
 *   <li>{@link apigateway.impl.IntegrationPropsBuilder_apigatewayImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link apigateway.impl.IntegrationPropsBuilder_apigatewayImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link apigateway.impl.IntegrationPropsBuilder_apigatewayImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link apigateway.impl.IntegrationPropsBuilder_apigatewayImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegrationPropsBuilder_apigatewayImpl extends MinimalEObjectImpl.Container
		implements IntegrationPropsBuilder_apigateway {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.apigateway.IntegrationProps";
	 ...
	 * @generated
	 */
	protected IntegrationPropsBuilder_apigatewayImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ApigatewayPackage.Literals.INTEGRATION_PROPS_BUILDER_APIGATEWAY;
	}
	...
	public void setType_software_amazon_awscdk_services_apigateway_IntegrationType_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_PROPS_BUILDER_APIGATEWAY__TYPE_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_INTEGRATION_TYPE_,
	...
	public void setIntegrationHttpMethod_java_lang_String_(String newIntegrationHttpMethod_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_PROPS_BUILDER_APIGATEWAY__INTEGRATION_HTTP_METHOD_JAVA_LANG_STRING_,
	...
	public void setOptionsWithIntegrationOptions_software_amazon_awscdk_services_apigateway_IntegrationOptions_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_PROPS_BUILDER_APIGATEWAY__OPTIONS_WITH_INTEGRATION_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_INTEGRATION_OPTIONS_AS_REFERENCE,
	...
	public void setUri_java_lang_Object_(Object newUri_java_lang_Object_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_PROPS_BUILDER_APIGATEWAY__URI_JAVA_LANG_OBJECT_,
					oldUri_java_lang_Object_, uri_java_lang_Object_));
	}
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_PROPS_BUILDER_APIGATEWAY__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_PROPS_BUILDER_APIGATEWAY__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_PROPS_BUILDER_APIGATEWAY__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ApigatewayPackage.INTEGRATION_PROPS_BUILDER_APIGATEWAY__TYPE_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_INTEGRATION_TYPE_:
			return getType_software_amazon_awscdk_services_apigateway_IntegrationType_();
		case ApigatewayPackage.INTEGRATION_PROPS_BUILDER_APIGATEWAY__INTEGRATION_HTTP_METHOD_JAVA_LANG_STRING_:
			return getIntegrationHttpMethod_java_lang_String_();
		case ApigatewayPackage.INTEGRATION_PROPS_BUILDER_APIGATEWAY__OPTIONS_WITH_INTEGRATION_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_INTEGRATION_OPTIONS_AS_REFERENCE:
			return getOptionsWithIntegrationOptions_software_amazon_awscdk_services_apigateway_IntegrationOptions_AsReference();
		case ApigatewayPackage.INTEGRATION_PROPS_BUILDER_APIGATEWAY__URI_JAVA_LANG_OBJECT_:
			return getUri_java_lang_Object_();
		case ApigatewayPackage.INTEGRATION_PROPS_BUILDER_APIGATEWAY__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case ApigatewayPackage.INTEGRATION_PROPS_BUILDER_APIGATEWAY__VAR_NAME:
			return getVarName();
		case ApigatewayPackage.INTEGRATION_PROPS_BUILDER_APIGATEWAY__IDENTIFIER:
			return getIdentifier();
		case ApigatewayPackage.INTEGRATION_PROPS_BUILDER_APIGATEWAY__ADDITIONAL_CODE:
...
} //IntegrationPropsBuilder_apigatewayImpl
