...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Add To Resource Policy Result Builder iam</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link iam.impl.AddToResourcePolicyResultBuilder_iamImpl#getStatementAdded_java_lang_Boolean_ <em>Statement Added java lang Boolean </em>}</li>
 *   <li>{@link iam.impl.AddToResourcePolicyResultBuilder_iamImpl#getPolicyDependableWithIDependable_software_amazon_awscdk_core_IDependable_AsReference <em>Policy Dependable With IDependable software amazon awscdk core IDependable As Reference</em>}</li>
 *   <li>{@link iam.impl.AddToResourcePolicyResultBuilder_iamImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link iam.impl.AddToResourcePolicyResultBuilder_iamImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link iam.impl.AddToResourcePolicyResultBuilder_iamImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link iam.impl.AddToResourcePolicyResultBuilder_iamImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AddToResourcePolicyResultBuilder_iamImpl extends MinimalEObjectImpl.Container
		implements AddToResourcePolicyResultBuilder_iam {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.iam.AddToResourcePolicyResult";
	 ...
	 * @generated
	 */
	protected AddToResourcePolicyResultBuilder_iamImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return IamPackage.Literals.ADD_TO_RESOURCE_POLICY_RESULT_BUILDER_IAM;
	}
	...
	public void setStatementAdded_java_lang_Boolean_(Boolean newStatementAdded_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.ADD_TO_RESOURCE_POLICY_RESULT_BUILDER_IAM__STATEMENT_ADDED_JAVA_LANG_BOOLEAN_,
	...
	public void setPolicyDependableWithIDependable_software_amazon_awscdk_core_IDependable_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.ADD_TO_RESOURCE_POLICY_RESULT_BUILDER_IAM__POLICY_DEPENDABLE_WITH_IDEPENDABLE_SOFTWARE_AMAZON_AWSCDK_CORE_IDEPENDABLE_AS_REFERENCE,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.ADD_TO_RESOURCE_POLICY_RESULT_BUILDER_IAM__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.ADD_TO_RESOURCE_POLICY_RESULT_BUILDER_IAM__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.ADD_TO_RESOURCE_POLICY_RESULT_BUILDER_IAM__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
...
} //AddToResourcePolicyResultBuilder_iamImpl
