...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Domain Name Builder apigateway</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link apigateway.impl.DomainNameBuilder_apigatewayImpl#getCertificateWithICertificate_software_amazon_awscdk_services_certificatemanager_ICertificate_AsReference <em>Certificate With ICertificate software amazon awscdk services certificatemanager ICertificate As Reference</em>}</li>
 *   <li>{@link apigateway.impl.DomainNameBuilder_apigatewayImpl#getDomainName_java_lang_String_ <em>Domain Name java lang String </em>}</li>
 *   <li>{@link apigateway.impl.DomainNameBuilder_apigatewayImpl#getEndpointType_software_amazon_awscdk_services_apigateway_EndpointType_ <em>Endpoint Type software amazon awscdk services apigateway Endpoint Type </em>}</li>
 *   <li>{@link apigateway.impl.DomainNameBuilder_apigatewayImpl#getSecurityPolicy_software_amazon_awscdk_services_apigateway_SecurityPolicy_ <em>Security Policy software amazon awscdk services apigateway Security Policy </em>}</li>
 *   <li>{@link apigateway.impl.DomainNameBuilder_apigatewayImpl#getMappingWithIRestApi_software_amazon_awscdk_services_apigateway_IRestApi_AsReference <em>Mapping With IRest Api software amazon awscdk services apigateway IRest Api As Reference</em>}</li>
 *   <li>{@link apigateway.impl.DomainNameBuilder_apigatewayImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link apigateway.impl.DomainNameBuilder_apigatewayImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link apigateway.impl.DomainNameBuilder_apigatewayImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link apigateway.impl.DomainNameBuilder_apigatewayImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DomainNameBuilder_apigatewayImpl extends MinimalEObjectImpl.Container
		implements DomainNameBuilder_apigateway {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.apigateway.DomainName";
	 ...
	 * @generated
	 */
	protected DomainNameBuilder_apigatewayImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ApigatewayPackage.Literals.DOMAIN_NAME_BUILDER_APIGATEWAY;
	}
	...
	public void setCertificateWithICertificate_software_amazon_awscdk_services_certificatemanager_ICertificate_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.DOMAIN_NAME_BUILDER_APIGATEWAY__CERTIFICATE_WITH_ICERTIFICATE_SOFTWARE_AMAZON_AWSCDK_SERVICES_CERTIFICATEMANAGER_ICERTIFICATE_AS_REFERENCE,
	...
	public void setDomainName_java_lang_String_(String newDomainName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.DOMAIN_NAME_BUILDER_APIGATEWAY__DOMAIN_NAME_JAVA_LANG_STRING_,
	...
	public void setEndpointType_software_amazon_awscdk_services_apigateway_EndpointType_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.DOMAIN_NAME_BUILDER_APIGATEWAY__ENDPOINT_TYPE_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_ENDPOINT_TYPE_,
	...
	public void setSecurityPolicy_software_amazon_awscdk_services_apigateway_SecurityPolicy_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.DOMAIN_NAME_BUILDER_APIGATEWAY__SECURITY_POLICY_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_SECURITY_POLICY_,
	...
	public void setMappingWithIRestApi_software_amazon_awscdk_services_apigateway_IRestApi_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.DOMAIN_NAME_BUILDER_APIGATEWAY__MAPPING_WITH_IREST_API_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_IREST_API_AS_REFERENCE,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.DOMAIN_NAME_BUILDER_APIGATEWAY__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.DOMAIN_NAME_BUILDER_APIGATEWAY__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.DOMAIN_NAME_BUILDER_APIGATEWAY__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ApigatewayPackage.DOMAIN_NAME_BUILDER_APIGATEWAY__CERTIFICATE_WITH_ICERTIFICATE_SOFTWARE_AMAZON_AWSCDK_SERVICES_CERTIFICATEMANAGER_ICERTIFICATE_AS_REFERENCE:
			return getCertificateWithICertificate_software_amazon_awscdk_services_certificatemanager_ICertificate_AsReference();
		case ApigatewayPackage.DOMAIN_NAME_BUILDER_APIGATEWAY__DOMAIN_NAME_JAVA_LANG_STRING_:
			return getDomainName_java_lang_String_();
		case ApigatewayPackage.DOMAIN_NAME_BUILDER_APIGATEWAY__ENDPOINT_TYPE_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_ENDPOINT_TYPE_:
			return getEndpointType_software_amazon_awscdk_services_apigateway_EndpointType_();
		case ApigatewayPackage.DOMAIN_NAME_BUILDER_APIGATEWAY__SECURITY_POLICY_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_SECURITY_POLICY_:
			return getSecurityPolicy_software_amazon_awscdk_services_apigateway_SecurityPolicy_();
		case ApigatewayPackage.DOMAIN_NAME_BUILDER_APIGATEWAY__MAPPING_WITH_IREST_API_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_IREST_API_AS_REFERENCE:
			return getMappingWithIRestApi_software_amazon_awscdk_services_apigateway_IRestApi_AsReference();
		case ApigatewayPackage.DOMAIN_NAME_BUILDER_APIGATEWAY__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case ApigatewayPackage.DOMAIN_NAME_BUILDER_APIGATEWAY__VAR_NAME:
			return getVarName();
		case ApigatewayPackage.DOMAIN_NAME_BUILDER_APIGATEWAY__IDENTIFIER:
			return getIdentifier();
		case ApigatewayPackage.DOMAIN_NAME_BUILDER_APIGATEWAY__ADDITIONAL_CODE:
...
} //DomainNameBuilder_apigatewayImpl
