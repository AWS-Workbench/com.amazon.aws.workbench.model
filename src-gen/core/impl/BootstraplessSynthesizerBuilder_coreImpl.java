...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Bootstrapless Synthesizer Builder core</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link core.impl.BootstraplessSynthesizerBuilder_coreImpl#getCloudFormationExecutionRoleArn_java_lang_String_ <em>Cloud Formation Execution Role Arn java lang String </em>}</li>
 *   <li>{@link core.impl.BootstraplessSynthesizerBuilder_coreImpl#getDeployRoleArn_java_lang_String_ <em>Deploy Role Arn java lang String </em>}</li>
 *   <li>{@link core.impl.BootstraplessSynthesizerBuilder_coreImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link core.impl.BootstraplessSynthesizerBuilder_coreImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link core.impl.BootstraplessSynthesizerBuilder_coreImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link core.impl.BootstraplessSynthesizerBuilder_coreImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BootstraplessSynthesizerBuilder_coreImpl extends MinimalEObjectImpl.Container
		implements BootstraplessSynthesizerBuilder_core {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.core.BootstraplessSynthesizer";
	 ...
	 * @generated
	 */
	protected BootstraplessSynthesizerBuilder_coreImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.BOOTSTRAPLESS_SYNTHESIZER_BUILDER_CORE;
	}
	...
	public void setCloudFormationExecutionRoleArn_java_lang_String_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.BOOTSTRAPLESS_SYNTHESIZER_BUILDER_CORE__CLOUD_FORMATION_EXECUTION_ROLE_ARN_JAVA_LANG_STRING_,
	...
	public void setDeployRoleArn_java_lang_String_(String newDeployRoleArn_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.BOOTSTRAPLESS_SYNTHESIZER_BUILDER_CORE__DEPLOY_ROLE_ARN_JAVA_LANG_STRING_,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.BOOTSTRAPLESS_SYNTHESIZER_BUILDER_CORE__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.BOOTSTRAPLESS_SYNTHESIZER_BUILDER_CORE__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.BOOTSTRAPLESS_SYNTHESIZER_BUILDER_CORE__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
...
} //BootstraplessSynthesizerBuilder_coreImpl
