...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Custom Resource Props Builder core</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link core.impl.CustomResourcePropsBuilder_coreImpl#getServiceToken_java_lang_String_ <em>Service Token java lang String </em>}</li>
 *   <li>{@link core.impl.CustomResourcePropsBuilder_coreImpl#getPascalCaseProperties_java_lang_Boolean_ <em>Pascal Case Properties java lang Boolean </em>}</li>
 *   <li>{@link core.impl.CustomResourcePropsBuilder_coreImpl#getProperties_java_lang_String__java_lang_Object_AsMap <em>Properties java lang String java lang Object As Map</em>}</li>
 *   <li>{@link core.impl.CustomResourcePropsBuilder_coreImpl#getRemovalPolicy_software_amazon_awscdk_core_RemovalPolicy_ <em>Removal Policy software amazon awscdk core Removal Policy </em>}</li>
 *   <li>{@link core.impl.CustomResourcePropsBuilder_coreImpl#getResourceType_java_lang_String_ <em>Resource Type java lang String </em>}</li>
 *   <li>{@link core.impl.CustomResourcePropsBuilder_coreImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link core.impl.CustomResourcePropsBuilder_coreImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link core.impl.CustomResourcePropsBuilder_coreImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link core.impl.CustomResourcePropsBuilder_coreImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CustomResourcePropsBuilder_coreImpl extends MinimalEObjectImpl.Container
		implements CustomResourcePropsBuilder_core {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.core.CustomResourceProps";
	 ...
	 * @generated
	 */
	protected CustomResourcePropsBuilder_coreImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.CUSTOM_RESOURCE_PROPS_BUILDER_CORE;
	}
	...
	public void setServiceToken_java_lang_String_(String newServiceToken_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.CUSTOM_RESOURCE_PROPS_BUILDER_CORE__SERVICE_TOKEN_JAVA_LANG_STRING_,
	...
	public void setPascalCaseProperties_java_lang_Boolean_(Boolean newPascalCaseProperties_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.CUSTOM_RESOURCE_PROPS_BUILDER_CORE__PASCAL_CASE_PROPERTIES_JAVA_LANG_BOOLEAN_,
	...
	public void setProperties_java_lang_String__java_lang_Object_AsMap(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.CUSTOM_RESOURCE_PROPS_BUILDER_CORE__PROPERTIES_JAVA_LANG_STRING_JAVA_LANG_OBJECT_AS_MAP,
	...
	public void setRemovalPolicy_software_amazon_awscdk_core_RemovalPolicy_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.CUSTOM_RESOURCE_PROPS_BUILDER_CORE__REMOVAL_POLICY_SOFTWARE_AMAZON_AWSCDK_CORE_REMOVAL_POLICY_,
	...
	public void setResourceType_java_lang_String_(String newResourceType_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.CUSTOM_RESOURCE_PROPS_BUILDER_CORE__RESOURCE_TYPE_JAVA_LANG_STRING_,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.CUSTOM_RESOURCE_PROPS_BUILDER_CORE__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.CUSTOM_RESOURCE_PROPS_BUILDER_CORE__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.CUSTOM_RESOURCE_PROPS_BUILDER_CORE__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CorePackage.CUSTOM_RESOURCE_PROPS_BUILDER_CORE__SERVICE_TOKEN_JAVA_LANG_STRING_:
			return getServiceToken_java_lang_String_();
		case CorePackage.CUSTOM_RESOURCE_PROPS_BUILDER_CORE__PASCAL_CASE_PROPERTIES_JAVA_LANG_BOOLEAN_:
			return getPascalCaseProperties_java_lang_Boolean_();
		case CorePackage.CUSTOM_RESOURCE_PROPS_BUILDER_CORE__PROPERTIES_JAVA_LANG_STRING_JAVA_LANG_OBJECT_AS_MAP:
			return getProperties_java_lang_String__java_lang_Object_AsMap();
		case CorePackage.CUSTOM_RESOURCE_PROPS_BUILDER_CORE__REMOVAL_POLICY_SOFTWARE_AMAZON_AWSCDK_CORE_REMOVAL_POLICY_:
			return getRemovalPolicy_software_amazon_awscdk_core_RemovalPolicy_();
		case CorePackage.CUSTOM_RESOURCE_PROPS_BUILDER_CORE__RESOURCE_TYPE_JAVA_LANG_STRING_:
			return getResourceType_java_lang_String_();
		case CorePackage.CUSTOM_RESOURCE_PROPS_BUILDER_CORE__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case CorePackage.CUSTOM_RESOURCE_PROPS_BUILDER_CORE__VAR_NAME:
			return getVarName();
		case CorePackage.CUSTOM_RESOURCE_PROPS_BUILDER_CORE__IDENTIFIER:
			return getIdentifier();
		case CorePackage.CUSTOM_RESOURCE_PROPS_BUILDER_CORE__ADDITIONAL_CODE:
...
} //CustomResourcePropsBuilder_coreImpl
