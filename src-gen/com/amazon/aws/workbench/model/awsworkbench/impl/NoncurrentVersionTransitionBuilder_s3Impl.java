...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Noncurrent Version Transition Builder s3</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NoncurrentVersionTransitionBuilder_s3Impl#getStorageClassWithStorageClass_software_amazon_awscdk_services_s3_StorageClass_AsReference <em>Storage Class With Storage Class software amazon awscdk services s3 Storage Class As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NoncurrentVersionTransitionBuilder_s3Impl#getTransitionAfterWithDuration_software_amazon_awscdk_core_Duration_AsReference <em>Transition After With Duration software amazon awscdk core Duration As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NoncurrentVersionTransitionBuilder_s3Impl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NoncurrentVersionTransitionBuilder_s3Impl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NoncurrentVersionTransitionBuilder_s3Impl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NoncurrentVersionTransitionBuilder_s3Impl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NoncurrentVersionTransitionBuilder_s3Impl extends MinimalEObjectImpl.Container
		implements NoncurrentVersionTransitionBuilder_s3 {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.s3.NoncurrentVersionTransition";
	 ...
	 * @generated
	 */
	protected NoncurrentVersionTransitionBuilder_s3Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AwsworkbenchPackage.Literals.NONCURRENT_VERSION_TRANSITION_BUILDER_S3;
	}
	...
	public void setStorageClassWithStorageClass_software_amazon_awscdk_services_s3_StorageClass_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NONCURRENT_VERSION_TRANSITION_BUILDER_S3__STORAGE_CLASS_WITH_STORAGE_CLASS_SOFTWARE_AMAZON_AWSCDK_SERVICES_S3_STORAGE_CLASS_AS_REFERENCE,
	...
	public void setTransitionAfterWithDuration_software_amazon_awscdk_core_Duration_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NONCURRENT_VERSION_TRANSITION_BUILDER_S3__TRANSITION_AFTER_WITH_DURATION_SOFTWARE_AMAZON_AWSCDK_CORE_DURATION_AS_REFERENCE,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NONCURRENT_VERSION_TRANSITION_BUILDER_S3__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NONCURRENT_VERSION_TRANSITION_BUILDER_S3__IDENTIFIER, oldIdentifier,
					identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NONCURRENT_VERSION_TRANSITION_BUILDER_S3__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
...
} //NoncurrentVersionTransitionBuilder_s3Impl
