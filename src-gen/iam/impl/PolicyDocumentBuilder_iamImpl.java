 ...
 * </p>
 * <ul>
 *   <li>{@link iam.impl.PolicyDocumentBuilder_iamImpl#getAssignSids_java_lang_Boolean_ <em>Assign Sids java lang Boolean </em>}</li>
 *   <li>{@link iam.impl.PolicyDocumentBuilder_iamImpl#getStatements_software_amazon_awscdk_services_iam_PolicyStatement_AsList <em>Statements software amazon awscdk services iam Policy Statement As List</em>}</li>
 *   <li>{@link iam.impl.PolicyDocumentBuilder_iamImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link iam.impl.PolicyDocumentBuilder_iamImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link iam.impl.PolicyDocumentBuilder_iamImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link iam.impl.PolicyDocumentBuilder_iamImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PolicyDocumentBuilder_iamImpl extends MinimalEObjectImpl.Container implements PolicyDocumentBuilder_iam {
	...
	protected EClass eStaticClass() {
		return IamPackage.Literals.POLICY_DOCUMENT_BUILDER_IAM;
	}
	...
	public void setAssignSids_java_lang_Boolean_(Boolean newAssignSids_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.POLICY_DOCUMENT_BUILDER_IAM__ASSIGN_SIDS_JAVA_LANG_BOOLEAN_,
	...
	public void setStatements_software_amazon_awscdk_services_iam_PolicyStatement_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.POLICY_DOCUMENT_BUILDER_IAM__STATEMENTS_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_POLICY_STATEMENT_AS_LIST,
	...
	public void setVarName(String newVarName) {
		...
		varName = newVarName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IamPackage.POLICY_DOCUMENT_BUILDER_IAM__VAR_NAME,
					oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IamPackage.POLICY_DOCUMENT_BUILDER_IAM__IDENTIFIER,
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.POLICY_DOCUMENT_BUILDER_IAM__ADDITIONAL_CODE, oldAdditionalCode, additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case IamPackage.POLICY_DOCUMENT_BUILDER_IAM__ASSIGN_SIDS_JAVA_LANG_BOOLEAN_:
			return getAssignSids_java_lang_Boolean_();
		case IamPackage.POLICY_DOCUMENT_BUILDER_IAM__STATEMENTS_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_POLICY_STATEMENT_AS_LIST:
			return getStatements_software_amazon_awscdk_services_iam_PolicyStatement_AsList();
		case IamPackage.POLICY_DOCUMENT_BUILDER_IAM__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case IamPackage.POLICY_DOCUMENT_BUILDER_IAM__VAR_NAME:
			return getVarName();
		case IamPackage.POLICY_DOCUMENT_BUILDER_IAM__IDENTIFIER:
			return getIdentifier();
		case IamPackage.POLICY_DOCUMENT_BUILDER_IAM__ADDITIONAL_CODE:
