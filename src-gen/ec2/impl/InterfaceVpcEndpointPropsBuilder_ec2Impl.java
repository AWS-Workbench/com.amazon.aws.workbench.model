...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Interface Vpc Endpoint Props Builder ec2</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ec2.impl.InterfaceVpcEndpointPropsBuilder_ec2Impl#getVpcWithIVpc_software_amazon_awscdk_services_ec2_IVpc_AsReference <em>Vpc With IVpc software amazon awscdk services ec2 IVpc As Reference</em>}</li>
 *   <li>{@link ec2.impl.InterfaceVpcEndpointPropsBuilder_ec2Impl#getServiceWithIInterfaceVpcEndpointService_software_amazon_awscdk_services_ec2_IInterfaceVpcEndpointService_AsReference <em>Service With IInterface Vpc Endpoint Service software amazon awscdk services ec2 IInterface Vpc Endpoint Service As Reference</em>}</li>
 *   <li>{@link ec2.impl.InterfaceVpcEndpointPropsBuilder_ec2Impl#getLookupSupportedAzs_java_lang_Boolean_ <em>Lookup Supported Azs java lang Boolean </em>}</li>
 *   <li>{@link ec2.impl.InterfaceVpcEndpointPropsBuilder_ec2Impl#getOpen_java_lang_Boolean_ <em>Open java lang Boolean </em>}</li>
 *   <li>{@link ec2.impl.InterfaceVpcEndpointPropsBuilder_ec2Impl#getPrivateDnsEnabled_java_lang_Boolean_ <em>Private Dns Enabled java lang Boolean </em>}</li>
 *   <li>{@link ec2.impl.InterfaceVpcEndpointPropsBuilder_ec2Impl#getSecurityGroups_software_amazon_awscdk_services_ec2_ISecurityGroup_AsList <em>Security Groups software amazon awscdk services ec2 ISecurity Group As List</em>}</li>
 *   <li>{@link ec2.impl.InterfaceVpcEndpointPropsBuilder_ec2Impl#getSubnetsWithSubnetSelection_software_amazon_awscdk_services_ec2_SubnetSelection_AsReference <em>Subnets With Subnet Selection software amazon awscdk services ec2 Subnet Selection As Reference</em>}</li>
 *   <li>{@link ec2.impl.InterfaceVpcEndpointPropsBuilder_ec2Impl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link ec2.impl.InterfaceVpcEndpointPropsBuilder_ec2Impl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link ec2.impl.InterfaceVpcEndpointPropsBuilder_ec2Impl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link ec2.impl.InterfaceVpcEndpointPropsBuilder_ec2Impl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InterfaceVpcEndpointPropsBuilder_ec2Impl extends MinimalEObjectImpl.Container
		implements InterfaceVpcEndpointPropsBuilder_ec2 {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.ec2.InterfaceVpcEndpointProps";
	 ...
	 * @generated
	 */
	protected InterfaceVpcEndpointPropsBuilder_ec2Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Ec2Package.Literals.INTERFACE_VPC_ENDPOINT_PROPS_BUILDER_EC2;
	}
	...
	public void setVpcWithIVpc_software_amazon_awscdk_services_ec2_IVpc_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.INTERFACE_VPC_ENDPOINT_PROPS_BUILDER_EC2__VPC_WITH_IVPC_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_IVPC_AS_REFERENCE,
	...
	public void setServiceWithIInterfaceVpcEndpointService_software_amazon_awscdk_services_ec2_IInterfaceVpcEndpointService_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.INTERFACE_VPC_ENDPOINT_PROPS_BUILDER_EC2__SERVICE_WITH_IINTERFACE_VPC_ENDPOINT_SERVICE_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_IINTERFACE_VPC_ENDPOINT_SERVICE_AS_REFERENCE,
	...
	public void setLookupSupportedAzs_java_lang_Boolean_(Boolean newLookupSupportedAzs_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.INTERFACE_VPC_ENDPOINT_PROPS_BUILDER_EC2__LOOKUP_SUPPORTED_AZS_JAVA_LANG_BOOLEAN_,
	...
	public void setOpen_java_lang_Boolean_(Boolean newOpen_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.INTERFACE_VPC_ENDPOINT_PROPS_BUILDER_EC2__OPEN_JAVA_LANG_BOOLEAN_,
					oldOpen_java_lang_Boolean_, open_java_lang_Boolean_));
	}
	...
	public void setPrivateDnsEnabled_java_lang_Boolean_(Boolean newPrivateDnsEnabled_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.INTERFACE_VPC_ENDPOINT_PROPS_BUILDER_EC2__PRIVATE_DNS_ENABLED_JAVA_LANG_BOOLEAN_,
	...
	public void setSecurityGroups_software_amazon_awscdk_services_ec2_ISecurityGroup_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.INTERFACE_VPC_ENDPOINT_PROPS_BUILDER_EC2__SECURITY_GROUPS_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_ISECURITY_GROUP_AS_LIST,
	...
	public void setSubnetsWithSubnetSelection_software_amazon_awscdk_services_ec2_SubnetSelection_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.INTERFACE_VPC_ENDPOINT_PROPS_BUILDER_EC2__SUBNETS_WITH_SUBNET_SELECTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_SUBNET_SELECTION_AS_REFERENCE,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.INTERFACE_VPC_ENDPOINT_PROPS_BUILDER_EC2__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.INTERFACE_VPC_ENDPOINT_PROPS_BUILDER_EC2__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.INTERFACE_VPC_ENDPOINT_PROPS_BUILDER_EC2__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Ec2Package.INTERFACE_VPC_ENDPOINT_PROPS_BUILDER_EC2__VPC_WITH_IVPC_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_IVPC_AS_REFERENCE:
			return getVpcWithIVpc_software_amazon_awscdk_services_ec2_IVpc_AsReference();
		case Ec2Package.INTERFACE_VPC_ENDPOINT_PROPS_BUILDER_EC2__SERVICE_WITH_IINTERFACE_VPC_ENDPOINT_SERVICE_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_IINTERFACE_VPC_ENDPOINT_SERVICE_AS_REFERENCE:
		...
		case Ec2Package.INTERFACE_VPC_ENDPOINT_PROPS_BUILDER_EC2__LOOKUP_SUPPORTED_AZS_JAVA_LANG_BOOLEAN_:
			return getLookupSupportedAzs_java_lang_Boolean_();
		case Ec2Package.INTERFACE_VPC_ENDPOINT_PROPS_BUILDER_EC2__OPEN_JAVA_LANG_BOOLEAN_:
			return getOpen_java_lang_Boolean_();
		case Ec2Package.INTERFACE_VPC_ENDPOINT_PROPS_BUILDER_EC2__PRIVATE_DNS_ENABLED_JAVA_LANG_BOOLEAN_:
			return getPrivateDnsEnabled_java_lang_Boolean_();
		case Ec2Package.INTERFACE_VPC_ENDPOINT_PROPS_BUILDER_EC2__SECURITY_GROUPS_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_ISECURITY_GROUP_AS_LIST:
			return getSecurityGroups_software_amazon_awscdk_services_ec2_ISecurityGroup_AsList();
		case Ec2Package.INTERFACE_VPC_ENDPOINT_PROPS_BUILDER_EC2__SUBNETS_WITH_SUBNET_SELECTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_SUBNET_SELECTION_AS_REFERENCE:
			return getSubnetsWithSubnetSelection_software_amazon_awscdk_services_ec2_SubnetSelection_AsReference();
		case Ec2Package.INTERFACE_VPC_ENDPOINT_PROPS_BUILDER_EC2__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case Ec2Package.INTERFACE_VPC_ENDPOINT_PROPS_BUILDER_EC2__VAR_NAME:
			return getVarName();
		case Ec2Package.INTERFACE_VPC_ENDPOINT_PROPS_BUILDER_EC2__IDENTIFIER:
			return getIdentifier();
		case Ec2Package.INTERFACE_VPC_ENDPOINT_PROPS_BUILDER_EC2__ADDITIONAL_CODE:
...
} //InterfaceVpcEndpointPropsBuilder_ec2Impl
