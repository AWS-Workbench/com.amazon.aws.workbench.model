...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Spec Rest Api Builder apigateway</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link apigateway.impl.SpecRestApiBuilder_apigatewayImpl#getDefaultCorsPreflightOptionsWithCorsOptions_software_amazon_awscdk_services_apigateway_CorsOptions_AsReference <em>Default Cors Preflight Options With Cors Options software amazon awscdk services apigateway Cors Options As Reference</em>}</li>
 *   <li>{@link apigateway.impl.SpecRestApiBuilder_apigatewayImpl#getDefaultIntegrationWithIntegration_software_amazon_awscdk_services_apigateway_Integration_AsReference <em>Default Integration With Integration software amazon awscdk services apigateway Integration As Reference</em>}</li>
 *   <li>{@link apigateway.impl.SpecRestApiBuilder_apigatewayImpl#getDefaultMethodOptionsWithMethodOptions_software_amazon_awscdk_services_apigateway_MethodOptions_AsReference <em>Default Method Options With Method Options software amazon awscdk services apigateway Method Options As Reference</em>}</li>
 *   <li>{@link apigateway.impl.SpecRestApiBuilder_apigatewayImpl#getCloudWatchRole_java_lang_Boolean_ <em>Cloud Watch Role java lang Boolean </em>}</li>
 *   <li>{@link apigateway.impl.SpecRestApiBuilder_apigatewayImpl#getDeploy_java_lang_Boolean_ <em>Deploy java lang Boolean </em>}</li>
 *   <li>{@link apigateway.impl.SpecRestApiBuilder_apigatewayImpl#getDeployOptionsWithStageOptions_software_amazon_awscdk_services_apigateway_StageOptions_AsReference <em>Deploy Options With Stage Options software amazon awscdk services apigateway Stage Options As Reference</em>}</li>
 *   <li>{@link apigateway.impl.SpecRestApiBuilder_apigatewayImpl#getDomainNameWithDomainNameOptions_software_amazon_awscdk_services_apigateway_DomainNameOptions_AsReference <em>Domain Name With Domain Name Options software amazon awscdk services apigateway Domain Name Options As Reference</em>}</li>
 *   <li>{@link apigateway.impl.SpecRestApiBuilder_apigatewayImpl#getEndpointExportName_java_lang_String_ <em>Endpoint Export Name java lang String </em>}</li>
 *   <li>{@link apigateway.impl.SpecRestApiBuilder_apigatewayImpl#getFailOnWarnings_java_lang_Boolean_ <em>Fail On Warnings java lang Boolean </em>}</li>
 *   <li>{@link apigateway.impl.SpecRestApiBuilder_apigatewayImpl#getParameters_java_lang_String__java_lang_String_AsMap <em>Parameters java lang String java lang String As Map</em>}</li>
 *   <li>{@link apigateway.impl.SpecRestApiBuilder_apigatewayImpl#getPolicyWithPolicyDocument_software_amazon_awscdk_services_iam_PolicyDocument_AsReference <em>Policy With Policy Document software amazon awscdk services iam Policy Document As Reference</em>}</li>
 *   <li>{@link apigateway.impl.SpecRestApiBuilder_apigatewayImpl#getRestApiName_java_lang_String_ <em>Rest Api Name java lang String </em>}</li>
 *   <li>{@link apigateway.impl.SpecRestApiBuilder_apigatewayImpl#getRetainDeployments_java_lang_Boolean_ <em>Retain Deployments java lang Boolean </em>}</li>
 *   <li>{@link apigateway.impl.SpecRestApiBuilder_apigatewayImpl#getApiDefinitionWithApiDefinition_software_amazon_awscdk_services_apigateway_ApiDefinition_AsReference <em>Api Definition With Api Definition software amazon awscdk services apigateway Api Definition As Reference</em>}</li>
 *   <li>{@link apigateway.impl.SpecRestApiBuilder_apigatewayImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link apigateway.impl.SpecRestApiBuilder_apigatewayImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link apigateway.impl.SpecRestApiBuilder_apigatewayImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link apigateway.impl.SpecRestApiBuilder_apigatewayImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpecRestApiBuilder_apigatewayImpl extends MinimalEObjectImpl.Container
		implements SpecRestApiBuilder_apigateway {
	/**
	...
	/**
	 * The default value of the '{@link #getApiDefinitionWithApiDefinition_software_amazon_awscdk_services_apigateway_ApiDefinition_AsReference() <em>Api Definition With Api Definition software amazon awscdk services apigateway Api Definition As Reference</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected static final String API_DEFINITION_WITH_API_DEFINITION_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_API_DEFINITION_AS_REFERENCE_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getApiDefinitionWithApiDefinition_software_amazon_awscdk_services_apigateway_ApiDefinition_AsReference() <em>Api Definition With Api Definition software amazon awscdk services apigateway Api Definition As Reference</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getApiDefinitionWithApiDefinition_software_amazon_awscdk_services_apigateway_ApiDefinition_AsReference()
	 * @generated
	 * @ordered
	 */
	protected String apiDefinitionWithApiDefinition_software_amazon_awscdk_services_apigateway_ApiDefinition_AsReference = API_DEFINITION_WITH_API_DEFINITION_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_API_DEFINITION_AS_REFERENCE_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.apigateway.SpecRestApi";
	 ...
	 * @generated
	 */
	protected SpecRestApiBuilder_apigatewayImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ApigatewayPackage.Literals.SPEC_REST_API_BUILDER_APIGATEWAY;
	}
	...
	public void setDefaultCorsPreflightOptionsWithCorsOptions_software_amazon_awscdk_services_apigateway_CorsOptions_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__DEFAULT_CORS_PREFLIGHT_OPTIONS_WITH_CORS_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_CORS_OPTIONS_AS_REFERENCE,
	...
	public void setDefaultIntegrationWithIntegration_software_amazon_awscdk_services_apigateway_Integration_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__DEFAULT_INTEGRATION_WITH_INTEGRATION_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_INTEGRATION_AS_REFERENCE,
	...
	public void setDefaultMethodOptionsWithMethodOptions_software_amazon_awscdk_services_apigateway_MethodOptions_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__DEFAULT_METHOD_OPTIONS_WITH_METHOD_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_METHOD_OPTIONS_AS_REFERENCE,
	...
	public void setCloudWatchRole_java_lang_Boolean_(Boolean newCloudWatchRole_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__CLOUD_WATCH_ROLE_JAVA_LANG_BOOLEAN_,
	...
	public void setDeploy_java_lang_Boolean_(Boolean newDeploy_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__DEPLOY_JAVA_LANG_BOOLEAN_,
	...
	public void setDeployOptionsWithStageOptions_software_amazon_awscdk_services_apigateway_StageOptions_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__DEPLOY_OPTIONS_WITH_STAGE_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_STAGE_OPTIONS_AS_REFERENCE,
	...
	public void setDomainNameWithDomainNameOptions_software_amazon_awscdk_services_apigateway_DomainNameOptions_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__DOMAIN_NAME_WITH_DOMAIN_NAME_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_DOMAIN_NAME_OPTIONS_AS_REFERENCE,
	...
	public void setEndpointExportName_java_lang_String_(String newEndpointExportName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__ENDPOINT_EXPORT_NAME_JAVA_LANG_STRING_,
	...
	public void setFailOnWarnings_java_lang_Boolean_(Boolean newFailOnWarnings_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__FAIL_ON_WARNINGS_JAVA_LANG_BOOLEAN_,
	...
	public void setParameters_java_lang_String__java_lang_String_AsMap(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__PARAMETERS_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP,
	...
	public void setPolicyWithPolicyDocument_software_amazon_awscdk_services_iam_PolicyDocument_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__POLICY_WITH_POLICY_DOCUMENT_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_POLICY_DOCUMENT_AS_REFERENCE,
	...
	public void setRestApiName_java_lang_String_(String newRestApiName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__REST_API_NAME_JAVA_LANG_STRING_,
	...
	public void setRetainDeployments_java_lang_Boolean_(Boolean newRetainDeployments_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__RETAIN_DEPLOYMENTS_JAVA_LANG_BOOLEAN_,
	 ...
	 */
	@Override
	public String getApiDefinitionWithApiDefinition_software_amazon_awscdk_services_apigateway_ApiDefinition_AsReference() {
		return apiDefinitionWithApiDefinition_software_amazon_awscdk_services_apigateway_ApiDefinition_AsReference;
	}
	 ...
	 */
	@Override
	public void setApiDefinitionWithApiDefinition_software_amazon_awscdk_services_apigateway_ApiDefinition_AsReference(
			String newApiDefinitionWithApiDefinition_software_amazon_awscdk_services_apigateway_ApiDefinition_AsReference) {
		String oldApiDefinitionWithApiDefinition_software_amazon_awscdk_services_apigateway_ApiDefinition_AsReference = apiDefinitionWithApiDefinition_software_amazon_awscdk_services_apigateway_ApiDefinition_AsReference;
		apiDefinitionWithApiDefinition_software_amazon_awscdk_services_apigateway_ApiDefinition_AsReference = newApiDefinitionWithApiDefinition_software_amazon_awscdk_services_apigateway_ApiDefinition_AsReference;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__API_DEFINITION_WITH_API_DEFINITION_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_API_DEFINITION_AS_REFERENCE,
					oldApiDefinitionWithApiDefinition_software_amazon_awscdk_services_apigateway_ApiDefinition_AsReference,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__DEFAULT_CORS_PREFLIGHT_OPTIONS_WITH_CORS_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_CORS_OPTIONS_AS_REFERENCE:
			return getDefaultCorsPreflightOptionsWithCorsOptions_software_amazon_awscdk_services_apigateway_CorsOptions_AsReference();
		case ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__DEFAULT_INTEGRATION_WITH_INTEGRATION_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_INTEGRATION_AS_REFERENCE:
			return getDefaultIntegrationWithIntegration_software_amazon_awscdk_services_apigateway_Integration_AsReference();
		case ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__DEFAULT_METHOD_OPTIONS_WITH_METHOD_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_METHOD_OPTIONS_AS_REFERENCE:
			return getDefaultMethodOptionsWithMethodOptions_software_amazon_awscdk_services_apigateway_MethodOptions_AsReference();
		case ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__CLOUD_WATCH_ROLE_JAVA_LANG_BOOLEAN_:
			return getCloudWatchRole_java_lang_Boolean_();
		case ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__DEPLOY_JAVA_LANG_BOOLEAN_:
			return getDeploy_java_lang_Boolean_();
		case ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__DEPLOY_OPTIONS_WITH_STAGE_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_STAGE_OPTIONS_AS_REFERENCE:
			return getDeployOptionsWithStageOptions_software_amazon_awscdk_services_apigateway_StageOptions_AsReference();
		case ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__DOMAIN_NAME_WITH_DOMAIN_NAME_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_DOMAIN_NAME_OPTIONS_AS_REFERENCE:
			return getDomainNameWithDomainNameOptions_software_amazon_awscdk_services_apigateway_DomainNameOptions_AsReference();
		case ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__ENDPOINT_EXPORT_NAME_JAVA_LANG_STRING_:
			return getEndpointExportName_java_lang_String_();
		case ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__FAIL_ON_WARNINGS_JAVA_LANG_BOOLEAN_:
			return getFailOnWarnings_java_lang_Boolean_();
		case ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__PARAMETERS_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP:
			return getParameters_java_lang_String__java_lang_String_AsMap();
		case ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__POLICY_WITH_POLICY_DOCUMENT_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_POLICY_DOCUMENT_AS_REFERENCE:
			return getPolicyWithPolicyDocument_software_amazon_awscdk_services_iam_PolicyDocument_AsReference();
		case ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__REST_API_NAME_JAVA_LANG_STRING_:
			return getRestApiName_java_lang_String_();
		case ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__RETAIN_DEPLOYMENTS_JAVA_LANG_BOOLEAN_:
			return getRetainDeployments_java_lang_Boolean_();
		case ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__API_DEFINITION_WITH_API_DEFINITION_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_API_DEFINITION_AS_REFERENCE:
			return getApiDefinitionWithApiDefinition_software_amazon_awscdk_services_apigateway_ApiDefinition_AsReference();
		case ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__VAR_NAME:
			return getVarName();
		case ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__IDENTIFIER:
			return getIdentifier();
		case ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__ADDITIONAL_CODE:
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__RETAIN_DEPLOYMENTS_JAVA_LANG_BOOLEAN_:
			...
			return;
		case ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__API_DEFINITION_WITH_API_DEFINITION_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_API_DEFINITION_AS_REFERENCE:
			setApiDefinitionWithApiDefinition_software_amazon_awscdk_services_apigateway_ApiDefinition_AsReference(
					(String) newValue);
			return;
		case ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__VAR_NAME:
	...
	public void eUnset(int featureID) {
		...
		case ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__API_DEFINITION_WITH_API_DEFINITION_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_API_DEFINITION_AS_REFERENCE:
			setApiDefinitionWithApiDefinition_software_amazon_awscdk_services_apigateway_ApiDefinition_AsReference(
					API_DEFINITION_WITH_API_DEFINITION_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_API_DEFINITION_AS_REFERENCE_EDEFAULT);
			return;
		case ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__VAR_NAME:
	...
	public boolean eIsSet(int featureID) {
		...
		case ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__API_DEFINITION_WITH_API_DEFINITION_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_API_DEFINITION_AS_REFERENCE:
			return API_DEFINITION_WITH_API_DEFINITION_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_API_DEFINITION_AS_REFERENCE_EDEFAULT == null
					? apiDefinitionWithApiDefinition_software_amazon_awscdk_services_apigateway_ApiDefinition_AsReference != null
					: !API_DEFINITION_WITH_API_DEFINITION_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_API_DEFINITION_AS_REFERENCE_EDEFAULT
							.equals(apiDefinitionWithApiDefinition_software_amazon_awscdk_services_apigateway_ApiDefinition_AsReference);
		case ApigatewayPackage.SPEC_REST_API_BUILDER_APIGATEWAY__GENERATED_CLASS_NAME:
...
} //SpecRestApiBuilder_apigatewayImpl
