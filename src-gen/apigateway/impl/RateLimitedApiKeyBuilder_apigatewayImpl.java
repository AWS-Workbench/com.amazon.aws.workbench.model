...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Rate Limited Api Key Builder apigateway</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link apigateway.impl.RateLimitedApiKeyBuilder_apigatewayImpl#getDefaultCorsPreflightOptionsWithCorsOptions_software_amazon_awscdk_services_apigateway_CorsOptions_AsReference <em>Default Cors Preflight Options With Cors Options software amazon awscdk services apigateway Cors Options As Reference</em>}</li>
 *   <li>{@link apigateway.impl.RateLimitedApiKeyBuilder_apigatewayImpl#getDefaultIntegrationWithIntegration_software_amazon_awscdk_services_apigateway_Integration_AsReference <em>Default Integration With Integration software amazon awscdk services apigateway Integration As Reference</em>}</li>
 *   <li>{@link apigateway.impl.RateLimitedApiKeyBuilder_apigatewayImpl#getDefaultMethodOptionsWithMethodOptions_software_amazon_awscdk_services_apigateway_MethodOptions_AsReference <em>Default Method Options With Method Options software amazon awscdk services apigateway Method Options As Reference</em>}</li>
 *   <li>{@link apigateway.impl.RateLimitedApiKeyBuilder_apigatewayImpl#getApiKeyName_java_lang_String_ <em>Api Key Name java lang String </em>}</li>
 *   <li>{@link apigateway.impl.RateLimitedApiKeyBuilder_apigatewayImpl#getValue_java_lang_String_ <em>Value java lang String </em>}</li>
 *   <li>{@link apigateway.impl.RateLimitedApiKeyBuilder_apigatewayImpl#getCustomerId_java_lang_String_ <em>Customer Id java lang String </em>}</li>
 *   <li>{@link apigateway.impl.RateLimitedApiKeyBuilder_apigatewayImpl#getDescription_java_lang_String_ <em>Description java lang String </em>}</li>
 *   <li>{@link apigateway.impl.RateLimitedApiKeyBuilder_apigatewayImpl#getEnabled_java_lang_Boolean_ <em>Enabled java lang Boolean </em>}</li>
 *   <li>{@link apigateway.impl.RateLimitedApiKeyBuilder_apigatewayImpl#getGenerateDistinctId_java_lang_Boolean_ <em>Generate Distinct Id java lang Boolean </em>}</li>
 *   <li>{@link apigateway.impl.RateLimitedApiKeyBuilder_apigatewayImpl#getResources_software_amazon_awscdk_services_apigateway_RestApi_AsList <em>Resources software amazon awscdk services apigateway Rest Api As List</em>}</li>
 *   <li>{@link apigateway.impl.RateLimitedApiKeyBuilder_apigatewayImpl#getApiStages_software_amazon_awscdk_services_apigateway_UsagePlanPerApiStage_AsList <em>Api Stages software amazon awscdk services apigateway Usage Plan Per Api Stage As List</em>}</li>
 *   <li>{@link apigateway.impl.RateLimitedApiKeyBuilder_apigatewayImpl#getQuotaWithQuotaSettings_software_amazon_awscdk_services_apigateway_QuotaSettings_AsReference <em>Quota With Quota Settings software amazon awscdk services apigateway Quota Settings As Reference</em>}</li>
 *   <li>{@link apigateway.impl.RateLimitedApiKeyBuilder_apigatewayImpl#getThrottleWithThrottleSettings_software_amazon_awscdk_services_apigateway_ThrottleSettings_AsReference <em>Throttle With Throttle Settings software amazon awscdk services apigateway Throttle Settings As Reference</em>}</li>
 *   <li>{@link apigateway.impl.RateLimitedApiKeyBuilder_apigatewayImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link apigateway.impl.RateLimitedApiKeyBuilder_apigatewayImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link apigateway.impl.RateLimitedApiKeyBuilder_apigatewayImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link apigateway.impl.RateLimitedApiKeyBuilder_apigatewayImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RateLimitedApiKeyBuilder_apigatewayImpl extends MinimalEObjectImpl.Container
		implements RateLimitedApiKeyBuilder_apigateway {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.apigateway.RateLimitedApiKey";
	 ...
	 * @generated
	 */
	protected RateLimitedApiKeyBuilder_apigatewayImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ApigatewayPackage.Literals.RATE_LIMITED_API_KEY_BUILDER_APIGATEWAY;
	}
	...
	public void setDefaultCorsPreflightOptionsWithCorsOptions_software_amazon_awscdk_services_apigateway_CorsOptions_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.RATE_LIMITED_API_KEY_BUILDER_APIGATEWAY__DEFAULT_CORS_PREFLIGHT_OPTIONS_WITH_CORS_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_CORS_OPTIONS_AS_REFERENCE,
	...
	public void setDefaultIntegrationWithIntegration_software_amazon_awscdk_services_apigateway_Integration_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.RATE_LIMITED_API_KEY_BUILDER_APIGATEWAY__DEFAULT_INTEGRATION_WITH_INTEGRATION_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_INTEGRATION_AS_REFERENCE,
	...
	public void setDefaultMethodOptionsWithMethodOptions_software_amazon_awscdk_services_apigateway_MethodOptions_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.RATE_LIMITED_API_KEY_BUILDER_APIGATEWAY__DEFAULT_METHOD_OPTIONS_WITH_METHOD_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_METHOD_OPTIONS_AS_REFERENCE,
	...
	public void setApiKeyName_java_lang_String_(String newApiKeyName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.RATE_LIMITED_API_KEY_BUILDER_APIGATEWAY__API_KEY_NAME_JAVA_LANG_STRING_,
	...
	public void setValue_java_lang_String_(String newValue_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.RATE_LIMITED_API_KEY_BUILDER_APIGATEWAY__VALUE_JAVA_LANG_STRING_,
	...
	public void setCustomerId_java_lang_String_(String newCustomerId_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.RATE_LIMITED_API_KEY_BUILDER_APIGATEWAY__CUSTOMER_ID_JAVA_LANG_STRING_,
	...
	public void setDescription_java_lang_String_(String newDescription_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.RATE_LIMITED_API_KEY_BUILDER_APIGATEWAY__DESCRIPTION_JAVA_LANG_STRING_,
	...
	public void setEnabled_java_lang_Boolean_(Boolean newEnabled_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.RATE_LIMITED_API_KEY_BUILDER_APIGATEWAY__ENABLED_JAVA_LANG_BOOLEAN_,
	...
	public void setGenerateDistinctId_java_lang_Boolean_(Boolean newGenerateDistinctId_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.RATE_LIMITED_API_KEY_BUILDER_APIGATEWAY__GENERATE_DISTINCT_ID_JAVA_LANG_BOOLEAN_,
	...
	public void setResources_software_amazon_awscdk_services_apigateway_RestApi_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.RATE_LIMITED_API_KEY_BUILDER_APIGATEWAY__RESOURCES_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_REST_API_AS_LIST,
	...
	public void setApiStages_software_amazon_awscdk_services_apigateway_UsagePlanPerApiStage_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.RATE_LIMITED_API_KEY_BUILDER_APIGATEWAY__API_STAGES_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_USAGE_PLAN_PER_API_STAGE_AS_LIST,
	...
	public void setQuotaWithQuotaSettings_software_amazon_awscdk_services_apigateway_QuotaSettings_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.RATE_LIMITED_API_KEY_BUILDER_APIGATEWAY__QUOTA_WITH_QUOTA_SETTINGS_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_QUOTA_SETTINGS_AS_REFERENCE,
	...
	public void setThrottleWithThrottleSettings_software_amazon_awscdk_services_apigateway_ThrottleSettings_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.RATE_LIMITED_API_KEY_BUILDER_APIGATEWAY__THROTTLE_WITH_THROTTLE_SETTINGS_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_THROTTLE_SETTINGS_AS_REFERENCE,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.RATE_LIMITED_API_KEY_BUILDER_APIGATEWAY__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.RATE_LIMITED_API_KEY_BUILDER_APIGATEWAY__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.RATE_LIMITED_API_KEY_BUILDER_APIGATEWAY__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
