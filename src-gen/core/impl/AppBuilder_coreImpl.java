 ...
 * </p>
 * <ul>
 *   <li>{@link core.impl.AppBuilder_coreImpl#getAutoSynth_java_lang_Boolean_ <em>Auto Synth java lang Boolean </em>}</li>
 *   <li>{@link core.impl.AppBuilder_coreImpl#getContext_java_lang_String__java_lang_String_AsMap <em>Context java lang String java lang String As Map</em>}</li>
 *   <li>{@link core.impl.AppBuilder_coreImpl#getOutdir_java_lang_String_ <em>Outdir java lang String </em>}</li>
 *   <li>{@link core.impl.AppBuilder_coreImpl#getRuntimeInfo_java_lang_Boolean_ <em>Runtime Info java lang Boolean </em>}</li>
 *   <li>{@link core.impl.AppBuilder_coreImpl#getStackTraces_java_lang_Boolean_ <em>Stack Traces java lang Boolean </em>}</li>
 *   <li>{@link core.impl.AppBuilder_coreImpl#getTreeMetadata_java_lang_Boolean_ <em>Tree Metadata java lang Boolean </em>}</li>
 *   <li>{@link core.impl.AppBuilder_coreImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link core.impl.AppBuilder_coreImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link core.impl.AppBuilder_coreImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link core.impl.AppBuilder_coreImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AppBuilder_coreImpl extends MinimalEObjectImpl.Container implements AppBuilder_core {
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.APP_BUILDER_CORE;
	}
	...
	public void setAutoSynth_java_lang_Boolean_(Boolean newAutoSynth_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.APP_BUILDER_CORE__AUTO_SYNTH_JAVA_LANG_BOOLEAN_, oldAutoSynth_java_lang_Boolean_,
	...
	public void setContext_java_lang_String__java_lang_String_AsMap(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.APP_BUILDER_CORE__CONTEXT_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP,
	...
	public void setOutdir_java_lang_String_(String newOutdir_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.APP_BUILDER_CORE__OUTDIR_JAVA_LANG_STRING_, oldOutdir_java_lang_String_,
	...
	public void setRuntimeInfo_java_lang_Boolean_(Boolean newRuntimeInfo_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.APP_BUILDER_CORE__RUNTIME_INFO_JAVA_LANG_BOOLEAN_, oldRuntimeInfo_java_lang_Boolean_,
					runtimeInfo_java_lang_Boolean_));
	}
	...
	public void setStackTraces_java_lang_Boolean_(Boolean newStackTraces_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.APP_BUILDER_CORE__STACK_TRACES_JAVA_LANG_BOOLEAN_, oldStackTraces_java_lang_Boolean_,
					stackTraces_java_lang_Boolean_));
	}
	...
	public void setTreeMetadata_java_lang_Boolean_(Boolean newTreeMetadata_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.APP_BUILDER_CORE__TREE_METADATA_JAVA_LANG_BOOLEAN_, oldTreeMetadata_java_lang_Boolean_,
					treeMetadata_java_lang_Boolean_));
	}
	...
	public void setVarName(String newVarName) {
		...
		varName = newVarName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.APP_BUILDER_CORE__VAR_NAME, oldVarName,
					varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.APP_BUILDER_CORE__IDENTIFIER,
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.APP_BUILDER_CORE__ADDITIONAL_CODE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CorePackage.APP_BUILDER_CORE__AUTO_SYNTH_JAVA_LANG_BOOLEAN_:
			return getAutoSynth_java_lang_Boolean_();
		case CorePackage.APP_BUILDER_CORE__CONTEXT_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP:
			return getContext_java_lang_String__java_lang_String_AsMap();
		case CorePackage.APP_BUILDER_CORE__OUTDIR_JAVA_LANG_STRING_:
			return getOutdir_java_lang_String_();
		case CorePackage.APP_BUILDER_CORE__RUNTIME_INFO_JAVA_LANG_BOOLEAN_:
			return getRuntimeInfo_java_lang_Boolean_();
		case CorePackage.APP_BUILDER_CORE__STACK_TRACES_JAVA_LANG_BOOLEAN_:
			return getStackTraces_java_lang_Boolean_();
		case CorePackage.APP_BUILDER_CORE__TREE_METADATA_JAVA_LANG_BOOLEAN_:
			return getTreeMetadata_java_lang_Boolean_();
		case CorePackage.APP_BUILDER_CORE__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case CorePackage.APP_BUILDER_CORE__VAR_NAME:
			return getVarName();
		case CorePackage.APP_BUILDER_CORE__IDENTIFIER:
			return getIdentifier();
		case CorePackage.APP_BUILDER_CORE__ADDITIONAL_CODE:
