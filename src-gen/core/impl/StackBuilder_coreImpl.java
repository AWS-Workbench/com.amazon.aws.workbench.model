 ...
 * </p>
 * <ul>
 *   <li>{@link core.impl.StackBuilder_coreImpl#getDescription_java_lang_String_ <em>Description java lang String </em>}</li>
 *   <li>{@link core.impl.StackBuilder_coreImpl#getEnvWithEnvironment_software_amazon_awscdk_core_Environment_AsReference <em>Env With Environment software amazon awscdk core Environment As Reference</em>}</li>
 *   <li>{@link core.impl.StackBuilder_coreImpl#getStackName_java_lang_String_ <em>Stack Name java lang String </em>}</li>
 *   <li>{@link core.impl.StackBuilder_coreImpl#getSynthesizerWithIStackSynthesizer_software_amazon_awscdk_core_IStackSynthesizer_AsReference <em>Synthesizer With IStack Synthesizer software amazon awscdk core IStack Synthesizer As Reference</em>}</li>
 *   <li>{@link core.impl.StackBuilder_coreImpl#getTags_java_lang_String__java_lang_String_AsMap <em>Tags java lang String java lang String As Map</em>}</li>
 *   <li>{@link core.impl.StackBuilder_coreImpl#getTerminationProtection_java_lang_Boolean_ <em>Termination Protection java lang Boolean </em>}</li>
 *   <li>{@link core.impl.StackBuilder_coreImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link core.impl.StackBuilder_coreImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link core.impl.StackBuilder_coreImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link core.impl.StackBuilder_coreImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StackBuilder_coreImpl extends MinimalEObjectImpl.Container implements StackBuilder_core {
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.STACK_BUILDER_CORE;
	}
	...
	public void setDescription_java_lang_String_(String newDescription_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.STACK_BUILDER_CORE__DESCRIPTION_JAVA_LANG_STRING_, oldDescription_java_lang_String_,
	...
	public void setEnvWithEnvironment_software_amazon_awscdk_core_Environment_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.STACK_BUILDER_CORE__ENV_WITH_ENVIRONMENT_SOFTWARE_AMAZON_AWSCDK_CORE_ENVIRONMENT_AS_REFERENCE,
	...
	public void setStackName_java_lang_String_(String newStackName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.STACK_BUILDER_CORE__STACK_NAME_JAVA_LANG_STRING_, oldStackName_java_lang_String_,
	...
	public void setSynthesizerWithIStackSynthesizer_software_amazon_awscdk_core_IStackSynthesizer_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.STACK_BUILDER_CORE__SYNTHESIZER_WITH_ISTACK_SYNTHESIZER_SOFTWARE_AMAZON_AWSCDK_CORE_ISTACK_SYNTHESIZER_AS_REFERENCE,
	...
	public void setTags_java_lang_String__java_lang_String_AsMap(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.STACK_BUILDER_CORE__TAGS_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP,
	...
	public void setTerminationProtection_java_lang_Boolean_(Boolean newTerminationProtection_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.STACK_BUILDER_CORE__TERMINATION_PROTECTION_JAVA_LANG_BOOLEAN_,
	...
	public void setVarName(String newVarName) {
		...
		varName = newVarName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.STACK_BUILDER_CORE__VAR_NAME, oldVarName,
					varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.STACK_BUILDER_CORE__IDENTIFIER,
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.STACK_BUILDER_CORE__ADDITIONAL_CODE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CorePackage.STACK_BUILDER_CORE__DESCRIPTION_JAVA_LANG_STRING_:
			return getDescription_java_lang_String_();
		case CorePackage.STACK_BUILDER_CORE__ENV_WITH_ENVIRONMENT_SOFTWARE_AMAZON_AWSCDK_CORE_ENVIRONMENT_AS_REFERENCE:
			return getEnvWithEnvironment_software_amazon_awscdk_core_Environment_AsReference();
		case CorePackage.STACK_BUILDER_CORE__STACK_NAME_JAVA_LANG_STRING_:
			return getStackName_java_lang_String_();
		case CorePackage.STACK_BUILDER_CORE__SYNTHESIZER_WITH_ISTACK_SYNTHESIZER_SOFTWARE_AMAZON_AWSCDK_CORE_ISTACK_SYNTHESIZER_AS_REFERENCE:
			return getSynthesizerWithIStackSynthesizer_software_amazon_awscdk_core_IStackSynthesizer_AsReference();
		case CorePackage.STACK_BUILDER_CORE__TAGS_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP:
			return getTags_java_lang_String__java_lang_String_AsMap();
		case CorePackage.STACK_BUILDER_CORE__TERMINATION_PROTECTION_JAVA_LANG_BOOLEAN_:
			return getTerminationProtection_java_lang_Boolean_();
		case CorePackage.STACK_BUILDER_CORE__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case CorePackage.STACK_BUILDER_CORE__VAR_NAME:
			return getVarName();
		case CorePackage.STACK_BUILDER_CORE__IDENTIFIER:
			return getIdentifier();
		case CorePackage.STACK_BUILDER_CORE__ADDITIONAL_CODE:
