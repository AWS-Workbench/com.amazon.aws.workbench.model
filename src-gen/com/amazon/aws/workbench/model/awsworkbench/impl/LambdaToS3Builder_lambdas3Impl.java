...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Lambda To S3 Builder lambdas3</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.LambdaToS3Builder_lambdas3Impl#getBucketPermissions_java_lang_String_AsList <em>Bucket Permissions java lang String As List</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.LambdaToS3Builder_lambdas3Impl#getBucketPropsWithBucketProps_software_amazon_awscdk_services_s3_BucketProps_AsReference <em>Bucket Props With Bucket Props software amazon awscdk services s3 Bucket Props As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.LambdaToS3Builder_lambdas3Impl#getExistingBucketObjWithBucket_software_amazon_awscdk_services_s3_Bucket_AsReference <em>Existing Bucket Obj With Bucket software amazon awscdk services s3 Bucket As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.LambdaToS3Builder_lambdas3Impl#getExistingLambdaObjWithFunction_software_amazon_awscdk_services_lambda_Function_AsReference <em>Existing Lambda Obj With Function software amazon awscdk services lambda Function As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.LambdaToS3Builder_lambdas3Impl#getLambdaFunctionPropsWithFunctionProps_software_amazon_awscdk_services_lambda_FunctionProps_AsReference <em>Lambda Function Props With Function Props software amazon awscdk services lambda Function Props As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.LambdaToS3Builder_lambdas3Impl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.LambdaToS3Builder_lambdas3Impl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.LambdaToS3Builder_lambdas3Impl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.LambdaToS3Builder_lambdas3Impl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LambdaToS3Builder_lambdas3Impl extends ServiceResourcesImpl implements LambdaToS3Builder_lambdas3 {
	 ...
	 * @ordered
	 */
	protected static final String BUCKET_PERMISSIONS_JAVA_LANG_STRING_AS_LIST_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getBucketPermissions_java_lang_String_AsList() <em>Bucket Permissions java lang String As List</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getBucketPermissions_java_lang_String_AsList()
	 * @generated
	 * @ordered
	 */
	protected String bucketPermissions_java_lang_String_AsList = BUCKET_PERMISSIONS_JAVA_LANG_STRING_AS_LIST_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.awsconstructs.services.lambdas3.LambdaToS3";
	 ...
	 * @generated
	 */
	protected LambdaToS3Builder_lambdas3Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AwsworkbenchPackage.Literals.LAMBDA_TO_S3_BUILDER_LAMBDAS3;
	}
	 ...
	 */
	@Override
	public String getBucketPermissions_java_lang_String_AsList() {
		return bucketPermissions_java_lang_String_AsList;
	}
	 ...
	 */
	@Override
	public void setBucketPermissions_java_lang_String_AsList(String newBucketPermissions_java_lang_String_AsList) {
		String oldBucketPermissions_java_lang_String_AsList = bucketPermissions_java_lang_String_AsList;
		bucketPermissions_java_lang_String_AsList = newBucketPermissions_java_lang_String_AsList;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.LAMBDA_TO_S3_BUILDER_LAMBDAS3__BUCKET_PERMISSIONS_JAVA_LANG_STRING_AS_LIST,
					oldBucketPermissions_java_lang_String_AsList, bucketPermissions_java_lang_String_AsList));
	}
	...
	public void setBucketPropsWithBucketProps_software_amazon_awscdk_services_s3_BucketProps_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.LAMBDA_TO_S3_BUILDER_LAMBDAS3__BUCKET_PROPS_WITH_BUCKET_PROPS_SOFTWARE_AMAZON_AWSCDK_SERVICES_S3_BUCKET_PROPS_AS_REFERENCE,
	...
	public void setExistingBucketObjWithBucket_software_amazon_awscdk_services_s3_Bucket_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.LAMBDA_TO_S3_BUILDER_LAMBDAS3__EXISTING_BUCKET_OBJ_WITH_BUCKET_SOFTWARE_AMAZON_AWSCDK_SERVICES_S3_BUCKET_AS_REFERENCE,
	...
	public void setExistingLambdaObjWithFunction_software_amazon_awscdk_services_lambda_Function_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.LAMBDA_TO_S3_BUILDER_LAMBDAS3__EXISTING_LAMBDA_OBJ_WITH_FUNCTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_FUNCTION_AS_REFERENCE,
	...
	public void setLambdaFunctionPropsWithFunctionProps_software_amazon_awscdk_services_lambda_FunctionProps_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.LAMBDA_TO_S3_BUILDER_LAMBDAS3__LAMBDA_FUNCTION_PROPS_WITH_FUNCTION_PROPS_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_FUNCTION_PROPS_AS_REFERENCE,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.LAMBDA_TO_S3_BUILDER_LAMBDAS3__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.LAMBDA_TO_S3_BUILDER_LAMBDAS3__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.LAMBDA_TO_S3_BUILDER_LAMBDAS3__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case AwsworkbenchPackage.LAMBDA_TO_S3_BUILDER_LAMBDAS3__BUCKET_PERMISSIONS_JAVA_LANG_STRING_AS_LIST:
			return getBucketPermissions_java_lang_String_AsList();
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
		case AwsworkbenchPackage.LAMBDA_TO_S3_BUILDER_LAMBDAS3__BUCKET_PERMISSIONS_JAVA_LANG_STRING_AS_LIST:
			setBucketPermissions_java_lang_String_AsList((String) newValue);
			return;
		case AwsworkbenchPackage.LAMBDA_TO_S3_BUILDER_LAMBDAS3__BUCKET_PROPS_WITH_BUCKET_PROPS_SOFTWARE_AMAZON_AWSCDK_SERVICES_S3_BUCKET_PROPS_AS_REFERENCE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
		case AwsworkbenchPackage.LAMBDA_TO_S3_BUILDER_LAMBDAS3__BUCKET_PERMISSIONS_JAVA_LANG_STRING_AS_LIST:
			setBucketPermissions_java_lang_String_AsList(BUCKET_PERMISSIONS_JAVA_LANG_STRING_AS_LIST_EDEFAULT);
			return;
		case AwsworkbenchPackage.LAMBDA_TO_S3_BUILDER_LAMBDAS3__BUCKET_PROPS_WITH_BUCKET_PROPS_SOFTWARE_AMAZON_AWSCDK_SERVICES_S3_BUCKET_PROPS_AS_REFERENCE:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case AwsworkbenchPackage.LAMBDA_TO_S3_BUILDER_LAMBDAS3__BUCKET_PERMISSIONS_JAVA_LANG_STRING_AS_LIST:
			return BUCKET_PERMISSIONS_JAVA_LANG_STRING_AS_LIST_EDEFAULT == null
					? bucketPermissions_java_lang_String_AsList != null
					: !BUCKET_PERMISSIONS_JAVA_LANG_STRING_AS_LIST_EDEFAULT
							.equals(bucketPermissions_java_lang_String_AsList);
		case AwsworkbenchPackage.LAMBDA_TO_S3_BUILDER_LAMBDAS3__BUCKET_PROPS_WITH_BUCKET_PROPS_SOFTWARE_AMAZON_AWSCDK_SERVICES_S3_BUCKET_PROPS_AS_REFERENCE:
	...
	public String toString() {
		...
		result.append(" (bucketPermissions_java_lang_String_AsList: ");
		result.append(bucketPermissions_java_lang_String_AsList);
...
} //LambdaToS3Builder_lambdas3Impl
