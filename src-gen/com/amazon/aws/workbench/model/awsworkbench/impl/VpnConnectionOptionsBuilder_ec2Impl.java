 ...
 * </p>
 * <ul>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.VpnConnectionOptionsBuilder_ec2Impl#getIp_java_lang_String_ <em>Ip java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.VpnConnectionOptionsBuilder_ec2Impl#getAsn_java_lang_Number_ <em>Asn java lang Number </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.VpnConnectionOptionsBuilder_ec2Impl#getStaticRoutes_java_lang_String_AsList <em>Static Routes java lang String As List</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.VpnConnectionOptionsBuilder_ec2Impl#getTunnelOptions_software_amazon_awscdk_services_ec2_VpnTunnelOption_AsList <em>Tunnel Options software amazon awscdk services ec2 Vpn Tunnel Option As List</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.VpnConnectionOptionsBuilder_ec2Impl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.VpnConnectionOptionsBuilder_ec2Impl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.VpnConnectionOptionsBuilder_ec2Impl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.VpnConnectionOptionsBuilder_ec2Impl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VpnConnectionOptionsBuilder_ec2Impl extends ServiceResourcesImpl
	...
	protected EClass eStaticClass() {
		return AwsworkbenchPackage.Literals.VPN_CONNECTION_OPTIONS_BUILDER_EC2;
	}
	...
	public void setIp_java_lang_String_(String newIp_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.VPN_CONNECTION_OPTIONS_BUILDER_EC2__IP_JAVA_LANG_STRING_,
					oldIp_java_lang_String_, ip_java_lang_String_));
	}
	...
	public void setAsn_java_lang_Number_(int newAsn_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.VPN_CONNECTION_OPTIONS_BUILDER_EC2__ASN_JAVA_LANG_NUMBER_,
					oldAsn_java_lang_Number_, asn_java_lang_Number_));
	}
	...
	public void setStaticRoutes_java_lang_String_AsList(String newStaticRoutes_java_lang_String_AsList) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.VPN_CONNECTION_OPTIONS_BUILDER_EC2__STATIC_ROUTES_JAVA_LANG_STRING_AS_LIST,
	...
	public void setTunnelOptions_software_amazon_awscdk_services_ec2_VpnTunnelOption_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.VPN_CONNECTION_OPTIONS_BUILDER_EC2__TUNNEL_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_VPN_TUNNEL_OPTION_AS_LIST,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.VPN_CONNECTION_OPTIONS_BUILDER_EC2__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.VPN_CONNECTION_OPTIONS_BUILDER_EC2__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.VPN_CONNECTION_OPTIONS_BUILDER_EC2__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
