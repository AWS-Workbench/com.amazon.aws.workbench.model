 ...
 * </p>
 * <ul>
 *   <li>{@link ec2.impl.SubnetSelectionBuilder_ec2Impl#getAvailabilityZones_java_lang_String_AsList <em>Availability Zones java lang String As List</em>}</li>
 *   <li>{@link ec2.impl.SubnetSelectionBuilder_ec2Impl#getOnePerAz_java_lang_Boolean_ <em>One Per Az java lang Boolean </em>}</li>
 *   <li>{@link ec2.impl.SubnetSelectionBuilder_ec2Impl#getSubnetGroupName_java_lang_String_ <em>Subnet Group Name java lang String </em>}</li>
 *   <li>{@link ec2.impl.SubnetSelectionBuilder_ec2Impl#getSubnetName_java_lang_String_ <em>Subnet Name java lang String </em>}</li>
 *   <li>{@link ec2.impl.SubnetSelectionBuilder_ec2Impl#getSubnets_software_amazon_awscdk_services_ec2_ISubnet_AsList <em>Subnets software amazon awscdk services ec2 ISubnet As List</em>}</li>
 *   <li>{@link ec2.impl.SubnetSelectionBuilder_ec2Impl#getSubnetType_software_amazon_awscdk_services_ec2_SubnetType_ <em>Subnet Type software amazon awscdk services ec2 Subnet Type </em>}</li>
 *   <li>{@link ec2.impl.SubnetSelectionBuilder_ec2Impl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link ec2.impl.SubnetSelectionBuilder_ec2Impl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link ec2.impl.SubnetSelectionBuilder_ec2Impl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link ec2.impl.SubnetSelectionBuilder_ec2Impl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubnetSelectionBuilder_ec2Impl extends MinimalEObjectImpl.Container implements SubnetSelectionBuilder_ec2 {
	...
	protected EClass eStaticClass() {
		return Ec2Package.Literals.SUBNET_SELECTION_BUILDER_EC2;
	}
	...
	public void setAvailabilityZones_java_lang_String_AsList(String newAvailabilityZones_java_lang_String_AsList) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.SUBNET_SELECTION_BUILDER_EC2__AVAILABILITY_ZONES_JAVA_LANG_STRING_AS_LIST,
	...
	public void setOnePerAz_java_lang_Boolean_(Boolean newOnePerAz_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.SUBNET_SELECTION_BUILDER_EC2__ONE_PER_AZ_JAVA_LANG_BOOLEAN_,
	...
	public void setSubnetGroupName_java_lang_String_(String newSubnetGroupName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.SUBNET_SELECTION_BUILDER_EC2__SUBNET_GROUP_NAME_JAVA_LANG_STRING_,
	...
	public void setSubnetName_java_lang_String_(String newSubnetName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.SUBNET_SELECTION_BUILDER_EC2__SUBNET_NAME_JAVA_LANG_STRING_,
	...
	public void setSubnets_software_amazon_awscdk_services_ec2_ISubnet_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.SUBNET_SELECTION_BUILDER_EC2__SUBNETS_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_ISUBNET_AS_LIST,
	...
	public void setSubnetType_software_amazon_awscdk_services_ec2_SubnetType_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.SUBNET_SELECTION_BUILDER_EC2__SUBNET_TYPE_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_SUBNET_TYPE_,
	...
	public void setVarName(String newVarName) {
		...
		varName = newVarName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.SUBNET_SELECTION_BUILDER_EC2__VAR_NAME,
					oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.SUBNET_SELECTION_BUILDER_EC2__IDENTIFIER,
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.SUBNET_SELECTION_BUILDER_EC2__ADDITIONAL_CODE, oldAdditionalCode, additionalCode));
	}
