 ...
 * </p>
 * <ul>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.SubnetConfigurationBuilder_ec2Impl#getName_java_lang_String_ <em>Name java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.SubnetConfigurationBuilder_ec2Impl#getSubnetType_software_amazon_awscdk_services_ec2_SubnetType_ <em>Subnet Type software amazon awscdk services ec2 Subnet Type </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.SubnetConfigurationBuilder_ec2Impl#getCidrMask_java_lang_Number_ <em>Cidr Mask java lang Number </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.SubnetConfigurationBuilder_ec2Impl#getReserved_java_lang_Boolean_ <em>Reserved java lang Boolean </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.SubnetConfigurationBuilder_ec2Impl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.SubnetConfigurationBuilder_ec2Impl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.SubnetConfigurationBuilder_ec2Impl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.SubnetConfigurationBuilder_ec2Impl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubnetConfigurationBuilder_ec2Impl extends ServiceResourcesImpl implements SubnetConfigurationBuilder_ec2 {
	/**
	...
	protected EClass eStaticClass() {
		return AwsworkbenchPackage.Literals.SUBNET_CONFIGURATION_BUILDER_EC2;
	}
	...
	public void setName_java_lang_String_(String newName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.SUBNET_CONFIGURATION_BUILDER_EC2__NAME_JAVA_LANG_STRING_,
	...
	public void setSubnetType_software_amazon_awscdk_services_ec2_SubnetType_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.SUBNET_CONFIGURATION_BUILDER_EC2__SUBNET_TYPE_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_SUBNET_TYPE_,
	...
	public void setCidrMask_java_lang_Number_(int newCidrMask_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.SUBNET_CONFIGURATION_BUILDER_EC2__CIDR_MASK_JAVA_LANG_NUMBER_,
	...
	public void setReserved_java_lang_Boolean_(Boolean newReserved_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.SUBNET_CONFIGURATION_BUILDER_EC2__RESERVED_JAVA_LANG_BOOLEAN_,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.SUBNET_CONFIGURATION_BUILDER_EC2__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.SUBNET_CONFIGURATION_BUILDER_EC2__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.SUBNET_CONFIGURATION_BUILDER_EC2__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case AwsworkbenchPackage.SUBNET_CONFIGURATION_BUILDER_EC2__NAME_JAVA_LANG_STRING_:
			return getName_java_lang_String_();
		case AwsworkbenchPackage.SUBNET_CONFIGURATION_BUILDER_EC2__SUBNET_TYPE_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_SUBNET_TYPE_:
			return getSubnetType_software_amazon_awscdk_services_ec2_SubnetType_();
		case AwsworkbenchPackage.SUBNET_CONFIGURATION_BUILDER_EC2__CIDR_MASK_JAVA_LANG_NUMBER_:
			return getCidrMask_java_lang_Number_();
		case AwsworkbenchPackage.SUBNET_CONFIGURATION_BUILDER_EC2__RESERVED_JAVA_LANG_BOOLEAN_:
			return getReserved_java_lang_Boolean_();
		case AwsworkbenchPackage.SUBNET_CONFIGURATION_BUILDER_EC2__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case AwsworkbenchPackage.SUBNET_CONFIGURATION_BUILDER_EC2__VAR_NAME:
			return getVarName();
		case AwsworkbenchPackage.SUBNET_CONFIGURATION_BUILDER_EC2__IDENTIFIER:
			return getIdentifier();
		case AwsworkbenchPackage.SUBNET_CONFIGURATION_BUILDER_EC2__ADDITIONAL_CODE:
