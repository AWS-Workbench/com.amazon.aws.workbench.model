...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Default Stack Synthesizer Props Builder core</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link core.impl.DefaultStackSynthesizerPropsBuilder_coreImpl#getAssetPublishingExternalId_java_lang_String_ <em>Asset Publishing External Id java lang String </em>}</li>
 *   <li>{@link core.impl.DefaultStackSynthesizerPropsBuilder_coreImpl#getAssetPublishingRoleArn_java_lang_String_ <em>Asset Publishing Role Arn java lang String </em>}</li>
 *   <li>{@link core.impl.DefaultStackSynthesizerPropsBuilder_coreImpl#getCloudFormationExecutionRole_java_lang_String_ <em>Cloud Formation Execution Role java lang String </em>}</li>
 *   <li>{@link core.impl.DefaultStackSynthesizerPropsBuilder_coreImpl#getDeployRoleArn_java_lang_String_ <em>Deploy Role Arn java lang String </em>}</li>
 *   <li>{@link core.impl.DefaultStackSynthesizerPropsBuilder_coreImpl#getFileAssetsBucketName_java_lang_String_ <em>File Assets Bucket Name java lang String </em>}</li>
 *   <li>{@link core.impl.DefaultStackSynthesizerPropsBuilder_coreImpl#getImageAssetsRepositoryName_java_lang_String_ <em>Image Assets Repository Name java lang String </em>}</li>
 *   <li>{@link core.impl.DefaultStackSynthesizerPropsBuilder_coreImpl#getQualifier_java_lang_String_ <em>Qualifier java lang String </em>}</li>
 *   <li>{@link core.impl.DefaultStackSynthesizerPropsBuilder_coreImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link core.impl.DefaultStackSynthesizerPropsBuilder_coreImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link core.impl.DefaultStackSynthesizerPropsBuilder_coreImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link core.impl.DefaultStackSynthesizerPropsBuilder_coreImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DefaultStackSynthesizerPropsBuilder_coreImpl extends MinimalEObjectImpl.Container
		implements DefaultStackSynthesizerPropsBuilder_core {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.core.DefaultStackSynthesizerProps";
	 ...
	 * @generated
	 */
	protected DefaultStackSynthesizerPropsBuilder_coreImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.DEFAULT_STACK_SYNTHESIZER_PROPS_BUILDER_CORE;
	}
	...
	public void setAssetPublishingExternalId_java_lang_String_(String newAssetPublishingExternalId_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.DEFAULT_STACK_SYNTHESIZER_PROPS_BUILDER_CORE__ASSET_PUBLISHING_EXTERNAL_ID_JAVA_LANG_STRING_,
	...
	public void setAssetPublishingRoleArn_java_lang_String_(String newAssetPublishingRoleArn_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.DEFAULT_STACK_SYNTHESIZER_PROPS_BUILDER_CORE__ASSET_PUBLISHING_ROLE_ARN_JAVA_LANG_STRING_,
	...
	public void setCloudFormationExecutionRole_java_lang_String_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.DEFAULT_STACK_SYNTHESIZER_PROPS_BUILDER_CORE__CLOUD_FORMATION_EXECUTION_ROLE_JAVA_LANG_STRING_,
	...
	public void setDeployRoleArn_java_lang_String_(String newDeployRoleArn_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.DEFAULT_STACK_SYNTHESIZER_PROPS_BUILDER_CORE__DEPLOY_ROLE_ARN_JAVA_LANG_STRING_,
	...
	public void setFileAssetsBucketName_java_lang_String_(String newFileAssetsBucketName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.DEFAULT_STACK_SYNTHESIZER_PROPS_BUILDER_CORE__FILE_ASSETS_BUCKET_NAME_JAVA_LANG_STRING_,
	...
	public void setImageAssetsRepositoryName_java_lang_String_(String newImageAssetsRepositoryName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.DEFAULT_STACK_SYNTHESIZER_PROPS_BUILDER_CORE__IMAGE_ASSETS_REPOSITORY_NAME_JAVA_LANG_STRING_,
	...
	public void setQualifier_java_lang_String_(String newQualifier_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.DEFAULT_STACK_SYNTHESIZER_PROPS_BUILDER_CORE__QUALIFIER_JAVA_LANG_STRING_,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.DEFAULT_STACK_SYNTHESIZER_PROPS_BUILDER_CORE__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.DEFAULT_STACK_SYNTHESIZER_PROPS_BUILDER_CORE__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.DEFAULT_STACK_SYNTHESIZER_PROPS_BUILDER_CORE__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CorePackage.DEFAULT_STACK_SYNTHESIZER_PROPS_BUILDER_CORE__ASSET_PUBLISHING_EXTERNAL_ID_JAVA_LANG_STRING_:
			return getAssetPublishingExternalId_java_lang_String_();
		case CorePackage.DEFAULT_STACK_SYNTHESIZER_PROPS_BUILDER_CORE__ASSET_PUBLISHING_ROLE_ARN_JAVA_LANG_STRING_:
			return getAssetPublishingRoleArn_java_lang_String_();
		case CorePackage.DEFAULT_STACK_SYNTHESIZER_PROPS_BUILDER_CORE__CLOUD_FORMATION_EXECUTION_ROLE_JAVA_LANG_STRING_:
			return getCloudFormationExecutionRole_java_lang_String_();
		case CorePackage.DEFAULT_STACK_SYNTHESIZER_PROPS_BUILDER_CORE__DEPLOY_ROLE_ARN_JAVA_LANG_STRING_:
			return getDeployRoleArn_java_lang_String_();
		case CorePackage.DEFAULT_STACK_SYNTHESIZER_PROPS_BUILDER_CORE__FILE_ASSETS_BUCKET_NAME_JAVA_LANG_STRING_:
			return getFileAssetsBucketName_java_lang_String_();
		case CorePackage.DEFAULT_STACK_SYNTHESIZER_PROPS_BUILDER_CORE__IMAGE_ASSETS_REPOSITORY_NAME_JAVA_LANG_STRING_:
			return getImageAssetsRepositoryName_java_lang_String_();
		case CorePackage.DEFAULT_STACK_SYNTHESIZER_PROPS_BUILDER_CORE__QUALIFIER_JAVA_LANG_STRING_:
			return getQualifier_java_lang_String_();
		case CorePackage.DEFAULT_STACK_SYNTHESIZER_PROPS_BUILDER_CORE__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case CorePackage.DEFAULT_STACK_SYNTHESIZER_PROPS_BUILDER_CORE__VAR_NAME:
			return getVarName();
		case CorePackage.DEFAULT_STACK_SYNTHESIZER_PROPS_BUILDER_CORE__IDENTIFIER:
			return getIdentifier();
		case CorePackage.DEFAULT_STACK_SYNTHESIZER_PROPS_BUILDER_CORE__ADDITIONAL_CODE:
...
} //DefaultStackSynthesizerPropsBuilder_coreImpl
