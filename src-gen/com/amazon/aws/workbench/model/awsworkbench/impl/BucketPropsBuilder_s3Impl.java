...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Bucket Props Builder s3</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.BucketPropsBuilder_s3Impl#getAccessControl_software_amazon_awscdk_services_s3_BucketAccessControl_ <em>Access Control software amazon awscdk services s3 Bucket Access Control </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.BucketPropsBuilder_s3Impl#getBlockPublicAccessWithBlockPublicAccess_software_amazon_awscdk_services_s3_BlockPublicAccess_AsReference <em>Block Public Access With Block Public Access software amazon awscdk services s3 Block Public Access As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.BucketPropsBuilder_s3Impl#getBucketName_java_lang_String_ <em>Bucket Name java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.BucketPropsBuilder_s3Impl#getCors_software_amazon_awscdk_services_s3_CorsRule_AsList <em>Cors software amazon awscdk services s3 Cors Rule As List</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.BucketPropsBuilder_s3Impl#getEncryption_software_amazon_awscdk_services_s3_BucketEncryption_ <em>Encryption software amazon awscdk services s3 Bucket Encryption </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.BucketPropsBuilder_s3Impl#getEncryptionKeyWithIKey_software_amazon_awscdk_services_kms_IKey_AsReference <em>Encryption Key With IKey software amazon awscdk services kms IKey As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.BucketPropsBuilder_s3Impl#getLifecycleRules_software_amazon_awscdk_services_s3_LifecycleRule_AsList <em>Lifecycle Rules software amazon awscdk services s3 Lifecycle Rule As List</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.BucketPropsBuilder_s3Impl#getMetrics_software_amazon_awscdk_services_s3_BucketMetrics_AsList <em>Metrics software amazon awscdk services s3 Bucket Metrics As List</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.BucketPropsBuilder_s3Impl#getPublicReadAccess_java_lang_Boolean_ <em>Public Read Access java lang Boolean </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.BucketPropsBuilder_s3Impl#getRemovalPolicy_software_amazon_awscdk_core_RemovalPolicy_ <em>Removal Policy software amazon awscdk core Removal Policy </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.BucketPropsBuilder_s3Impl#getServerAccessLogsBucketWithIBucket_software_amazon_awscdk_services_s3_IBucket_AsReference <em>Server Access Logs Bucket With IBucket software amazon awscdk services s3 IBucket As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.BucketPropsBuilder_s3Impl#getServerAccessLogsPrefix_java_lang_String_ <em>Server Access Logs Prefix java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.BucketPropsBuilder_s3Impl#getVersioned_java_lang_Boolean_ <em>Versioned java lang Boolean </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.BucketPropsBuilder_s3Impl#getWebsiteErrorDocument_java_lang_String_ <em>Website Error Document java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.BucketPropsBuilder_s3Impl#getWebsiteIndexDocument_java_lang_String_ <em>Website Index Document java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.BucketPropsBuilder_s3Impl#getWebsiteRedirectWithRedirectTarget_software_amazon_awscdk_services_s3_RedirectTarget_AsReference <em>Website Redirect With Redirect Target software amazon awscdk services s3 Redirect Target As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.BucketPropsBuilder_s3Impl#getWebsiteRoutingRules_software_amazon_awscdk_services_s3_RoutingRule_AsList <em>Website Routing Rules software amazon awscdk services s3 Routing Rule As List</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.BucketPropsBuilder_s3Impl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.BucketPropsBuilder_s3Impl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.BucketPropsBuilder_s3Impl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.BucketPropsBuilder_s3Impl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BucketPropsBuilder_s3Impl extends MinimalEObjectImpl.Container implements BucketPropsBuilder_s3 {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.s3.BucketProps";
	 ...
	 * @generated
	 */
	protected BucketPropsBuilder_s3Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AwsworkbenchPackage.Literals.BUCKET_PROPS_BUILDER_S3;
	}
	...
	public void setAccessControl_software_amazon_awscdk_services_s3_BucketAccessControl_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.BUCKET_PROPS_BUILDER_S3__ACCESS_CONTROL_SOFTWARE_AMAZON_AWSCDK_SERVICES_S3_BUCKET_ACCESS_CONTROL_,
	...
	public void setBlockPublicAccessWithBlockPublicAccess_software_amazon_awscdk_services_s3_BlockPublicAccess_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.BUCKET_PROPS_BUILDER_S3__BLOCK_PUBLIC_ACCESS_WITH_BLOCK_PUBLIC_ACCESS_SOFTWARE_AMAZON_AWSCDK_SERVICES_S3_BLOCK_PUBLIC_ACCESS_AS_REFERENCE,
	...
	public void setBucketName_java_lang_String_(String newBucketName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.BUCKET_PROPS_BUILDER_S3__BUCKET_NAME_JAVA_LANG_STRING_,
	...
	public void setCors_software_amazon_awscdk_services_s3_CorsRule_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.BUCKET_PROPS_BUILDER_S3__CORS_SOFTWARE_AMAZON_AWSCDK_SERVICES_S3_CORS_RULE_AS_LIST,
	...
	public void setEncryption_software_amazon_awscdk_services_s3_BucketEncryption_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.BUCKET_PROPS_BUILDER_S3__ENCRYPTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_S3_BUCKET_ENCRYPTION_,
	...
	public void setEncryptionKeyWithIKey_software_amazon_awscdk_services_kms_IKey_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.BUCKET_PROPS_BUILDER_S3__ENCRYPTION_KEY_WITH_IKEY_SOFTWARE_AMAZON_AWSCDK_SERVICES_KMS_IKEY_AS_REFERENCE,
	...
	public void setLifecycleRules_software_amazon_awscdk_services_s3_LifecycleRule_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.BUCKET_PROPS_BUILDER_S3__LIFECYCLE_RULES_SOFTWARE_AMAZON_AWSCDK_SERVICES_S3_LIFECYCLE_RULE_AS_LIST,
	...
	public void setMetrics_software_amazon_awscdk_services_s3_BucketMetrics_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.BUCKET_PROPS_BUILDER_S3__METRICS_SOFTWARE_AMAZON_AWSCDK_SERVICES_S3_BUCKET_METRICS_AS_LIST,
	...
	public void setPublicReadAccess_java_lang_Boolean_(Boolean newPublicReadAccess_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.BUCKET_PROPS_BUILDER_S3__PUBLIC_READ_ACCESS_JAVA_LANG_BOOLEAN_,
	...
	public void setRemovalPolicy_software_amazon_awscdk_core_RemovalPolicy_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.BUCKET_PROPS_BUILDER_S3__REMOVAL_POLICY_SOFTWARE_AMAZON_AWSCDK_CORE_REMOVAL_POLICY_,
	...
	public void setServerAccessLogsBucketWithIBucket_software_amazon_awscdk_services_s3_IBucket_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.BUCKET_PROPS_BUILDER_S3__SERVER_ACCESS_LOGS_BUCKET_WITH_IBUCKET_SOFTWARE_AMAZON_AWSCDK_SERVICES_S3_IBUCKET_AS_REFERENCE,
	...
	public void setServerAccessLogsPrefix_java_lang_String_(String newServerAccessLogsPrefix_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.BUCKET_PROPS_BUILDER_S3__SERVER_ACCESS_LOGS_PREFIX_JAVA_LANG_STRING_,
	...
	public void setVersioned_java_lang_Boolean_(Boolean newVersioned_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.BUCKET_PROPS_BUILDER_S3__VERSIONED_JAVA_LANG_BOOLEAN_,
	...
	public void setWebsiteErrorDocument_java_lang_String_(String newWebsiteErrorDocument_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.BUCKET_PROPS_BUILDER_S3__WEBSITE_ERROR_DOCUMENT_JAVA_LANG_STRING_,
	...
	public void setWebsiteIndexDocument_java_lang_String_(String newWebsiteIndexDocument_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.BUCKET_PROPS_BUILDER_S3__WEBSITE_INDEX_DOCUMENT_JAVA_LANG_STRING_,
	...
	public void setWebsiteRedirectWithRedirectTarget_software_amazon_awscdk_services_s3_RedirectTarget_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.BUCKET_PROPS_BUILDER_S3__WEBSITE_REDIRECT_WITH_REDIRECT_TARGET_SOFTWARE_AMAZON_AWSCDK_SERVICES_S3_REDIRECT_TARGET_AS_REFERENCE,
	...
	public void setWebsiteRoutingRules_software_amazon_awscdk_services_s3_RoutingRule_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.BUCKET_PROPS_BUILDER_S3__WEBSITE_ROUTING_RULES_SOFTWARE_AMAZON_AWSCDK_SERVICES_S3_ROUTING_RULE_AS_LIST,
	...
	public void setVarName(String newVarName) {
		...
		varName = newVarName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AwsworkbenchPackage.BUCKET_PROPS_BUILDER_S3__VAR_NAME,
					oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.BUCKET_PROPS_BUILDER_S3__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.BUCKET_PROPS_BUILDER_S3__ADDITIONAL_CODE, oldAdditionalCode, additionalCode));
	}
