...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Function Props Builder lambda</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getCodeWithCode_software_amazon_awscdk_services_lambda_Code_AsReference <em>Code With Code software amazon awscdk services lambda Code As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getHandler_java_lang_String_ <em>Handler java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getRuntimeWithRuntime_software_amazon_awscdk_services_lambda_Runtime_AsReference <em>Runtime With Runtime software amazon awscdk services lambda Runtime As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getAllowAllOutbound_java_lang_Boolean_ <em>Allow All Outbound java lang Boolean </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getCurrentVersionOptionsWithVersionOptions_software_amazon_awscdk_services_lambda_VersionOptions_AsReference <em>Current Version Options With Version Options software amazon awscdk services lambda Version Options As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getDeadLetterQueueWithIQueue_software_amazon_awscdk_services_sqs_IQueue_AsReference <em>Dead Letter Queue With IQueue software amazon awscdk services sqs IQueue As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getDeadLetterQueueEnabled_java_lang_Boolean_ <em>Dead Letter Queue Enabled java lang Boolean </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getDescription_java_lang_String_ <em>Description java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getEnvironment_java_lang_String__java_lang_String_AsMap <em>Environment java lang String java lang String As Map</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getEvents_software_amazon_awscdk_services_lambda_IEventSource_AsList <em>Events software amazon awscdk services lambda IEvent Source As List</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getFunctionName_java_lang_String_ <em>Function Name java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getInitialPolicy_software_amazon_awscdk_services_iam_PolicyStatement_AsList <em>Initial Policy software amazon awscdk services iam Policy Statement As List</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getLayers_software_amazon_awscdk_services_lambda_ILayerVersion_AsList <em>Layers software amazon awscdk services lambda ILayer Version As List</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getLogRetention_software_amazon_awscdk_services_logs_RetentionDays_ <em>Log Retention software amazon awscdk services logs Retention Days </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getLogRetentionRoleWithIRole_software_amazon_awscdk_services_iam_IRole_AsReference <em>Log Retention Role With IRole software amazon awscdk services iam IRole As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getMemorySize_java_lang_Number_ <em>Memory Size java lang Number </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getReservedConcurrentExecutions_java_lang_Number_ <em>Reserved Concurrent Executions java lang Number </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getRoleWithIRole_software_amazon_awscdk_services_iam_IRole_AsReference <em>Role With IRole software amazon awscdk services iam IRole As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getSecurityGroupWithISecurityGroup_software_amazon_awscdk_services_ec2_ISecurityGroup_AsReference <em>Security Group With ISecurity Group software amazon awscdk services ec2 ISecurity Group As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getSecurityGroups_software_amazon_awscdk_services_ec2_ISecurityGroup_AsList <em>Security Groups software amazon awscdk services ec2 ISecurity Group As List</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getTimeoutWithDuration_software_amazon_awscdk_core_Duration_AsReference <em>Timeout With Duration software amazon awscdk core Duration As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getTracing_software_amazon_awscdk_services_lambda_Tracing_ <em>Tracing software amazon awscdk services lambda Tracing </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getVpcWithIVpc_software_amazon_awscdk_services_ec2_IVpc_AsReference <em>Vpc With IVpc software amazon awscdk services ec2 IVpc As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getVpcSubnetsWithSubnetSelection_software_amazon_awscdk_services_ec2_SubnetSelection_AsReference <em>Vpc Subnets With Subnet Selection software amazon awscdk services ec2 Subnet Selection As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getMaxEventAgeWithDuration_software_amazon_awscdk_core_Duration_AsReference <em>Max Event Age With Duration software amazon awscdk core Duration As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getOnFailureWithIDestination_software_amazon_awscdk_services_lambda_IDestination_AsReference <em>On Failure With IDestination software amazon awscdk services lambda IDestination As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getOnSuccessWithIDestination_software_amazon_awscdk_services_lambda_IDestination_AsReference <em>On Success With IDestination software amazon awscdk services lambda IDestination As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getRetryAttempts_java_lang_Number_ <em>Retry Attempts java lang Number </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.FunctionPropsBuilder_lambdaImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctionPropsBuilder_lambdaImpl extends ServiceResourcesImpl implements FunctionPropsBuilder_lambda {
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.lambda.FunctionProps";
	 ...
	 * @generated
	 */
	protected FunctionPropsBuilder_lambdaImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AwsworkbenchPackage.Literals.FUNCTION_PROPS_BUILDER_LAMBDA;
	}
	...
	public void setCodeWithCode_software_amazon_awscdk_services_lambda_Code_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__CODE_WITH_CODE_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_CODE_AS_REFERENCE,
	...
	public void setHandler_java_lang_String_(String newHandler_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__HANDLER_JAVA_LANG_STRING_,
	...
	public void setRuntimeWithRuntime_software_amazon_awscdk_services_lambda_Runtime_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__RUNTIME_WITH_RUNTIME_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_RUNTIME_AS_REFERENCE,
	...
	public void setAllowAllOutbound_java_lang_Boolean_(Boolean newAllowAllOutbound_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__ALLOW_ALL_OUTBOUND_JAVA_LANG_BOOLEAN_,
	...
	public void setCurrentVersionOptionsWithVersionOptions_software_amazon_awscdk_services_lambda_VersionOptions_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__CURRENT_VERSION_OPTIONS_WITH_VERSION_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_VERSION_OPTIONS_AS_REFERENCE,
	...
	public void setDeadLetterQueueWithIQueue_software_amazon_awscdk_services_sqs_IQueue_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__DEAD_LETTER_QUEUE_WITH_IQUEUE_SOFTWARE_AMAZON_AWSCDK_SERVICES_SQS_IQUEUE_AS_REFERENCE,
	...
	public void setDeadLetterQueueEnabled_java_lang_Boolean_(Boolean newDeadLetterQueueEnabled_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__DEAD_LETTER_QUEUE_ENABLED_JAVA_LANG_BOOLEAN_,
	...
	public void setDescription_java_lang_String_(String newDescription_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__DESCRIPTION_JAVA_LANG_STRING_,
	...
	public void setEnvironment_java_lang_String__java_lang_String_AsMap(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__ENVIRONMENT_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP,
	...
	public void setEvents_software_amazon_awscdk_services_lambda_IEventSource_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__EVENTS_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_IEVENT_SOURCE_AS_LIST,
	...
	public void setFunctionName_java_lang_String_(String newFunctionName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__FUNCTION_NAME_JAVA_LANG_STRING_,
	...
	public void setInitialPolicy_software_amazon_awscdk_services_iam_PolicyStatement_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__INITIAL_POLICY_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_POLICY_STATEMENT_AS_LIST,
	...
	public void setLayers_software_amazon_awscdk_services_lambda_ILayerVersion_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__LAYERS_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_ILAYER_VERSION_AS_LIST,
	...
	public void setLogRetention_software_amazon_awscdk_services_logs_RetentionDays_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__LOG_RETENTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_LOGS_RETENTION_DAYS_,
	...
	public void setLogRetentionRoleWithIRole_software_amazon_awscdk_services_iam_IRole_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__LOG_RETENTION_ROLE_WITH_IROLE_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IROLE_AS_REFERENCE,
	...
	public void setMemorySize_java_lang_Number_(int newMemorySize_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__MEMORY_SIZE_JAVA_LANG_NUMBER_,
	...
	public void setReservedConcurrentExecutions_java_lang_Number_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__RESERVED_CONCURRENT_EXECUTIONS_JAVA_LANG_NUMBER_,
	...
	public void setRoleWithIRole_software_amazon_awscdk_services_iam_IRole_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__ROLE_WITH_IROLE_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IROLE_AS_REFERENCE,
	...
	public void setSecurityGroupWithISecurityGroup_software_amazon_awscdk_services_ec2_ISecurityGroup_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__SECURITY_GROUP_WITH_ISECURITY_GROUP_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_ISECURITY_GROUP_AS_REFERENCE,
	...
	public void setSecurityGroups_software_amazon_awscdk_services_ec2_ISecurityGroup_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__SECURITY_GROUPS_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_ISECURITY_GROUP_AS_LIST,
	...
	public void setTimeoutWithDuration_software_amazon_awscdk_core_Duration_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__TIMEOUT_WITH_DURATION_SOFTWARE_AMAZON_AWSCDK_CORE_DURATION_AS_REFERENCE,
	...
	public void setTracing_software_amazon_awscdk_services_lambda_Tracing_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__TRACING_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_TRACING_,
	...
	public void setVpcWithIVpc_software_amazon_awscdk_services_ec2_IVpc_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__VPC_WITH_IVPC_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_IVPC_AS_REFERENCE,
	...
	public void setVpcSubnetsWithSubnetSelection_software_amazon_awscdk_services_ec2_SubnetSelection_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__VPC_SUBNETS_WITH_SUBNET_SELECTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_SUBNET_SELECTION_AS_REFERENCE,
	...
	public void setMaxEventAgeWithDuration_software_amazon_awscdk_core_Duration_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__MAX_EVENT_AGE_WITH_DURATION_SOFTWARE_AMAZON_AWSCDK_CORE_DURATION_AS_REFERENCE,
	...
	public void setOnFailureWithIDestination_software_amazon_awscdk_services_lambda_IDestination_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__ON_FAILURE_WITH_IDESTINATION_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_IDESTINATION_AS_REFERENCE,
	...
	public void setOnSuccessWithIDestination_software_amazon_awscdk_services_lambda_IDestination_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__ON_SUCCESS_WITH_IDESTINATION_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_IDESTINATION_AS_REFERENCE,
	...
	public void setRetryAttempts_java_lang_Number_(int newRetryAttempts_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__RETRY_ATTEMPTS_JAVA_LANG_NUMBER_,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__CODE_WITH_CODE_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_CODE_AS_REFERENCE:
			return getCodeWithCode_software_amazon_awscdk_services_lambda_Code_AsReference();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__HANDLER_JAVA_LANG_STRING_:
			return getHandler_java_lang_String_();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__RUNTIME_WITH_RUNTIME_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_RUNTIME_AS_REFERENCE:
			return getRuntimeWithRuntime_software_amazon_awscdk_services_lambda_Runtime_AsReference();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__ALLOW_ALL_OUTBOUND_JAVA_LANG_BOOLEAN_:
			return getAllowAllOutbound_java_lang_Boolean_();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__CURRENT_VERSION_OPTIONS_WITH_VERSION_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_VERSION_OPTIONS_AS_REFERENCE:
			return getCurrentVersionOptionsWithVersionOptions_software_amazon_awscdk_services_lambda_VersionOptions_AsReference();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__DEAD_LETTER_QUEUE_WITH_IQUEUE_SOFTWARE_AMAZON_AWSCDK_SERVICES_SQS_IQUEUE_AS_REFERENCE:
			return getDeadLetterQueueWithIQueue_software_amazon_awscdk_services_sqs_IQueue_AsReference();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__DEAD_LETTER_QUEUE_ENABLED_JAVA_LANG_BOOLEAN_:
			return getDeadLetterQueueEnabled_java_lang_Boolean_();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__DESCRIPTION_JAVA_LANG_STRING_:
			return getDescription_java_lang_String_();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__ENVIRONMENT_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP:
			return getEnvironment_java_lang_String__java_lang_String_AsMap();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__EVENTS_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_IEVENT_SOURCE_AS_LIST:
			return getEvents_software_amazon_awscdk_services_lambda_IEventSource_AsList();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__FUNCTION_NAME_JAVA_LANG_STRING_:
			return getFunctionName_java_lang_String_();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__INITIAL_POLICY_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_POLICY_STATEMENT_AS_LIST:
			return getInitialPolicy_software_amazon_awscdk_services_iam_PolicyStatement_AsList();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__LAYERS_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_ILAYER_VERSION_AS_LIST:
			return getLayers_software_amazon_awscdk_services_lambda_ILayerVersion_AsList();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__LOG_RETENTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_LOGS_RETENTION_DAYS_:
			return getLogRetention_software_amazon_awscdk_services_logs_RetentionDays_();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__LOG_RETENTION_ROLE_WITH_IROLE_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IROLE_AS_REFERENCE:
			return getLogRetentionRoleWithIRole_software_amazon_awscdk_services_iam_IRole_AsReference();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__MEMORY_SIZE_JAVA_LANG_NUMBER_:
			return getMemorySize_java_lang_Number_();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__RESERVED_CONCURRENT_EXECUTIONS_JAVA_LANG_NUMBER_:
			return getReservedConcurrentExecutions_java_lang_Number_();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__ROLE_WITH_IROLE_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IROLE_AS_REFERENCE:
			return getRoleWithIRole_software_amazon_awscdk_services_iam_IRole_AsReference();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__SECURITY_GROUP_WITH_ISECURITY_GROUP_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_ISECURITY_GROUP_AS_REFERENCE:
			return getSecurityGroupWithISecurityGroup_software_amazon_awscdk_services_ec2_ISecurityGroup_AsReference();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__SECURITY_GROUPS_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_ISECURITY_GROUP_AS_LIST:
			return getSecurityGroups_software_amazon_awscdk_services_ec2_ISecurityGroup_AsList();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__TIMEOUT_WITH_DURATION_SOFTWARE_AMAZON_AWSCDK_CORE_DURATION_AS_REFERENCE:
			return getTimeoutWithDuration_software_amazon_awscdk_core_Duration_AsReference();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__TRACING_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_TRACING_:
			return getTracing_software_amazon_awscdk_services_lambda_Tracing_();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__VPC_WITH_IVPC_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_IVPC_AS_REFERENCE:
			return getVpcWithIVpc_software_amazon_awscdk_services_ec2_IVpc_AsReference();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__VPC_SUBNETS_WITH_SUBNET_SELECTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_SUBNET_SELECTION_AS_REFERENCE:
			return getVpcSubnetsWithSubnetSelection_software_amazon_awscdk_services_ec2_SubnetSelection_AsReference();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__MAX_EVENT_AGE_WITH_DURATION_SOFTWARE_AMAZON_AWSCDK_CORE_DURATION_AS_REFERENCE:
			return getMaxEventAgeWithDuration_software_amazon_awscdk_core_Duration_AsReference();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__ON_FAILURE_WITH_IDESTINATION_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_IDESTINATION_AS_REFERENCE:
			return getOnFailureWithIDestination_software_amazon_awscdk_services_lambda_IDestination_AsReference();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__ON_SUCCESS_WITH_IDESTINATION_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_IDESTINATION_AS_REFERENCE:
			return getOnSuccessWithIDestination_software_amazon_awscdk_services_lambda_IDestination_AsReference();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__RETRY_ATTEMPTS_JAVA_LANG_NUMBER_:
			return getRetryAttempts_java_lang_Number_();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__VAR_NAME:
			return getVarName();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__IDENTIFIER:
			return getIdentifier();
		case AwsworkbenchPackage.FUNCTION_PROPS_BUILDER_LAMBDA__ADDITIONAL_CODE:
...
} //FunctionPropsBuilder_lambdaImpl
