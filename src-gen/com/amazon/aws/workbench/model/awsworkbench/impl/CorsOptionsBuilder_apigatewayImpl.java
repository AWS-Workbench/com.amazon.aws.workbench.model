 ...
 * </p>
 * <ul>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.CorsOptionsBuilder_apigatewayImpl#getAllowOrigins_java_lang_String_AsList <em>Allow Origins java lang String As List</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.CorsOptionsBuilder_apigatewayImpl#getAllowCredentials_java_lang_Boolean_ <em>Allow Credentials java lang Boolean </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.CorsOptionsBuilder_apigatewayImpl#getAllowHeaders_java_lang_String_AsList <em>Allow Headers java lang String As List</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.CorsOptionsBuilder_apigatewayImpl#getAllowMethods_java_lang_String_AsList <em>Allow Methods java lang String As List</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.CorsOptionsBuilder_apigatewayImpl#getDisableCache_java_lang_Boolean_ <em>Disable Cache java lang Boolean </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.CorsOptionsBuilder_apigatewayImpl#getExposeHeaders_java_lang_String_AsList <em>Expose Headers java lang String As List</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.CorsOptionsBuilder_apigatewayImpl#getMaxAgeWithDuration_software_amazon_awscdk_core_Duration_AsReference <em>Max Age With Duration software amazon awscdk core Duration As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.CorsOptionsBuilder_apigatewayImpl#getStatusCode_java_lang_Number_ <em>Status Code java lang Number </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.CorsOptionsBuilder_apigatewayImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.CorsOptionsBuilder_apigatewayImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.CorsOptionsBuilder_apigatewayImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.CorsOptionsBuilder_apigatewayImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CorsOptionsBuilder_apigatewayImpl extends ServiceResourcesImpl implements CorsOptionsBuilder_apigateway {
	...
	protected EClass eStaticClass() {
		return AwsworkbenchPackage.Literals.CORS_OPTIONS_BUILDER_APIGATEWAY;
	}
	...
	public void setAllowOrigins_java_lang_String_AsList(String newAllowOrigins_java_lang_String_AsList) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.CORS_OPTIONS_BUILDER_APIGATEWAY__ALLOW_ORIGINS_JAVA_LANG_STRING_AS_LIST,
	...
	public void setAllowCredentials_java_lang_Boolean_(Boolean newAllowCredentials_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.CORS_OPTIONS_BUILDER_APIGATEWAY__ALLOW_CREDENTIALS_JAVA_LANG_BOOLEAN_,
	...
	public void setAllowHeaders_java_lang_String_AsList(String newAllowHeaders_java_lang_String_AsList) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.CORS_OPTIONS_BUILDER_APIGATEWAY__ALLOW_HEADERS_JAVA_LANG_STRING_AS_LIST,
	...
	public void setAllowMethods_java_lang_String_AsList(String newAllowMethods_java_lang_String_AsList) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.CORS_OPTIONS_BUILDER_APIGATEWAY__ALLOW_METHODS_JAVA_LANG_STRING_AS_LIST,
	...
	public void setDisableCache_java_lang_Boolean_(Boolean newDisableCache_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.CORS_OPTIONS_BUILDER_APIGATEWAY__DISABLE_CACHE_JAVA_LANG_BOOLEAN_,
	...
	public void setExposeHeaders_java_lang_String_AsList(String newExposeHeaders_java_lang_String_AsList) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.CORS_OPTIONS_BUILDER_APIGATEWAY__EXPOSE_HEADERS_JAVA_LANG_STRING_AS_LIST,
	...
	public void setMaxAgeWithDuration_software_amazon_awscdk_core_Duration_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.CORS_OPTIONS_BUILDER_APIGATEWAY__MAX_AGE_WITH_DURATION_SOFTWARE_AMAZON_AWSCDK_CORE_DURATION_AS_REFERENCE,
	...
	public void setStatusCode_java_lang_Number_(int newStatusCode_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.CORS_OPTIONS_BUILDER_APIGATEWAY__STATUS_CODE_JAVA_LANG_NUMBER_,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.CORS_OPTIONS_BUILDER_APIGATEWAY__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.CORS_OPTIONS_BUILDER_APIGATEWAY__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.CORS_OPTIONS_BUILDER_APIGATEWAY__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
