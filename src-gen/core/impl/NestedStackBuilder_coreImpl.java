...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Nested Stack Builder core</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link core.impl.NestedStackBuilder_coreImpl#getNotificationArns_java_lang_String_AsList <em>Notification Arns java lang String As List</em>}</li>
 *   <li>{@link core.impl.NestedStackBuilder_coreImpl#getParameters_java_lang_String__java_lang_String_AsMap <em>Parameters java lang String java lang String As Map</em>}</li>
 *   <li>{@link core.impl.NestedStackBuilder_coreImpl#getTimeoutWithDuration_software_amazon_awscdk_core_Duration_AsReference <em>Timeout With Duration software amazon awscdk core Duration As Reference</em>}</li>
 *   <li>{@link core.impl.NestedStackBuilder_coreImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link core.impl.NestedStackBuilder_coreImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link core.impl.NestedStackBuilder_coreImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link core.impl.NestedStackBuilder_coreImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NestedStackBuilder_coreImpl extends MinimalEObjectImpl.Container implements NestedStackBuilder_core {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.core.NestedStack";
	 ...
	 * @generated
	 */
	protected NestedStackBuilder_coreImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.NESTED_STACK_BUILDER_CORE;
	}
	...
	public void setNotificationArns_java_lang_String_AsList(String newNotificationArns_java_lang_String_AsList) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.NESTED_STACK_BUILDER_CORE__NOTIFICATION_ARNS_JAVA_LANG_STRING_AS_LIST,
	...
	public void setParameters_java_lang_String__java_lang_String_AsMap(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.NESTED_STACK_BUILDER_CORE__PARAMETERS_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP,
	...
	public void setTimeoutWithDuration_software_amazon_awscdk_core_Duration_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.NESTED_STACK_BUILDER_CORE__TIMEOUT_WITH_DURATION_SOFTWARE_AMAZON_AWSCDK_CORE_DURATION_AS_REFERENCE,
	...
	public void setVarName(String newVarName) {
		...
		varName = newVarName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.NESTED_STACK_BUILDER_CORE__VAR_NAME,
					oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.NESTED_STACK_BUILDER_CORE__IDENTIFIER,
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.NESTED_STACK_BUILDER_CORE__ADDITIONAL_CODE, oldAdditionalCode, additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CorePackage.NESTED_STACK_BUILDER_CORE__NOTIFICATION_ARNS_JAVA_LANG_STRING_AS_LIST:
			return getNotificationArns_java_lang_String_AsList();
		case CorePackage.NESTED_STACK_BUILDER_CORE__PARAMETERS_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP:
			return getParameters_java_lang_String__java_lang_String_AsMap();
		case CorePackage.NESTED_STACK_BUILDER_CORE__TIMEOUT_WITH_DURATION_SOFTWARE_AMAZON_AWSCDK_CORE_DURATION_AS_REFERENCE:
			return getTimeoutWithDuration_software_amazon_awscdk_core_Duration_AsReference();
		case CorePackage.NESTED_STACK_BUILDER_CORE__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case CorePackage.NESTED_STACK_BUILDER_CORE__VAR_NAME:
			return getVarName();
		case CorePackage.NESTED_STACK_BUILDER_CORE__IDENTIFIER:
			return getIdentifier();
		case CorePackage.NESTED_STACK_BUILDER_CORE__ADDITIONAL_CODE:
