 ...
 * </p>
 * <ul>
 *   <li>{@link dynamodb.impl.AttributeBuilder_dynamodbImpl#getName_java_lang_String_ <em>Name java lang String </em>}</li>
 *   <li>{@link dynamodb.impl.AttributeBuilder_dynamodbImpl#getType_software_amazon_awscdk_services_dynamodb_AttributeType_ <em>Type software amazon awscdk services dynamodb Attribute Type </em>}</li>
 *   <li>{@link dynamodb.impl.AttributeBuilder_dynamodbImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link dynamodb.impl.AttributeBuilder_dynamodbImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link dynamodb.impl.AttributeBuilder_dynamodbImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link dynamodb.impl.AttributeBuilder_dynamodbImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttributeBuilder_dynamodbImpl extends MinimalEObjectImpl.Container implements AttributeBuilder_dynamodb {
	...
	protected EClass eStaticClass() {
		return DynamodbPackage.Literals.ATTRIBUTE_BUILDER_DYNAMODB;
	}
	...
	public void setName_java_lang_String_(String newName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DynamodbPackage.ATTRIBUTE_BUILDER_DYNAMODB__NAME_JAVA_LANG_STRING_, oldName_java_lang_String_,
	...
	public void setType_software_amazon_awscdk_services_dynamodb_AttributeType_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DynamodbPackage.ATTRIBUTE_BUILDER_DYNAMODB__TYPE_SOFTWARE_AMAZON_AWSCDK_SERVICES_DYNAMODB_ATTRIBUTE_TYPE_,
	...
	public void setVarName(String newVarName) {
		...
		varName = newVarName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DynamodbPackage.ATTRIBUTE_BUILDER_DYNAMODB__VAR_NAME,
					oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DynamodbPackage.ATTRIBUTE_BUILDER_DYNAMODB__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DynamodbPackage.ATTRIBUTE_BUILDER_DYNAMODB__ADDITIONAL_CODE, oldAdditionalCode, additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case DynamodbPackage.ATTRIBUTE_BUILDER_DYNAMODB__NAME_JAVA_LANG_STRING_:
			return getName_java_lang_String_();
		case DynamodbPackage.ATTRIBUTE_BUILDER_DYNAMODB__TYPE_SOFTWARE_AMAZON_AWSCDK_SERVICES_DYNAMODB_ATTRIBUTE_TYPE_:
			return getType_software_amazon_awscdk_services_dynamodb_AttributeType_();
		case DynamodbPackage.ATTRIBUTE_BUILDER_DYNAMODB__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case DynamodbPackage.ATTRIBUTE_BUILDER_DYNAMODB__VAR_NAME:
			return getVarName();
		case DynamodbPackage.ATTRIBUTE_BUILDER_DYNAMODB__IDENTIFIER:
			return getIdentifier();
		case DynamodbPackage.ATTRIBUTE_BUILDER_DYNAMODB__ADDITIONAL_CODE:
