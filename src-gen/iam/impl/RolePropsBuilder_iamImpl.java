...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Role Props Builder iam</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link iam.impl.RolePropsBuilder_iamImpl#getAssumedByWithIPrincipal_software_amazon_awscdk_services_iam_IPrincipal_AsReference <em>Assumed By With IPrincipal software amazon awscdk services iam IPrincipal As Reference</em>}</li>
 *   <li>{@link iam.impl.RolePropsBuilder_iamImpl#getDescription_java_lang_String_ <em>Description java lang String </em>}</li>
 *   <li>{@link iam.impl.RolePropsBuilder_iamImpl#getExternalId_java_lang_String_ <em>External Id java lang String </em>}</li>
 *   <li>{@link iam.impl.RolePropsBuilder_iamImpl#getExternalIds_java_lang_String_AsList <em>External Ids java lang String As List</em>}</li>
 *   <li>{@link iam.impl.RolePropsBuilder_iamImpl#getInlinePolicies_java_lang_String__software_amazon_awscdk_services_iam_PolicyDocument_AsMap <em>Inline Policies java lang String software amazon awscdk services iam Policy Document As Map</em>}</li>
 *   <li>{@link iam.impl.RolePropsBuilder_iamImpl#getManagedPolicies_software_amazon_awscdk_services_iam_IManagedPolicy_AsList <em>Managed Policies software amazon awscdk services iam IManaged Policy As List</em>}</li>
 *   <li>{@link iam.impl.RolePropsBuilder_iamImpl#getMaxSessionDurationWithDuration_software_amazon_awscdk_core_Duration_AsReference <em>Max Session Duration With Duration software amazon awscdk core Duration As Reference</em>}</li>
 *   <li>{@link iam.impl.RolePropsBuilder_iamImpl#getPath_java_lang_String_ <em>Path java lang String </em>}</li>
 *   <li>{@link iam.impl.RolePropsBuilder_iamImpl#getPermissionsBoundaryWithIManagedPolicy_software_amazon_awscdk_services_iam_IManagedPolicy_AsReference <em>Permissions Boundary With IManaged Policy software amazon awscdk services iam IManaged Policy As Reference</em>}</li>
 *   <li>{@link iam.impl.RolePropsBuilder_iamImpl#getRoleName_java_lang_String_ <em>Role Name java lang String </em>}</li>
 *   <li>{@link iam.impl.RolePropsBuilder_iamImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link iam.impl.RolePropsBuilder_iamImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link iam.impl.RolePropsBuilder_iamImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link iam.impl.RolePropsBuilder_iamImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RolePropsBuilder_iamImpl extends MinimalEObjectImpl.Container implements RolePropsBuilder_iam {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.iam.RoleProps";
	 ...
	 * @generated
	 */
	protected RolePropsBuilder_iamImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return IamPackage.Literals.ROLE_PROPS_BUILDER_IAM;
	}
	...
	public void setAssumedByWithIPrincipal_software_amazon_awscdk_services_iam_IPrincipal_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.ROLE_PROPS_BUILDER_IAM__ASSUMED_BY_WITH_IPRINCIPAL_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IPRINCIPAL_AS_REFERENCE,
	...
	public void setDescription_java_lang_String_(String newDescription_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.ROLE_PROPS_BUILDER_IAM__DESCRIPTION_JAVA_LANG_STRING_, oldDescription_java_lang_String_,
	...
	public void setExternalId_java_lang_String_(String newExternalId_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.ROLE_PROPS_BUILDER_IAM__EXTERNAL_ID_JAVA_LANG_STRING_, oldExternalId_java_lang_String_,
	...
	public void setExternalIds_java_lang_String_AsList(String newExternalIds_java_lang_String_AsList) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.ROLE_PROPS_BUILDER_IAM__EXTERNAL_IDS_JAVA_LANG_STRING_AS_LIST,
	...
	public void setInlinePolicies_java_lang_String__software_amazon_awscdk_services_iam_PolicyDocument_AsMap(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.ROLE_PROPS_BUILDER_IAM__INLINE_POLICIES_JAVA_LANG_STRING_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_POLICY_DOCUMENT_AS_MAP,
	...
	public void setManagedPolicies_software_amazon_awscdk_services_iam_IManagedPolicy_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.ROLE_PROPS_BUILDER_IAM__MANAGED_POLICIES_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IMANAGED_POLICY_AS_LIST,
	...
	public void setMaxSessionDurationWithDuration_software_amazon_awscdk_core_Duration_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.ROLE_PROPS_BUILDER_IAM__MAX_SESSION_DURATION_WITH_DURATION_SOFTWARE_AMAZON_AWSCDK_CORE_DURATION_AS_REFERENCE,
	...
	public void setPath_java_lang_String_(String newPath_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.ROLE_PROPS_BUILDER_IAM__PATH_JAVA_LANG_STRING_, oldPath_java_lang_String_,
	...
	public void setPermissionsBoundaryWithIManagedPolicy_software_amazon_awscdk_services_iam_IManagedPolicy_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.ROLE_PROPS_BUILDER_IAM__PERMISSIONS_BOUNDARY_WITH_IMANAGED_POLICY_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IMANAGED_POLICY_AS_REFERENCE,
	...
	public void setRoleName_java_lang_String_(String newRoleName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.ROLE_PROPS_BUILDER_IAM__ROLE_NAME_JAVA_LANG_STRING_, oldRoleName_java_lang_String_,
	...
	public void setVarName(String newVarName) {
		...
		varName = newVarName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IamPackage.ROLE_PROPS_BUILDER_IAM__VAR_NAME,
					oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IamPackage.ROLE_PROPS_BUILDER_IAM__IDENTIFIER,
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IamPackage.ROLE_PROPS_BUILDER_IAM__ADDITIONAL_CODE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case IamPackage.ROLE_PROPS_BUILDER_IAM__ASSUMED_BY_WITH_IPRINCIPAL_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IPRINCIPAL_AS_REFERENCE:
			return getAssumedByWithIPrincipal_software_amazon_awscdk_services_iam_IPrincipal_AsReference();
		case IamPackage.ROLE_PROPS_BUILDER_IAM__DESCRIPTION_JAVA_LANG_STRING_:
			return getDescription_java_lang_String_();
		case IamPackage.ROLE_PROPS_BUILDER_IAM__EXTERNAL_ID_JAVA_LANG_STRING_:
			return getExternalId_java_lang_String_();
		case IamPackage.ROLE_PROPS_BUILDER_IAM__EXTERNAL_IDS_JAVA_LANG_STRING_AS_LIST:
			return getExternalIds_java_lang_String_AsList();
		case IamPackage.ROLE_PROPS_BUILDER_IAM__INLINE_POLICIES_JAVA_LANG_STRING_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_POLICY_DOCUMENT_AS_MAP:
			return getInlinePolicies_java_lang_String__software_amazon_awscdk_services_iam_PolicyDocument_AsMap();
		case IamPackage.ROLE_PROPS_BUILDER_IAM__MANAGED_POLICIES_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IMANAGED_POLICY_AS_LIST:
			return getManagedPolicies_software_amazon_awscdk_services_iam_IManagedPolicy_AsList();
		case IamPackage.ROLE_PROPS_BUILDER_IAM__MAX_SESSION_DURATION_WITH_DURATION_SOFTWARE_AMAZON_AWSCDK_CORE_DURATION_AS_REFERENCE:
			return getMaxSessionDurationWithDuration_software_amazon_awscdk_core_Duration_AsReference();
		case IamPackage.ROLE_PROPS_BUILDER_IAM__PATH_JAVA_LANG_STRING_:
			return getPath_java_lang_String_();
		case IamPackage.ROLE_PROPS_BUILDER_IAM__PERMISSIONS_BOUNDARY_WITH_IMANAGED_POLICY_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IMANAGED_POLICY_AS_REFERENCE:
			return getPermissionsBoundaryWithIManagedPolicy_software_amazon_awscdk_services_iam_IManagedPolicy_AsReference();
		case IamPackage.ROLE_PROPS_BUILDER_IAM__ROLE_NAME_JAVA_LANG_STRING_:
			return getRoleName_java_lang_String_();
		case IamPackage.ROLE_PROPS_BUILDER_IAM__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case IamPackage.ROLE_PROPS_BUILDER_IAM__VAR_NAME:
			return getVarName();
		case IamPackage.ROLE_PROPS_BUILDER_IAM__IDENTIFIER:
			return getIdentifier();
		case IamPackage.ROLE_PROPS_BUILDER_IAM__ADDITIONAL_CODE:
