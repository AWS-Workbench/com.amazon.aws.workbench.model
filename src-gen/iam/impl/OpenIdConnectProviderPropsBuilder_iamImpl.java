...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Open Id Connect Provider Props Builder iam</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link iam.impl.OpenIdConnectProviderPropsBuilder_iamImpl#getUrl_java_lang_String_ <em>Url java lang String </em>}</li>
 *   <li>{@link iam.impl.OpenIdConnectProviderPropsBuilder_iamImpl#getClientIds_java_lang_String_AsList <em>Client Ids java lang String As List</em>}</li>
 *   <li>{@link iam.impl.OpenIdConnectProviderPropsBuilder_iamImpl#getThumbprints_java_lang_String_AsList <em>Thumbprints java lang String As List</em>}</li>
 *   <li>{@link iam.impl.OpenIdConnectProviderPropsBuilder_iamImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link iam.impl.OpenIdConnectProviderPropsBuilder_iamImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link iam.impl.OpenIdConnectProviderPropsBuilder_iamImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link iam.impl.OpenIdConnectProviderPropsBuilder_iamImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OpenIdConnectProviderPropsBuilder_iamImpl extends MinimalEObjectImpl.Container
		implements OpenIdConnectProviderPropsBuilder_iam {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.iam.OpenIdConnectProviderProps";
	 ...
	 * @generated
	 */
	protected OpenIdConnectProviderPropsBuilder_iamImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return IamPackage.Literals.OPEN_ID_CONNECT_PROVIDER_PROPS_BUILDER_IAM;
	}
	...
	public void setUrl_java_lang_String_(String newUrl_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.OPEN_ID_CONNECT_PROVIDER_PROPS_BUILDER_IAM__URL_JAVA_LANG_STRING_,
					oldUrl_java_lang_String_, url_java_lang_String_));
	}
	...
	public void setClientIds_java_lang_String_AsList(String newClientIds_java_lang_String_AsList) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.OPEN_ID_CONNECT_PROVIDER_PROPS_BUILDER_IAM__CLIENT_IDS_JAVA_LANG_STRING_AS_LIST,
	...
	public void setThumbprints_java_lang_String_AsList(String newThumbprints_java_lang_String_AsList) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.OPEN_ID_CONNECT_PROVIDER_PROPS_BUILDER_IAM__THUMBPRINTS_JAVA_LANG_STRING_AS_LIST,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.OPEN_ID_CONNECT_PROVIDER_PROPS_BUILDER_IAM__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.OPEN_ID_CONNECT_PROVIDER_PROPS_BUILDER_IAM__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.OPEN_ID_CONNECT_PROVIDER_PROPS_BUILDER_IAM__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
...
} //OpenIdConnectProviderPropsBuilder_iamImpl
