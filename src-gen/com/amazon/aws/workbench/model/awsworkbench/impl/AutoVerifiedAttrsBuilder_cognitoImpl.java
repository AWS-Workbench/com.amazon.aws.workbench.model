...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Auto Verified Attrs Builder cognito</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.AutoVerifiedAttrsBuilder_cognitoImpl#getEmail_java_lang_Boolean_ <em>Email java lang Boolean </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.AutoVerifiedAttrsBuilder_cognitoImpl#getPhone_java_lang_Boolean_ <em>Phone java lang Boolean </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.AutoVerifiedAttrsBuilder_cognitoImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.AutoVerifiedAttrsBuilder_cognitoImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.AutoVerifiedAttrsBuilder_cognitoImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.AutoVerifiedAttrsBuilder_cognitoImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AutoVerifiedAttrsBuilder_cognitoImpl extends ServiceResourcesImpl
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.cognito.AutoVerifiedAttrs";
	 ...
	 * @generated
	 */
	protected AutoVerifiedAttrsBuilder_cognitoImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AwsworkbenchPackage.Literals.AUTO_VERIFIED_ATTRS_BUILDER_COGNITO;
	}
	...
	public void setEmail_java_lang_Boolean_(Boolean newEmail_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.AUTO_VERIFIED_ATTRS_BUILDER_COGNITO__EMAIL_JAVA_LANG_BOOLEAN_,
	...
	public void setPhone_java_lang_Boolean_(Boolean newPhone_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.AUTO_VERIFIED_ATTRS_BUILDER_COGNITO__PHONE_JAVA_LANG_BOOLEAN_,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.AUTO_VERIFIED_ATTRS_BUILDER_COGNITO__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.AUTO_VERIFIED_ATTRS_BUILDER_COGNITO__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.AUTO_VERIFIED_ATTRS_BUILDER_COGNITO__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
...
} //AutoVerifiedAttrsBuilder_cognitoImpl
