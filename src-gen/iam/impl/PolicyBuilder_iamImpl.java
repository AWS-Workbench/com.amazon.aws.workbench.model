...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Policy Builder iam</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link iam.impl.PolicyBuilder_iamImpl#getForce_java_lang_Boolean_ <em>Force java lang Boolean </em>}</li>
 *   <li>{@link iam.impl.PolicyBuilder_iamImpl#getGroups_software_amazon_awscdk_services_iam_IGroup_AsList <em>Groups software amazon awscdk services iam IGroup As List</em>}</li>
 *   <li>{@link iam.impl.PolicyBuilder_iamImpl#getPolicyName_java_lang_String_ <em>Policy Name java lang String </em>}</li>
 *   <li>{@link iam.impl.PolicyBuilder_iamImpl#getRoles_software_amazon_awscdk_services_iam_IRole_AsList <em>Roles software amazon awscdk services iam IRole As List</em>}</li>
 *   <li>{@link iam.impl.PolicyBuilder_iamImpl#getStatements_software_amazon_awscdk_services_iam_PolicyStatement_AsList <em>Statements software amazon awscdk services iam Policy Statement As List</em>}</li>
 *   <li>{@link iam.impl.PolicyBuilder_iamImpl#getUsers_software_amazon_awscdk_services_iam_IUser_AsList <em>Users software amazon awscdk services iam IUser As List</em>}</li>
 *   <li>{@link iam.impl.PolicyBuilder_iamImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link iam.impl.PolicyBuilder_iamImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link iam.impl.PolicyBuilder_iamImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link iam.impl.PolicyBuilder_iamImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PolicyBuilder_iamImpl extends MinimalEObjectImpl.Container implements PolicyBuilder_iam {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.iam.Policy";
	 ...
	 * @generated
	 */
	protected PolicyBuilder_iamImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return IamPackage.Literals.POLICY_BUILDER_IAM;
	}
	...
	public void setForce_java_lang_Boolean_(Boolean newForce_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.POLICY_BUILDER_IAM__FORCE_JAVA_LANG_BOOLEAN_, oldForce_java_lang_Boolean_,
	...
	public void setGroups_software_amazon_awscdk_services_iam_IGroup_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.POLICY_BUILDER_IAM__GROUPS_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IGROUP_AS_LIST,
	...
	public void setPolicyName_java_lang_String_(String newPolicyName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.POLICY_BUILDER_IAM__POLICY_NAME_JAVA_LANG_STRING_, oldPolicyName_java_lang_String_,
	...
	public void setRoles_software_amazon_awscdk_services_iam_IRole_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.POLICY_BUILDER_IAM__ROLES_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IROLE_AS_LIST,
	...
	public void setStatements_software_amazon_awscdk_services_iam_PolicyStatement_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.POLICY_BUILDER_IAM__STATEMENTS_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_POLICY_STATEMENT_AS_LIST,
	...
	public void setUsers_software_amazon_awscdk_services_iam_IUser_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.POLICY_BUILDER_IAM__USERS_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IUSER_AS_LIST,
	...
	public void setVarName(String newVarName) {
		...
		varName = newVarName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IamPackage.POLICY_BUILDER_IAM__VAR_NAME, oldVarName,
					varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IamPackage.POLICY_BUILDER_IAM__IDENTIFIER,
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IamPackage.POLICY_BUILDER_IAM__ADDITIONAL_CODE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case IamPackage.POLICY_BUILDER_IAM__FORCE_JAVA_LANG_BOOLEAN_:
			return getForce_java_lang_Boolean_();
		case IamPackage.POLICY_BUILDER_IAM__GROUPS_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IGROUP_AS_LIST:
			return getGroups_software_amazon_awscdk_services_iam_IGroup_AsList();
		case IamPackage.POLICY_BUILDER_IAM__POLICY_NAME_JAVA_LANG_STRING_:
			return getPolicyName_java_lang_String_();
		case IamPackage.POLICY_BUILDER_IAM__ROLES_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IROLE_AS_LIST:
			return getRoles_software_amazon_awscdk_services_iam_IRole_AsList();
		case IamPackage.POLICY_BUILDER_IAM__STATEMENTS_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_POLICY_STATEMENT_AS_LIST:
			return getStatements_software_amazon_awscdk_services_iam_PolicyStatement_AsList();
		case IamPackage.POLICY_BUILDER_IAM__USERS_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IUSER_AS_LIST:
			return getUsers_software_amazon_awscdk_services_iam_IUser_AsList();
		case IamPackage.POLICY_BUILDER_IAM__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case IamPackage.POLICY_BUILDER_IAM__VAR_NAME:
			return getVarName();
		case IamPackage.POLICY_BUILDER_IAM__IDENTIFIER:
			return getIdentifier();
		case IamPackage.POLICY_BUILDER_IAM__ADDITIONAL_CODE:
