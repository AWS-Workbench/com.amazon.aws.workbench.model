 ...
 * </p>
 * <ul>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.PortBuilder_ec2Impl#getProtocol_software_amazon_awscdk_services_ec2_Protocol_ <em>Protocol software amazon awscdk services ec2 Protocol </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.PortBuilder_ec2Impl#getStringRepresentation_java_lang_String_ <em>String Representation java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.PortBuilder_ec2Impl#getFromPort_java_lang_Number_ <em>From Port java lang Number </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.PortBuilder_ec2Impl#getToPort_java_lang_Number_ <em>To Port java lang Number </em>}</li>
...
public class PortBuilder_ec2Impl extends ServiceResourcesImpl implements PortBuilder_ec2 {
	 ...
	 * @ordered
	 */
	protected static final Protocol PROTOCOL_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_PROTOCOL__EDEFAULT = Protocol.TCP;
	...
	public void setProtocol_software_amazon_awscdk_services_ec2_Protocol_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.PORT_BUILDER_EC2__PROTOCOL_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_PROTOCOL_,
	...
	public void setStringRepresentation_java_lang_String_(String newStringRepresentation_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.PORT_BUILDER_EC2__STRING_REPRESENTATION_JAVA_LANG_STRING_,
	...
	public void setFromPort_java_lang_Number_(int newFromPort_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.PORT_BUILDER_EC2__FROM_PORT_JAVA_LANG_NUMBER_, oldFromPort_java_lang_Number_,
	...
	public void setToPort_java_lang_Number_(int newToPort_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.PORT_BUILDER_EC2__TO_PORT_JAVA_LANG_NUMBER_, oldToPort_java_lang_Number_,
