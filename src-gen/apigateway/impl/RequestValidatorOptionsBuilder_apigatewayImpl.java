...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Request Validator Options Builder apigateway</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link apigateway.impl.RequestValidatorOptionsBuilder_apigatewayImpl#getRequestValidatorName_java_lang_String_ <em>Request Validator Name java lang String </em>}</li>
 *   <li>{@link apigateway.impl.RequestValidatorOptionsBuilder_apigatewayImpl#getValidateRequestBody_java_lang_Boolean_ <em>Validate Request Body java lang Boolean </em>}</li>
 *   <li>{@link apigateway.impl.RequestValidatorOptionsBuilder_apigatewayImpl#getValidateRequestParameters_java_lang_Boolean_ <em>Validate Request Parameters java lang Boolean </em>}</li>
 *   <li>{@link apigateway.impl.RequestValidatorOptionsBuilder_apigatewayImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link apigateway.impl.RequestValidatorOptionsBuilder_apigatewayImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link apigateway.impl.RequestValidatorOptionsBuilder_apigatewayImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link apigateway.impl.RequestValidatorOptionsBuilder_apigatewayImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequestValidatorOptionsBuilder_apigatewayImpl extends MinimalEObjectImpl.Container
		implements RequestValidatorOptionsBuilder_apigateway {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.apigateway.RequestValidatorOptions";
	 ...
	 * @generated
	 */
	protected RequestValidatorOptionsBuilder_apigatewayImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ApigatewayPackage.Literals.REQUEST_VALIDATOR_OPTIONS_BUILDER_APIGATEWAY;
	}
	...
	public void setRequestValidatorName_java_lang_String_(String newRequestValidatorName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.REQUEST_VALIDATOR_OPTIONS_BUILDER_APIGATEWAY__REQUEST_VALIDATOR_NAME_JAVA_LANG_STRING_,
	...
	public void setValidateRequestBody_java_lang_Boolean_(Boolean newValidateRequestBody_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.REQUEST_VALIDATOR_OPTIONS_BUILDER_APIGATEWAY__VALIDATE_REQUEST_BODY_JAVA_LANG_BOOLEAN_,
	...
	public void setValidateRequestParameters_java_lang_Boolean_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.REQUEST_VALIDATOR_OPTIONS_BUILDER_APIGATEWAY__VALIDATE_REQUEST_PARAMETERS_JAVA_LANG_BOOLEAN_,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.REQUEST_VALIDATOR_OPTIONS_BUILDER_APIGATEWAY__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.REQUEST_VALIDATOR_OPTIONS_BUILDER_APIGATEWAY__IDENTIFIER, oldIdentifier,
					identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.REQUEST_VALIDATOR_OPTIONS_BUILDER_APIGATEWAY__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ApigatewayPackage.REQUEST_VALIDATOR_OPTIONS_BUILDER_APIGATEWAY__REQUEST_VALIDATOR_NAME_JAVA_LANG_STRING_:
			return getRequestValidatorName_java_lang_String_();
		case ApigatewayPackage.REQUEST_VALIDATOR_OPTIONS_BUILDER_APIGATEWAY__VALIDATE_REQUEST_BODY_JAVA_LANG_BOOLEAN_:
			return getValidateRequestBody_java_lang_Boolean_();
		case ApigatewayPackage.REQUEST_VALIDATOR_OPTIONS_BUILDER_APIGATEWAY__VALIDATE_REQUEST_PARAMETERS_JAVA_LANG_BOOLEAN_:
			return getValidateRequestParameters_java_lang_Boolean_();
		case ApigatewayPackage.REQUEST_VALIDATOR_OPTIONS_BUILDER_APIGATEWAY__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case ApigatewayPackage.REQUEST_VALIDATOR_OPTIONS_BUILDER_APIGATEWAY__VAR_NAME:
			return getVarName();
		case ApigatewayPackage.REQUEST_VALIDATOR_OPTIONS_BUILDER_APIGATEWAY__IDENTIFIER:
			return getIdentifier();
		case ApigatewayPackage.REQUEST_VALIDATOR_OPTIONS_BUILDER_APIGATEWAY__ADDITIONAL_CODE:
...
} //RequestValidatorOptionsBuilder_apigatewayImpl
