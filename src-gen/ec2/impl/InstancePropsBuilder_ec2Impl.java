...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Instance Props Builder ec2</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ec2.impl.InstancePropsBuilder_ec2Impl#getInstanceTypeWithInstanceType_software_amazon_awscdk_services_ec2_InstanceType_AsReference <em>Instance Type With Instance Type software amazon awscdk services ec2 Instance Type As Reference</em>}</li>
 *   <li>{@link ec2.impl.InstancePropsBuilder_ec2Impl#getMachineImageWithIMachineImage_software_amazon_awscdk_services_ec2_IMachineImage_AsReference <em>Machine Image With IMachine Image software amazon awscdk services ec2 IMachine Image As Reference</em>}</li>
 *   <li>{@link ec2.impl.InstancePropsBuilder_ec2Impl#getVpcWithIVpc_software_amazon_awscdk_services_ec2_IVpc_AsReference <em>Vpc With IVpc software amazon awscdk services ec2 IVpc As Reference</em>}</li>
 *   <li>{@link ec2.impl.InstancePropsBuilder_ec2Impl#getAllowAllOutbound_java_lang_Boolean_ <em>Allow All Outbound java lang Boolean </em>}</li>
 *   <li>{@link ec2.impl.InstancePropsBuilder_ec2Impl#getAvailabilityZone_java_lang_String_ <em>Availability Zone java lang String </em>}</li>
 *   <li>{@link ec2.impl.InstancePropsBuilder_ec2Impl#getBlockDevices_software_amazon_awscdk_services_ec2_BlockDevice_AsList <em>Block Devices software amazon awscdk services ec2 Block Device As List</em>}</li>
 *   <li>{@link ec2.impl.InstancePropsBuilder_ec2Impl#getInstanceName_java_lang_String_ <em>Instance Name java lang String </em>}</li>
 *   <li>{@link ec2.impl.InstancePropsBuilder_ec2Impl#getKeyName_java_lang_String_ <em>Key Name java lang String </em>}</li>
 *   <li>{@link ec2.impl.InstancePropsBuilder_ec2Impl#getPrivateIpAddress_java_lang_String_ <em>Private Ip Address java lang String </em>}</li>
 *   <li>{@link ec2.impl.InstancePropsBuilder_ec2Impl#getResourceSignalTimeoutWithDuration_software_amazon_awscdk_core_Duration_AsReference <em>Resource Signal Timeout With Duration software amazon awscdk core Duration As Reference</em>}</li>
 *   <li>{@link ec2.impl.InstancePropsBuilder_ec2Impl#getRoleWithIRole_software_amazon_awscdk_services_iam_IRole_AsReference <em>Role With IRole software amazon awscdk services iam IRole As Reference</em>}</li>
 *   <li>{@link ec2.impl.InstancePropsBuilder_ec2Impl#getSecurityGroupWithISecurityGroup_software_amazon_awscdk_services_ec2_ISecurityGroup_AsReference <em>Security Group With ISecurity Group software amazon awscdk services ec2 ISecurity Group As Reference</em>}</li>
 *   <li>{@link ec2.impl.InstancePropsBuilder_ec2Impl#getSourceDestCheck_java_lang_Boolean_ <em>Source Dest Check java lang Boolean </em>}</li>
 *   <li>{@link ec2.impl.InstancePropsBuilder_ec2Impl#getUserDataWithUserData_software_amazon_awscdk_services_ec2_UserData_AsReference <em>User Data With User Data software amazon awscdk services ec2 User Data As Reference</em>}</li>
 *   <li>{@link ec2.impl.InstancePropsBuilder_ec2Impl#getVpcSubnetsWithSubnetSelection_software_amazon_awscdk_services_ec2_SubnetSelection_AsReference <em>Vpc Subnets With Subnet Selection software amazon awscdk services ec2 Subnet Selection As Reference</em>}</li>
 *   <li>{@link ec2.impl.InstancePropsBuilder_ec2Impl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link ec2.impl.InstancePropsBuilder_ec2Impl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link ec2.impl.InstancePropsBuilder_ec2Impl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link ec2.impl.InstancePropsBuilder_ec2Impl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InstancePropsBuilder_ec2Impl extends MinimalEObjectImpl.Container implements InstancePropsBuilder_ec2 {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.ec2.InstanceProps";
	 ...
	 * @generated
	 */
	protected InstancePropsBuilder_ec2Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Ec2Package.Literals.INSTANCE_PROPS_BUILDER_EC2;
	}
	...
	public void setInstanceTypeWithInstanceType_software_amazon_awscdk_services_ec2_InstanceType_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.INSTANCE_PROPS_BUILDER_EC2__INSTANCE_TYPE_WITH_INSTANCE_TYPE_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_INSTANCE_TYPE_AS_REFERENCE,
	...
	public void setMachineImageWithIMachineImage_software_amazon_awscdk_services_ec2_IMachineImage_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.INSTANCE_PROPS_BUILDER_EC2__MACHINE_IMAGE_WITH_IMACHINE_IMAGE_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_IMACHINE_IMAGE_AS_REFERENCE,
	...
	public void setVpcWithIVpc_software_amazon_awscdk_services_ec2_IVpc_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.INSTANCE_PROPS_BUILDER_EC2__VPC_WITH_IVPC_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_IVPC_AS_REFERENCE,
	...
	public void setAllowAllOutbound_java_lang_Boolean_(Boolean newAllowAllOutbound_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.INSTANCE_PROPS_BUILDER_EC2__ALLOW_ALL_OUTBOUND_JAVA_LANG_BOOLEAN_,
	...
	public void setAvailabilityZone_java_lang_String_(String newAvailabilityZone_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.INSTANCE_PROPS_BUILDER_EC2__AVAILABILITY_ZONE_JAVA_LANG_STRING_,
	...
	public void setBlockDevices_software_amazon_awscdk_services_ec2_BlockDevice_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.INSTANCE_PROPS_BUILDER_EC2__BLOCK_DEVICES_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_BLOCK_DEVICE_AS_LIST,
	...
	public void setInstanceName_java_lang_String_(String newInstanceName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.INSTANCE_PROPS_BUILDER_EC2__INSTANCE_NAME_JAVA_LANG_STRING_,
	...
	public void setKeyName_java_lang_String_(String newKeyName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.INSTANCE_PROPS_BUILDER_EC2__KEY_NAME_JAVA_LANG_STRING_, oldKeyName_java_lang_String_,
	...
	public void setPrivateIpAddress_java_lang_String_(String newPrivateIpAddress_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.INSTANCE_PROPS_BUILDER_EC2__PRIVATE_IP_ADDRESS_JAVA_LANG_STRING_,
	...
	public void setResourceSignalTimeoutWithDuration_software_amazon_awscdk_core_Duration_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.INSTANCE_PROPS_BUILDER_EC2__RESOURCE_SIGNAL_TIMEOUT_WITH_DURATION_SOFTWARE_AMAZON_AWSCDK_CORE_DURATION_AS_REFERENCE,
	...
	public void setRoleWithIRole_software_amazon_awscdk_services_iam_IRole_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.INSTANCE_PROPS_BUILDER_EC2__ROLE_WITH_IROLE_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IROLE_AS_REFERENCE,
	...
	public void setSecurityGroupWithISecurityGroup_software_amazon_awscdk_services_ec2_ISecurityGroup_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.INSTANCE_PROPS_BUILDER_EC2__SECURITY_GROUP_WITH_ISECURITY_GROUP_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_ISECURITY_GROUP_AS_REFERENCE,
	...
	public void setSourceDestCheck_java_lang_Boolean_(Boolean newSourceDestCheck_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.INSTANCE_PROPS_BUILDER_EC2__SOURCE_DEST_CHECK_JAVA_LANG_BOOLEAN_,
	...
	public void setUserDataWithUserData_software_amazon_awscdk_services_ec2_UserData_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.INSTANCE_PROPS_BUILDER_EC2__USER_DATA_WITH_USER_DATA_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_USER_DATA_AS_REFERENCE,
	...
	public void setVpcSubnetsWithSubnetSelection_software_amazon_awscdk_services_ec2_SubnetSelection_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.INSTANCE_PROPS_BUILDER_EC2__VPC_SUBNETS_WITH_SUBNET_SELECTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_SUBNET_SELECTION_AS_REFERENCE,
	...
	public void setVarName(String newVarName) {
		...
		varName = newVarName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.INSTANCE_PROPS_BUILDER_EC2__VAR_NAME,
					oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.INSTANCE_PROPS_BUILDER_EC2__IDENTIFIER,
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.INSTANCE_PROPS_BUILDER_EC2__ADDITIONAL_CODE, oldAdditionalCode, additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Ec2Package.INSTANCE_PROPS_BUILDER_EC2__INSTANCE_TYPE_WITH_INSTANCE_TYPE_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_INSTANCE_TYPE_AS_REFERENCE:
			return getInstanceTypeWithInstanceType_software_amazon_awscdk_services_ec2_InstanceType_AsReference();
		case Ec2Package.INSTANCE_PROPS_BUILDER_EC2__MACHINE_IMAGE_WITH_IMACHINE_IMAGE_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_IMACHINE_IMAGE_AS_REFERENCE:
			return getMachineImageWithIMachineImage_software_amazon_awscdk_services_ec2_IMachineImage_AsReference();
		case Ec2Package.INSTANCE_PROPS_BUILDER_EC2__VPC_WITH_IVPC_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_IVPC_AS_REFERENCE:
			return getVpcWithIVpc_software_amazon_awscdk_services_ec2_IVpc_AsReference();
		case Ec2Package.INSTANCE_PROPS_BUILDER_EC2__ALLOW_ALL_OUTBOUND_JAVA_LANG_BOOLEAN_:
			return getAllowAllOutbound_java_lang_Boolean_();
		case Ec2Package.INSTANCE_PROPS_BUILDER_EC2__AVAILABILITY_ZONE_JAVA_LANG_STRING_:
			return getAvailabilityZone_java_lang_String_();
		case Ec2Package.INSTANCE_PROPS_BUILDER_EC2__BLOCK_DEVICES_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_BLOCK_DEVICE_AS_LIST:
			return getBlockDevices_software_amazon_awscdk_services_ec2_BlockDevice_AsList();
		case Ec2Package.INSTANCE_PROPS_BUILDER_EC2__INSTANCE_NAME_JAVA_LANG_STRING_:
			return getInstanceName_java_lang_String_();
		case Ec2Package.INSTANCE_PROPS_BUILDER_EC2__KEY_NAME_JAVA_LANG_STRING_:
			return getKeyName_java_lang_String_();
		case Ec2Package.INSTANCE_PROPS_BUILDER_EC2__PRIVATE_IP_ADDRESS_JAVA_LANG_STRING_:
			return getPrivateIpAddress_java_lang_String_();
		case Ec2Package.INSTANCE_PROPS_BUILDER_EC2__RESOURCE_SIGNAL_TIMEOUT_WITH_DURATION_SOFTWARE_AMAZON_AWSCDK_CORE_DURATION_AS_REFERENCE:
			return getResourceSignalTimeoutWithDuration_software_amazon_awscdk_core_Duration_AsReference();
		case Ec2Package.INSTANCE_PROPS_BUILDER_EC2__ROLE_WITH_IROLE_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IROLE_AS_REFERENCE:
			return getRoleWithIRole_software_amazon_awscdk_services_iam_IRole_AsReference();
		case Ec2Package.INSTANCE_PROPS_BUILDER_EC2__SECURITY_GROUP_WITH_ISECURITY_GROUP_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_ISECURITY_GROUP_AS_REFERENCE:
			return getSecurityGroupWithISecurityGroup_software_amazon_awscdk_services_ec2_ISecurityGroup_AsReference();
		case Ec2Package.INSTANCE_PROPS_BUILDER_EC2__SOURCE_DEST_CHECK_JAVA_LANG_BOOLEAN_:
			return getSourceDestCheck_java_lang_Boolean_();
		case Ec2Package.INSTANCE_PROPS_BUILDER_EC2__USER_DATA_WITH_USER_DATA_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_USER_DATA_AS_REFERENCE:
			return getUserDataWithUserData_software_amazon_awscdk_services_ec2_UserData_AsReference();
		case Ec2Package.INSTANCE_PROPS_BUILDER_EC2__VPC_SUBNETS_WITH_SUBNET_SELECTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_SUBNET_SELECTION_AS_REFERENCE:
			return getVpcSubnetsWithSubnetSelection_software_amazon_awscdk_services_ec2_SubnetSelection_AsReference();
		case Ec2Package.INSTANCE_PROPS_BUILDER_EC2__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case Ec2Package.INSTANCE_PROPS_BUILDER_EC2__VAR_NAME:
			return getVarName();
		case Ec2Package.INSTANCE_PROPS_BUILDER_EC2__IDENTIFIER:
			return getIdentifier();
		case Ec2Package.INSTANCE_PROPS_BUILDER_EC2__ADDITIONAL_CODE:
