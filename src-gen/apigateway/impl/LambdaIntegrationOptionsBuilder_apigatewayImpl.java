...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Lambda Integration Options Builder apigateway</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link apigateway.impl.LambdaIntegrationOptionsBuilder_apigatewayImpl#getAllowTestInvoke_java_lang_Boolean_ <em>Allow Test Invoke java lang Boolean </em>}</li>
 *   <li>{@link apigateway.impl.LambdaIntegrationOptionsBuilder_apigatewayImpl#getProxy_java_lang_Boolean_ <em>Proxy java lang Boolean </em>}</li>
 *   <li>{@link apigateway.impl.LambdaIntegrationOptionsBuilder_apigatewayImpl#getCacheKeyParameters_java_lang_String_AsList <em>Cache Key Parameters java lang String As List</em>}</li>
 *   <li>{@link apigateway.impl.LambdaIntegrationOptionsBuilder_apigatewayImpl#getCacheNamespace_java_lang_String_ <em>Cache Namespace java lang String </em>}</li>
 *   <li>{@link apigateway.impl.LambdaIntegrationOptionsBuilder_apigatewayImpl#getConnectionType_software_amazon_awscdk_services_apigateway_ConnectionType_ <em>Connection Type software amazon awscdk services apigateway Connection Type </em>}</li>
 *   <li>{@link apigateway.impl.LambdaIntegrationOptionsBuilder_apigatewayImpl#getContentHandling_software_amazon_awscdk_services_apigateway_ContentHandling_ <em>Content Handling software amazon awscdk services apigateway Content Handling </em>}</li>
 *   <li>{@link apigateway.impl.LambdaIntegrationOptionsBuilder_apigatewayImpl#getCredentialsPassthrough_java_lang_Boolean_ <em>Credentials Passthrough java lang Boolean </em>}</li>
 *   <li>{@link apigateway.impl.LambdaIntegrationOptionsBuilder_apigatewayImpl#getCredentialsRoleWithIRole_software_amazon_awscdk_services_iam_IRole_AsReference <em>Credentials Role With IRole software amazon awscdk services iam IRole As Reference</em>}</li>
 *   <li>{@link apigateway.impl.LambdaIntegrationOptionsBuilder_apigatewayImpl#getIntegrationResponses_software_amazon_awscdk_services_apigateway_IntegrationResponse_AsList <em>Integration Responses software amazon awscdk services apigateway Integration Response As List</em>}</li>
 *   <li>{@link apigateway.impl.LambdaIntegrationOptionsBuilder_apigatewayImpl#getPassthroughBehavior_software_amazon_awscdk_services_apigateway_PassthroughBehavior_ <em>Passthrough Behavior software amazon awscdk services apigateway Passthrough Behavior </em>}</li>
 *   <li>{@link apigateway.impl.LambdaIntegrationOptionsBuilder_apigatewayImpl#getRequestParameters_java_lang_String__java_lang_String_AsMap <em>Request Parameters java lang String java lang String As Map</em>}</li>
 *   <li>{@link apigateway.impl.LambdaIntegrationOptionsBuilder_apigatewayImpl#getRequestTemplates_java_lang_String__java_lang_String_AsMap <em>Request Templates java lang String java lang String As Map</em>}</li>
 *   <li>{@link apigateway.impl.LambdaIntegrationOptionsBuilder_apigatewayImpl#getVpcLinkWithIVpcLink_software_amazon_awscdk_services_apigateway_IVpcLink_AsReference <em>Vpc Link With IVpc Link software amazon awscdk services apigateway IVpc Link As Reference</em>}</li>
 *   <li>{@link apigateway.impl.LambdaIntegrationOptionsBuilder_apigatewayImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link apigateway.impl.LambdaIntegrationOptionsBuilder_apigatewayImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link apigateway.impl.LambdaIntegrationOptionsBuilder_apigatewayImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link apigateway.impl.LambdaIntegrationOptionsBuilder_apigatewayImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LambdaIntegrationOptionsBuilder_apigatewayImpl extends MinimalEObjectImpl.Container
		implements LambdaIntegrationOptionsBuilder_apigateway {
	/**
	 * The default value of the '{@link #getAllowTestInvoke_java_lang_Boolean_() <em>Allow Test Invoke java lang Boolean </em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected static final Boolean ALLOW_TEST_INVOKE_JAVA_LANG_BOOLEAN__EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getAllowTestInvoke_java_lang_Boolean_() <em>Allow Test Invoke java lang Boolean </em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getAllowTestInvoke_java_lang_Boolean_()
	 * @generated
	 * @ordered
	 */
	protected Boolean allowTestInvoke_java_lang_Boolean_ = ALLOW_TEST_INVOKE_JAVA_LANG_BOOLEAN__EDEFAULT;
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.apigateway.LambdaIntegrationOptions";
	 ...
	 * @generated
	 */
	protected LambdaIntegrationOptionsBuilder_apigatewayImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ApigatewayPackage.Literals.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY;
	}
	 ...
	 */
	@Override
	public Boolean getAllowTestInvoke_java_lang_Boolean_() {
		return allowTestInvoke_java_lang_Boolean_;
	}
	 ...
	 */
	@Override
	public void setAllowTestInvoke_java_lang_Boolean_(Boolean newAllowTestInvoke_java_lang_Boolean_) {
		Boolean oldAllowTestInvoke_java_lang_Boolean_ = allowTestInvoke_java_lang_Boolean_;
		allowTestInvoke_java_lang_Boolean_ = newAllowTestInvoke_java_lang_Boolean_;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__ALLOW_TEST_INVOKE_JAVA_LANG_BOOLEAN_,
					oldAllowTestInvoke_java_lang_Boolean_, allowTestInvoke_java_lang_Boolean_));
	}
	...
	public void setProxy_java_lang_Boolean_(Boolean newProxy_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__PROXY_JAVA_LANG_BOOLEAN_,
	...
	public void setCacheKeyParameters_java_lang_String_AsList(String newCacheKeyParameters_java_lang_String_AsList) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__CACHE_KEY_PARAMETERS_JAVA_LANG_STRING_AS_LIST,
	...
	public void setCacheNamespace_java_lang_String_(String newCacheNamespace_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__CACHE_NAMESPACE_JAVA_LANG_STRING_,
	...
	public void setConnectionType_software_amazon_awscdk_services_apigateway_ConnectionType_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__CONNECTION_TYPE_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_CONNECTION_TYPE_,
	...
	public void setContentHandling_software_amazon_awscdk_services_apigateway_ContentHandling_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__CONTENT_HANDLING_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_CONTENT_HANDLING_,
	...
	public void setCredentialsPassthrough_java_lang_Boolean_(Boolean newCredentialsPassthrough_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__CREDENTIALS_PASSTHROUGH_JAVA_LANG_BOOLEAN_,
	...
	public void setCredentialsRoleWithIRole_software_amazon_awscdk_services_iam_IRole_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__CREDENTIALS_ROLE_WITH_IROLE_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IROLE_AS_REFERENCE,
	...
	public void setIntegrationResponses_software_amazon_awscdk_services_apigateway_IntegrationResponse_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__INTEGRATION_RESPONSES_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_INTEGRATION_RESPONSE_AS_LIST,
	...
	public void setPassthroughBehavior_software_amazon_awscdk_services_apigateway_PassthroughBehavior_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__PASSTHROUGH_BEHAVIOR_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_PASSTHROUGH_BEHAVIOR_,
	...
	public void setRequestParameters_java_lang_String__java_lang_String_AsMap(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__REQUEST_PARAMETERS_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP,
	...
	public void setRequestTemplates_java_lang_String__java_lang_String_AsMap(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__REQUEST_TEMPLATES_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP,
	...
	public void setVpcLinkWithIVpcLink_software_amazon_awscdk_services_apigateway_IVpcLink_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__VPC_LINK_WITH_IVPC_LINK_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_IVPC_LINK_AS_REFERENCE,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__IDENTIFIER, oldIdentifier,
					identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__ALLOW_TEST_INVOKE_JAVA_LANG_BOOLEAN_:
			return getAllowTestInvoke_java_lang_Boolean_();
		case ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__PROXY_JAVA_LANG_BOOLEAN_:
			return getProxy_java_lang_Boolean_();
		case ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__CACHE_KEY_PARAMETERS_JAVA_LANG_STRING_AS_LIST:
			return getCacheKeyParameters_java_lang_String_AsList();
		case ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__CACHE_NAMESPACE_JAVA_LANG_STRING_:
			return getCacheNamespace_java_lang_String_();
		case ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__CONNECTION_TYPE_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_CONNECTION_TYPE_:
			return getConnectionType_software_amazon_awscdk_services_apigateway_ConnectionType_();
		case ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__CONTENT_HANDLING_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_CONTENT_HANDLING_:
			return getContentHandling_software_amazon_awscdk_services_apigateway_ContentHandling_();
		case ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__CREDENTIALS_PASSTHROUGH_JAVA_LANG_BOOLEAN_:
			return getCredentialsPassthrough_java_lang_Boolean_();
		case ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__CREDENTIALS_ROLE_WITH_IROLE_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IROLE_AS_REFERENCE:
			return getCredentialsRoleWithIRole_software_amazon_awscdk_services_iam_IRole_AsReference();
		case ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__INTEGRATION_RESPONSES_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_INTEGRATION_RESPONSE_AS_LIST:
			return getIntegrationResponses_software_amazon_awscdk_services_apigateway_IntegrationResponse_AsList();
		case ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__PASSTHROUGH_BEHAVIOR_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_PASSTHROUGH_BEHAVIOR_:
			return getPassthroughBehavior_software_amazon_awscdk_services_apigateway_PassthroughBehavior_();
		case ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__REQUEST_PARAMETERS_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP:
			return getRequestParameters_java_lang_String__java_lang_String_AsMap();
		case ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__REQUEST_TEMPLATES_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP:
			return getRequestTemplates_java_lang_String__java_lang_String_AsMap();
		case ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__VPC_LINK_WITH_IVPC_LINK_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_IVPC_LINK_AS_REFERENCE:
			return getVpcLinkWithIVpcLink_software_amazon_awscdk_services_apigateway_IVpcLink_AsReference();
		case ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__VAR_NAME:
			return getVarName();
		case ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__IDENTIFIER:
			return getIdentifier();
		case ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__ADDITIONAL_CODE:
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
		case ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__ALLOW_TEST_INVOKE_JAVA_LANG_BOOLEAN_:
			setAllowTestInvoke_java_lang_Boolean_((Boolean) newValue);
			return;
		case ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__PROXY_JAVA_LANG_BOOLEAN_:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
		case ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__ALLOW_TEST_INVOKE_JAVA_LANG_BOOLEAN_:
			setAllowTestInvoke_java_lang_Boolean_(ALLOW_TEST_INVOKE_JAVA_LANG_BOOLEAN__EDEFAULT);
			return;
		case ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__PROXY_JAVA_LANG_BOOLEAN_:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__ALLOW_TEST_INVOKE_JAVA_LANG_BOOLEAN_:
			return ALLOW_TEST_INVOKE_JAVA_LANG_BOOLEAN__EDEFAULT == null ? allowTestInvoke_java_lang_Boolean_ != null
					: !ALLOW_TEST_INVOKE_JAVA_LANG_BOOLEAN__EDEFAULT.equals(allowTestInvoke_java_lang_Boolean_);
		case ApigatewayPackage.LAMBDA_INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__PROXY_JAVA_LANG_BOOLEAN_:
	...
	public String toString() {
		...
		result.append(" (allowTestInvoke_java_lang_Boolean_: ");
		result.append(allowTestInvoke_java_lang_Boolean_);
...
} //LambdaIntegrationOptionsBuilder_apigatewayImpl
