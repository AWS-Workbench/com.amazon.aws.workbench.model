...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Secondary Index Props Builder dynamodb</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link dynamodb.impl.SecondaryIndexPropsBuilder_dynamodbImpl#getIndexName_java_lang_String_ <em>Index Name java lang String </em>}</li>
 *   <li>{@link dynamodb.impl.SecondaryIndexPropsBuilder_dynamodbImpl#getNonKeyAttributes_java_lang_String_AsList <em>Non Key Attributes java lang String As List</em>}</li>
 *   <li>{@link dynamodb.impl.SecondaryIndexPropsBuilder_dynamodbImpl#getProjectionType_software_amazon_awscdk_services_dynamodb_ProjectionType_ <em>Projection Type software amazon awscdk services dynamodb Projection Type </em>}</li>
 *   <li>{@link dynamodb.impl.SecondaryIndexPropsBuilder_dynamodbImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link dynamodb.impl.SecondaryIndexPropsBuilder_dynamodbImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link dynamodb.impl.SecondaryIndexPropsBuilder_dynamodbImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link dynamodb.impl.SecondaryIndexPropsBuilder_dynamodbImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SecondaryIndexPropsBuilder_dynamodbImpl extends MinimalEObjectImpl.Container
		implements SecondaryIndexPropsBuilder_dynamodb {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.dynamodb.SecondaryIndexProps";
	 ...
	 * @generated
	 */
	protected SecondaryIndexPropsBuilder_dynamodbImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return DynamodbPackage.Literals.SECONDARY_INDEX_PROPS_BUILDER_DYNAMODB;
	}
	...
	public void setIndexName_java_lang_String_(String newIndexName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DynamodbPackage.SECONDARY_INDEX_PROPS_BUILDER_DYNAMODB__INDEX_NAME_JAVA_LANG_STRING_,
	...
	public void setNonKeyAttributes_java_lang_String_AsList(String newNonKeyAttributes_java_lang_String_AsList) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DynamodbPackage.SECONDARY_INDEX_PROPS_BUILDER_DYNAMODB__NON_KEY_ATTRIBUTES_JAVA_LANG_STRING_AS_LIST,
	...
	public void setProjectionType_software_amazon_awscdk_services_dynamodb_ProjectionType_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DynamodbPackage.SECONDARY_INDEX_PROPS_BUILDER_DYNAMODB__PROJECTION_TYPE_SOFTWARE_AMAZON_AWSCDK_SERVICES_DYNAMODB_PROJECTION_TYPE_,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DynamodbPackage.SECONDARY_INDEX_PROPS_BUILDER_DYNAMODB__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DynamodbPackage.SECONDARY_INDEX_PROPS_BUILDER_DYNAMODB__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DynamodbPackage.SECONDARY_INDEX_PROPS_BUILDER_DYNAMODB__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case DynamodbPackage.SECONDARY_INDEX_PROPS_BUILDER_DYNAMODB__INDEX_NAME_JAVA_LANG_STRING_:
			return getIndexName_java_lang_String_();
		case DynamodbPackage.SECONDARY_INDEX_PROPS_BUILDER_DYNAMODB__NON_KEY_ATTRIBUTES_JAVA_LANG_STRING_AS_LIST:
			return getNonKeyAttributes_java_lang_String_AsList();
		case DynamodbPackage.SECONDARY_INDEX_PROPS_BUILDER_DYNAMODB__PROJECTION_TYPE_SOFTWARE_AMAZON_AWSCDK_SERVICES_DYNAMODB_PROJECTION_TYPE_:
			return getProjectionType_software_amazon_awscdk_services_dynamodb_ProjectionType_();
		case DynamodbPackage.SECONDARY_INDEX_PROPS_BUILDER_DYNAMODB__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case DynamodbPackage.SECONDARY_INDEX_PROPS_BUILDER_DYNAMODB__VAR_NAME:
			return getVarName();
		case DynamodbPackage.SECONDARY_INDEX_PROPS_BUILDER_DYNAMODB__IDENTIFIER:
			return getIdentifier();
		case DynamodbPackage.SECONDARY_INDEX_PROPS_BUILDER_DYNAMODB__ADDITIONAL_CODE:
...
} //SecondaryIndexPropsBuilder_dynamodbImpl
