 ...
 * </p>
 * <ul>
 *   <li>{@link apigateway.impl.EndpointConfigurationBuilder_apigatewayImpl#getTypes_software_amazon_awscdk_services_apigateway_EndpointType_AsList <em>Types software amazon awscdk services apigateway Endpoint Type As List</em>}</li>
 *   <li>{@link apigateway.impl.EndpointConfigurationBuilder_apigatewayImpl#getVpcEndpoints_software_amazon_awscdk_services_ec2_IVpcEndpoint_AsList <em>Vpc Endpoints software amazon awscdk services ec2 IVpc Endpoint As List</em>}</li>
 *   <li>{@link apigateway.impl.EndpointConfigurationBuilder_apigatewayImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link apigateway.impl.EndpointConfigurationBuilder_apigatewayImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link apigateway.impl.EndpointConfigurationBuilder_apigatewayImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link apigateway.impl.EndpointConfigurationBuilder_apigatewayImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EndpointConfigurationBuilder_apigatewayImpl extends MinimalEObjectImpl.Container
	...
	protected EClass eStaticClass() {
		return ApigatewayPackage.Literals.ENDPOINT_CONFIGURATION_BUILDER_APIGATEWAY;
	}
	...
	public void setTypes_software_amazon_awscdk_services_apigateway_EndpointType_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.ENDPOINT_CONFIGURATION_BUILDER_APIGATEWAY__TYPES_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_ENDPOINT_TYPE_AS_LIST,
	...
	public void setVpcEndpoints_software_amazon_awscdk_services_ec2_IVpcEndpoint_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.ENDPOINT_CONFIGURATION_BUILDER_APIGATEWAY__VPC_ENDPOINTS_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_IVPC_ENDPOINT_AS_LIST,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.ENDPOINT_CONFIGURATION_BUILDER_APIGATEWAY__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.ENDPOINT_CONFIGURATION_BUILDER_APIGATEWAY__IDENTIFIER, oldIdentifier,
					identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.ENDPOINT_CONFIGURATION_BUILDER_APIGATEWAY__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ApigatewayPackage.ENDPOINT_CONFIGURATION_BUILDER_APIGATEWAY__TYPES_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_ENDPOINT_TYPE_AS_LIST:
			return getTypes_software_amazon_awscdk_services_apigateway_EndpointType_AsList();
		case ApigatewayPackage.ENDPOINT_CONFIGURATION_BUILDER_APIGATEWAY__VPC_ENDPOINTS_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_IVPC_ENDPOINT_AS_LIST:
			return getVpcEndpoints_software_amazon_awscdk_services_ec2_IVpcEndpoint_AsList();
		case ApigatewayPackage.ENDPOINT_CONFIGURATION_BUILDER_APIGATEWAY__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case ApigatewayPackage.ENDPOINT_CONFIGURATION_BUILDER_APIGATEWAY__VAR_NAME:
			return getVarName();
		case ApigatewayPackage.ENDPOINT_CONFIGURATION_BUILDER_APIGATEWAY__IDENTIFIER:
			return getIdentifier();
		case ApigatewayPackage.ENDPOINT_CONFIGURATION_BUILDER_APIGATEWAY__ADDITIONAL_CODE:
