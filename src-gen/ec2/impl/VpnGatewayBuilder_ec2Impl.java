...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Vpn Gateway Builder ec2</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ec2.impl.VpnGatewayBuilder_ec2Impl#getType_java_lang_String_ <em>Type java lang String </em>}</li>
 *   <li>{@link ec2.impl.VpnGatewayBuilder_ec2Impl#getAmazonSideAsn_java_lang_Number_ <em>Amazon Side Asn java lang Number </em>}</li>
 *   <li>{@link ec2.impl.VpnGatewayBuilder_ec2Impl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link ec2.impl.VpnGatewayBuilder_ec2Impl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link ec2.impl.VpnGatewayBuilder_ec2Impl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link ec2.impl.VpnGatewayBuilder_ec2Impl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VpnGatewayBuilder_ec2Impl extends MinimalEObjectImpl.Container implements VpnGatewayBuilder_ec2 {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.ec2.VpnGateway";
	 ...
	 * @generated
	 */
	protected VpnGatewayBuilder_ec2Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Ec2Package.Literals.VPN_GATEWAY_BUILDER_EC2;
	}
	...
	public void setType_java_lang_String_(String newType_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPN_GATEWAY_BUILDER_EC2__TYPE_JAVA_LANG_STRING_, oldType_java_lang_String_,
	...
	public void setAmazonSideAsn_java_lang_Number_(int newAmazonSideAsn_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPN_GATEWAY_BUILDER_EC2__AMAZON_SIDE_ASN_JAVA_LANG_NUMBER_,
	...
	public void setVarName(String newVarName) {
		...
		varName = newVarName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.VPN_GATEWAY_BUILDER_EC2__VAR_NAME,
					oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.VPN_GATEWAY_BUILDER_EC2__IDENTIFIER,
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.VPN_GATEWAY_BUILDER_EC2__ADDITIONAL_CODE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Ec2Package.VPN_GATEWAY_BUILDER_EC2__TYPE_JAVA_LANG_STRING_:
			return getType_java_lang_String_();
		case Ec2Package.VPN_GATEWAY_BUILDER_EC2__AMAZON_SIDE_ASN_JAVA_LANG_NUMBER_:
			return getAmazonSideAsn_java_lang_Number_();
		case Ec2Package.VPN_GATEWAY_BUILDER_EC2__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case Ec2Package.VPN_GATEWAY_BUILDER_EC2__VAR_NAME:
			return getVarName();
		case Ec2Package.VPN_GATEWAY_BUILDER_EC2__IDENTIFIER:
			return getIdentifier();
		case Ec2Package.VPN_GATEWAY_BUILDER_EC2__ADDITIONAL_CODE:
