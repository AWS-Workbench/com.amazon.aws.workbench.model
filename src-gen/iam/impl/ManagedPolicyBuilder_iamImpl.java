 ...
 * </p>
 * <ul>
 *   <li>{@link iam.impl.ManagedPolicyBuilder_iamImpl#getDescription_java_lang_String_ <em>Description java lang String </em>}</li>
 *   <li>{@link iam.impl.ManagedPolicyBuilder_iamImpl#getDocumentWithPolicyDocument_software_amazon_awscdk_services_iam_PolicyDocument_AsReference <em>Document With Policy Document software amazon awscdk services iam Policy Document As Reference</em>}</li>
 *   <li>{@link iam.impl.ManagedPolicyBuilder_iamImpl#getGroups_software_amazon_awscdk_services_iam_IGroup_AsList <em>Groups software amazon awscdk services iam IGroup As List</em>}</li>
 *   <li>{@link iam.impl.ManagedPolicyBuilder_iamImpl#getManagedPolicyName_java_lang_String_ <em>Managed Policy Name java lang String </em>}</li>
 *   <li>{@link iam.impl.ManagedPolicyBuilder_iamImpl#getPath_java_lang_String_ <em>Path java lang String </em>}</li>
 *   <li>{@link iam.impl.ManagedPolicyBuilder_iamImpl#getRoles_software_amazon_awscdk_services_iam_IRole_AsList <em>Roles software amazon awscdk services iam IRole As List</em>}</li>
 *   <li>{@link iam.impl.ManagedPolicyBuilder_iamImpl#getStatements_software_amazon_awscdk_services_iam_PolicyStatement_AsList <em>Statements software amazon awscdk services iam Policy Statement As List</em>}</li>
 *   <li>{@link iam.impl.ManagedPolicyBuilder_iamImpl#getUsers_software_amazon_awscdk_services_iam_IUser_AsList <em>Users software amazon awscdk services iam IUser As List</em>}</li>
 *   <li>{@link iam.impl.ManagedPolicyBuilder_iamImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link iam.impl.ManagedPolicyBuilder_iamImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link iam.impl.ManagedPolicyBuilder_iamImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link iam.impl.ManagedPolicyBuilder_iamImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ManagedPolicyBuilder_iamImpl extends MinimalEObjectImpl.Container implements ManagedPolicyBuilder_iam {
	...
	protected EClass eStaticClass() {
		return IamPackage.Literals.MANAGED_POLICY_BUILDER_IAM;
	}
	...
	public void setDescription_java_lang_String_(String newDescription_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.MANAGED_POLICY_BUILDER_IAM__DESCRIPTION_JAVA_LANG_STRING_,
	...
	public void setDocumentWithPolicyDocument_software_amazon_awscdk_services_iam_PolicyDocument_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.MANAGED_POLICY_BUILDER_IAM__DOCUMENT_WITH_POLICY_DOCUMENT_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_POLICY_DOCUMENT_AS_REFERENCE,
	...
	public void setGroups_software_amazon_awscdk_services_iam_IGroup_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.MANAGED_POLICY_BUILDER_IAM__GROUPS_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IGROUP_AS_LIST,
	...
	public void setManagedPolicyName_java_lang_String_(String newManagedPolicyName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.MANAGED_POLICY_BUILDER_IAM__MANAGED_POLICY_NAME_JAVA_LANG_STRING_,
	...
	public void setPath_java_lang_String_(String newPath_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.MANAGED_POLICY_BUILDER_IAM__PATH_JAVA_LANG_STRING_, oldPath_java_lang_String_,
	...
	public void setRoles_software_amazon_awscdk_services_iam_IRole_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.MANAGED_POLICY_BUILDER_IAM__ROLES_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IROLE_AS_LIST,
	...
	public void setStatements_software_amazon_awscdk_services_iam_PolicyStatement_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.MANAGED_POLICY_BUILDER_IAM__STATEMENTS_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_POLICY_STATEMENT_AS_LIST,
	...
	public void setUsers_software_amazon_awscdk_services_iam_IUser_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.MANAGED_POLICY_BUILDER_IAM__USERS_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IUSER_AS_LIST,
	...
	public void setVarName(String newVarName) {
		...
		varName = newVarName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IamPackage.MANAGED_POLICY_BUILDER_IAM__VAR_NAME,
					oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IamPackage.MANAGED_POLICY_BUILDER_IAM__IDENTIFIER,
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.MANAGED_POLICY_BUILDER_IAM__ADDITIONAL_CODE, oldAdditionalCode, additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case IamPackage.MANAGED_POLICY_BUILDER_IAM__DESCRIPTION_JAVA_LANG_STRING_:
			return getDescription_java_lang_String_();
		case IamPackage.MANAGED_POLICY_BUILDER_IAM__DOCUMENT_WITH_POLICY_DOCUMENT_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_POLICY_DOCUMENT_AS_REFERENCE:
			return getDocumentWithPolicyDocument_software_amazon_awscdk_services_iam_PolicyDocument_AsReference();
		case IamPackage.MANAGED_POLICY_BUILDER_IAM__GROUPS_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IGROUP_AS_LIST:
			return getGroups_software_amazon_awscdk_services_iam_IGroup_AsList();
		case IamPackage.MANAGED_POLICY_BUILDER_IAM__MANAGED_POLICY_NAME_JAVA_LANG_STRING_:
			return getManagedPolicyName_java_lang_String_();
		case IamPackage.MANAGED_POLICY_BUILDER_IAM__PATH_JAVA_LANG_STRING_:
			return getPath_java_lang_String_();
		case IamPackage.MANAGED_POLICY_BUILDER_IAM__ROLES_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IROLE_AS_LIST:
			return getRoles_software_amazon_awscdk_services_iam_IRole_AsList();
		case IamPackage.MANAGED_POLICY_BUILDER_IAM__STATEMENTS_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_POLICY_STATEMENT_AS_LIST:
			return getStatements_software_amazon_awscdk_services_iam_PolicyStatement_AsList();
		case IamPackage.MANAGED_POLICY_BUILDER_IAM__USERS_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IUSER_AS_LIST:
			return getUsers_software_amazon_awscdk_services_iam_IUser_AsList();
		case IamPackage.MANAGED_POLICY_BUILDER_IAM__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case IamPackage.MANAGED_POLICY_BUILDER_IAM__VAR_NAME:
			return getVarName();
		case IamPackage.MANAGED_POLICY_BUILDER_IAM__IDENTIFIER:
			return getIdentifier();
		case IamPackage.MANAGED_POLICY_BUILDER_IAM__ADDITIONAL_CODE:
