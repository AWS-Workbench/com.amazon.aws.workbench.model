...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Port Props Builder ec2</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ec2.impl.PortPropsBuilder_ec2Impl#getProtocol_software_amazon_awscdk_services_ec2_Protocol_ <em>Protocol software amazon awscdk services ec2 Protocol </em>}</li>
 *   <li>{@link ec2.impl.PortPropsBuilder_ec2Impl#getStringRepresentation_java_lang_String_ <em>String Representation java lang String </em>}</li>
 *   <li>{@link ec2.impl.PortPropsBuilder_ec2Impl#getFromPort_java_lang_Number_ <em>From Port java lang Number </em>}</li>
 *   <li>{@link ec2.impl.PortPropsBuilder_ec2Impl#getToPort_java_lang_Number_ <em>To Port java lang Number </em>}</li>
 *   <li>{@link ec2.impl.PortPropsBuilder_ec2Impl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link ec2.impl.PortPropsBuilder_ec2Impl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link ec2.impl.PortPropsBuilder_ec2Impl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link ec2.impl.PortPropsBuilder_ec2Impl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PortPropsBuilder_ec2Impl extends MinimalEObjectImpl.Container implements PortPropsBuilder_ec2 {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.ec2.PortProps";
	 ...
	 * @generated
	 */
	protected PortPropsBuilder_ec2Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Ec2Package.Literals.PORT_PROPS_BUILDER_EC2;
	}
	...
	public void setProtocol_software_amazon_awscdk_services_ec2_Protocol_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.PORT_PROPS_BUILDER_EC2__PROTOCOL_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_PROTOCOL_,
	...
	public void setStringRepresentation_java_lang_String_(String newStringRepresentation_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.PORT_PROPS_BUILDER_EC2__STRING_REPRESENTATION_JAVA_LANG_STRING_,
	...
	public void setFromPort_java_lang_Number_(int newFromPort_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.PORT_PROPS_BUILDER_EC2__FROM_PORT_JAVA_LANG_NUMBER_, oldFromPort_java_lang_Number_,
	...
	public void setToPort_java_lang_Number_(int newToPort_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.PORT_PROPS_BUILDER_EC2__TO_PORT_JAVA_LANG_NUMBER_, oldToPort_java_lang_Number_,
	...
	public void setVarName(String newVarName) {
		...
		varName = newVarName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.PORT_PROPS_BUILDER_EC2__VAR_NAME,
					oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.PORT_PROPS_BUILDER_EC2__IDENTIFIER,
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.PORT_PROPS_BUILDER_EC2__ADDITIONAL_CODE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Ec2Package.PORT_PROPS_BUILDER_EC2__PROTOCOL_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_PROTOCOL_:
			return getProtocol_software_amazon_awscdk_services_ec2_Protocol_();
		case Ec2Package.PORT_PROPS_BUILDER_EC2__STRING_REPRESENTATION_JAVA_LANG_STRING_:
			return getStringRepresentation_java_lang_String_();
		case Ec2Package.PORT_PROPS_BUILDER_EC2__FROM_PORT_JAVA_LANG_NUMBER_:
			return getFromPort_java_lang_Number_();
		case Ec2Package.PORT_PROPS_BUILDER_EC2__TO_PORT_JAVA_LANG_NUMBER_:
			return getToPort_java_lang_Number_();
		case Ec2Package.PORT_PROPS_BUILDER_EC2__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case Ec2Package.PORT_PROPS_BUILDER_EC2__VAR_NAME:
			return getVarName();
		case Ec2Package.PORT_PROPS_BUILDER_EC2__IDENTIFIER:
			return getIdentifier();
		case Ec2Package.PORT_PROPS_BUILDER_EC2__ADDITIONAL_CODE:
