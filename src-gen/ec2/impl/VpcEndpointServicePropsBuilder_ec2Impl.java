...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Vpc Endpoint Service Props Builder ec2</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ec2.impl.VpcEndpointServicePropsBuilder_ec2Impl#getVpcEndpointServiceLoadBalancers_software_amazon_awscdk_services_ec2_IVpcEndpointServiceLoadBalancer_AsList <em>Vpc Endpoint Service Load Balancers software amazon awscdk services ec2 IVpc Endpoint Service Load Balancer As List</em>}</li>
 *   <li>{@link ec2.impl.VpcEndpointServicePropsBuilder_ec2Impl#getAcceptanceRequired_java_lang_Boolean_ <em>Acceptance Required java lang Boolean </em>}</li>
 *   <li>{@link ec2.impl.VpcEndpointServicePropsBuilder_ec2Impl#getVpcEndpointServiceName_java_lang_String_ <em>Vpc Endpoint Service Name java lang String </em>}</li>
 *   <li>{@link ec2.impl.VpcEndpointServicePropsBuilder_ec2Impl#getWhitelistedPrincipals_software_amazon_awscdk_services_iam_ArnPrincipal_AsList <em>Whitelisted Principals software amazon awscdk services iam Arn Principal As List</em>}</li>
 *   <li>{@link ec2.impl.VpcEndpointServicePropsBuilder_ec2Impl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link ec2.impl.VpcEndpointServicePropsBuilder_ec2Impl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link ec2.impl.VpcEndpointServicePropsBuilder_ec2Impl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link ec2.impl.VpcEndpointServicePropsBuilder_ec2Impl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VpcEndpointServicePropsBuilder_ec2Impl extends MinimalEObjectImpl.Container
		implements VpcEndpointServicePropsBuilder_ec2 {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.ec2.VpcEndpointServiceProps";
	 ...
	 * @generated
	 */
	protected VpcEndpointServicePropsBuilder_ec2Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Ec2Package.Literals.VPC_ENDPOINT_SERVICE_PROPS_BUILDER_EC2;
	}
	...
	public void setVpcEndpointServiceLoadBalancers_software_amazon_awscdk_services_ec2_IVpcEndpointServiceLoadBalancer_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPC_ENDPOINT_SERVICE_PROPS_BUILDER_EC2__VPC_ENDPOINT_SERVICE_LOAD_BALANCERS_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_IVPC_ENDPOINT_SERVICE_LOAD_BALANCER_AS_LIST,
	...
	public void setAcceptanceRequired_java_lang_Boolean_(Boolean newAcceptanceRequired_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPC_ENDPOINT_SERVICE_PROPS_BUILDER_EC2__ACCEPTANCE_REQUIRED_JAVA_LANG_BOOLEAN_,
	...
	public void setVpcEndpointServiceName_java_lang_String_(String newVpcEndpointServiceName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPC_ENDPOINT_SERVICE_PROPS_BUILDER_EC2__VPC_ENDPOINT_SERVICE_NAME_JAVA_LANG_STRING_,
	...
	public void setWhitelistedPrincipals_software_amazon_awscdk_services_iam_ArnPrincipal_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPC_ENDPOINT_SERVICE_PROPS_BUILDER_EC2__WHITELISTED_PRINCIPALS_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_ARN_PRINCIPAL_AS_LIST,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPC_ENDPOINT_SERVICE_PROPS_BUILDER_EC2__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPC_ENDPOINT_SERVICE_PROPS_BUILDER_EC2__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPC_ENDPOINT_SERVICE_PROPS_BUILDER_EC2__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
...
} //VpcEndpointServicePropsBuilder_ec2Impl
