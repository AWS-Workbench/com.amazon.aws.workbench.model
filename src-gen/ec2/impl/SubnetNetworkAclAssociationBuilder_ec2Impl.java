...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Subnet Network Acl Association Builder ec2</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ec2.impl.SubnetNetworkAclAssociationBuilder_ec2Impl#getNetworkAclWithINetworkAcl_software_amazon_awscdk_services_ec2_INetworkAcl_AsReference <em>Network Acl With INetwork Acl software amazon awscdk services ec2 INetwork Acl As Reference</em>}</li>
 *   <li>{@link ec2.impl.SubnetNetworkAclAssociationBuilder_ec2Impl#getSubnetWithISubnet_software_amazon_awscdk_services_ec2_ISubnet_AsReference <em>Subnet With ISubnet software amazon awscdk services ec2 ISubnet As Reference</em>}</li>
 *   <li>{@link ec2.impl.SubnetNetworkAclAssociationBuilder_ec2Impl#getSubnetNetworkAclAssociationName_java_lang_String_ <em>Subnet Network Acl Association Name java lang String </em>}</li>
 *   <li>{@link ec2.impl.SubnetNetworkAclAssociationBuilder_ec2Impl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link ec2.impl.SubnetNetworkAclAssociationBuilder_ec2Impl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link ec2.impl.SubnetNetworkAclAssociationBuilder_ec2Impl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link ec2.impl.SubnetNetworkAclAssociationBuilder_ec2Impl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubnetNetworkAclAssociationBuilder_ec2Impl extends MinimalEObjectImpl.Container
		implements SubnetNetworkAclAssociationBuilder_ec2 {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.ec2.SubnetNetworkAclAssociation";
	 ...
	 * @generated
	 */
	protected SubnetNetworkAclAssociationBuilder_ec2Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Ec2Package.Literals.SUBNET_NETWORK_ACL_ASSOCIATION_BUILDER_EC2;
	}
	...
	public void setNetworkAclWithINetworkAcl_software_amazon_awscdk_services_ec2_INetworkAcl_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.SUBNET_NETWORK_ACL_ASSOCIATION_BUILDER_EC2__NETWORK_ACL_WITH_INETWORK_ACL_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_INETWORK_ACL_AS_REFERENCE,
	...
	public void setSubnetWithISubnet_software_amazon_awscdk_services_ec2_ISubnet_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.SUBNET_NETWORK_ACL_ASSOCIATION_BUILDER_EC2__SUBNET_WITH_ISUBNET_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_ISUBNET_AS_REFERENCE,
	...
	public void setSubnetNetworkAclAssociationName_java_lang_String_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.SUBNET_NETWORK_ACL_ASSOCIATION_BUILDER_EC2__SUBNET_NETWORK_ACL_ASSOCIATION_NAME_JAVA_LANG_STRING_,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.SUBNET_NETWORK_ACL_ASSOCIATION_BUILDER_EC2__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.SUBNET_NETWORK_ACL_ASSOCIATION_BUILDER_EC2__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.SUBNET_NETWORK_ACL_ASSOCIATION_BUILDER_EC2__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
...
} //SubnetNetworkAclAssociationBuilder_ec2Impl
