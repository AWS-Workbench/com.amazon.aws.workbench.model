...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Private Subnet Builder ec2</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.PrivateSubnetBuilder_ec2Impl#getAvailabilityZone <em>Availability Zone</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.PrivateSubnetBuilder_ec2Impl#getCidrBlock <em>Cidr Block</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.PrivateSubnetBuilder_ec2Impl#getVpcId <em>Vpc Id</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.PrivateSubnetBuilder_ec2Impl#getMapPublicIpOnLaunch <em>Map Public Ip On Launch</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.PrivateSubnetBuilder_ec2Impl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.PrivateSubnetBuilder_ec2Impl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.PrivateSubnetBuilder_ec2Impl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.PrivateSubnetBuilder_ec2Impl#getAdditionalCode <em>Additional Code</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.PrivateSubnetBuilder_ec2Impl#getInstancebuilder_ec2 <em>Instancebuilder ec2</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrivateSubnetBuilder_ec2Impl extends ServiceResourcesImpl implements PrivateSubnetBuilder_ec2 {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.ec2.PrivateSubnet";
	 ...
	 * @generated
	 */
	protected PrivateSubnetBuilder_ec2Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AwsworkbenchPackage.Literals.PRIVATE_SUBNET_BUILDER_EC2;
	}
	...
	public void setAvailabilityZone(String newAvailabilityZone) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.PRIVATE_SUBNET_BUILDER_EC2__AVAILABILITY_ZONE, oldAvailabilityZone,
					availabilityZone));
	}
	...
	public void setCidrBlock(String newCidrBlock) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.PRIVATE_SUBNET_BUILDER_EC2__CIDR_BLOCK, oldCidrBlock, cidrBlock));
	}
	...
	public void setVpcId(String newVpcId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.PRIVATE_SUBNET_BUILDER_EC2__VPC_ID, oldVpcId, vpcId));
	}
	...
	public void setMapPublicIpOnLaunch(Boolean newMapPublicIpOnLaunch) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.PRIVATE_SUBNET_BUILDER_EC2__MAP_PUBLIC_IP_ON_LAUNCH, oldMapPublicIpOnLaunch,
					mapPublicIpOnLaunch));
	}
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.PRIVATE_SUBNET_BUILDER_EC2__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.PRIVATE_SUBNET_BUILDER_EC2__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.PRIVATE_SUBNET_BUILDER_EC2__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
	...
	public EList<InstanceBuilder_ec2> getInstancebuilder_ec2() {
		if (instancebuilder_ec2 == null) {
			instancebuilder_ec2 = new EObjectContainmentEList<InstanceBuilder_ec2>(InstanceBuilder_ec2.class, this,
					AwsworkbenchPackage.PRIVATE_SUBNET_BUILDER_EC2__INSTANCEBUILDER_EC2);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case AwsworkbenchPackage.PRIVATE_SUBNET_BUILDER_EC2__INSTANCEBUILDER_EC2:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case AwsworkbenchPackage.PRIVATE_SUBNET_BUILDER_EC2__AVAILABILITY_ZONE:
			return getAvailabilityZone();
		case AwsworkbenchPackage.PRIVATE_SUBNET_BUILDER_EC2__CIDR_BLOCK:
			return getCidrBlock();
		case AwsworkbenchPackage.PRIVATE_SUBNET_BUILDER_EC2__VPC_ID:
			return getVpcId();
		case AwsworkbenchPackage.PRIVATE_SUBNET_BUILDER_EC2__MAP_PUBLIC_IP_ON_LAUNCH:
			return getMapPublicIpOnLaunch();
		case AwsworkbenchPackage.PRIVATE_SUBNET_BUILDER_EC2__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case AwsworkbenchPackage.PRIVATE_SUBNET_BUILDER_EC2__VAR_NAME:
			return getVarName();
		case AwsworkbenchPackage.PRIVATE_SUBNET_BUILDER_EC2__IDENTIFIER:
			return getIdentifier();
		case AwsworkbenchPackage.PRIVATE_SUBNET_BUILDER_EC2__ADDITIONAL_CODE:
