...
public class SubnetBuilder_ec2Impl extends ServiceResourcesImpl implements SubnetBuilder_ec2 {
	...
	protected EClass eStaticClass() {
		return AwsworkbenchPackage.Literals.SUBNET_BUILDER_EC2;
	}
	...
	public void setVarName(String newVarName) {
		...
		varName = newVarName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AwsworkbenchPackage.SUBNET_BUILDER_EC2__VAR_NAME,
					oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AwsworkbenchPackage.SUBNET_BUILDER_EC2__IDENTIFIER,
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.SUBNET_BUILDER_EC2__ADDITIONAL_CODE, oldAdditionalCode, additionalCode));
	}
