...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Private Subnet Props Builder ec2</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ec2.impl.PrivateSubnetPropsBuilder_ec2Impl#getAvailabilityZone_java_lang_String_ <em>Availability Zone java lang String </em>}</li>
 *   <li>{@link ec2.impl.PrivateSubnetPropsBuilder_ec2Impl#getCidrBlock_java_lang_String_ <em>Cidr Block java lang String </em>}</li>
 *   <li>{@link ec2.impl.PrivateSubnetPropsBuilder_ec2Impl#getVpcId_java_lang_String_ <em>Vpc Id java lang String </em>}</li>
 *   <li>{@link ec2.impl.PrivateSubnetPropsBuilder_ec2Impl#getMapPublicIpOnLaunch_java_lang_Boolean_ <em>Map Public Ip On Launch java lang Boolean </em>}</li>
 *   <li>{@link ec2.impl.PrivateSubnetPropsBuilder_ec2Impl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link ec2.impl.PrivateSubnetPropsBuilder_ec2Impl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link ec2.impl.PrivateSubnetPropsBuilder_ec2Impl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link ec2.impl.PrivateSubnetPropsBuilder_ec2Impl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrivateSubnetPropsBuilder_ec2Impl extends MinimalEObjectImpl.Container
		implements PrivateSubnetPropsBuilder_ec2 {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.ec2.PrivateSubnetProps";
	 ...
	 * @generated
	 */
	protected PrivateSubnetPropsBuilder_ec2Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Ec2Package.Literals.PRIVATE_SUBNET_PROPS_BUILDER_EC2;
	}
	...
	public void setAvailabilityZone_java_lang_String_(String newAvailabilityZone_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.PRIVATE_SUBNET_PROPS_BUILDER_EC2__AVAILABILITY_ZONE_JAVA_LANG_STRING_,
	...
	public void setCidrBlock_java_lang_String_(String newCidrBlock_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.PRIVATE_SUBNET_PROPS_BUILDER_EC2__CIDR_BLOCK_JAVA_LANG_STRING_,
	...
	public void setVpcId_java_lang_String_(String newVpcId_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.PRIVATE_SUBNET_PROPS_BUILDER_EC2__VPC_ID_JAVA_LANG_STRING_, oldVpcId_java_lang_String_,
	...
	public void setMapPublicIpOnLaunch_java_lang_Boolean_(Boolean newMapPublicIpOnLaunch_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.PRIVATE_SUBNET_PROPS_BUILDER_EC2__MAP_PUBLIC_IP_ON_LAUNCH_JAVA_LANG_BOOLEAN_,
	...
	public void setVarName(String newVarName) {
		...
		varName = newVarName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.PRIVATE_SUBNET_PROPS_BUILDER_EC2__VAR_NAME,
					oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.PRIVATE_SUBNET_PROPS_BUILDER_EC2__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.PRIVATE_SUBNET_PROPS_BUILDER_EC2__ADDITIONAL_CODE, oldAdditionalCode, additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Ec2Package.PRIVATE_SUBNET_PROPS_BUILDER_EC2__AVAILABILITY_ZONE_JAVA_LANG_STRING_:
			return getAvailabilityZone_java_lang_String_();
		case Ec2Package.PRIVATE_SUBNET_PROPS_BUILDER_EC2__CIDR_BLOCK_JAVA_LANG_STRING_:
			return getCidrBlock_java_lang_String_();
		case Ec2Package.PRIVATE_SUBNET_PROPS_BUILDER_EC2__VPC_ID_JAVA_LANG_STRING_:
			return getVpcId_java_lang_String_();
		case Ec2Package.PRIVATE_SUBNET_PROPS_BUILDER_EC2__MAP_PUBLIC_IP_ON_LAUNCH_JAVA_LANG_BOOLEAN_:
			return getMapPublicIpOnLaunch_java_lang_Boolean_();
		case Ec2Package.PRIVATE_SUBNET_PROPS_BUILDER_EC2__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case Ec2Package.PRIVATE_SUBNET_PROPS_BUILDER_EC2__VAR_NAME:
			return getVarName();
		case Ec2Package.PRIVATE_SUBNET_PROPS_BUILDER_EC2__IDENTIFIER:
			return getIdentifier();
		case Ec2Package.PRIVATE_SUBNET_PROPS_BUILDER_EC2__ADDITIONAL_CODE:
...
} //PrivateSubnetPropsBuilder_ec2Impl
