...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Resource Props Builder apigateway</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link apigateway.impl.ResourcePropsBuilder_apigatewayImpl#getParentWithIResource_software_amazon_awscdk_services_apigateway_IResource_AsReference <em>Parent With IResource software amazon awscdk services apigateway IResource As Reference</em>}</li>
 *   <li>{@link apigateway.impl.ResourcePropsBuilder_apigatewayImpl#getPathPart_java_lang_String_ <em>Path Part java lang String </em>}</li>
 *   <li>{@link apigateway.impl.ResourcePropsBuilder_apigatewayImpl#getDefaultCorsPreflightOptionsWithCorsOptions_software_amazon_awscdk_services_apigateway_CorsOptions_AsReference <em>Default Cors Preflight Options With Cors Options software amazon awscdk services apigateway Cors Options As Reference</em>}</li>
 *   <li>{@link apigateway.impl.ResourcePropsBuilder_apigatewayImpl#getDefaultIntegrationWithIntegration_software_amazon_awscdk_services_apigateway_Integration_AsReference <em>Default Integration With Integration software amazon awscdk services apigateway Integration As Reference</em>}</li>
 *   <li>{@link apigateway.impl.ResourcePropsBuilder_apigatewayImpl#getDefaultMethodOptionsWithMethodOptions_software_amazon_awscdk_services_apigateway_MethodOptions_AsReference <em>Default Method Options With Method Options software amazon awscdk services apigateway Method Options As Reference</em>}</li>
 *   <li>{@link apigateway.impl.ResourcePropsBuilder_apigatewayImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link apigateway.impl.ResourcePropsBuilder_apigatewayImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link apigateway.impl.ResourcePropsBuilder_apigatewayImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link apigateway.impl.ResourcePropsBuilder_apigatewayImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResourcePropsBuilder_apigatewayImpl extends MinimalEObjectImpl.Container
		implements ResourcePropsBuilder_apigateway {
	/**
	...
	/**
	 * The default value of the '{@link #getPathPart_java_lang_String_() <em>Path Part java lang String </em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getPathPart_java_lang_String_()
	 * @generated
	 * @ordered
	 */
	protected static final String PATH_PART_JAVA_LANG_STRING__EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getPathPart_java_lang_String_() <em>Path Part java lang String </em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getPathPart_java_lang_String_()
	 * @generated
	 * @ordered
	 */
	protected String pathPart_java_lang_String_ = PATH_PART_JAVA_LANG_STRING__EDEFAULT;
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.apigateway.ResourceProps";
	 ...
	 * @generated
	 */
	protected ResourcePropsBuilder_apigatewayImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ApigatewayPackage.Literals.RESOURCE_PROPS_BUILDER_APIGATEWAY;
	}
	...
	public void setParentWithIResource_software_amazon_awscdk_services_apigateway_IResource_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.RESOURCE_PROPS_BUILDER_APIGATEWAY__PARENT_WITH_IRESOURCE_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_IRESOURCE_AS_REFERENCE,
	 ...
	 */
	@Override
	public String getPathPart_java_lang_String_() {
		return pathPart_java_lang_String_;
	}
	 ...
	 */
	@Override
	public void setPathPart_java_lang_String_(String newPathPart_java_lang_String_) {
		String oldPathPart_java_lang_String_ = pathPart_java_lang_String_;
		pathPart_java_lang_String_ = newPathPart_java_lang_String_;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.RESOURCE_PROPS_BUILDER_APIGATEWAY__PATH_PART_JAVA_LANG_STRING_,
					oldPathPart_java_lang_String_, pathPart_java_lang_String_));
	}
	...
	public void setDefaultCorsPreflightOptionsWithCorsOptions_software_amazon_awscdk_services_apigateway_CorsOptions_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.RESOURCE_PROPS_BUILDER_APIGATEWAY__DEFAULT_CORS_PREFLIGHT_OPTIONS_WITH_CORS_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_CORS_OPTIONS_AS_REFERENCE,
	...
	public void setDefaultIntegrationWithIntegration_software_amazon_awscdk_services_apigateway_Integration_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.RESOURCE_PROPS_BUILDER_APIGATEWAY__DEFAULT_INTEGRATION_WITH_INTEGRATION_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_INTEGRATION_AS_REFERENCE,
	...
	public void setDefaultMethodOptionsWithMethodOptions_software_amazon_awscdk_services_apigateway_MethodOptions_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.RESOURCE_PROPS_BUILDER_APIGATEWAY__DEFAULT_METHOD_OPTIONS_WITH_METHOD_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_METHOD_OPTIONS_AS_REFERENCE,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.RESOURCE_PROPS_BUILDER_APIGATEWAY__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.RESOURCE_PROPS_BUILDER_APIGATEWAY__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.RESOURCE_PROPS_BUILDER_APIGATEWAY__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ApigatewayPackage.RESOURCE_PROPS_BUILDER_APIGATEWAY__PARENT_WITH_IRESOURCE_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_IRESOURCE_AS_REFERENCE:
			return getParentWithIResource_software_amazon_awscdk_services_apigateway_IResource_AsReference();
		case ApigatewayPackage.RESOURCE_PROPS_BUILDER_APIGATEWAY__PATH_PART_JAVA_LANG_STRING_:
			return getPathPart_java_lang_String_();
		case ApigatewayPackage.RESOURCE_PROPS_BUILDER_APIGATEWAY__DEFAULT_CORS_PREFLIGHT_OPTIONS_WITH_CORS_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_CORS_OPTIONS_AS_REFERENCE:
			return getDefaultCorsPreflightOptionsWithCorsOptions_software_amazon_awscdk_services_apigateway_CorsOptions_AsReference();
		case ApigatewayPackage.RESOURCE_PROPS_BUILDER_APIGATEWAY__DEFAULT_INTEGRATION_WITH_INTEGRATION_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_INTEGRATION_AS_REFERENCE:
			return getDefaultIntegrationWithIntegration_software_amazon_awscdk_services_apigateway_Integration_AsReference();
		case ApigatewayPackage.RESOURCE_PROPS_BUILDER_APIGATEWAY__DEFAULT_METHOD_OPTIONS_WITH_METHOD_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_METHOD_OPTIONS_AS_REFERENCE:
			return getDefaultMethodOptionsWithMethodOptions_software_amazon_awscdk_services_apigateway_MethodOptions_AsReference();
		case ApigatewayPackage.RESOURCE_PROPS_BUILDER_APIGATEWAY__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case ApigatewayPackage.RESOURCE_PROPS_BUILDER_APIGATEWAY__VAR_NAME:
			return getVarName();
		case ApigatewayPackage.RESOURCE_PROPS_BUILDER_APIGATEWAY__IDENTIFIER:
			return getIdentifier();
		case ApigatewayPackage.RESOURCE_PROPS_BUILDER_APIGATEWAY__ADDITIONAL_CODE:
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ApigatewayPackage.RESOURCE_PROPS_BUILDER_APIGATEWAY__PARENT_WITH_IRESOURCE_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_IRESOURCE_AS_REFERENCE:
			...
			return;
		case ApigatewayPackage.RESOURCE_PROPS_BUILDER_APIGATEWAY__PATH_PART_JAVA_LANG_STRING_:
			setPathPart_java_lang_String_((String) newValue);
			return;
		case ApigatewayPackage.RESOURCE_PROPS_BUILDER_APIGATEWAY__DEFAULT_CORS_PREFLIGHT_OPTIONS_WITH_CORS_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_CORS_OPTIONS_AS_REFERENCE:
	...
	public void eUnset(int featureID) {
		...
		case ApigatewayPackage.RESOURCE_PROPS_BUILDER_APIGATEWAY__PARENT_WITH_IRESOURCE_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_IRESOURCE_AS_REFERENCE:
			...
			return;
		case ApigatewayPackage.RESOURCE_PROPS_BUILDER_APIGATEWAY__PATH_PART_JAVA_LANG_STRING_:
			setPathPart_java_lang_String_(PATH_PART_JAVA_LANG_STRING__EDEFAULT);
			return;
		case ApigatewayPackage.RESOURCE_PROPS_BUILDER_APIGATEWAY__DEFAULT_CORS_PREFLIGHT_OPTIONS_WITH_CORS_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_CORS_OPTIONS_AS_REFERENCE:
			setDefaultCorsPreflightOptionsWithCorsOptions_software_amazon_awscdk_services_apigateway_CorsOptions_AsReference(
	...
	public boolean eIsSet(int featureID) {
		...
		case ApigatewayPackage.RESOURCE_PROPS_BUILDER_APIGATEWAY__PATH_PART_JAVA_LANG_STRING_:
			return PATH_PART_JAVA_LANG_STRING__EDEFAULT == null ? pathPart_java_lang_String_ != null
					: !PATH_PART_JAVA_LANG_STRING__EDEFAULT.equals(pathPart_java_lang_String_);
		case ApigatewayPackage.RESOURCE_PROPS_BUILDER_APIGATEWAY__DEFAULT_CORS_PREFLIGHT_OPTIONS_WITH_CORS_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_CORS_OPTIONS_AS_REFERENCE:
	...
	public String toString() {
		...
		result.append(parentWithIResource_software_amazon_awscdk_services_apigateway_IResource_AsReference);
		result.append(", pathPart_java_lang_String_: ");
		result.append(pathPart_java_lang_String_);
		result.append(
				", defaultCorsPreflightOptionsWithCorsOptions_software_amazon_awscdk_services_apigateway_CorsOptions_AsReference: ");
		result.append(
...
} //ResourcePropsBuilder_apigatewayImpl
