...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Tag Props Builder core</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link core.impl.TagPropsBuilder_coreImpl#getApplyToLaunchedInstances_java_lang_Boolean_ <em>Apply To Launched Instances java lang Boolean </em>}</li>
 *   <li>{@link core.impl.TagPropsBuilder_coreImpl#getExcludeResourceTypes_java_lang_String_AsList <em>Exclude Resource Types java lang String As List</em>}</li>
 *   <li>{@link core.impl.TagPropsBuilder_coreImpl#getIncludeResourceTypes_java_lang_String_AsList <em>Include Resource Types java lang String As List</em>}</li>
 *   <li>{@link core.impl.TagPropsBuilder_coreImpl#getPriority_java_lang_Number_ <em>Priority java lang Number </em>}</li>
 *   <li>{@link core.impl.TagPropsBuilder_coreImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link core.impl.TagPropsBuilder_coreImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link core.impl.TagPropsBuilder_coreImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link core.impl.TagPropsBuilder_coreImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TagPropsBuilder_coreImpl extends MinimalEObjectImpl.Container implements TagPropsBuilder_core {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.core.TagProps";
	 ...
	 * @generated
	 */
	protected TagPropsBuilder_coreImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.TAG_PROPS_BUILDER_CORE;
	}
	...
	public void setApplyToLaunchedInstances_java_lang_Boolean_(Boolean newApplyToLaunchedInstances_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.TAG_PROPS_BUILDER_CORE__APPLY_TO_LAUNCHED_INSTANCES_JAVA_LANG_BOOLEAN_,
	...
	public void setExcludeResourceTypes_java_lang_String_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.TAG_PROPS_BUILDER_CORE__EXCLUDE_RESOURCE_TYPES_JAVA_LANG_STRING_AS_LIST,
	...
	public void setIncludeResourceTypes_java_lang_String_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.TAG_PROPS_BUILDER_CORE__INCLUDE_RESOURCE_TYPES_JAVA_LANG_STRING_AS_LIST,
	...
	public void setPriority_java_lang_Number_(int newPriority_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.TAG_PROPS_BUILDER_CORE__PRIORITY_JAVA_LANG_NUMBER_, oldPriority_java_lang_Number_,
	...
	public void setVarName(String newVarName) {
		...
		varName = newVarName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.TAG_PROPS_BUILDER_CORE__VAR_NAME,
					oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.TAG_PROPS_BUILDER_CORE__IDENTIFIER,
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.TAG_PROPS_BUILDER_CORE__ADDITIONAL_CODE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CorePackage.TAG_PROPS_BUILDER_CORE__APPLY_TO_LAUNCHED_INSTANCES_JAVA_LANG_BOOLEAN_:
			return getApplyToLaunchedInstances_java_lang_Boolean_();
		case CorePackage.TAG_PROPS_BUILDER_CORE__EXCLUDE_RESOURCE_TYPES_JAVA_LANG_STRING_AS_LIST:
			return getExcludeResourceTypes_java_lang_String_AsList();
		case CorePackage.TAG_PROPS_BUILDER_CORE__INCLUDE_RESOURCE_TYPES_JAVA_LANG_STRING_AS_LIST:
			return getIncludeResourceTypes_java_lang_String_AsList();
		case CorePackage.TAG_PROPS_BUILDER_CORE__PRIORITY_JAVA_LANG_NUMBER_:
			return getPriority_java_lang_Number_();
		case CorePackage.TAG_PROPS_BUILDER_CORE__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case CorePackage.TAG_PROPS_BUILDER_CORE__VAR_NAME:
			return getVarName();
		case CorePackage.TAG_PROPS_BUILDER_CORE__IDENTIFIER:
			return getIdentifier();
		case CorePackage.TAG_PROPS_BUILDER_CORE__ADDITIONAL_CODE:
