...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Certificate Builder certificatemanager</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link certificatemanager.impl.CertificateBuilder_certificatemanagerImpl#getDomainName_java_lang_String_ <em>Domain Name java lang String </em>}</li>
 *   <li>{@link certificatemanager.impl.CertificateBuilder_certificatemanagerImpl#getSubjectAlternativeNames_java_lang_String_AsList <em>Subject Alternative Names java lang String As List</em>}</li>
 *   <li>{@link certificatemanager.impl.CertificateBuilder_certificatemanagerImpl#getValidationDomains_java_lang_String__java_lang_String_AsMap <em>Validation Domains java lang String java lang String As Map</em>}</li>
 *   <li>{@link certificatemanager.impl.CertificateBuilder_certificatemanagerImpl#getValidationMethod_software_amazon_awscdk_services_certificatemanager_ValidationMethod_ <em>Validation Method software amazon awscdk services certificatemanager Validation Method </em>}</li>
 *   <li>{@link certificatemanager.impl.CertificateBuilder_certificatemanagerImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link certificatemanager.impl.CertificateBuilder_certificatemanagerImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link certificatemanager.impl.CertificateBuilder_certificatemanagerImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link certificatemanager.impl.CertificateBuilder_certificatemanagerImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CertificateBuilder_certificatemanagerImpl extends MinimalEObjectImpl.Container
		implements CertificateBuilder_certificatemanager {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.certificatemanager.Certificate";
	 ...
	 * @generated
	 */
	protected CertificateBuilder_certificatemanagerImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CertificatemanagerPackage.Literals.CERTIFICATE_BUILDER_CERTIFICATEMANAGER;
	}
	...
	public void setDomainName_java_lang_String_(String newDomainName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CertificatemanagerPackage.CERTIFICATE_BUILDER_CERTIFICATEMANAGER__DOMAIN_NAME_JAVA_LANG_STRING_,
	...
	public void setSubjectAlternativeNames_java_lang_String_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CertificatemanagerPackage.CERTIFICATE_BUILDER_CERTIFICATEMANAGER__SUBJECT_ALTERNATIVE_NAMES_JAVA_LANG_STRING_AS_LIST,
	...
	public void setValidationDomains_java_lang_String__java_lang_String_AsMap(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CertificatemanagerPackage.CERTIFICATE_BUILDER_CERTIFICATEMANAGER__VALIDATION_DOMAINS_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP,
	...
	public void setValidationMethod_software_amazon_awscdk_services_certificatemanager_ValidationMethod_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CertificatemanagerPackage.CERTIFICATE_BUILDER_CERTIFICATEMANAGER__VALIDATION_METHOD_SOFTWARE_AMAZON_AWSCDK_SERVICES_CERTIFICATEMANAGER_VALIDATION_METHOD_,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CertificatemanagerPackage.CERTIFICATE_BUILDER_CERTIFICATEMANAGER__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CertificatemanagerPackage.CERTIFICATE_BUILDER_CERTIFICATEMANAGER__IDENTIFIER, oldIdentifier,
					identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CertificatemanagerPackage.CERTIFICATE_BUILDER_CERTIFICATEMANAGER__ADDITIONAL_CODE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CertificatemanagerPackage.CERTIFICATE_BUILDER_CERTIFICATEMANAGER__DOMAIN_NAME_JAVA_LANG_STRING_:
			return getDomainName_java_lang_String_();
		case CertificatemanagerPackage.CERTIFICATE_BUILDER_CERTIFICATEMANAGER__SUBJECT_ALTERNATIVE_NAMES_JAVA_LANG_STRING_AS_LIST:
			return getSubjectAlternativeNames_java_lang_String_AsList();
		case CertificatemanagerPackage.CERTIFICATE_BUILDER_CERTIFICATEMANAGER__VALIDATION_DOMAINS_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP:
			return getValidationDomains_java_lang_String__java_lang_String_AsMap();
		case CertificatemanagerPackage.CERTIFICATE_BUILDER_CERTIFICATEMANAGER__VALIDATION_METHOD_SOFTWARE_AMAZON_AWSCDK_SERVICES_CERTIFICATEMANAGER_VALIDATION_METHOD_:
			return getValidationMethod_software_amazon_awscdk_services_certificatemanager_ValidationMethod_();
		case CertificatemanagerPackage.CERTIFICATE_BUILDER_CERTIFICATEMANAGER__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case CertificatemanagerPackage.CERTIFICATE_BUILDER_CERTIFICATEMANAGER__VAR_NAME:
			return getVarName();
		case CertificatemanagerPackage.CERTIFICATE_BUILDER_CERTIFICATEMANAGER__IDENTIFIER:
			return getIdentifier();
		case CertificatemanagerPackage.CERTIFICATE_BUILDER_CERTIFICATEMANAGER__ADDITIONAL_CODE:
...
} //CertificateBuilder_certificatemanagerImpl
