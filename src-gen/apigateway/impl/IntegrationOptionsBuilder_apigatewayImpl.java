 ...
 * </p>
 * <ul>
 *   <li>{@link apigateway.impl.IntegrationOptionsBuilder_apigatewayImpl#getCacheKeyParameters_java_lang_String_AsList <em>Cache Key Parameters java lang String As List</em>}</li>
 *   <li>{@link apigateway.impl.IntegrationOptionsBuilder_apigatewayImpl#getCacheNamespace_java_lang_String_ <em>Cache Namespace java lang String </em>}</li>
 *   <li>{@link apigateway.impl.IntegrationOptionsBuilder_apigatewayImpl#getConnectionType_software_amazon_awscdk_services_apigateway_ConnectionType_ <em>Connection Type software amazon awscdk services apigateway Connection Type </em>}</li>
 *   <li>{@link apigateway.impl.IntegrationOptionsBuilder_apigatewayImpl#getContentHandling_software_amazon_awscdk_services_apigateway_ContentHandling_ <em>Content Handling software amazon awscdk services apigateway Content Handling </em>}</li>
 *   <li>{@link apigateway.impl.IntegrationOptionsBuilder_apigatewayImpl#getCredentialsPassthrough_java_lang_Boolean_ <em>Credentials Passthrough java lang Boolean </em>}</li>
 *   <li>{@link apigateway.impl.IntegrationOptionsBuilder_apigatewayImpl#getCredentialsRoleWithIRole_software_amazon_awscdk_services_iam_IRole_AsReference <em>Credentials Role With IRole software amazon awscdk services iam IRole As Reference</em>}</li>
 *   <li>{@link apigateway.impl.IntegrationOptionsBuilder_apigatewayImpl#getIntegrationResponses_software_amazon_awscdk_services_apigateway_IntegrationResponse_AsList <em>Integration Responses software amazon awscdk services apigateway Integration Response As List</em>}</li>
 *   <li>{@link apigateway.impl.IntegrationOptionsBuilder_apigatewayImpl#getPassthroughBehavior_software_amazon_awscdk_services_apigateway_PassthroughBehavior_ <em>Passthrough Behavior software amazon awscdk services apigateway Passthrough Behavior </em>}</li>
 *   <li>{@link apigateway.impl.IntegrationOptionsBuilder_apigatewayImpl#getRequestParameters_java_lang_String__java_lang_String_AsMap <em>Request Parameters java lang String java lang String As Map</em>}</li>
 *   <li>{@link apigateway.impl.IntegrationOptionsBuilder_apigatewayImpl#getRequestTemplates_java_lang_String__java_lang_String_AsMap <em>Request Templates java lang String java lang String As Map</em>}</li>
 *   <li>{@link apigateway.impl.IntegrationOptionsBuilder_apigatewayImpl#getVpcLinkWithIVpcLink_software_amazon_awscdk_services_apigateway_IVpcLink_AsReference <em>Vpc Link With IVpc Link software amazon awscdk services apigateway IVpc Link As Reference</em>}</li>
 *   <li>{@link apigateway.impl.IntegrationOptionsBuilder_apigatewayImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link apigateway.impl.IntegrationOptionsBuilder_apigatewayImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link apigateway.impl.IntegrationOptionsBuilder_apigatewayImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link apigateway.impl.IntegrationOptionsBuilder_apigatewayImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegrationOptionsBuilder_apigatewayImpl extends MinimalEObjectImpl.Container
	...
	protected EClass eStaticClass() {
		return ApigatewayPackage.Literals.INTEGRATION_OPTIONS_BUILDER_APIGATEWAY;
	}
	...
	public void setCacheKeyParameters_java_lang_String_AsList(String newCacheKeyParameters_java_lang_String_AsList) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__CACHE_KEY_PARAMETERS_JAVA_LANG_STRING_AS_LIST,
	...
	public void setCacheNamespace_java_lang_String_(String newCacheNamespace_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__CACHE_NAMESPACE_JAVA_LANG_STRING_,
	...
	public void setConnectionType_software_amazon_awscdk_services_apigateway_ConnectionType_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__CONNECTION_TYPE_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_CONNECTION_TYPE_,
	...
	public void setContentHandling_software_amazon_awscdk_services_apigateway_ContentHandling_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__CONTENT_HANDLING_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_CONTENT_HANDLING_,
	...
	public void setCredentialsPassthrough_java_lang_Boolean_(Boolean newCredentialsPassthrough_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__CREDENTIALS_PASSTHROUGH_JAVA_LANG_BOOLEAN_,
	...
	public void setCredentialsRoleWithIRole_software_amazon_awscdk_services_iam_IRole_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__CREDENTIALS_ROLE_WITH_IROLE_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IROLE_AS_REFERENCE,
	...
	public void setIntegrationResponses_software_amazon_awscdk_services_apigateway_IntegrationResponse_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__INTEGRATION_RESPONSES_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_INTEGRATION_RESPONSE_AS_LIST,
	...
	public void setPassthroughBehavior_software_amazon_awscdk_services_apigateway_PassthroughBehavior_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__PASSTHROUGH_BEHAVIOR_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_PASSTHROUGH_BEHAVIOR_,
	...
	public void setRequestParameters_java_lang_String__java_lang_String_AsMap(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__REQUEST_PARAMETERS_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP,
	...
	public void setRequestTemplates_java_lang_String__java_lang_String_AsMap(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__REQUEST_TEMPLATES_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP,
	...
	public void setVpcLinkWithIVpcLink_software_amazon_awscdk_services_apigateway_IVpcLink_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__VPC_LINK_WITH_IVPC_LINK_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_IVPC_LINK_AS_REFERENCE,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_OPTIONS_BUILDER_APIGATEWAY__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
