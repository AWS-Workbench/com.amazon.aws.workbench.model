...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Stage Props Builder apigateway</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link apigateway.impl.StagePropsBuilder_apigatewayImpl#getDeploymentWithDeployment_software_amazon_awscdk_services_apigateway_Deployment_AsReference <em>Deployment With Deployment software amazon awscdk services apigateway Deployment As Reference</em>}</li>
 *   <li>{@link apigateway.impl.StagePropsBuilder_apigatewayImpl#getAccessLogDestinationWithIAccessLogDestination_software_amazon_awscdk_services_apigateway_IAccessLogDestination_AsReference <em>Access Log Destination With IAccess Log Destination software amazon awscdk services apigateway IAccess Log Destination As Reference</em>}</li>
 *   <li>{@link apigateway.impl.StagePropsBuilder_apigatewayImpl#getAccessLogFormatWithAccessLogFormat_software_amazon_awscdk_services_apigateway_AccessLogFormat_AsReference <em>Access Log Format With Access Log Format software amazon awscdk services apigateway Access Log Format As Reference</em>}</li>
 *   <li>{@link apigateway.impl.StagePropsBuilder_apigatewayImpl#getCacheClusterEnabled_java_lang_Boolean_ <em>Cache Cluster Enabled java lang Boolean </em>}</li>
 *   <li>{@link apigateway.impl.StagePropsBuilder_apigatewayImpl#getCacheClusterSize_java_lang_String_ <em>Cache Cluster Size java lang String </em>}</li>
 *   <li>{@link apigateway.impl.StagePropsBuilder_apigatewayImpl#getClientCertificateId_java_lang_String_ <em>Client Certificate Id java lang String </em>}</li>
 *   <li>{@link apigateway.impl.StagePropsBuilder_apigatewayImpl#getDescription_java_lang_String_ <em>Description java lang String </em>}</li>
 *   <li>{@link apigateway.impl.StagePropsBuilder_apigatewayImpl#getDocumentationVersion_java_lang_String_ <em>Documentation Version java lang String </em>}</li>
 *   <li>{@link apigateway.impl.StagePropsBuilder_apigatewayImpl#getMethodOptions_java_lang_String__software_amazon_awscdk_services_apigateway_MethodDeploymentOptions_AsMap <em>Method Options java lang String software amazon awscdk services apigateway Method Deployment Options As Map</em>}</li>
 *   <li>{@link apigateway.impl.StagePropsBuilder_apigatewayImpl#getStageName_java_lang_String_ <em>Stage Name java lang String </em>}</li>
 *   <li>{@link apigateway.impl.StagePropsBuilder_apigatewayImpl#getTracingEnabled_java_lang_Boolean_ <em>Tracing Enabled java lang Boolean </em>}</li>
 *   <li>{@link apigateway.impl.StagePropsBuilder_apigatewayImpl#getVariables_java_lang_String__java_lang_String_AsMap <em>Variables java lang String java lang String As Map</em>}</li>
 *   <li>{@link apigateway.impl.StagePropsBuilder_apigatewayImpl#getCacheDataEncrypted_java_lang_Boolean_ <em>Cache Data Encrypted java lang Boolean </em>}</li>
 *   <li>{@link apigateway.impl.StagePropsBuilder_apigatewayImpl#getCacheTtlWithDuration_software_amazon_awscdk_core_Duration_AsReference <em>Cache Ttl With Duration software amazon awscdk core Duration As Reference</em>}</li>
 *   <li>{@link apigateway.impl.StagePropsBuilder_apigatewayImpl#getCachingEnabled_java_lang_Boolean_ <em>Caching Enabled java lang Boolean </em>}</li>
 *   <li>{@link apigateway.impl.StagePropsBuilder_apigatewayImpl#getDataTraceEnabled_java_lang_Boolean_ <em>Data Trace Enabled java lang Boolean </em>}</li>
 *   <li>{@link apigateway.impl.StagePropsBuilder_apigatewayImpl#getLoggingLevel_software_amazon_awscdk_services_apigateway_MethodLoggingLevel_ <em>Logging Level software amazon awscdk services apigateway Method Logging Level </em>}</li>
 *   <li>{@link apigateway.impl.StagePropsBuilder_apigatewayImpl#getMetricsEnabled_java_lang_Boolean_ <em>Metrics Enabled java lang Boolean </em>}</li>
 *   <li>{@link apigateway.impl.StagePropsBuilder_apigatewayImpl#getThrottlingBurstLimit_java_lang_Number_ <em>Throttling Burst Limit java lang Number </em>}</li>
 *   <li>{@link apigateway.impl.StagePropsBuilder_apigatewayImpl#getThrottlingRateLimit_java_lang_Number_ <em>Throttling Rate Limit java lang Number </em>}</li>
 *   <li>{@link apigateway.impl.StagePropsBuilder_apigatewayImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link apigateway.impl.StagePropsBuilder_apigatewayImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link apigateway.impl.StagePropsBuilder_apigatewayImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link apigateway.impl.StagePropsBuilder_apigatewayImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StagePropsBuilder_apigatewayImpl extends MinimalEObjectImpl.Container
		implements StagePropsBuilder_apigateway {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.apigateway.StageProps";
	 ...
	 * @generated
	 */
	protected StagePropsBuilder_apigatewayImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ApigatewayPackage.Literals.STAGE_PROPS_BUILDER_APIGATEWAY;
	}
	...
	public void setDeploymentWithDeployment_software_amazon_awscdk_services_apigateway_Deployment_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__DEPLOYMENT_WITH_DEPLOYMENT_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_DEPLOYMENT_AS_REFERENCE,
	...
	public void setAccessLogDestinationWithIAccessLogDestination_software_amazon_awscdk_services_apigateway_IAccessLogDestination_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__ACCESS_LOG_DESTINATION_WITH_IACCESS_LOG_DESTINATION_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_IACCESS_LOG_DESTINATION_AS_REFERENCE,
	...
	public void setAccessLogFormatWithAccessLogFormat_software_amazon_awscdk_services_apigateway_AccessLogFormat_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__ACCESS_LOG_FORMAT_WITH_ACCESS_LOG_FORMAT_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_ACCESS_LOG_FORMAT_AS_REFERENCE,
	...
	public void setCacheClusterEnabled_java_lang_Boolean_(Boolean newCacheClusterEnabled_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__CACHE_CLUSTER_ENABLED_JAVA_LANG_BOOLEAN_,
	...
	public void setCacheClusterSize_java_lang_String_(String newCacheClusterSize_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__CACHE_CLUSTER_SIZE_JAVA_LANG_STRING_,
	...
	public void setClientCertificateId_java_lang_String_(String newClientCertificateId_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__CLIENT_CERTIFICATE_ID_JAVA_LANG_STRING_,
	...
	public void setDescription_java_lang_String_(String newDescription_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__DESCRIPTION_JAVA_LANG_STRING_,
	...
	public void setDocumentationVersion_java_lang_String_(String newDocumentationVersion_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__DOCUMENTATION_VERSION_JAVA_LANG_STRING_,
	...
	public void setMethodOptions_java_lang_String__software_amazon_awscdk_services_apigateway_MethodDeploymentOptions_AsMap(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__METHOD_OPTIONS_JAVA_LANG_STRING_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_METHOD_DEPLOYMENT_OPTIONS_AS_MAP,
	...
	public void setStageName_java_lang_String_(String newStageName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__STAGE_NAME_JAVA_LANG_STRING_,
	...
	public void setTracingEnabled_java_lang_Boolean_(Boolean newTracingEnabled_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__TRACING_ENABLED_JAVA_LANG_BOOLEAN_,
	...
	public void setVariables_java_lang_String__java_lang_String_AsMap(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__VARIABLES_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP,
	...
	public void setCacheDataEncrypted_java_lang_Boolean_(Boolean newCacheDataEncrypted_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__CACHE_DATA_ENCRYPTED_JAVA_LANG_BOOLEAN_,
	...
	public void setCacheTtlWithDuration_software_amazon_awscdk_core_Duration_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__CACHE_TTL_WITH_DURATION_SOFTWARE_AMAZON_AWSCDK_CORE_DURATION_AS_REFERENCE,
	...
	public void setCachingEnabled_java_lang_Boolean_(Boolean newCachingEnabled_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__CACHING_ENABLED_JAVA_LANG_BOOLEAN_,
	...
	public void setDataTraceEnabled_java_lang_Boolean_(Boolean newDataTraceEnabled_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__DATA_TRACE_ENABLED_JAVA_LANG_BOOLEAN_,
	...
	public void setLoggingLevel_software_amazon_awscdk_services_apigateway_MethodLoggingLevel_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__LOGGING_LEVEL_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_METHOD_LOGGING_LEVEL_,
	...
	public void setMetricsEnabled_java_lang_Boolean_(Boolean newMetricsEnabled_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__METRICS_ENABLED_JAVA_LANG_BOOLEAN_,
	...
	public void setThrottlingBurstLimit_java_lang_Number_(int newThrottlingBurstLimit_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__THROTTLING_BURST_LIMIT_JAVA_LANG_NUMBER_,
	...
	public void setThrottlingRateLimit_java_lang_Number_(int newThrottlingRateLimit_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__THROTTLING_RATE_LIMIT_JAVA_LANG_NUMBER_,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__DEPLOYMENT_WITH_DEPLOYMENT_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_DEPLOYMENT_AS_REFERENCE:
			return getDeploymentWithDeployment_software_amazon_awscdk_services_apigateway_Deployment_AsReference();
		case ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__ACCESS_LOG_DESTINATION_WITH_IACCESS_LOG_DESTINATION_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_IACCESS_LOG_DESTINATION_AS_REFERENCE:
		...
		case ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__ACCESS_LOG_FORMAT_WITH_ACCESS_LOG_FORMAT_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_ACCESS_LOG_FORMAT_AS_REFERENCE:
			return getAccessLogFormatWithAccessLogFormat_software_amazon_awscdk_services_apigateway_AccessLogFormat_AsReference();
		case ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__CACHE_CLUSTER_ENABLED_JAVA_LANG_BOOLEAN_:
			return getCacheClusterEnabled_java_lang_Boolean_();
		case ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__CACHE_CLUSTER_SIZE_JAVA_LANG_STRING_:
			return getCacheClusterSize_java_lang_String_();
		case ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__CLIENT_CERTIFICATE_ID_JAVA_LANG_STRING_:
			return getClientCertificateId_java_lang_String_();
		case ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__DESCRIPTION_JAVA_LANG_STRING_:
			return getDescription_java_lang_String_();
		case ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__DOCUMENTATION_VERSION_JAVA_LANG_STRING_:
			return getDocumentationVersion_java_lang_String_();
		case ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__METHOD_OPTIONS_JAVA_LANG_STRING_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_METHOD_DEPLOYMENT_OPTIONS_AS_MAP:
			return getMethodOptions_java_lang_String__software_amazon_awscdk_services_apigateway_MethodDeploymentOptions_AsMap();
		case ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__STAGE_NAME_JAVA_LANG_STRING_:
			return getStageName_java_lang_String_();
		case ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__TRACING_ENABLED_JAVA_LANG_BOOLEAN_:
			return getTracingEnabled_java_lang_Boolean_();
		case ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__VARIABLES_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP:
			return getVariables_java_lang_String__java_lang_String_AsMap();
		case ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__CACHE_DATA_ENCRYPTED_JAVA_LANG_BOOLEAN_:
			return getCacheDataEncrypted_java_lang_Boolean_();
		case ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__CACHE_TTL_WITH_DURATION_SOFTWARE_AMAZON_AWSCDK_CORE_DURATION_AS_REFERENCE:
			return getCacheTtlWithDuration_software_amazon_awscdk_core_Duration_AsReference();
		case ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__CACHING_ENABLED_JAVA_LANG_BOOLEAN_:
			return getCachingEnabled_java_lang_Boolean_();
		case ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__DATA_TRACE_ENABLED_JAVA_LANG_BOOLEAN_:
			return getDataTraceEnabled_java_lang_Boolean_();
		case ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__LOGGING_LEVEL_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_METHOD_LOGGING_LEVEL_:
			return getLoggingLevel_software_amazon_awscdk_services_apigateway_MethodLoggingLevel_();
		case ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__METRICS_ENABLED_JAVA_LANG_BOOLEAN_:
			return getMetricsEnabled_java_lang_Boolean_();
		case ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__THROTTLING_BURST_LIMIT_JAVA_LANG_NUMBER_:
			return getThrottlingBurstLimit_java_lang_Number_();
		case ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__THROTTLING_RATE_LIMIT_JAVA_LANG_NUMBER_:
			return getThrottlingRateLimit_java_lang_Number_();
		case ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__VAR_NAME:
			return getVarName();
		case ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__IDENTIFIER:
			return getIdentifier();
		case ApigatewayPackage.STAGE_PROPS_BUILDER_APIGATEWAY__ADDITIONAL_CODE:
...
} //StagePropsBuilder_apigatewayImpl
