...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Get Context Key Options Builder core</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link core.impl.GetContextKeyOptionsBuilder_coreImpl#getProvider_java_lang_String_ <em>Provider java lang String </em>}</li>
 *   <li>{@link core.impl.GetContextKeyOptionsBuilder_coreImpl#getProps_java_lang_String__java_lang_Object_AsMap <em>Props java lang String java lang Object As Map</em>}</li>
 *   <li>{@link core.impl.GetContextKeyOptionsBuilder_coreImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link core.impl.GetContextKeyOptionsBuilder_coreImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link core.impl.GetContextKeyOptionsBuilder_coreImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link core.impl.GetContextKeyOptionsBuilder_coreImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GetContextKeyOptionsBuilder_coreImpl extends MinimalEObjectImpl.Container
		implements GetContextKeyOptionsBuilder_core {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.core.GetContextKeyOptions";
	 ...
	 * @generated
	 */
	protected GetContextKeyOptionsBuilder_coreImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.GET_CONTEXT_KEY_OPTIONS_BUILDER_CORE;
	}
	...
	public void setProvider_java_lang_String_(String newProvider_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.GET_CONTEXT_KEY_OPTIONS_BUILDER_CORE__PROVIDER_JAVA_LANG_STRING_,
	...
	public void setProps_java_lang_String__java_lang_Object_AsMap(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.GET_CONTEXT_KEY_OPTIONS_BUILDER_CORE__PROPS_JAVA_LANG_STRING_JAVA_LANG_OBJECT_AS_MAP,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.GET_CONTEXT_KEY_OPTIONS_BUILDER_CORE__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.GET_CONTEXT_KEY_OPTIONS_BUILDER_CORE__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.GET_CONTEXT_KEY_OPTIONS_BUILDER_CORE__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CorePackage.GET_CONTEXT_KEY_OPTIONS_BUILDER_CORE__PROVIDER_JAVA_LANG_STRING_:
			return getProvider_java_lang_String_();
		case CorePackage.GET_CONTEXT_KEY_OPTIONS_BUILDER_CORE__PROPS_JAVA_LANG_STRING_JAVA_LANG_OBJECT_AS_MAP:
			return getProps_java_lang_String__java_lang_Object_AsMap();
		case CorePackage.GET_CONTEXT_KEY_OPTIONS_BUILDER_CORE__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case CorePackage.GET_CONTEXT_KEY_OPTIONS_BUILDER_CORE__VAR_NAME:
			return getVarName();
		case CorePackage.GET_CONTEXT_KEY_OPTIONS_BUILDER_CORE__IDENTIFIER:
			return getIdentifier();
		case CorePackage.GET_CONTEXT_KEY_OPTIONS_BUILDER_CORE__ADDITIONAL_CODE:
...
} //GetContextKeyOptionsBuilder_coreImpl
