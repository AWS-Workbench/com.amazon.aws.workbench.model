 ...
 * </p>
 * <ul>
 *   <li>{@link core.impl.EnvironmentBuilder_coreImpl#getAccount_java_lang_String_ <em>Account java lang String </em>}</li>
 *   <li>{@link core.impl.EnvironmentBuilder_coreImpl#getRegion_java_lang_String_ <em>Region java lang String </em>}</li>
 *   <li>{@link core.impl.EnvironmentBuilder_coreImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link core.impl.EnvironmentBuilder_coreImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link core.impl.EnvironmentBuilder_coreImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link core.impl.EnvironmentBuilder_coreImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnvironmentBuilder_coreImpl extends MinimalEObjectImpl.Container implements EnvironmentBuilder_core {
	...
	protected EClass eStaticClass() {
		return CorePackage.Literals.ENVIRONMENT_BUILDER_CORE;
	}
	...
	public void setAccount_java_lang_String_(String newAccount_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.ENVIRONMENT_BUILDER_CORE__ACCOUNT_JAVA_LANG_STRING_, oldAccount_java_lang_String_,
	...
	public void setRegion_java_lang_String_(String newRegion_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CorePackage.ENVIRONMENT_BUILDER_CORE__REGION_JAVA_LANG_STRING_, oldRegion_java_lang_String_,
	...
	public void setVarName(String newVarName) {
		...
		varName = newVarName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.ENVIRONMENT_BUILDER_CORE__VAR_NAME,
					oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.ENVIRONMENT_BUILDER_CORE__IDENTIFIER,
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CorePackage.ENVIRONMENT_BUILDER_CORE__ADDITIONAL_CODE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CorePackage.ENVIRONMENT_BUILDER_CORE__ACCOUNT_JAVA_LANG_STRING_:
			return getAccount_java_lang_String_();
		case CorePackage.ENVIRONMENT_BUILDER_CORE__REGION_JAVA_LANG_STRING_:
			return getRegion_java_lang_String_();
		case CorePackage.ENVIRONMENT_BUILDER_CORE__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case CorePackage.ENVIRONMENT_BUILDER_CORE__VAR_NAME:
			return getVarName();
		case CorePackage.ENVIRONMENT_BUILDER_CORE__IDENTIFIER:
			return getIdentifier();
		case CorePackage.ENVIRONMENT_BUILDER_CORE__ADDITIONAL_CODE:
