...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Topic Builder sns</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.TopicBuilder_snsImpl#getDisplayName_java_lang_String_ <em>Display Name java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.TopicBuilder_snsImpl#getMasterKeyWithIKey_software_amazon_awscdk_services_kms_IKey_AsReference <em>Master Key With IKey software amazon awscdk services kms IKey As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.TopicBuilder_snsImpl#getTopicName_java_lang_String_ <em>Topic Name java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.TopicBuilder_snsImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.TopicBuilder_snsImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.TopicBuilder_snsImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.TopicBuilder_snsImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TopicBuilder_snsImpl extends ServiceResourcesImpl implements TopicBuilder_sns {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.sns.Topic";
	 ...
	 * @generated
	 */
	protected TopicBuilder_snsImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AwsworkbenchPackage.Literals.TOPIC_BUILDER_SNS;
	}
	...
	public void setDisplayName_java_lang_String_(String newDisplayName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.TOPIC_BUILDER_SNS__DISPLAY_NAME_JAVA_LANG_STRING_,
	...
	public void setMasterKeyWithIKey_software_amazon_awscdk_services_kms_IKey_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.TOPIC_BUILDER_SNS__MASTER_KEY_WITH_IKEY_SOFTWARE_AMAZON_AWSCDK_SERVICES_KMS_IKEY_AS_REFERENCE,
	...
	public void setTopicName_java_lang_String_(String newTopicName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.TOPIC_BUILDER_SNS__TOPIC_NAME_JAVA_LANG_STRING_, oldTopicName_java_lang_String_,
					topicName_java_lang_String_));
	}
	...
	public void setVarName(String newVarName) {
		...
		varName = newVarName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AwsworkbenchPackage.TOPIC_BUILDER_SNS__VAR_NAME,
					oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AwsworkbenchPackage.TOPIC_BUILDER_SNS__IDENTIFIER,
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.TOPIC_BUILDER_SNS__ADDITIONAL_CODE, oldAdditionalCode, additionalCode));
	}
