 ...
 * </p>
 * <ul>
 *   <li>{@link ec2.impl.AmazonLinuxImageBuilder_ec2Impl#getEdition_software_amazon_awscdk_services_ec2_AmazonLinuxEdition_ <em>Edition software amazon awscdk services ec2 Amazon Linux Edition </em>}</li>
 *   <li>{@link ec2.impl.AmazonLinuxImageBuilder_ec2Impl#getGeneration_software_amazon_awscdk_services_ec2_AmazonLinuxGeneration_ <em>Generation software amazon awscdk services ec2 Amazon Linux Generation </em>}</li>
 *   <li>{@link ec2.impl.AmazonLinuxImageBuilder_ec2Impl#getStorage_software_amazon_awscdk_services_ec2_AmazonLinuxStorage_ <em>Storage software amazon awscdk services ec2 Amazon Linux Storage </em>}</li>
 *   <li>{@link ec2.impl.AmazonLinuxImageBuilder_ec2Impl#getUserDataWithUserData_software_amazon_awscdk_services_ec2_UserData_AsReference <em>User Data With User Data software amazon awscdk services ec2 User Data As Reference</em>}</li>
 *   <li>{@link ec2.impl.AmazonLinuxImageBuilder_ec2Impl#getVirtualization_software_amazon_awscdk_services_ec2_AmazonLinuxVirt_ <em>Virtualization software amazon awscdk services ec2 Amazon Linux Virt </em>}</li>
 *   <li>{@link ec2.impl.AmazonLinuxImageBuilder_ec2Impl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link ec2.impl.AmazonLinuxImageBuilder_ec2Impl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link ec2.impl.AmazonLinuxImageBuilder_ec2Impl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link ec2.impl.AmazonLinuxImageBuilder_ec2Impl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AmazonLinuxImageBuilder_ec2Impl extends MinimalEObjectImpl.Container
	...
	protected EClass eStaticClass() {
		return Ec2Package.Literals.AMAZON_LINUX_IMAGE_BUILDER_EC2;
	}
	...
	public void setEdition_software_amazon_awscdk_services_ec2_AmazonLinuxEdition_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.AMAZON_LINUX_IMAGE_BUILDER_EC2__EDITION_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_AMAZON_LINUX_EDITION_,
	...
	public void setGeneration_software_amazon_awscdk_services_ec2_AmazonLinuxGeneration_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.AMAZON_LINUX_IMAGE_BUILDER_EC2__GENERATION_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_AMAZON_LINUX_GENERATION_,
	...
	public void setStorage_software_amazon_awscdk_services_ec2_AmazonLinuxStorage_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.AMAZON_LINUX_IMAGE_BUILDER_EC2__STORAGE_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_AMAZON_LINUX_STORAGE_,
	...
	public void setUserDataWithUserData_software_amazon_awscdk_services_ec2_UserData_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.AMAZON_LINUX_IMAGE_BUILDER_EC2__USER_DATA_WITH_USER_DATA_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_USER_DATA_AS_REFERENCE,
	...
	public void setVirtualization_software_amazon_awscdk_services_ec2_AmazonLinuxVirt_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.AMAZON_LINUX_IMAGE_BUILDER_EC2__VIRTUALIZATION_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_AMAZON_LINUX_VIRT_,
	...
	public void setVarName(String newVarName) {
		...
		varName = newVarName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.AMAZON_LINUX_IMAGE_BUILDER_EC2__VAR_NAME,
					oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.AMAZON_LINUX_IMAGE_BUILDER_EC2__IDENTIFIER,
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.AMAZON_LINUX_IMAGE_BUILDER_EC2__ADDITIONAL_CODE, oldAdditionalCode, additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Ec2Package.AMAZON_LINUX_IMAGE_BUILDER_EC2__EDITION_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_AMAZON_LINUX_EDITION_:
			return getEdition_software_amazon_awscdk_services_ec2_AmazonLinuxEdition_();
		case Ec2Package.AMAZON_LINUX_IMAGE_BUILDER_EC2__GENERATION_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_AMAZON_LINUX_GENERATION_:
			return getGeneration_software_amazon_awscdk_services_ec2_AmazonLinuxGeneration_();
		case Ec2Package.AMAZON_LINUX_IMAGE_BUILDER_EC2__STORAGE_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_AMAZON_LINUX_STORAGE_:
			return getStorage_software_amazon_awscdk_services_ec2_AmazonLinuxStorage_();
		case Ec2Package.AMAZON_LINUX_IMAGE_BUILDER_EC2__USER_DATA_WITH_USER_DATA_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_USER_DATA_AS_REFERENCE:
			return getUserDataWithUserData_software_amazon_awscdk_services_ec2_UserData_AsReference();
		case Ec2Package.AMAZON_LINUX_IMAGE_BUILDER_EC2__VIRTUALIZATION_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_AMAZON_LINUX_VIRT_:
			return getVirtualization_software_amazon_awscdk_services_ec2_AmazonLinuxVirt_();
		case Ec2Package.AMAZON_LINUX_IMAGE_BUILDER_EC2__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case Ec2Package.AMAZON_LINUX_IMAGE_BUILDER_EC2__VAR_NAME:
			return getVarName();
		case Ec2Package.AMAZON_LINUX_IMAGE_BUILDER_EC2__IDENTIFIER:
			return getIdentifier();
		case Ec2Package.AMAZON_LINUX_IMAGE_BUILDER_EC2__ADDITIONAL_CODE:
