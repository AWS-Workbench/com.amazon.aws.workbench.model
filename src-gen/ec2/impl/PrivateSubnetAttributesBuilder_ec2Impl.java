...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Private Subnet Attributes Builder ec2</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ec2.impl.PrivateSubnetAttributesBuilder_ec2Impl#getSubnetId_java_lang_String_ <em>Subnet Id java lang String </em>}</li>
 *   <li>{@link ec2.impl.PrivateSubnetAttributesBuilder_ec2Impl#getAvailabilityZone_java_lang_String_ <em>Availability Zone java lang String </em>}</li>
 *   <li>{@link ec2.impl.PrivateSubnetAttributesBuilder_ec2Impl#getRouteTableId_java_lang_String_ <em>Route Table Id java lang String </em>}</li>
 *   <li>{@link ec2.impl.PrivateSubnetAttributesBuilder_ec2Impl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link ec2.impl.PrivateSubnetAttributesBuilder_ec2Impl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link ec2.impl.PrivateSubnetAttributesBuilder_ec2Impl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link ec2.impl.PrivateSubnetAttributesBuilder_ec2Impl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrivateSubnetAttributesBuilder_ec2Impl extends MinimalEObjectImpl.Container
		implements PrivateSubnetAttributesBuilder_ec2 {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.ec2.PrivateSubnetAttributes";
	 ...
	 * @generated
	 */
	protected PrivateSubnetAttributesBuilder_ec2Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Ec2Package.Literals.PRIVATE_SUBNET_ATTRIBUTES_BUILDER_EC2;
	}
	...
	public void setSubnetId_java_lang_String_(String newSubnetId_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.PRIVATE_SUBNET_ATTRIBUTES_BUILDER_EC2__SUBNET_ID_JAVA_LANG_STRING_,
	...
	public void setAvailabilityZone_java_lang_String_(String newAvailabilityZone_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.PRIVATE_SUBNET_ATTRIBUTES_BUILDER_EC2__AVAILABILITY_ZONE_JAVA_LANG_STRING_,
	...
	public void setRouteTableId_java_lang_String_(String newRouteTableId_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.PRIVATE_SUBNET_ATTRIBUTES_BUILDER_EC2__ROUTE_TABLE_ID_JAVA_LANG_STRING_,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.PRIVATE_SUBNET_ATTRIBUTES_BUILDER_EC2__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.PRIVATE_SUBNET_ATTRIBUTES_BUILDER_EC2__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.PRIVATE_SUBNET_ATTRIBUTES_BUILDER_EC2__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Ec2Package.PRIVATE_SUBNET_ATTRIBUTES_BUILDER_EC2__SUBNET_ID_JAVA_LANG_STRING_:
			return getSubnetId_java_lang_String_();
		case Ec2Package.PRIVATE_SUBNET_ATTRIBUTES_BUILDER_EC2__AVAILABILITY_ZONE_JAVA_LANG_STRING_:
			return getAvailabilityZone_java_lang_String_();
		case Ec2Package.PRIVATE_SUBNET_ATTRIBUTES_BUILDER_EC2__ROUTE_TABLE_ID_JAVA_LANG_STRING_:
			return getRouteTableId_java_lang_String_();
		case Ec2Package.PRIVATE_SUBNET_ATTRIBUTES_BUILDER_EC2__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case Ec2Package.PRIVATE_SUBNET_ATTRIBUTES_BUILDER_EC2__VAR_NAME:
			return getVarName();
		case Ec2Package.PRIVATE_SUBNET_ATTRIBUTES_BUILDER_EC2__IDENTIFIER:
			return getIdentifier();
		case Ec2Package.PRIVATE_SUBNET_ATTRIBUTES_BUILDER_EC2__ADDITIONAL_CODE:
...
} //PrivateSubnetAttributesBuilder_ec2Impl
