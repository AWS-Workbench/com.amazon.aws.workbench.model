...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>User Invitation Config Builder cognito</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.UserInvitationConfigBuilder_cognitoImpl#getEmailBody_java_lang_String_ <em>Email Body java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.UserInvitationConfigBuilder_cognitoImpl#getEmailSubject_java_lang_String_ <em>Email Subject java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.UserInvitationConfigBuilder_cognitoImpl#getSmsMessage_java_lang_String_ <em>Sms Message java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.UserInvitationConfigBuilder_cognitoImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.UserInvitationConfigBuilder_cognitoImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.UserInvitationConfigBuilder_cognitoImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.UserInvitationConfigBuilder_cognitoImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UserInvitationConfigBuilder_cognitoImpl extends MinimalEObjectImpl.Container
		implements UserInvitationConfigBuilder_cognito {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.cognito.UserInvitationConfig";
	 ...
	 * @generated
	 */
	protected UserInvitationConfigBuilder_cognitoImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AwsworkbenchPackage.Literals.USER_INVITATION_CONFIG_BUILDER_COGNITO;
	}
	...
	public void setEmailBody_java_lang_String_(String newEmailBody_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.USER_INVITATION_CONFIG_BUILDER_COGNITO__EMAIL_BODY_JAVA_LANG_STRING_,
	...
	public void setEmailSubject_java_lang_String_(String newEmailSubject_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.USER_INVITATION_CONFIG_BUILDER_COGNITO__EMAIL_SUBJECT_JAVA_LANG_STRING_,
	...
	public void setSmsMessage_java_lang_String_(String newSmsMessage_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.USER_INVITATION_CONFIG_BUILDER_COGNITO__SMS_MESSAGE_JAVA_LANG_STRING_,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.USER_INVITATION_CONFIG_BUILDER_COGNITO__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.USER_INVITATION_CONFIG_BUILDER_COGNITO__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.USER_INVITATION_CONFIG_BUILDER_COGNITO__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
...
} //UserInvitationConfigBuilder_cognitoImpl
