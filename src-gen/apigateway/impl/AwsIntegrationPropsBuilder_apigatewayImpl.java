...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Aws Integration Props Builder apigateway</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link apigateway.impl.AwsIntegrationPropsBuilder_apigatewayImpl#getService_java_lang_String_ <em>Service java lang String </em>}</li>
 *   <li>{@link apigateway.impl.AwsIntegrationPropsBuilder_apigatewayImpl#getAction_java_lang_String_ <em>Action java lang String </em>}</li>
 *   <li>{@link apigateway.impl.AwsIntegrationPropsBuilder_apigatewayImpl#getActionParameters_java_lang_String__java_lang_String_AsMap <em>Action Parameters java lang String java lang String As Map</em>}</li>
 *   <li>{@link apigateway.impl.AwsIntegrationPropsBuilder_apigatewayImpl#getIntegrationHttpMethod_java_lang_String_ <em>Integration Http Method java lang String </em>}</li>
 *   <li>{@link apigateway.impl.AwsIntegrationPropsBuilder_apigatewayImpl#getOptionsWithIntegrationOptions_software_amazon_awscdk_services_apigateway_IntegrationOptions_AsReference <em>Options With Integration Options software amazon awscdk services apigateway Integration Options As Reference</em>}</li>
 *   <li>{@link apigateway.impl.AwsIntegrationPropsBuilder_apigatewayImpl#getPath_java_lang_String_ <em>Path java lang String </em>}</li>
 *   <li>{@link apigateway.impl.AwsIntegrationPropsBuilder_apigatewayImpl#getProxy_java_lang_Boolean_ <em>Proxy java lang Boolean </em>}</li>
 *   <li>{@link apigateway.impl.AwsIntegrationPropsBuilder_apigatewayImpl#getSubdomain_java_lang_String_ <em>Subdomain java lang String </em>}</li>
 *   <li>{@link apigateway.impl.AwsIntegrationPropsBuilder_apigatewayImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link apigateway.impl.AwsIntegrationPropsBuilder_apigatewayImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link apigateway.impl.AwsIntegrationPropsBuilder_apigatewayImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link apigateway.impl.AwsIntegrationPropsBuilder_apigatewayImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AwsIntegrationPropsBuilder_apigatewayImpl extends MinimalEObjectImpl.Container
		implements AwsIntegrationPropsBuilder_apigateway {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.apigateway.AwsIntegrationProps";
	 ...
	 * @generated
	 */
	protected AwsIntegrationPropsBuilder_apigatewayImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ApigatewayPackage.Literals.AWS_INTEGRATION_PROPS_BUILDER_APIGATEWAY;
	}
	...
	public void setService_java_lang_String_(String newService_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.AWS_INTEGRATION_PROPS_BUILDER_APIGATEWAY__SERVICE_JAVA_LANG_STRING_,
	...
	public void setAction_java_lang_String_(String newAction_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.AWS_INTEGRATION_PROPS_BUILDER_APIGATEWAY__ACTION_JAVA_LANG_STRING_,
	...
	public void setActionParameters_java_lang_String__java_lang_String_AsMap(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.AWS_INTEGRATION_PROPS_BUILDER_APIGATEWAY__ACTION_PARAMETERS_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP,
	...
	public void setIntegrationHttpMethod_java_lang_String_(String newIntegrationHttpMethod_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.AWS_INTEGRATION_PROPS_BUILDER_APIGATEWAY__INTEGRATION_HTTP_METHOD_JAVA_LANG_STRING_,
	...
	public void setOptionsWithIntegrationOptions_software_amazon_awscdk_services_apigateway_IntegrationOptions_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.AWS_INTEGRATION_PROPS_BUILDER_APIGATEWAY__OPTIONS_WITH_INTEGRATION_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_INTEGRATION_OPTIONS_AS_REFERENCE,
	...
	public void setPath_java_lang_String_(String newPath_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.AWS_INTEGRATION_PROPS_BUILDER_APIGATEWAY__PATH_JAVA_LANG_STRING_,
	...
	public void setProxy_java_lang_Boolean_(Boolean newProxy_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.AWS_INTEGRATION_PROPS_BUILDER_APIGATEWAY__PROXY_JAVA_LANG_BOOLEAN_,
	...
	public void setSubdomain_java_lang_String_(String newSubdomain_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.AWS_INTEGRATION_PROPS_BUILDER_APIGATEWAY__SUBDOMAIN_JAVA_LANG_STRING_,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.AWS_INTEGRATION_PROPS_BUILDER_APIGATEWAY__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.AWS_INTEGRATION_PROPS_BUILDER_APIGATEWAY__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.AWS_INTEGRATION_PROPS_BUILDER_APIGATEWAY__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ApigatewayPackage.AWS_INTEGRATION_PROPS_BUILDER_APIGATEWAY__SERVICE_JAVA_LANG_STRING_:
			return getService_java_lang_String_();
		case ApigatewayPackage.AWS_INTEGRATION_PROPS_BUILDER_APIGATEWAY__ACTION_JAVA_LANG_STRING_:
			return getAction_java_lang_String_();
		case ApigatewayPackage.AWS_INTEGRATION_PROPS_BUILDER_APIGATEWAY__ACTION_PARAMETERS_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP:
			return getActionParameters_java_lang_String__java_lang_String_AsMap();
		case ApigatewayPackage.AWS_INTEGRATION_PROPS_BUILDER_APIGATEWAY__INTEGRATION_HTTP_METHOD_JAVA_LANG_STRING_:
			return getIntegrationHttpMethod_java_lang_String_();
		case ApigatewayPackage.AWS_INTEGRATION_PROPS_BUILDER_APIGATEWAY__OPTIONS_WITH_INTEGRATION_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_INTEGRATION_OPTIONS_AS_REFERENCE:
			return getOptionsWithIntegrationOptions_software_amazon_awscdk_services_apigateway_IntegrationOptions_AsReference();
		case ApigatewayPackage.AWS_INTEGRATION_PROPS_BUILDER_APIGATEWAY__PATH_JAVA_LANG_STRING_:
			return getPath_java_lang_String_();
		case ApigatewayPackage.AWS_INTEGRATION_PROPS_BUILDER_APIGATEWAY__PROXY_JAVA_LANG_BOOLEAN_:
			return getProxy_java_lang_Boolean_();
		case ApigatewayPackage.AWS_INTEGRATION_PROPS_BUILDER_APIGATEWAY__SUBDOMAIN_JAVA_LANG_STRING_:
			return getSubdomain_java_lang_String_();
		case ApigatewayPackage.AWS_INTEGRATION_PROPS_BUILDER_APIGATEWAY__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case ApigatewayPackage.AWS_INTEGRATION_PROPS_BUILDER_APIGATEWAY__VAR_NAME:
			return getVarName();
		case ApigatewayPackage.AWS_INTEGRATION_PROPS_BUILDER_APIGATEWAY__IDENTIFIER:
			return getIdentifier();
		case ApigatewayPackage.AWS_INTEGRATION_PROPS_BUILDER_APIGATEWAY__ADDITIONAL_CODE:
...
} //AwsIntegrationPropsBuilder_apigatewayImpl
