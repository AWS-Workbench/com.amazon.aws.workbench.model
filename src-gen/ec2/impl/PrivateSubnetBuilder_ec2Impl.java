 ...
 * </p>
 * <ul>
 *   <li>{@link ec2.impl.PrivateSubnetBuilder_ec2Impl#getAvailabilityZone_java_lang_String_ <em>Availability Zone java lang String </em>}</li>
 *   <li>{@link ec2.impl.PrivateSubnetBuilder_ec2Impl#getCidrBlock_java_lang_String_ <em>Cidr Block java lang String </em>}</li>
 *   <li>{@link ec2.impl.PrivateSubnetBuilder_ec2Impl#getVpcId_java_lang_String_ <em>Vpc Id java lang String </em>}</li>
 *   <li>{@link ec2.impl.PrivateSubnetBuilder_ec2Impl#getMapPublicIpOnLaunch_java_lang_Boolean_ <em>Map Public Ip On Launch java lang Boolean </em>}</li>
 *   <li>{@link ec2.impl.PrivateSubnetBuilder_ec2Impl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link ec2.impl.PrivateSubnetBuilder_ec2Impl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link ec2.impl.PrivateSubnetBuilder_ec2Impl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link ec2.impl.PrivateSubnetBuilder_ec2Impl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PrivateSubnetBuilder_ec2Impl extends MinimalEObjectImpl.Container implements PrivateSubnetBuilder_ec2 {
	/**
	...
	protected EClass eStaticClass() {
		return Ec2Package.Literals.PRIVATE_SUBNET_BUILDER_EC2;
	}
	...
	public void setAvailabilityZone_java_lang_String_(String newAvailabilityZone_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.PRIVATE_SUBNET_BUILDER_EC2__AVAILABILITY_ZONE_JAVA_LANG_STRING_,
	...
	public void setCidrBlock_java_lang_String_(String newCidrBlock_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.PRIVATE_SUBNET_BUILDER_EC2__CIDR_BLOCK_JAVA_LANG_STRING_, oldCidrBlock_java_lang_String_,
	...
	public void setVpcId_java_lang_String_(String newVpcId_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.PRIVATE_SUBNET_BUILDER_EC2__VPC_ID_JAVA_LANG_STRING_, oldVpcId_java_lang_String_,
	...
	public void setMapPublicIpOnLaunch_java_lang_Boolean_(Boolean newMapPublicIpOnLaunch_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.PRIVATE_SUBNET_BUILDER_EC2__MAP_PUBLIC_IP_ON_LAUNCH_JAVA_LANG_BOOLEAN_,
	...
	public void setVarName(String newVarName) {
		...
		varName = newVarName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.PRIVATE_SUBNET_BUILDER_EC2__VAR_NAME,
					oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.PRIVATE_SUBNET_BUILDER_EC2__IDENTIFIER,
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.PRIVATE_SUBNET_BUILDER_EC2__ADDITIONAL_CODE, oldAdditionalCode, additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Ec2Package.PRIVATE_SUBNET_BUILDER_EC2__AVAILABILITY_ZONE_JAVA_LANG_STRING_:
			return getAvailabilityZone_java_lang_String_();
		case Ec2Package.PRIVATE_SUBNET_BUILDER_EC2__CIDR_BLOCK_JAVA_LANG_STRING_:
			return getCidrBlock_java_lang_String_();
		case Ec2Package.PRIVATE_SUBNET_BUILDER_EC2__VPC_ID_JAVA_LANG_STRING_:
			return getVpcId_java_lang_String_();
		case Ec2Package.PRIVATE_SUBNET_BUILDER_EC2__MAP_PUBLIC_IP_ON_LAUNCH_JAVA_LANG_BOOLEAN_:
			return getMapPublicIpOnLaunch_java_lang_Boolean_();
		case Ec2Package.PRIVATE_SUBNET_BUILDER_EC2__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case Ec2Package.PRIVATE_SUBNET_BUILDER_EC2__VAR_NAME:
			return getVarName();
		case Ec2Package.PRIVATE_SUBNET_BUILDER_EC2__IDENTIFIER:
			return getIdentifier();
		case Ec2Package.PRIVATE_SUBNET_BUILDER_EC2__ADDITIONAL_CODE:
