...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Policy Statement Props Builder iam</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link iam.impl.PolicyStatementPropsBuilder_iamImpl#getActions_java_lang_String_AsList <em>Actions java lang String As List</em>}</li>
 *   <li>{@link iam.impl.PolicyStatementPropsBuilder_iamImpl#getConditions_java_lang_String__java_lang_Object_AsMap <em>Conditions java lang String java lang Object As Map</em>}</li>
 *   <li>{@link iam.impl.PolicyStatementPropsBuilder_iamImpl#getEffect_software_amazon_awscdk_services_iam_Effect_ <em>Effect software amazon awscdk services iam Effect </em>}</li>
 *   <li>{@link iam.impl.PolicyStatementPropsBuilder_iamImpl#getNotActions_java_lang_String_AsList <em>Not Actions java lang String As List</em>}</li>
 *   <li>{@link iam.impl.PolicyStatementPropsBuilder_iamImpl#getNotPrincipals_software_amazon_awscdk_services_iam_IPrincipal_AsList <em>Not Principals software amazon awscdk services iam IPrincipal As List</em>}</li>
 *   <li>{@link iam.impl.PolicyStatementPropsBuilder_iamImpl#getNotResources_java_lang_String_AsList <em>Not Resources java lang String As List</em>}</li>
 *   <li>{@link iam.impl.PolicyStatementPropsBuilder_iamImpl#getPrincipals_software_amazon_awscdk_services_iam_IPrincipal_AsList <em>Principals software amazon awscdk services iam IPrincipal As List</em>}</li>
 *   <li>{@link iam.impl.PolicyStatementPropsBuilder_iamImpl#getResources_java_lang_String_AsList <em>Resources java lang String As List</em>}</li>
 *   <li>{@link iam.impl.PolicyStatementPropsBuilder_iamImpl#getSid_java_lang_String_ <em>Sid java lang String </em>}</li>
 *   <li>{@link iam.impl.PolicyStatementPropsBuilder_iamImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link iam.impl.PolicyStatementPropsBuilder_iamImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link iam.impl.PolicyStatementPropsBuilder_iamImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link iam.impl.PolicyStatementPropsBuilder_iamImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PolicyStatementPropsBuilder_iamImpl extends MinimalEObjectImpl.Container
		implements PolicyStatementPropsBuilder_iam {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.iam.PolicyStatementProps";
	 ...
	 * @generated
	 */
	protected PolicyStatementPropsBuilder_iamImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return IamPackage.Literals.POLICY_STATEMENT_PROPS_BUILDER_IAM;
	}
	...
	public void setActions_java_lang_String_AsList(String newActions_java_lang_String_AsList) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.POLICY_STATEMENT_PROPS_BUILDER_IAM__ACTIONS_JAVA_LANG_STRING_AS_LIST,
	...
	public void setConditions_java_lang_String__java_lang_Object_AsMap(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.POLICY_STATEMENT_PROPS_BUILDER_IAM__CONDITIONS_JAVA_LANG_STRING_JAVA_LANG_OBJECT_AS_MAP,
	...
	public void setEffect_software_amazon_awscdk_services_iam_Effect_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.POLICY_STATEMENT_PROPS_BUILDER_IAM__EFFECT_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_EFFECT_,
	...
	public void setNotActions_java_lang_String_AsList(String newNotActions_java_lang_String_AsList) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.POLICY_STATEMENT_PROPS_BUILDER_IAM__NOT_ACTIONS_JAVA_LANG_STRING_AS_LIST,
	...
	public void setNotPrincipals_software_amazon_awscdk_services_iam_IPrincipal_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.POLICY_STATEMENT_PROPS_BUILDER_IAM__NOT_PRINCIPALS_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IPRINCIPAL_AS_LIST,
	...
	public void setNotResources_java_lang_String_AsList(String newNotResources_java_lang_String_AsList) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.POLICY_STATEMENT_PROPS_BUILDER_IAM__NOT_RESOURCES_JAVA_LANG_STRING_AS_LIST,
	...
	public void setPrincipals_software_amazon_awscdk_services_iam_IPrincipal_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.POLICY_STATEMENT_PROPS_BUILDER_IAM__PRINCIPALS_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IPRINCIPAL_AS_LIST,
	...
	public void setResources_java_lang_String_AsList(String newResources_java_lang_String_AsList) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.POLICY_STATEMENT_PROPS_BUILDER_IAM__RESOURCES_JAVA_LANG_STRING_AS_LIST,
	...
	public void setSid_java_lang_String_(String newSid_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.POLICY_STATEMENT_PROPS_BUILDER_IAM__SID_JAVA_LANG_STRING_, oldSid_java_lang_String_,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.POLICY_STATEMENT_PROPS_BUILDER_IAM__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.POLICY_STATEMENT_PROPS_BUILDER_IAM__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.POLICY_STATEMENT_PROPS_BUILDER_IAM__ADDITIONAL_CODE, oldAdditionalCode, additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case IamPackage.POLICY_STATEMENT_PROPS_BUILDER_IAM__ACTIONS_JAVA_LANG_STRING_AS_LIST:
			return getActions_java_lang_String_AsList();
		case IamPackage.POLICY_STATEMENT_PROPS_BUILDER_IAM__CONDITIONS_JAVA_LANG_STRING_JAVA_LANG_OBJECT_AS_MAP:
			return getConditions_java_lang_String__java_lang_Object_AsMap();
		case IamPackage.POLICY_STATEMENT_PROPS_BUILDER_IAM__EFFECT_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_EFFECT_:
			return getEffect_software_amazon_awscdk_services_iam_Effect_();
		case IamPackage.POLICY_STATEMENT_PROPS_BUILDER_IAM__NOT_ACTIONS_JAVA_LANG_STRING_AS_LIST:
			return getNotActions_java_lang_String_AsList();
		case IamPackage.POLICY_STATEMENT_PROPS_BUILDER_IAM__NOT_PRINCIPALS_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IPRINCIPAL_AS_LIST:
			return getNotPrincipals_software_amazon_awscdk_services_iam_IPrincipal_AsList();
		case IamPackage.POLICY_STATEMENT_PROPS_BUILDER_IAM__NOT_RESOURCES_JAVA_LANG_STRING_AS_LIST:
			return getNotResources_java_lang_String_AsList();
		case IamPackage.POLICY_STATEMENT_PROPS_BUILDER_IAM__PRINCIPALS_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IPRINCIPAL_AS_LIST:
			return getPrincipals_software_amazon_awscdk_services_iam_IPrincipal_AsList();
		case IamPackage.POLICY_STATEMENT_PROPS_BUILDER_IAM__RESOURCES_JAVA_LANG_STRING_AS_LIST:
			return getResources_java_lang_String_AsList();
		case IamPackage.POLICY_STATEMENT_PROPS_BUILDER_IAM__SID_JAVA_LANG_STRING_:
			return getSid_java_lang_String_();
		case IamPackage.POLICY_STATEMENT_PROPS_BUILDER_IAM__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case IamPackage.POLICY_STATEMENT_PROPS_BUILDER_IAM__VAR_NAME:
			return getVarName();
		case IamPackage.POLICY_STATEMENT_PROPS_BUILDER_IAM__IDENTIFIER:
			return getIdentifier();
		case IamPackage.POLICY_STATEMENT_PROPS_BUILDER_IAM__ADDITIONAL_CODE:
...
} //PolicyStatementPropsBuilder_iamImpl
