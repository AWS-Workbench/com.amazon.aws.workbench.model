...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Oracle Se2 Instance Engine Props Builder rds</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.OracleSe2InstanceEnginePropsBuilder_rdsImpl#getVersionWithOracleEngineVersion_software_amazon_awscdk_services_rds_OracleEngineVersion_AsReference <em>Version With Oracle Engine Version software amazon awscdk services rds Oracle Engine Version As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.OracleSe2InstanceEnginePropsBuilder_rdsImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.OracleSe2InstanceEnginePropsBuilder_rdsImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.OracleSe2InstanceEnginePropsBuilder_rdsImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.OracleSe2InstanceEnginePropsBuilder_rdsImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OracleSe2InstanceEnginePropsBuilder_rdsImpl extends ServiceResourcesImpl
		implements OracleSe2InstanceEnginePropsBuilder_rds {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.rds.OracleSe2InstanceEngineProps";
	 ...
	 * @generated
	 */
	protected OracleSe2InstanceEnginePropsBuilder_rdsImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AwsworkbenchPackage.Literals.ORACLE_SE2_INSTANCE_ENGINE_PROPS_BUILDER_RDS;
	}
	...
	public void setVersionWithOracleEngineVersion_software_amazon_awscdk_services_rds_OracleEngineVersion_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.ORACLE_SE2_INSTANCE_ENGINE_PROPS_BUILDER_RDS__VERSION_WITH_ORACLE_ENGINE_VERSION_SOFTWARE_AMAZON_AWSCDK_SERVICES_RDS_ORACLE_ENGINE_VERSION_AS_REFERENCE,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.ORACLE_SE2_INSTANCE_ENGINE_PROPS_BUILDER_RDS__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.ORACLE_SE2_INSTANCE_ENGINE_PROPS_BUILDER_RDS__IDENTIFIER, oldIdentifier,
					identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.ORACLE_SE2_INSTANCE_ENGINE_PROPS_BUILDER_RDS__ADDITIONAL_CODE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case AwsworkbenchPackage.ORACLE_SE2_INSTANCE_ENGINE_PROPS_BUILDER_RDS__VERSION_WITH_ORACLE_ENGINE_VERSION_SOFTWARE_AMAZON_AWSCDK_SERVICES_RDS_ORACLE_ENGINE_VERSION_AS_REFERENCE:
			return getVersionWithOracleEngineVersion_software_amazon_awscdk_services_rds_OracleEngineVersion_AsReference();
		case AwsworkbenchPackage.ORACLE_SE2_INSTANCE_ENGINE_PROPS_BUILDER_RDS__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case AwsworkbenchPackage.ORACLE_SE2_INSTANCE_ENGINE_PROPS_BUILDER_RDS__VAR_NAME:
			return getVarName();
		case AwsworkbenchPackage.ORACLE_SE2_INSTANCE_ENGINE_PROPS_BUILDER_RDS__IDENTIFIER:
			return getIdentifier();
		case AwsworkbenchPackage.ORACLE_SE2_INSTANCE_ENGINE_PROPS_BUILDER_RDS__ADDITIONAL_CODE:
...
} //OracleSe2InstanceEnginePropsBuilder_rdsImpl
