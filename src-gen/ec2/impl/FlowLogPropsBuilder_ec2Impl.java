...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Flow Log Props Builder ec2</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ec2.impl.FlowLogPropsBuilder_ec2Impl#getResourceTypeWithFlowLogResourceType_software_amazon_awscdk_services_ec2_FlowLogResourceType_AsReference <em>Resource Type With Flow Log Resource Type software amazon awscdk services ec2 Flow Log Resource Type As Reference</em>}</li>
 *   <li>{@link ec2.impl.FlowLogPropsBuilder_ec2Impl#getFlowLogName_java_lang_String_ <em>Flow Log Name java lang String </em>}</li>
 *   <li>{@link ec2.impl.FlowLogPropsBuilder_ec2Impl#getDestinationWithFlowLogDestination_software_amazon_awscdk_services_ec2_FlowLogDestination_AsReference <em>Destination With Flow Log Destination software amazon awscdk services ec2 Flow Log Destination As Reference</em>}</li>
 *   <li>{@link ec2.impl.FlowLogPropsBuilder_ec2Impl#getTrafficType_software_amazon_awscdk_services_ec2_FlowLogTrafficType_ <em>Traffic Type software amazon awscdk services ec2 Flow Log Traffic Type </em>}</li>
 *   <li>{@link ec2.impl.FlowLogPropsBuilder_ec2Impl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link ec2.impl.FlowLogPropsBuilder_ec2Impl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link ec2.impl.FlowLogPropsBuilder_ec2Impl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link ec2.impl.FlowLogPropsBuilder_ec2Impl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FlowLogPropsBuilder_ec2Impl extends MinimalEObjectImpl.Container implements FlowLogPropsBuilder_ec2 {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.ec2.FlowLogProps";
	 ...
	 * @generated
	 */
	protected FlowLogPropsBuilder_ec2Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Ec2Package.Literals.FLOW_LOG_PROPS_BUILDER_EC2;
	}
	...
	public void setResourceTypeWithFlowLogResourceType_software_amazon_awscdk_services_ec2_FlowLogResourceType_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.FLOW_LOG_PROPS_BUILDER_EC2__RESOURCE_TYPE_WITH_FLOW_LOG_RESOURCE_TYPE_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_FLOW_LOG_RESOURCE_TYPE_AS_REFERENCE,
	...
	public void setFlowLogName_java_lang_String_(String newFlowLogName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.FLOW_LOG_PROPS_BUILDER_EC2__FLOW_LOG_NAME_JAVA_LANG_STRING_,
					oldFlowLogName_java_lang_String_, flowLogName_java_lang_String_));
	}
	...
	public void setDestinationWithFlowLogDestination_software_amazon_awscdk_services_ec2_FlowLogDestination_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.FLOW_LOG_PROPS_BUILDER_EC2__DESTINATION_WITH_FLOW_LOG_DESTINATION_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_FLOW_LOG_DESTINATION_AS_REFERENCE,
	...
	public void setTrafficType_software_amazon_awscdk_services_ec2_FlowLogTrafficType_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.FLOW_LOG_PROPS_BUILDER_EC2__TRAFFIC_TYPE_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_FLOW_LOG_TRAFFIC_TYPE_,
	...
	public void setVarName(String newVarName) {
		...
		varName = newVarName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.FLOW_LOG_PROPS_BUILDER_EC2__VAR_NAME,
					oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.FLOW_LOG_PROPS_BUILDER_EC2__IDENTIFIER,
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.FLOW_LOG_PROPS_BUILDER_EC2__ADDITIONAL_CODE, oldAdditionalCode, additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Ec2Package.FLOW_LOG_PROPS_BUILDER_EC2__RESOURCE_TYPE_WITH_FLOW_LOG_RESOURCE_TYPE_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_FLOW_LOG_RESOURCE_TYPE_AS_REFERENCE:
			return getResourceTypeWithFlowLogResourceType_software_amazon_awscdk_services_ec2_FlowLogResourceType_AsReference();
		case Ec2Package.FLOW_LOG_PROPS_BUILDER_EC2__FLOW_LOG_NAME_JAVA_LANG_STRING_:
			return getFlowLogName_java_lang_String_();
		case Ec2Package.FLOW_LOG_PROPS_BUILDER_EC2__DESTINATION_WITH_FLOW_LOG_DESTINATION_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_FLOW_LOG_DESTINATION_AS_REFERENCE:
			return getDestinationWithFlowLogDestination_software_amazon_awscdk_services_ec2_FlowLogDestination_AsReference();
		case Ec2Package.FLOW_LOG_PROPS_BUILDER_EC2__TRAFFIC_TYPE_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_FLOW_LOG_TRAFFIC_TYPE_:
			return getTrafficType_software_amazon_awscdk_services_ec2_FlowLogTrafficType_();
		case Ec2Package.FLOW_LOG_PROPS_BUILDER_EC2__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case Ec2Package.FLOW_LOG_PROPS_BUILDER_EC2__VAR_NAME:
			return getVarName();
		case Ec2Package.FLOW_LOG_PROPS_BUILDER_EC2__IDENTIFIER:
			return getIdentifier();
		case Ec2Package.FLOW_LOG_PROPS_BUILDER_EC2__ADDITIONAL_CODE:
