 ...
 * </p>
 * <ul>
 *   <li>{@link apigateway.impl.IntegrationResponseBuilder_apigatewayImpl#getStatusCode_java_lang_String_ <em>Status Code java lang String </em>}</li>
 *   <li>{@link apigateway.impl.IntegrationResponseBuilder_apigatewayImpl#getContentHandling_software_amazon_awscdk_services_apigateway_ContentHandling_ <em>Content Handling software amazon awscdk services apigateway Content Handling </em>}</li>
 *   <li>{@link apigateway.impl.IntegrationResponseBuilder_apigatewayImpl#getResponseParameters_java_lang_String__java_lang_String_AsMap <em>Response Parameters java lang String java lang String As Map</em>}</li>
 *   <li>{@link apigateway.impl.IntegrationResponseBuilder_apigatewayImpl#getResponseTemplates_java_lang_String__java_lang_String_AsMap <em>Response Templates java lang String java lang String As Map</em>}</li>
 *   <li>{@link apigateway.impl.IntegrationResponseBuilder_apigatewayImpl#getSelectionPattern_java_lang_String_ <em>Selection Pattern java lang String </em>}</li>
 *   <li>{@link apigateway.impl.IntegrationResponseBuilder_apigatewayImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link apigateway.impl.IntegrationResponseBuilder_apigatewayImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link apigateway.impl.IntegrationResponseBuilder_apigatewayImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link apigateway.impl.IntegrationResponseBuilder_apigatewayImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegrationResponseBuilder_apigatewayImpl extends MinimalEObjectImpl.Container
	...
	protected EClass eStaticClass() {
		return ApigatewayPackage.Literals.INTEGRATION_RESPONSE_BUILDER_APIGATEWAY;
	}
	...
	public void setStatusCode_java_lang_String_(String newStatusCode_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_RESPONSE_BUILDER_APIGATEWAY__STATUS_CODE_JAVA_LANG_STRING_,
	...
	public void setContentHandling_software_amazon_awscdk_services_apigateway_ContentHandling_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_RESPONSE_BUILDER_APIGATEWAY__CONTENT_HANDLING_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_CONTENT_HANDLING_,
	...
	public void setResponseParameters_java_lang_String__java_lang_String_AsMap(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_RESPONSE_BUILDER_APIGATEWAY__RESPONSE_PARAMETERS_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP,
	...
	public void setResponseTemplates_java_lang_String__java_lang_String_AsMap(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_RESPONSE_BUILDER_APIGATEWAY__RESPONSE_TEMPLATES_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP,
	...
	public void setSelectionPattern_java_lang_String_(String newSelectionPattern_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_RESPONSE_BUILDER_APIGATEWAY__SELECTION_PATTERN_JAVA_LANG_STRING_,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_RESPONSE_BUILDER_APIGATEWAY__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_RESPONSE_BUILDER_APIGATEWAY__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.INTEGRATION_RESPONSE_BUILDER_APIGATEWAY__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ApigatewayPackage.INTEGRATION_RESPONSE_BUILDER_APIGATEWAY__STATUS_CODE_JAVA_LANG_STRING_:
			return getStatusCode_java_lang_String_();
		case ApigatewayPackage.INTEGRATION_RESPONSE_BUILDER_APIGATEWAY__CONTENT_HANDLING_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_CONTENT_HANDLING_:
			return getContentHandling_software_amazon_awscdk_services_apigateway_ContentHandling_();
		case ApigatewayPackage.INTEGRATION_RESPONSE_BUILDER_APIGATEWAY__RESPONSE_PARAMETERS_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP:
			return getResponseParameters_java_lang_String__java_lang_String_AsMap();
		case ApigatewayPackage.INTEGRATION_RESPONSE_BUILDER_APIGATEWAY__RESPONSE_TEMPLATES_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP:
			return getResponseTemplates_java_lang_String__java_lang_String_AsMap();
		case ApigatewayPackage.INTEGRATION_RESPONSE_BUILDER_APIGATEWAY__SELECTION_PATTERN_JAVA_LANG_STRING_:
			return getSelectionPattern_java_lang_String_();
		case ApigatewayPackage.INTEGRATION_RESPONSE_BUILDER_APIGATEWAY__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case ApigatewayPackage.INTEGRATION_RESPONSE_BUILDER_APIGATEWAY__VAR_NAME:
			return getVarName();
		case ApigatewayPackage.INTEGRATION_RESPONSE_BUILDER_APIGATEWAY__IDENTIFIER:
			return getIdentifier();
		case ApigatewayPackage.INTEGRATION_RESPONSE_BUILDER_APIGATEWAY__ADDITIONAL_CODE:
