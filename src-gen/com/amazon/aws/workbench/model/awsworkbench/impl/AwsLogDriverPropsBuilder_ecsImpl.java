...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Aws Log Driver Props Builder ecs</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.AwsLogDriverPropsBuilder_ecsImpl#getStreamPrefix_java_lang_String_ <em>Stream Prefix java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.AwsLogDriverPropsBuilder_ecsImpl#getDatetimeFormat_java_lang_String_ <em>Datetime Format java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.AwsLogDriverPropsBuilder_ecsImpl#getLogGroupWithILogGroup_software_amazon_awscdk_services_logs_ILogGroup_AsReference <em>Log Group With ILog Group software amazon awscdk services logs ILog Group As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.AwsLogDriverPropsBuilder_ecsImpl#getLogRetention_software_amazon_awscdk_services_logs_RetentionDays_ <em>Log Retention software amazon awscdk services logs Retention Days </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.AwsLogDriverPropsBuilder_ecsImpl#getMultilinePattern_java_lang_String_ <em>Multiline Pattern java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.AwsLogDriverPropsBuilder_ecsImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.AwsLogDriverPropsBuilder_ecsImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.AwsLogDriverPropsBuilder_ecsImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.AwsLogDriverPropsBuilder_ecsImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AwsLogDriverPropsBuilder_ecsImpl extends MinimalEObjectImpl.Container
		implements AwsLogDriverPropsBuilder_ecs {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.ecs.AwsLogDriverProps";
	 ...
	 * @generated
	 */
	protected AwsLogDriverPropsBuilder_ecsImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AwsworkbenchPackage.Literals.AWS_LOG_DRIVER_PROPS_BUILDER_ECS;
	}
	...
	public void setStreamPrefix_java_lang_String_(String newStreamPrefix_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.AWS_LOG_DRIVER_PROPS_BUILDER_ECS__STREAM_PREFIX_JAVA_LANG_STRING_,
	...
	public void setDatetimeFormat_java_lang_String_(String newDatetimeFormat_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.AWS_LOG_DRIVER_PROPS_BUILDER_ECS__DATETIME_FORMAT_JAVA_LANG_STRING_,
	...
	public void setLogGroupWithILogGroup_software_amazon_awscdk_services_logs_ILogGroup_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.AWS_LOG_DRIVER_PROPS_BUILDER_ECS__LOG_GROUP_WITH_ILOG_GROUP_SOFTWARE_AMAZON_AWSCDK_SERVICES_LOGS_ILOG_GROUP_AS_REFERENCE,
	...
	public void setLogRetention_software_amazon_awscdk_services_logs_RetentionDays_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.AWS_LOG_DRIVER_PROPS_BUILDER_ECS__LOG_RETENTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_LOGS_RETENTION_DAYS_,
	...
	public void setMultilinePattern_java_lang_String_(String newMultilinePattern_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.AWS_LOG_DRIVER_PROPS_BUILDER_ECS__MULTILINE_PATTERN_JAVA_LANG_STRING_,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.AWS_LOG_DRIVER_PROPS_BUILDER_ECS__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.AWS_LOG_DRIVER_PROPS_BUILDER_ECS__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.AWS_LOG_DRIVER_PROPS_BUILDER_ECS__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case AwsworkbenchPackage.AWS_LOG_DRIVER_PROPS_BUILDER_ECS__STREAM_PREFIX_JAVA_LANG_STRING_:
			return getStreamPrefix_java_lang_String_();
		case AwsworkbenchPackage.AWS_LOG_DRIVER_PROPS_BUILDER_ECS__DATETIME_FORMAT_JAVA_LANG_STRING_:
			return getDatetimeFormat_java_lang_String_();
		case AwsworkbenchPackage.AWS_LOG_DRIVER_PROPS_BUILDER_ECS__LOG_GROUP_WITH_ILOG_GROUP_SOFTWARE_AMAZON_AWSCDK_SERVICES_LOGS_ILOG_GROUP_AS_REFERENCE:
			return getLogGroupWithILogGroup_software_amazon_awscdk_services_logs_ILogGroup_AsReference();
		case AwsworkbenchPackage.AWS_LOG_DRIVER_PROPS_BUILDER_ECS__LOG_RETENTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_LOGS_RETENTION_DAYS_:
			return getLogRetention_software_amazon_awscdk_services_logs_RetentionDays_();
		case AwsworkbenchPackage.AWS_LOG_DRIVER_PROPS_BUILDER_ECS__MULTILINE_PATTERN_JAVA_LANG_STRING_:
			return getMultilinePattern_java_lang_String_();
		case AwsworkbenchPackage.AWS_LOG_DRIVER_PROPS_BUILDER_ECS__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case AwsworkbenchPackage.AWS_LOG_DRIVER_PROPS_BUILDER_ECS__VAR_NAME:
			return getVarName();
		case AwsworkbenchPackage.AWS_LOG_DRIVER_PROPS_BUILDER_ECS__IDENTIFIER:
			return getIdentifier();
		case AwsworkbenchPackage.AWS_LOG_DRIVER_PROPS_BUILDER_ECS__ADDITIONAL_CODE:
...
} //AwsLogDriverPropsBuilder_ecsImpl
