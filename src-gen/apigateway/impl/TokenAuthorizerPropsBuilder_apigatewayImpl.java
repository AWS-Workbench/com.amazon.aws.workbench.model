...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Token Authorizer Props Builder apigateway</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link apigateway.impl.TokenAuthorizerPropsBuilder_apigatewayImpl#getIdentitySource_java_lang_String_ <em>Identity Source java lang String </em>}</li>
 *   <li>{@link apigateway.impl.TokenAuthorizerPropsBuilder_apigatewayImpl#getValidationRegex_java_lang_String_ <em>Validation Regex java lang String </em>}</li>
 *   <li>{@link apigateway.impl.TokenAuthorizerPropsBuilder_apigatewayImpl#getHandlerWithIFunction_software_amazon_awscdk_services_lambda_IFunction_AsReference <em>Handler With IFunction software amazon awscdk services lambda IFunction As Reference</em>}</li>
 *   <li>{@link apigateway.impl.TokenAuthorizerPropsBuilder_apigatewayImpl#getAssumeRoleWithIRole_software_amazon_awscdk_services_iam_IRole_AsReference <em>Assume Role With IRole software amazon awscdk services iam IRole As Reference</em>}</li>
 *   <li>{@link apigateway.impl.TokenAuthorizerPropsBuilder_apigatewayImpl#getAuthorizerName_java_lang_String_ <em>Authorizer Name java lang String </em>}</li>
 *   <li>{@link apigateway.impl.TokenAuthorizerPropsBuilder_apigatewayImpl#getResultsCacheTtlWithDuration_software_amazon_awscdk_core_Duration_AsReference <em>Results Cache Ttl With Duration software amazon awscdk core Duration As Reference</em>}</li>
 *   <li>{@link apigateway.impl.TokenAuthorizerPropsBuilder_apigatewayImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link apigateway.impl.TokenAuthorizerPropsBuilder_apigatewayImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link apigateway.impl.TokenAuthorizerPropsBuilder_apigatewayImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link apigateway.impl.TokenAuthorizerPropsBuilder_apigatewayImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TokenAuthorizerPropsBuilder_apigatewayImpl extends MinimalEObjectImpl.Container
		implements TokenAuthorizerPropsBuilder_apigateway {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.apigateway.TokenAuthorizerProps";
	 ...
	 * @generated
	 */
	protected TokenAuthorizerPropsBuilder_apigatewayImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ApigatewayPackage.Literals.TOKEN_AUTHORIZER_PROPS_BUILDER_APIGATEWAY;
	}
	...
	public void setIdentitySource_java_lang_String_(String newIdentitySource_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.TOKEN_AUTHORIZER_PROPS_BUILDER_APIGATEWAY__IDENTITY_SOURCE_JAVA_LANG_STRING_,
	...
	public void setValidationRegex_java_lang_String_(String newValidationRegex_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.TOKEN_AUTHORIZER_PROPS_BUILDER_APIGATEWAY__VALIDATION_REGEX_JAVA_LANG_STRING_,
	...
	public void setHandlerWithIFunction_software_amazon_awscdk_services_lambda_IFunction_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.TOKEN_AUTHORIZER_PROPS_BUILDER_APIGATEWAY__HANDLER_WITH_IFUNCTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_IFUNCTION_AS_REFERENCE,
	...
	public void setAssumeRoleWithIRole_software_amazon_awscdk_services_iam_IRole_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.TOKEN_AUTHORIZER_PROPS_BUILDER_APIGATEWAY__ASSUME_ROLE_WITH_IROLE_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IROLE_AS_REFERENCE,
	...
	public void setAuthorizerName_java_lang_String_(String newAuthorizerName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.TOKEN_AUTHORIZER_PROPS_BUILDER_APIGATEWAY__AUTHORIZER_NAME_JAVA_LANG_STRING_,
	...
	public void setResultsCacheTtlWithDuration_software_amazon_awscdk_core_Duration_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.TOKEN_AUTHORIZER_PROPS_BUILDER_APIGATEWAY__RESULTS_CACHE_TTL_WITH_DURATION_SOFTWARE_AMAZON_AWSCDK_CORE_DURATION_AS_REFERENCE,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.TOKEN_AUTHORIZER_PROPS_BUILDER_APIGATEWAY__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.TOKEN_AUTHORIZER_PROPS_BUILDER_APIGATEWAY__IDENTIFIER, oldIdentifier,
					identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.TOKEN_AUTHORIZER_PROPS_BUILDER_APIGATEWAY__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
...
} //TokenAuthorizerPropsBuilder_apigatewayImpl
