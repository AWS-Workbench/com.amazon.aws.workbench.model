...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Sql Server Se Instance Engine Props Builder rds</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.SqlServerSeInstanceEnginePropsBuilder_rdsImpl#getVersionWithSqlServerEngineVersion_software_amazon_awscdk_services_rds_SqlServerEngineVersion_AsReference <em>Version With Sql Server Engine Version software amazon awscdk services rds Sql Server Engine Version As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.SqlServerSeInstanceEnginePropsBuilder_rdsImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.SqlServerSeInstanceEnginePropsBuilder_rdsImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.SqlServerSeInstanceEnginePropsBuilder_rdsImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.SqlServerSeInstanceEnginePropsBuilder_rdsImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SqlServerSeInstanceEnginePropsBuilder_rdsImpl extends ServiceResourcesImpl
		implements SqlServerSeInstanceEnginePropsBuilder_rds {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.rds.SqlServerSeInstanceEngineProps";
	 ...
	 * @generated
	 */
	protected SqlServerSeInstanceEnginePropsBuilder_rdsImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AwsworkbenchPackage.Literals.SQL_SERVER_SE_INSTANCE_ENGINE_PROPS_BUILDER_RDS;
	}
	...
	public void setVersionWithSqlServerEngineVersion_software_amazon_awscdk_services_rds_SqlServerEngineVersion_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.SQL_SERVER_SE_INSTANCE_ENGINE_PROPS_BUILDER_RDS__VERSION_WITH_SQL_SERVER_ENGINE_VERSION_SOFTWARE_AMAZON_AWSCDK_SERVICES_RDS_SQL_SERVER_ENGINE_VERSION_AS_REFERENCE,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.SQL_SERVER_SE_INSTANCE_ENGINE_PROPS_BUILDER_RDS__VAR_NAME, oldVarName,
					varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.SQL_SERVER_SE_INSTANCE_ENGINE_PROPS_BUILDER_RDS__IDENTIFIER, oldIdentifier,
					identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.SQL_SERVER_SE_INSTANCE_ENGINE_PROPS_BUILDER_RDS__ADDITIONAL_CODE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case AwsworkbenchPackage.SQL_SERVER_SE_INSTANCE_ENGINE_PROPS_BUILDER_RDS__VERSION_WITH_SQL_SERVER_ENGINE_VERSION_SOFTWARE_AMAZON_AWSCDK_SERVICES_RDS_SQL_SERVER_ENGINE_VERSION_AS_REFERENCE:
			return getVersionWithSqlServerEngineVersion_software_amazon_awscdk_services_rds_SqlServerEngineVersion_AsReference();
		case AwsworkbenchPackage.SQL_SERVER_SE_INSTANCE_ENGINE_PROPS_BUILDER_RDS__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case AwsworkbenchPackage.SQL_SERVER_SE_INSTANCE_ENGINE_PROPS_BUILDER_RDS__VAR_NAME:
			return getVarName();
		case AwsworkbenchPackage.SQL_SERVER_SE_INSTANCE_ENGINE_PROPS_BUILDER_RDS__IDENTIFIER:
			return getIdentifier();
		case AwsworkbenchPackage.SQL_SERVER_SE_INSTANCE_ENGINE_PROPS_BUILDER_RDS__ADDITIONAL_CODE:
...
} //SqlServerSeInstanceEnginePropsBuilder_rdsImpl
