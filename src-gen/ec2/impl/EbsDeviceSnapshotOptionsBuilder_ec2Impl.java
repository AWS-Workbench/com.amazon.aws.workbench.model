...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Ebs Device Snapshot Options Builder ec2</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ec2.impl.EbsDeviceSnapshotOptionsBuilder_ec2Impl#getVolumeSize_java_lang_Number_ <em>Volume Size java lang Number </em>}</li>
 *   <li>{@link ec2.impl.EbsDeviceSnapshotOptionsBuilder_ec2Impl#getDeleteOnTermination_java_lang_Boolean_ <em>Delete On Termination java lang Boolean </em>}</li>
 *   <li>{@link ec2.impl.EbsDeviceSnapshotOptionsBuilder_ec2Impl#getIops_java_lang_Number_ <em>Iops java lang Number </em>}</li>
 *   <li>{@link ec2.impl.EbsDeviceSnapshotOptionsBuilder_ec2Impl#getVolumeType_software_amazon_awscdk_services_ec2_EbsDeviceVolumeType_ <em>Volume Type software amazon awscdk services ec2 Ebs Device Volume Type </em>}</li>
 *   <li>{@link ec2.impl.EbsDeviceSnapshotOptionsBuilder_ec2Impl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link ec2.impl.EbsDeviceSnapshotOptionsBuilder_ec2Impl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link ec2.impl.EbsDeviceSnapshotOptionsBuilder_ec2Impl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link ec2.impl.EbsDeviceSnapshotOptionsBuilder_ec2Impl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EbsDeviceSnapshotOptionsBuilder_ec2Impl extends MinimalEObjectImpl.Container
		implements EbsDeviceSnapshotOptionsBuilder_ec2 {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.ec2.EbsDeviceSnapshotOptions";
	 ...
	 * @generated
	 */
	protected EbsDeviceSnapshotOptionsBuilder_ec2Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Ec2Package.Literals.EBS_DEVICE_SNAPSHOT_OPTIONS_BUILDER_EC2;
	}
	...
	public void setVolumeSize_java_lang_Number_(int newVolumeSize_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.EBS_DEVICE_SNAPSHOT_OPTIONS_BUILDER_EC2__VOLUME_SIZE_JAVA_LANG_NUMBER_,
	...
	public void setDeleteOnTermination_java_lang_Boolean_(Boolean newDeleteOnTermination_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.EBS_DEVICE_SNAPSHOT_OPTIONS_BUILDER_EC2__DELETE_ON_TERMINATION_JAVA_LANG_BOOLEAN_,
	...
	public void setIops_java_lang_Number_(int newIops_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.EBS_DEVICE_SNAPSHOT_OPTIONS_BUILDER_EC2__IOPS_JAVA_LANG_NUMBER_,
	...
	public void setVolumeType_software_amazon_awscdk_services_ec2_EbsDeviceVolumeType_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.EBS_DEVICE_SNAPSHOT_OPTIONS_BUILDER_EC2__VOLUME_TYPE_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_EBS_DEVICE_VOLUME_TYPE_,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.EBS_DEVICE_SNAPSHOT_OPTIONS_BUILDER_EC2__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.EBS_DEVICE_SNAPSHOT_OPTIONS_BUILDER_EC2__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.EBS_DEVICE_SNAPSHOT_OPTIONS_BUILDER_EC2__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Ec2Package.EBS_DEVICE_SNAPSHOT_OPTIONS_BUILDER_EC2__VOLUME_SIZE_JAVA_LANG_NUMBER_:
			return getVolumeSize_java_lang_Number_();
		case Ec2Package.EBS_DEVICE_SNAPSHOT_OPTIONS_BUILDER_EC2__DELETE_ON_TERMINATION_JAVA_LANG_BOOLEAN_:
			return getDeleteOnTermination_java_lang_Boolean_();
		case Ec2Package.EBS_DEVICE_SNAPSHOT_OPTIONS_BUILDER_EC2__IOPS_JAVA_LANG_NUMBER_:
			return getIops_java_lang_Number_();
		case Ec2Package.EBS_DEVICE_SNAPSHOT_OPTIONS_BUILDER_EC2__VOLUME_TYPE_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_EBS_DEVICE_VOLUME_TYPE_:
			return getVolumeType_software_amazon_awscdk_services_ec2_EbsDeviceVolumeType_();
		case Ec2Package.EBS_DEVICE_SNAPSHOT_OPTIONS_BUILDER_EC2__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case Ec2Package.EBS_DEVICE_SNAPSHOT_OPTIONS_BUILDER_EC2__VAR_NAME:
			return getVarName();
		case Ec2Package.EBS_DEVICE_SNAPSHOT_OPTIONS_BUILDER_EC2__IDENTIFIER:
			return getIdentifier();
		case Ec2Package.EBS_DEVICE_SNAPSHOT_OPTIONS_BUILDER_EC2__ADDITIONAL_CODE:
...
} //EbsDeviceSnapshotOptionsBuilder_ec2Impl
