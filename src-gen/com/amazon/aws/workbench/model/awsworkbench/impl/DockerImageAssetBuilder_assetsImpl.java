...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Docker Image Asset Builder assets</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.DockerImageAssetBuilder_assetsImpl#getExclude_java_lang_String_AsList <em>Exclude java lang String As List</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.DockerImageAssetBuilder_assetsImpl#getFollow_software_amazon_awscdk_assets_FollowMode_ <em>Follow software amazon awscdk assets Follow Mode </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.DockerImageAssetBuilder_assetsImpl#getExtraHash_java_lang_String_ <em>Extra Hash java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.DockerImageAssetBuilder_assetsImpl#getBuildArgs_java_lang_String__java_lang_String_AsMap <em>Build Args java lang String java lang String As Map</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.DockerImageAssetBuilder_assetsImpl#getFile_java_lang_String_ <em>File java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.DockerImageAssetBuilder_assetsImpl#getRepositoryName_java_lang_String_ <em>Repository Name java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.DockerImageAssetBuilder_assetsImpl#getTarget_java_lang_String_ <em>Target java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.DockerImageAssetBuilder_assetsImpl#getDirectory_java_lang_String_ <em>Directory java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.DockerImageAssetBuilder_assetsImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.DockerImageAssetBuilder_assetsImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.DockerImageAssetBuilder_assetsImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.DockerImageAssetBuilder_assetsImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DockerImageAssetBuilder_assetsImpl extends ServiceResourcesImpl implements DockerImageAssetBuilder_assets {
	...
	/**
	 * The default value of the '{@link #getDirectory_java_lang_String_() <em>Directory java lang String </em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected static final String DIRECTORY_JAVA_LANG_STRING__EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getDirectory_java_lang_String_() <em>Directory java lang String </em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getDirectory_java_lang_String_()
	 * @generated
	 * @ordered
	 */
	protected String directory_java_lang_String_ = DIRECTORY_JAVA_LANG_STRING__EDEFAULT;
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.ecr.assets.DockerImageAsset";
	 ...
	 * @generated
	 */
	protected DockerImageAssetBuilder_assetsImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AwsworkbenchPackage.Literals.DOCKER_IMAGE_ASSET_BUILDER_ASSETS;
	}
	...
	public void setExclude_java_lang_String_AsList(String newExclude_java_lang_String_AsList) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.DOCKER_IMAGE_ASSET_BUILDER_ASSETS__EXCLUDE_JAVA_LANG_STRING_AS_LIST,
	...
	public void setFollow_software_amazon_awscdk_assets_FollowMode_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.DOCKER_IMAGE_ASSET_BUILDER_ASSETS__FOLLOW_SOFTWARE_AMAZON_AWSCDK_ASSETS_FOLLOW_MODE_,
	...
	public void setExtraHash_java_lang_String_(String newExtraHash_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.DOCKER_IMAGE_ASSET_BUILDER_ASSETS__EXTRA_HASH_JAVA_LANG_STRING_,
	...
	public void setBuildArgs_java_lang_String__java_lang_String_AsMap(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.DOCKER_IMAGE_ASSET_BUILDER_ASSETS__BUILD_ARGS_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP,
	...
	public void setFile_java_lang_String_(String newFile_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.DOCKER_IMAGE_ASSET_BUILDER_ASSETS__FILE_JAVA_LANG_STRING_,
					oldFile_java_lang_String_, file_java_lang_String_));
	}
	...
	public void setRepositoryName_java_lang_String_(String newRepositoryName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.DOCKER_IMAGE_ASSET_BUILDER_ASSETS__REPOSITORY_NAME_JAVA_LANG_STRING_,
	...
	public void setTarget_java_lang_String_(String newTarget_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.DOCKER_IMAGE_ASSET_BUILDER_ASSETS__TARGET_JAVA_LANG_STRING_,
					oldTarget_java_lang_String_, target_java_lang_String_));
	}
	 ...
	 */
	@Override
	public String getDirectory_java_lang_String_() {
		return directory_java_lang_String_;
	}
	 ...
	 */
	@Override
	public void setDirectory_java_lang_String_(String newDirectory_java_lang_String_) {
		String oldDirectory_java_lang_String_ = directory_java_lang_String_;
		directory_java_lang_String_ = newDirectory_java_lang_String_;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.DOCKER_IMAGE_ASSET_BUILDER_ASSETS__DIRECTORY_JAVA_LANG_STRING_,
					oldDirectory_java_lang_String_, directory_java_lang_String_));
	}
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.DOCKER_IMAGE_ASSET_BUILDER_ASSETS__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.DOCKER_IMAGE_ASSET_BUILDER_ASSETS__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.DOCKER_IMAGE_ASSET_BUILDER_ASSETS__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case AwsworkbenchPackage.DOCKER_IMAGE_ASSET_BUILDER_ASSETS__DIRECTORY_JAVA_LANG_STRING_:
			return getDirectory_java_lang_String_();
	...
	public void eSet(int featureID, Object newValue) {
		...
		case AwsworkbenchPackage.DOCKER_IMAGE_ASSET_BUILDER_ASSETS__TARGET_JAVA_LANG_STRING_:
			...
			return;
		case AwsworkbenchPackage.DOCKER_IMAGE_ASSET_BUILDER_ASSETS__DIRECTORY_JAVA_LANG_STRING_:
			setDirectory_java_lang_String_((String) newValue);
			return;
		case AwsworkbenchPackage.DOCKER_IMAGE_ASSET_BUILDER_ASSETS__VAR_NAME:
	...
	public void eUnset(int featureID) {
		...
		case AwsworkbenchPackage.DOCKER_IMAGE_ASSET_BUILDER_ASSETS__TARGET_JAVA_LANG_STRING_:
			...
			return;
		case AwsworkbenchPackage.DOCKER_IMAGE_ASSET_BUILDER_ASSETS__DIRECTORY_JAVA_LANG_STRING_:
			setDirectory_java_lang_String_(DIRECTORY_JAVA_LANG_STRING__EDEFAULT);
			return;
		case AwsworkbenchPackage.DOCKER_IMAGE_ASSET_BUILDER_ASSETS__VAR_NAME:
	...
	public boolean eIsSet(int featureID) {
		...
		case AwsworkbenchPackage.DOCKER_IMAGE_ASSET_BUILDER_ASSETS__DIRECTORY_JAVA_LANG_STRING_:
			return DIRECTORY_JAVA_LANG_STRING__EDEFAULT == null ? directory_java_lang_String_ != null
					: !DIRECTORY_JAVA_LANG_STRING__EDEFAULT.equals(directory_java_lang_String_);
		case AwsworkbenchPackage.DOCKER_IMAGE_ASSET_BUILDER_ASSETS__GENERATED_CLASS_NAME:
	...
	public String toString() {
		...
		result.append(target_java_lang_String_);
		result.append(", directory_java_lang_String_: ");
		result.append(directory_java_lang_String_);
...
} //DockerImageAssetBuilder_assetsImpl
