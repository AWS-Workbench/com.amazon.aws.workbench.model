...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Vpn Connection Props Builder ec2</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ec2.impl.VpnConnectionPropsBuilder_ec2Impl#getVpcWithIVpc_software_amazon_awscdk_services_ec2_IVpc_AsReference <em>Vpc With IVpc software amazon awscdk services ec2 IVpc As Reference</em>}</li>
 *   <li>{@link ec2.impl.VpnConnectionPropsBuilder_ec2Impl#getIp_java_lang_String_ <em>Ip java lang String </em>}</li>
 *   <li>{@link ec2.impl.VpnConnectionPropsBuilder_ec2Impl#getAsn_java_lang_Number_ <em>Asn java lang Number </em>}</li>
 *   <li>{@link ec2.impl.VpnConnectionPropsBuilder_ec2Impl#getStaticRoutes_java_lang_String_AsList <em>Static Routes java lang String As List</em>}</li>
 *   <li>{@link ec2.impl.VpnConnectionPropsBuilder_ec2Impl#getTunnelOptions_software_amazon_awscdk_services_ec2_VpnTunnelOption_AsList <em>Tunnel Options software amazon awscdk services ec2 Vpn Tunnel Option As List</em>}</li>
 *   <li>{@link ec2.impl.VpnConnectionPropsBuilder_ec2Impl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link ec2.impl.VpnConnectionPropsBuilder_ec2Impl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link ec2.impl.VpnConnectionPropsBuilder_ec2Impl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link ec2.impl.VpnConnectionPropsBuilder_ec2Impl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VpnConnectionPropsBuilder_ec2Impl extends MinimalEObjectImpl.Container
		implements VpnConnectionPropsBuilder_ec2 {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.ec2.VpnConnectionProps";
	 ...
	 * @generated
	 */
	protected VpnConnectionPropsBuilder_ec2Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Ec2Package.Literals.VPN_CONNECTION_PROPS_BUILDER_EC2;
	}
	...
	public void setVpcWithIVpc_software_amazon_awscdk_services_ec2_IVpc_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPN_CONNECTION_PROPS_BUILDER_EC2__VPC_WITH_IVPC_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_IVPC_AS_REFERENCE,
	...
	public void setIp_java_lang_String_(String newIp_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPN_CONNECTION_PROPS_BUILDER_EC2__IP_JAVA_LANG_STRING_, oldIp_java_lang_String_,
	...
	public void setAsn_java_lang_Number_(int newAsn_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPN_CONNECTION_PROPS_BUILDER_EC2__ASN_JAVA_LANG_NUMBER_, oldAsn_java_lang_Number_,
	...
	public void setStaticRoutes_java_lang_String_AsList(String newStaticRoutes_java_lang_String_AsList) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPN_CONNECTION_PROPS_BUILDER_EC2__STATIC_ROUTES_JAVA_LANG_STRING_AS_LIST,
	...
	public void setTunnelOptions_software_amazon_awscdk_services_ec2_VpnTunnelOption_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPN_CONNECTION_PROPS_BUILDER_EC2__TUNNEL_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_VPN_TUNNEL_OPTION_AS_LIST,
	...
	public void setVarName(String newVarName) {
		...
		varName = newVarName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Ec2Package.VPN_CONNECTION_PROPS_BUILDER_EC2__VAR_NAME,
					oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPN_CONNECTION_PROPS_BUILDER_EC2__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.VPN_CONNECTION_PROPS_BUILDER_EC2__ADDITIONAL_CODE, oldAdditionalCode, additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Ec2Package.VPN_CONNECTION_PROPS_BUILDER_EC2__VPC_WITH_IVPC_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_IVPC_AS_REFERENCE:
			return getVpcWithIVpc_software_amazon_awscdk_services_ec2_IVpc_AsReference();
		case Ec2Package.VPN_CONNECTION_PROPS_BUILDER_EC2__IP_JAVA_LANG_STRING_:
			return getIp_java_lang_String_();
		case Ec2Package.VPN_CONNECTION_PROPS_BUILDER_EC2__ASN_JAVA_LANG_NUMBER_:
			return getAsn_java_lang_Number_();
		case Ec2Package.VPN_CONNECTION_PROPS_BUILDER_EC2__STATIC_ROUTES_JAVA_LANG_STRING_AS_LIST:
			return getStaticRoutes_java_lang_String_AsList();
		case Ec2Package.VPN_CONNECTION_PROPS_BUILDER_EC2__TUNNEL_OPTIONS_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_VPN_TUNNEL_OPTION_AS_LIST:
			return getTunnelOptions_software_amazon_awscdk_services_ec2_VpnTunnelOption_AsList();
		case Ec2Package.VPN_CONNECTION_PROPS_BUILDER_EC2__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case Ec2Package.VPN_CONNECTION_PROPS_BUILDER_EC2__VAR_NAME:
			return getVarName();
		case Ec2Package.VPN_CONNECTION_PROPS_BUILDER_EC2__IDENTIFIER:
			return getIdentifier();
		case Ec2Package.VPN_CONNECTION_PROPS_BUILDER_EC2__ADDITIONAL_CODE:
...
} //VpnConnectionPropsBuilder_ec2Impl
