...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Gateway Vpc Endpoint Options Builder ec2</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ec2.impl.GatewayVpcEndpointOptionsBuilder_ec2Impl#getServiceWithIGatewayVpcEndpointService_software_amazon_awscdk_services_ec2_IGatewayVpcEndpointService_AsReference <em>Service With IGateway Vpc Endpoint Service software amazon awscdk services ec2 IGateway Vpc Endpoint Service As Reference</em>}</li>
 *   <li>{@link ec2.impl.GatewayVpcEndpointOptionsBuilder_ec2Impl#getSubnets_software_amazon_awscdk_services_ec2_SubnetSelection_AsList <em>Subnets software amazon awscdk services ec2 Subnet Selection As List</em>}</li>
 *   <li>{@link ec2.impl.GatewayVpcEndpointOptionsBuilder_ec2Impl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link ec2.impl.GatewayVpcEndpointOptionsBuilder_ec2Impl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link ec2.impl.GatewayVpcEndpointOptionsBuilder_ec2Impl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link ec2.impl.GatewayVpcEndpointOptionsBuilder_ec2Impl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GatewayVpcEndpointOptionsBuilder_ec2Impl extends MinimalEObjectImpl.Container
		implements GatewayVpcEndpointOptionsBuilder_ec2 {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.ec2.GatewayVpcEndpointOptions";
	 ...
	 * @generated
	 */
	protected GatewayVpcEndpointOptionsBuilder_ec2Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Ec2Package.Literals.GATEWAY_VPC_ENDPOINT_OPTIONS_BUILDER_EC2;
	}
	...
	public void setServiceWithIGatewayVpcEndpointService_software_amazon_awscdk_services_ec2_IGatewayVpcEndpointService_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.GATEWAY_VPC_ENDPOINT_OPTIONS_BUILDER_EC2__SERVICE_WITH_IGATEWAY_VPC_ENDPOINT_SERVICE_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_IGATEWAY_VPC_ENDPOINT_SERVICE_AS_REFERENCE,
	...
	public void setSubnets_software_amazon_awscdk_services_ec2_SubnetSelection_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.GATEWAY_VPC_ENDPOINT_OPTIONS_BUILDER_EC2__SUBNETS_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_SUBNET_SELECTION_AS_LIST,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.GATEWAY_VPC_ENDPOINT_OPTIONS_BUILDER_EC2__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.GATEWAY_VPC_ENDPOINT_OPTIONS_BUILDER_EC2__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.GATEWAY_VPC_ENDPOINT_OPTIONS_BUILDER_EC2__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Ec2Package.GATEWAY_VPC_ENDPOINT_OPTIONS_BUILDER_EC2__SERVICE_WITH_IGATEWAY_VPC_ENDPOINT_SERVICE_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_IGATEWAY_VPC_ENDPOINT_SERVICE_AS_REFERENCE:
		...
		case Ec2Package.GATEWAY_VPC_ENDPOINT_OPTIONS_BUILDER_EC2__SUBNETS_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_SUBNET_SELECTION_AS_LIST:
			return getSubnets_software_amazon_awscdk_services_ec2_SubnetSelection_AsList();
		case Ec2Package.GATEWAY_VPC_ENDPOINT_OPTIONS_BUILDER_EC2__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case Ec2Package.GATEWAY_VPC_ENDPOINT_OPTIONS_BUILDER_EC2__VAR_NAME:
			return getVarName();
		case Ec2Package.GATEWAY_VPC_ENDPOINT_OPTIONS_BUILDER_EC2__IDENTIFIER:
			return getIdentifier();
		case Ec2Package.GATEWAY_VPC_ENDPOINT_OPTIONS_BUILDER_EC2__ADDITIONAL_CODE:
...
} //GatewayVpcEndpointOptionsBuilder_ec2Impl
