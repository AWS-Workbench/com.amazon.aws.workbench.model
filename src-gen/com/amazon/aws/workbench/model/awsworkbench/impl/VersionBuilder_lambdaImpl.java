...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Version Builder lambda</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.VersionBuilder_lambdaImpl#getMaxEventAgeWithDuration_software_amazon_awscdk_core_Duration_AsReference <em>Max Event Age With Duration software amazon awscdk core Duration As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.VersionBuilder_lambdaImpl#getOnFailureWithIDestination_software_amazon_awscdk_services_lambda_IDestination_AsReference <em>On Failure With IDestination software amazon awscdk services lambda IDestination As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.VersionBuilder_lambdaImpl#getOnSuccessWithIDestination_software_amazon_awscdk_services_lambda_IDestination_AsReference <em>On Success With IDestination software amazon awscdk services lambda IDestination As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.VersionBuilder_lambdaImpl#getRetryAttempts_java_lang_Number_ <em>Retry Attempts java lang Number </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.VersionBuilder_lambdaImpl#getCodeSha256_java_lang_String_ <em>Code Sha256 java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.VersionBuilder_lambdaImpl#getDescription_java_lang_String_ <em>Description java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.VersionBuilder_lambdaImpl#getProvisionedConcurrentExecutions_java_lang_Number_ <em>Provisioned Concurrent Executions java lang Number </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.VersionBuilder_lambdaImpl#getRemovalPolicy_software_amazon_awscdk_core_RemovalPolicy_ <em>Removal Policy software amazon awscdk core Removal Policy </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.VersionBuilder_lambdaImpl#getLambdaWithIFunction_software_amazon_awscdk_services_lambda_IFunction_AsReference <em>Lambda With IFunction software amazon awscdk services lambda IFunction As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.VersionBuilder_lambdaImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.VersionBuilder_lambdaImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.VersionBuilder_lambdaImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.VersionBuilder_lambdaImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VersionBuilder_lambdaImpl extends MinimalEObjectImpl.Container implements VersionBuilder_lambda {
	/**
	...
	/**
	 * The default value of the '{@link #getLambdaWithIFunction_software_amazon_awscdk_services_lambda_IFunction_AsReference() <em>Lambda With IFunction software amazon awscdk services lambda IFunction As Reference</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @ordered
	 */
	protected static final String LAMBDA_WITH_IFUNCTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_IFUNCTION_AS_REFERENCE_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getLambdaWithIFunction_software_amazon_awscdk_services_lambda_IFunction_AsReference() <em>Lambda With IFunction software amazon awscdk services lambda IFunction As Reference</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getLambdaWithIFunction_software_amazon_awscdk_services_lambda_IFunction_AsReference()
	 * @generated
	 * @ordered
	 */
	protected String lambdaWithIFunction_software_amazon_awscdk_services_lambda_IFunction_AsReference = LAMBDA_WITH_IFUNCTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_IFUNCTION_AS_REFERENCE_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.lambda.Version";
	 ...
	 * @generated
	 */
	protected VersionBuilder_lambdaImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AwsworkbenchPackage.Literals.VERSION_BUILDER_LAMBDA;
	}
	...
	public void setMaxEventAgeWithDuration_software_amazon_awscdk_core_Duration_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.VERSION_BUILDER_LAMBDA__MAX_EVENT_AGE_WITH_DURATION_SOFTWARE_AMAZON_AWSCDK_CORE_DURATION_AS_REFERENCE,
	...
	public void setOnFailureWithIDestination_software_amazon_awscdk_services_lambda_IDestination_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.VERSION_BUILDER_LAMBDA__ON_FAILURE_WITH_IDESTINATION_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_IDESTINATION_AS_REFERENCE,
	...
	public void setOnSuccessWithIDestination_software_amazon_awscdk_services_lambda_IDestination_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.VERSION_BUILDER_LAMBDA__ON_SUCCESS_WITH_IDESTINATION_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_IDESTINATION_AS_REFERENCE,
	...
	public void setRetryAttempts_java_lang_Number_(int newRetryAttempts_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.VERSION_BUILDER_LAMBDA__RETRY_ATTEMPTS_JAVA_LANG_NUMBER_,
	...
	public void setCodeSha256_java_lang_String_(String newCodeSha256_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.VERSION_BUILDER_LAMBDA__CODE_SHA256_JAVA_LANG_STRING_,
	...
	public void setDescription_java_lang_String_(String newDescription_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.VERSION_BUILDER_LAMBDA__DESCRIPTION_JAVA_LANG_STRING_,
	...
	public void setProvisionedConcurrentExecutions_java_lang_Number_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.VERSION_BUILDER_LAMBDA__PROVISIONED_CONCURRENT_EXECUTIONS_JAVA_LANG_NUMBER_,
	...
	public void setRemovalPolicy_software_amazon_awscdk_core_RemovalPolicy_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.VERSION_BUILDER_LAMBDA__REMOVAL_POLICY_SOFTWARE_AMAZON_AWSCDK_CORE_REMOVAL_POLICY_,
	 ...
	 */
	@Override
	public String getLambdaWithIFunction_software_amazon_awscdk_services_lambda_IFunction_AsReference() {
		return lambdaWithIFunction_software_amazon_awscdk_services_lambda_IFunction_AsReference;
	}
	 ...
	 */
	@Override
	public void setLambdaWithIFunction_software_amazon_awscdk_services_lambda_IFunction_AsReference(
			String newLambdaWithIFunction_software_amazon_awscdk_services_lambda_IFunction_AsReference) {
		String oldLambdaWithIFunction_software_amazon_awscdk_services_lambda_IFunction_AsReference = lambdaWithIFunction_software_amazon_awscdk_services_lambda_IFunction_AsReference;
		lambdaWithIFunction_software_amazon_awscdk_services_lambda_IFunction_AsReference = newLambdaWithIFunction_software_amazon_awscdk_services_lambda_IFunction_AsReference;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.VERSION_BUILDER_LAMBDA__LAMBDA_WITH_IFUNCTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_IFUNCTION_AS_REFERENCE,
					oldLambdaWithIFunction_software_amazon_awscdk_services_lambda_IFunction_AsReference,
					lambdaWithIFunction_software_amazon_awscdk_services_lambda_IFunction_AsReference));
	}
	...
	public void setVarName(String newVarName) {
		...
		varName = newVarName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AwsworkbenchPackage.VERSION_BUILDER_LAMBDA__VAR_NAME,
					oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.VERSION_BUILDER_LAMBDA__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.VERSION_BUILDER_LAMBDA__ADDITIONAL_CODE, oldAdditionalCode, additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case AwsworkbenchPackage.VERSION_BUILDER_LAMBDA__LAMBDA_WITH_IFUNCTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_IFUNCTION_AS_REFERENCE:
			return getLambdaWithIFunction_software_amazon_awscdk_services_lambda_IFunction_AsReference();
	...
	public void eSet(int featureID, Object newValue) {
		...
		case AwsworkbenchPackage.VERSION_BUILDER_LAMBDA__REMOVAL_POLICY_SOFTWARE_AMAZON_AWSCDK_CORE_REMOVAL_POLICY_:
			...
			return;
		case AwsworkbenchPackage.VERSION_BUILDER_LAMBDA__LAMBDA_WITH_IFUNCTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_IFUNCTION_AS_REFERENCE:
			setLambdaWithIFunction_software_amazon_awscdk_services_lambda_IFunction_AsReference((String) newValue);
			return;
		case AwsworkbenchPackage.VERSION_BUILDER_LAMBDA__VAR_NAME:
	...
	public void eUnset(int featureID) {
		...
		case AwsworkbenchPackage.VERSION_BUILDER_LAMBDA__REMOVAL_POLICY_SOFTWARE_AMAZON_AWSCDK_CORE_REMOVAL_POLICY_:
			...
			return;
		case AwsworkbenchPackage.VERSION_BUILDER_LAMBDA__LAMBDA_WITH_IFUNCTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_IFUNCTION_AS_REFERENCE:
			setLambdaWithIFunction_software_amazon_awscdk_services_lambda_IFunction_AsReference(
					LAMBDA_WITH_IFUNCTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_IFUNCTION_AS_REFERENCE_EDEFAULT);
			return;
		case AwsworkbenchPackage.VERSION_BUILDER_LAMBDA__VAR_NAME:
	...
	public boolean eIsSet(int featureID) {
		...
		case AwsworkbenchPackage.VERSION_BUILDER_LAMBDA__LAMBDA_WITH_IFUNCTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_IFUNCTION_AS_REFERENCE:
			return LAMBDA_WITH_IFUNCTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_IFUNCTION_AS_REFERENCE_EDEFAULT == null
					? lambdaWithIFunction_software_amazon_awscdk_services_lambda_IFunction_AsReference != null
					: !LAMBDA_WITH_IFUNCTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_LAMBDA_IFUNCTION_AS_REFERENCE_EDEFAULT
							.equals(lambdaWithIFunction_software_amazon_awscdk_services_lambda_IFunction_AsReference);
		case AwsworkbenchPackage.VERSION_BUILDER_LAMBDA__GENERATED_CLASS_NAME:
	...
	public String toString() {
		...
		result.append(removalPolicy_software_amazon_awscdk_core_RemovalPolicy_);
		result.append(", lambdaWithIFunction_software_amazon_awscdk_services_lambda_IFunction_AsReference: ");
		result.append(lambdaWithIFunction_software_amazon_awscdk_services_lambda_IFunction_AsReference);
