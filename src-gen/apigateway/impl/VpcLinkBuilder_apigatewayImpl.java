...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Vpc Link Builder apigateway</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link apigateway.impl.VpcLinkBuilder_apigatewayImpl#getDescription_java_lang_String_ <em>Description java lang String </em>}</li>
 *   <li>{@link apigateway.impl.VpcLinkBuilder_apigatewayImpl#getTargets_software_amazon_awscdk_services_elasticloadbalancingv2_INetworkLoadBalancer_AsList <em>Targets software amazon awscdk services elasticloadbalancingv2 INetwork Load Balancer As List</em>}</li>
 *   <li>{@link apigateway.impl.VpcLinkBuilder_apigatewayImpl#getVpcLinkName_java_lang_String_ <em>Vpc Link Name java lang String </em>}</li>
 *   <li>{@link apigateway.impl.VpcLinkBuilder_apigatewayImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link apigateway.impl.VpcLinkBuilder_apigatewayImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link apigateway.impl.VpcLinkBuilder_apigatewayImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link apigateway.impl.VpcLinkBuilder_apigatewayImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VpcLinkBuilder_apigatewayImpl extends MinimalEObjectImpl.Container implements VpcLinkBuilder_apigateway {
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.apigateway.VpcLink";
	 ...
	 * @generated
	 */
	protected VpcLinkBuilder_apigatewayImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ApigatewayPackage.Literals.VPC_LINK_BUILDER_APIGATEWAY;
	}
	...
	public void setDescription_java_lang_String_(String newDescription_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.VPC_LINK_BUILDER_APIGATEWAY__DESCRIPTION_JAVA_LANG_STRING_,
	...
	public void setTargets_software_amazon_awscdk_services_elasticloadbalancingv2_INetworkLoadBalancer_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.VPC_LINK_BUILDER_APIGATEWAY__TARGETS_SOFTWARE_AMAZON_AWSCDK_SERVICES_ELASTICLOADBALANCINGV2_INETWORK_LOAD_BALANCER_AS_LIST,
	...
	public void setVpcLinkName_java_lang_String_(String newVpcLinkName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.VPC_LINK_BUILDER_APIGATEWAY__VPC_LINK_NAME_JAVA_LANG_STRING_,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.VPC_LINK_BUILDER_APIGATEWAY__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.VPC_LINK_BUILDER_APIGATEWAY__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.VPC_LINK_BUILDER_APIGATEWAY__ADDITIONAL_CODE, oldAdditionalCode, additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ApigatewayPackage.VPC_LINK_BUILDER_APIGATEWAY__DESCRIPTION_JAVA_LANG_STRING_:
			return getDescription_java_lang_String_();
		case ApigatewayPackage.VPC_LINK_BUILDER_APIGATEWAY__TARGETS_SOFTWARE_AMAZON_AWSCDK_SERVICES_ELASTICLOADBALANCINGV2_INETWORK_LOAD_BALANCER_AS_LIST:
			return getTargets_software_amazon_awscdk_services_elasticloadbalancingv2_INetworkLoadBalancer_AsList();
		case ApigatewayPackage.VPC_LINK_BUILDER_APIGATEWAY__VPC_LINK_NAME_JAVA_LANG_STRING_:
			return getVpcLinkName_java_lang_String_();
		case ApigatewayPackage.VPC_LINK_BUILDER_APIGATEWAY__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case ApigatewayPackage.VPC_LINK_BUILDER_APIGATEWAY__VAR_NAME:
			return getVarName();
		case ApigatewayPackage.VPC_LINK_BUILDER_APIGATEWAY__IDENTIFIER:
			return getIdentifier();
		case ApigatewayPackage.VPC_LINK_BUILDER_APIGATEWAY__ADDITIONAL_CODE:
