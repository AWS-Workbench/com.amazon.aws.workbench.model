...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Request Validator Props Builder apigateway</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link apigateway.impl.RequestValidatorPropsBuilder_apigatewayImpl#getRestApiWithIRestApi_software_amazon_awscdk_services_apigateway_IRestApi_AsReference <em>Rest Api With IRest Api software amazon awscdk services apigateway IRest Api As Reference</em>}</li>
 *   <li>{@link apigateway.impl.RequestValidatorPropsBuilder_apigatewayImpl#getRequestValidatorName_java_lang_String_ <em>Request Validator Name java lang String </em>}</li>
 *   <li>{@link apigateway.impl.RequestValidatorPropsBuilder_apigatewayImpl#getValidateRequestBody_java_lang_Boolean_ <em>Validate Request Body java lang Boolean </em>}</li>
 *   <li>{@link apigateway.impl.RequestValidatorPropsBuilder_apigatewayImpl#getValidateRequestParameters_java_lang_Boolean_ <em>Validate Request Parameters java lang Boolean </em>}</li>
 *   <li>{@link apigateway.impl.RequestValidatorPropsBuilder_apigatewayImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link apigateway.impl.RequestValidatorPropsBuilder_apigatewayImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link apigateway.impl.RequestValidatorPropsBuilder_apigatewayImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link apigateway.impl.RequestValidatorPropsBuilder_apigatewayImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequestValidatorPropsBuilder_apigatewayImpl extends MinimalEObjectImpl.Container
		implements RequestValidatorPropsBuilder_apigateway {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.apigateway.RequestValidatorProps";
	 ...
	 * @generated
	 */
	protected RequestValidatorPropsBuilder_apigatewayImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ApigatewayPackage.Literals.REQUEST_VALIDATOR_PROPS_BUILDER_APIGATEWAY;
	}
	...
	public void setRestApiWithIRestApi_software_amazon_awscdk_services_apigateway_IRestApi_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.REQUEST_VALIDATOR_PROPS_BUILDER_APIGATEWAY__REST_API_WITH_IREST_API_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_IREST_API_AS_REFERENCE,
	...
	public void setRequestValidatorName_java_lang_String_(String newRequestValidatorName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.REQUEST_VALIDATOR_PROPS_BUILDER_APIGATEWAY__REQUEST_VALIDATOR_NAME_JAVA_LANG_STRING_,
	...
	public void setValidateRequestBody_java_lang_Boolean_(Boolean newValidateRequestBody_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.REQUEST_VALIDATOR_PROPS_BUILDER_APIGATEWAY__VALIDATE_REQUEST_BODY_JAVA_LANG_BOOLEAN_,
	...
	public void setValidateRequestParameters_java_lang_Boolean_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.REQUEST_VALIDATOR_PROPS_BUILDER_APIGATEWAY__VALIDATE_REQUEST_PARAMETERS_JAVA_LANG_BOOLEAN_,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.REQUEST_VALIDATOR_PROPS_BUILDER_APIGATEWAY__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.REQUEST_VALIDATOR_PROPS_BUILDER_APIGATEWAY__IDENTIFIER, oldIdentifier,
					identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.REQUEST_VALIDATOR_PROPS_BUILDER_APIGATEWAY__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
...
} //RequestValidatorPropsBuilder_apigatewayImpl
