 ...
 * </p>
 * <ul>
 *   <li>{@link apigateway.impl.MethodResponseBuilder_apigatewayImpl#getStatusCode_java_lang_String_ <em>Status Code java lang String </em>}</li>
 *   <li>{@link apigateway.impl.MethodResponseBuilder_apigatewayImpl#getResponseModels_java_lang_String__software_amazon_awscdk_services_apigateway_IModel_AsMap <em>Response Models java lang String software amazon awscdk services apigateway IModel As Map</em>}</li>
 *   <li>{@link apigateway.impl.MethodResponseBuilder_apigatewayImpl#getResponseParameters_java_lang_String__java_lang_Boolean_AsMap <em>Response Parameters java lang String java lang Boolean As Map</em>}</li>
 *   <li>{@link apigateway.impl.MethodResponseBuilder_apigatewayImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link apigateway.impl.MethodResponseBuilder_apigatewayImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link apigateway.impl.MethodResponseBuilder_apigatewayImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link apigateway.impl.MethodResponseBuilder_apigatewayImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MethodResponseBuilder_apigatewayImpl extends MinimalEObjectImpl.Container
	...
	protected EClass eStaticClass() {
		return ApigatewayPackage.Literals.METHOD_RESPONSE_BUILDER_APIGATEWAY;
	}
	...
	public void setStatusCode_java_lang_String_(String newStatusCode_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.METHOD_RESPONSE_BUILDER_APIGATEWAY__STATUS_CODE_JAVA_LANG_STRING_,
	...
	public void setResponseModels_java_lang_String__software_amazon_awscdk_services_apigateway_IModel_AsMap(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.METHOD_RESPONSE_BUILDER_APIGATEWAY__RESPONSE_MODELS_JAVA_LANG_STRING_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_IMODEL_AS_MAP,
	...
	public void setResponseParameters_java_lang_String__java_lang_Boolean_AsMap(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.METHOD_RESPONSE_BUILDER_APIGATEWAY__RESPONSE_PARAMETERS_JAVA_LANG_STRING_JAVA_LANG_BOOLEAN_AS_MAP,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.METHOD_RESPONSE_BUILDER_APIGATEWAY__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.METHOD_RESPONSE_BUILDER_APIGATEWAY__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.METHOD_RESPONSE_BUILDER_APIGATEWAY__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ApigatewayPackage.METHOD_RESPONSE_BUILDER_APIGATEWAY__STATUS_CODE_JAVA_LANG_STRING_:
			return getStatusCode_java_lang_String_();
		case ApigatewayPackage.METHOD_RESPONSE_BUILDER_APIGATEWAY__RESPONSE_MODELS_JAVA_LANG_STRING_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_IMODEL_AS_MAP:
			return getResponseModels_java_lang_String__software_amazon_awscdk_services_apigateway_IModel_AsMap();
		case ApigatewayPackage.METHOD_RESPONSE_BUILDER_APIGATEWAY__RESPONSE_PARAMETERS_JAVA_LANG_STRING_JAVA_LANG_BOOLEAN_AS_MAP:
			return getResponseParameters_java_lang_String__java_lang_Boolean_AsMap();
		case ApigatewayPackage.METHOD_RESPONSE_BUILDER_APIGATEWAY__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case ApigatewayPackage.METHOD_RESPONSE_BUILDER_APIGATEWAY__VAR_NAME:
			return getVarName();
		case ApigatewayPackage.METHOD_RESPONSE_BUILDER_APIGATEWAY__IDENTIFIER:
			return getIdentifier();
		case ApigatewayPackage.METHOD_RESPONSE_BUILDER_APIGATEWAY__ADDITIONAL_CODE:
