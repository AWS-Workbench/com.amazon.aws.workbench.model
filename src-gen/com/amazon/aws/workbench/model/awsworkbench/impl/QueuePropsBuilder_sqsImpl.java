...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Queue Props Builder sqs</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.QueuePropsBuilder_sqsImpl#getContentBasedDeduplication_java_lang_Boolean_ <em>Content Based Deduplication java lang Boolean </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.QueuePropsBuilder_sqsImpl#getDataKeyReuseWithDuration_software_amazon_awscdk_core_Duration_AsReference <em>Data Key Reuse With Duration software amazon awscdk core Duration As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.QueuePropsBuilder_sqsImpl#getDeadLetterQueueWithDeadLetterQueue_software_amazon_awscdk_services_sqs_DeadLetterQueue_AsReference <em>Dead Letter Queue With Dead Letter Queue software amazon awscdk services sqs Dead Letter Queue As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.QueuePropsBuilder_sqsImpl#getDeliveryDelayWithDuration_software_amazon_awscdk_core_Duration_AsReference <em>Delivery Delay With Duration software amazon awscdk core Duration As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.QueuePropsBuilder_sqsImpl#getEncryption_software_amazon_awscdk_services_sqs_QueueEncryption_ <em>Encryption software amazon awscdk services sqs Queue Encryption </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.QueuePropsBuilder_sqsImpl#getEncryptionMasterKeyWithIKey_software_amazon_awscdk_services_kms_IKey_AsReference <em>Encryption Master Key With IKey software amazon awscdk services kms IKey As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.QueuePropsBuilder_sqsImpl#getFifo_java_lang_Boolean_ <em>Fifo java lang Boolean </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.QueuePropsBuilder_sqsImpl#getMaxMessageSizeBytes_java_lang_Number_ <em>Max Message Size Bytes java lang Number </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.QueuePropsBuilder_sqsImpl#getQueueName_java_lang_String_ <em>Queue Name java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.QueuePropsBuilder_sqsImpl#getReceiveMessageWaitTimeWithDuration_software_amazon_awscdk_core_Duration_AsReference <em>Receive Message Wait Time With Duration software amazon awscdk core Duration As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.QueuePropsBuilder_sqsImpl#getRetentionPeriodWithDuration_software_amazon_awscdk_core_Duration_AsReference <em>Retention Period With Duration software amazon awscdk core Duration As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.QueuePropsBuilder_sqsImpl#getVisibilityTimeoutWithDuration_software_amazon_awscdk_core_Duration_AsReference <em>Visibility Timeout With Duration software amazon awscdk core Duration As Reference</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.QueuePropsBuilder_sqsImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.QueuePropsBuilder_sqsImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.QueuePropsBuilder_sqsImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.QueuePropsBuilder_sqsImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class QueuePropsBuilder_sqsImpl extends MinimalEObjectImpl.Container implements QueuePropsBuilder_sqs {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.sqs.QueueProps";
	 ...
	 * @generated
	 */
	protected QueuePropsBuilder_sqsImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AwsworkbenchPackage.Literals.QUEUE_PROPS_BUILDER_SQS;
	}
	...
	public void setContentBasedDeduplication_java_lang_Boolean_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.QUEUE_PROPS_BUILDER_SQS__CONTENT_BASED_DEDUPLICATION_JAVA_LANG_BOOLEAN_,
	...
	public void setDataKeyReuseWithDuration_software_amazon_awscdk_core_Duration_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.QUEUE_PROPS_BUILDER_SQS__DATA_KEY_REUSE_WITH_DURATION_SOFTWARE_AMAZON_AWSCDK_CORE_DURATION_AS_REFERENCE,
	...
	public void setDeadLetterQueueWithDeadLetterQueue_software_amazon_awscdk_services_sqs_DeadLetterQueue_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.QUEUE_PROPS_BUILDER_SQS__DEAD_LETTER_QUEUE_WITH_DEAD_LETTER_QUEUE_SOFTWARE_AMAZON_AWSCDK_SERVICES_SQS_DEAD_LETTER_QUEUE_AS_REFERENCE,
	...
	public void setDeliveryDelayWithDuration_software_amazon_awscdk_core_Duration_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.QUEUE_PROPS_BUILDER_SQS__DELIVERY_DELAY_WITH_DURATION_SOFTWARE_AMAZON_AWSCDK_CORE_DURATION_AS_REFERENCE,
	...
	public void setEncryption_software_amazon_awscdk_services_sqs_QueueEncryption_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.QUEUE_PROPS_BUILDER_SQS__ENCRYPTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_SQS_QUEUE_ENCRYPTION_,
	...
	public void setEncryptionMasterKeyWithIKey_software_amazon_awscdk_services_kms_IKey_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.QUEUE_PROPS_BUILDER_SQS__ENCRYPTION_MASTER_KEY_WITH_IKEY_SOFTWARE_AMAZON_AWSCDK_SERVICES_KMS_IKEY_AS_REFERENCE,
	...
	public void setFifo_java_lang_Boolean_(Boolean newFifo_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.QUEUE_PROPS_BUILDER_SQS__FIFO_JAVA_LANG_BOOLEAN_, oldFifo_java_lang_Boolean_,
	...
	public void setMaxMessageSizeBytes_java_lang_Number_(int newMaxMessageSizeBytes_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.QUEUE_PROPS_BUILDER_SQS__MAX_MESSAGE_SIZE_BYTES_JAVA_LANG_NUMBER_,
	...
	public void setQueueName_java_lang_String_(String newQueueName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.QUEUE_PROPS_BUILDER_SQS__QUEUE_NAME_JAVA_LANG_STRING_,
					oldQueueName_java_lang_String_, queueName_java_lang_String_));
	}
	...
	public void setReceiveMessageWaitTimeWithDuration_software_amazon_awscdk_core_Duration_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.QUEUE_PROPS_BUILDER_SQS__RECEIVE_MESSAGE_WAIT_TIME_WITH_DURATION_SOFTWARE_AMAZON_AWSCDK_CORE_DURATION_AS_REFERENCE,
	...
	public void setRetentionPeriodWithDuration_software_amazon_awscdk_core_Duration_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.QUEUE_PROPS_BUILDER_SQS__RETENTION_PERIOD_WITH_DURATION_SOFTWARE_AMAZON_AWSCDK_CORE_DURATION_AS_REFERENCE,
	...
	public void setVisibilityTimeoutWithDuration_software_amazon_awscdk_core_Duration_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.QUEUE_PROPS_BUILDER_SQS__VISIBILITY_TIMEOUT_WITH_DURATION_SOFTWARE_AMAZON_AWSCDK_CORE_DURATION_AS_REFERENCE,
	...
	public void setVarName(String newVarName) {
		...
		varName = newVarName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AwsworkbenchPackage.QUEUE_PROPS_BUILDER_SQS__VAR_NAME,
					oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.QUEUE_PROPS_BUILDER_SQS__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.QUEUE_PROPS_BUILDER_SQS__ADDITIONAL_CODE, oldAdditionalCode, additionalCode));
	}
