...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>User Props Builder iam</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link iam.impl.UserPropsBuilder_iamImpl#getGroups_software_amazon_awscdk_services_iam_IGroup_AsList <em>Groups software amazon awscdk services iam IGroup As List</em>}</li>
 *   <li>{@link iam.impl.UserPropsBuilder_iamImpl#getManagedPolicies_software_amazon_awscdk_services_iam_IManagedPolicy_AsList <em>Managed Policies software amazon awscdk services iam IManaged Policy As List</em>}</li>
 *   <li>{@link iam.impl.UserPropsBuilder_iamImpl#getPasswordWithSecretValue_software_amazon_awscdk_core_SecretValue_AsReference <em>Password With Secret Value software amazon awscdk core Secret Value As Reference</em>}</li>
 *   <li>{@link iam.impl.UserPropsBuilder_iamImpl#getPasswordResetRequired_java_lang_Boolean_ <em>Password Reset Required java lang Boolean </em>}</li>
 *   <li>{@link iam.impl.UserPropsBuilder_iamImpl#getPath_java_lang_String_ <em>Path java lang String </em>}</li>
 *   <li>{@link iam.impl.UserPropsBuilder_iamImpl#getPermissionsBoundaryWithIManagedPolicy_software_amazon_awscdk_services_iam_IManagedPolicy_AsReference <em>Permissions Boundary With IManaged Policy software amazon awscdk services iam IManaged Policy As Reference</em>}</li>
 *   <li>{@link iam.impl.UserPropsBuilder_iamImpl#getUserName_java_lang_String_ <em>User Name java lang String </em>}</li>
 *   <li>{@link iam.impl.UserPropsBuilder_iamImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link iam.impl.UserPropsBuilder_iamImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link iam.impl.UserPropsBuilder_iamImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link iam.impl.UserPropsBuilder_iamImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UserPropsBuilder_iamImpl extends MinimalEObjectImpl.Container implements UserPropsBuilder_iam {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.iam.UserProps";
	 ...
	 * @generated
	 */
	protected UserPropsBuilder_iamImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return IamPackage.Literals.USER_PROPS_BUILDER_IAM;
	}
	...
	public void setGroups_software_amazon_awscdk_services_iam_IGroup_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.USER_PROPS_BUILDER_IAM__GROUPS_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IGROUP_AS_LIST,
	...
	public void setManagedPolicies_software_amazon_awscdk_services_iam_IManagedPolicy_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.USER_PROPS_BUILDER_IAM__MANAGED_POLICIES_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IMANAGED_POLICY_AS_LIST,
	...
	public void setPasswordWithSecretValue_software_amazon_awscdk_core_SecretValue_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.USER_PROPS_BUILDER_IAM__PASSWORD_WITH_SECRET_VALUE_SOFTWARE_AMAZON_AWSCDK_CORE_SECRET_VALUE_AS_REFERENCE,
	...
	public void setPasswordResetRequired_java_lang_Boolean_(Boolean newPasswordResetRequired_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.USER_PROPS_BUILDER_IAM__PASSWORD_RESET_REQUIRED_JAVA_LANG_BOOLEAN_,
	...
	public void setPath_java_lang_String_(String newPath_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.USER_PROPS_BUILDER_IAM__PATH_JAVA_LANG_STRING_, oldPath_java_lang_String_,
	...
	public void setPermissionsBoundaryWithIManagedPolicy_software_amazon_awscdk_services_iam_IManagedPolicy_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.USER_PROPS_BUILDER_IAM__PERMISSIONS_BOUNDARY_WITH_IMANAGED_POLICY_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IMANAGED_POLICY_AS_REFERENCE,
	...
	public void setUserName_java_lang_String_(String newUserName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.USER_PROPS_BUILDER_IAM__USER_NAME_JAVA_LANG_STRING_, oldUserName_java_lang_String_,
	...
	public void setVarName(String newVarName) {
		...
		varName = newVarName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IamPackage.USER_PROPS_BUILDER_IAM__VAR_NAME,
					oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IamPackage.USER_PROPS_BUILDER_IAM__IDENTIFIER,
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IamPackage.USER_PROPS_BUILDER_IAM__ADDITIONAL_CODE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case IamPackage.USER_PROPS_BUILDER_IAM__GROUPS_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IGROUP_AS_LIST:
			return getGroups_software_amazon_awscdk_services_iam_IGroup_AsList();
		case IamPackage.USER_PROPS_BUILDER_IAM__MANAGED_POLICIES_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IMANAGED_POLICY_AS_LIST:
			return getManagedPolicies_software_amazon_awscdk_services_iam_IManagedPolicy_AsList();
		case IamPackage.USER_PROPS_BUILDER_IAM__PASSWORD_WITH_SECRET_VALUE_SOFTWARE_AMAZON_AWSCDK_CORE_SECRET_VALUE_AS_REFERENCE:
			return getPasswordWithSecretValue_software_amazon_awscdk_core_SecretValue_AsReference();
		case IamPackage.USER_PROPS_BUILDER_IAM__PASSWORD_RESET_REQUIRED_JAVA_LANG_BOOLEAN_:
			return getPasswordResetRequired_java_lang_Boolean_();
		case IamPackage.USER_PROPS_BUILDER_IAM__PATH_JAVA_LANG_STRING_:
			return getPath_java_lang_String_();
		case IamPackage.USER_PROPS_BUILDER_IAM__PERMISSIONS_BOUNDARY_WITH_IMANAGED_POLICY_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IMANAGED_POLICY_AS_REFERENCE:
			return getPermissionsBoundaryWithIManagedPolicy_software_amazon_awscdk_services_iam_IManagedPolicy_AsReference();
		case IamPackage.USER_PROPS_BUILDER_IAM__USER_NAME_JAVA_LANG_STRING_:
			return getUserName_java_lang_String_();
		case IamPackage.USER_PROPS_BUILDER_IAM__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case IamPackage.USER_PROPS_BUILDER_IAM__VAR_NAME:
			return getVarName();
		case IamPackage.USER_PROPS_BUILDER_IAM__IDENTIFIER:
			return getIdentifier();
		case IamPackage.USER_PROPS_BUILDER_IAM__ADDITIONAL_CODE:
