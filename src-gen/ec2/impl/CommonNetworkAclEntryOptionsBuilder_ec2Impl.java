...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Common Network Acl Entry Options Builder ec2</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link ec2.impl.CommonNetworkAclEntryOptionsBuilder_ec2Impl#getCidrWithAclCidr_software_amazon_awscdk_services_ec2_AclCidr_AsReference <em>Cidr With Acl Cidr software amazon awscdk services ec2 Acl Cidr As Reference</em>}</li>
 *   <li>{@link ec2.impl.CommonNetworkAclEntryOptionsBuilder_ec2Impl#getRuleNumber_java_lang_Number_ <em>Rule Number java lang Number </em>}</li>
 *   <li>{@link ec2.impl.CommonNetworkAclEntryOptionsBuilder_ec2Impl#getTrafficWithAclTraffic_software_amazon_awscdk_services_ec2_AclTraffic_AsReference <em>Traffic With Acl Traffic software amazon awscdk services ec2 Acl Traffic As Reference</em>}</li>
 *   <li>{@link ec2.impl.CommonNetworkAclEntryOptionsBuilder_ec2Impl#getDirection_software_amazon_awscdk_services_ec2_TrafficDirection_ <em>Direction software amazon awscdk services ec2 Traffic Direction </em>}</li>
 *   <li>{@link ec2.impl.CommonNetworkAclEntryOptionsBuilder_ec2Impl#getNetworkAclEntryName_java_lang_String_ <em>Network Acl Entry Name java lang String </em>}</li>
 *   <li>{@link ec2.impl.CommonNetworkAclEntryOptionsBuilder_ec2Impl#getRuleAction_software_amazon_awscdk_services_ec2_Action_ <em>Rule Action software amazon awscdk services ec2 Action </em>}</li>
 *   <li>{@link ec2.impl.CommonNetworkAclEntryOptionsBuilder_ec2Impl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link ec2.impl.CommonNetworkAclEntryOptionsBuilder_ec2Impl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link ec2.impl.CommonNetworkAclEntryOptionsBuilder_ec2Impl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link ec2.impl.CommonNetworkAclEntryOptionsBuilder_ec2Impl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CommonNetworkAclEntryOptionsBuilder_ec2Impl extends MinimalEObjectImpl.Container
		implements CommonNetworkAclEntryOptionsBuilder_ec2 {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.ec2.CommonNetworkAclEntryOptions";
	 ...
	 * @generated
	 */
	protected CommonNetworkAclEntryOptionsBuilder_ec2Impl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Ec2Package.Literals.COMMON_NETWORK_ACL_ENTRY_OPTIONS_BUILDER_EC2;
	}
	...
	public void setCidrWithAclCidr_software_amazon_awscdk_services_ec2_AclCidr_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.COMMON_NETWORK_ACL_ENTRY_OPTIONS_BUILDER_EC2__CIDR_WITH_ACL_CIDR_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_ACL_CIDR_AS_REFERENCE,
	...
	public void setRuleNumber_java_lang_Number_(int newRuleNumber_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.COMMON_NETWORK_ACL_ENTRY_OPTIONS_BUILDER_EC2__RULE_NUMBER_JAVA_LANG_NUMBER_,
	...
	public void setTrafficWithAclTraffic_software_amazon_awscdk_services_ec2_AclTraffic_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.COMMON_NETWORK_ACL_ENTRY_OPTIONS_BUILDER_EC2__TRAFFIC_WITH_ACL_TRAFFIC_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_ACL_TRAFFIC_AS_REFERENCE,
	...
	public void setDirection_software_amazon_awscdk_services_ec2_TrafficDirection_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.COMMON_NETWORK_ACL_ENTRY_OPTIONS_BUILDER_EC2__DIRECTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_TRAFFIC_DIRECTION_,
	...
	public void setNetworkAclEntryName_java_lang_String_(String newNetworkAclEntryName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.COMMON_NETWORK_ACL_ENTRY_OPTIONS_BUILDER_EC2__NETWORK_ACL_ENTRY_NAME_JAVA_LANG_STRING_,
	...
	public void setRuleAction_software_amazon_awscdk_services_ec2_Action_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.COMMON_NETWORK_ACL_ENTRY_OPTIONS_BUILDER_EC2__RULE_ACTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_EC2_ACTION_,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.COMMON_NETWORK_ACL_ENTRY_OPTIONS_BUILDER_EC2__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.COMMON_NETWORK_ACL_ENTRY_OPTIONS_BUILDER_EC2__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					Ec2Package.COMMON_NETWORK_ACL_ENTRY_OPTIONS_BUILDER_EC2__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
...
} //CommonNetworkAclEntryOptionsBuilder_ec2Impl
