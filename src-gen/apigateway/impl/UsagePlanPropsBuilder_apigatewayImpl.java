...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Usage Plan Props Builder apigateway</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link apigateway.impl.UsagePlanPropsBuilder_apigatewayImpl#getApiKeyWithIApiKey_software_amazon_awscdk_services_apigateway_IApiKey_AsReference <em>Api Key With IApi Key software amazon awscdk services apigateway IApi Key As Reference</em>}</li>
 *   <li>{@link apigateway.impl.UsagePlanPropsBuilder_apigatewayImpl#getApiStages_software_amazon_awscdk_services_apigateway_UsagePlanPerApiStage_AsList <em>Api Stages software amazon awscdk services apigateway Usage Plan Per Api Stage As List</em>}</li>
 *   <li>{@link apigateway.impl.UsagePlanPropsBuilder_apigatewayImpl#getDescription_java_lang_String_ <em>Description java lang String </em>}</li>
 *   <li>{@link apigateway.impl.UsagePlanPropsBuilder_apigatewayImpl#getName_java_lang_String_ <em>Name java lang String </em>}</li>
 *   <li>{@link apigateway.impl.UsagePlanPropsBuilder_apigatewayImpl#getQuotaWithQuotaSettings_software_amazon_awscdk_services_apigateway_QuotaSettings_AsReference <em>Quota With Quota Settings software amazon awscdk services apigateway Quota Settings As Reference</em>}</li>
 *   <li>{@link apigateway.impl.UsagePlanPropsBuilder_apigatewayImpl#getThrottleWithThrottleSettings_software_amazon_awscdk_services_apigateway_ThrottleSettings_AsReference <em>Throttle With Throttle Settings software amazon awscdk services apigateway Throttle Settings As Reference</em>}</li>
 *   <li>{@link apigateway.impl.UsagePlanPropsBuilder_apigatewayImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link apigateway.impl.UsagePlanPropsBuilder_apigatewayImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link apigateway.impl.UsagePlanPropsBuilder_apigatewayImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link apigateway.impl.UsagePlanPropsBuilder_apigatewayImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UsagePlanPropsBuilder_apigatewayImpl extends MinimalEObjectImpl.Container
		implements UsagePlanPropsBuilder_apigateway {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.apigateway.UsagePlanProps";
	 ...
	 * @generated
	 */
	protected UsagePlanPropsBuilder_apigatewayImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ApigatewayPackage.Literals.USAGE_PLAN_PROPS_BUILDER_APIGATEWAY;
	}
	...
	public void setApiKeyWithIApiKey_software_amazon_awscdk_services_apigateway_IApiKey_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.USAGE_PLAN_PROPS_BUILDER_APIGATEWAY__API_KEY_WITH_IAPI_KEY_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_IAPI_KEY_AS_REFERENCE,
	...
	public void setApiStages_software_amazon_awscdk_services_apigateway_UsagePlanPerApiStage_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.USAGE_PLAN_PROPS_BUILDER_APIGATEWAY__API_STAGES_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_USAGE_PLAN_PER_API_STAGE_AS_LIST,
	...
	public void setDescription_java_lang_String_(String newDescription_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.USAGE_PLAN_PROPS_BUILDER_APIGATEWAY__DESCRIPTION_JAVA_LANG_STRING_,
	...
	public void setName_java_lang_String_(String newName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.USAGE_PLAN_PROPS_BUILDER_APIGATEWAY__NAME_JAVA_LANG_STRING_,
	...
	public void setQuotaWithQuotaSettings_software_amazon_awscdk_services_apigateway_QuotaSettings_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.USAGE_PLAN_PROPS_BUILDER_APIGATEWAY__QUOTA_WITH_QUOTA_SETTINGS_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_QUOTA_SETTINGS_AS_REFERENCE,
	...
	public void setThrottleWithThrottleSettings_software_amazon_awscdk_services_apigateway_ThrottleSettings_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.USAGE_PLAN_PROPS_BUILDER_APIGATEWAY__THROTTLE_WITH_THROTTLE_SETTINGS_SOFTWARE_AMAZON_AWSCDK_SERVICES_APIGATEWAY_THROTTLE_SETTINGS_AS_REFERENCE,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.USAGE_PLAN_PROPS_BUILDER_APIGATEWAY__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.USAGE_PLAN_PROPS_BUILDER_APIGATEWAY__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ApigatewayPackage.USAGE_PLAN_PROPS_BUILDER_APIGATEWAY__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
...
} //UsagePlanPropsBuilder_apigatewayImpl
