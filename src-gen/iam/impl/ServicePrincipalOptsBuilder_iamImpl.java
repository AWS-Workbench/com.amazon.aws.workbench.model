...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Service Principal Opts Builder iam</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link iam.impl.ServicePrincipalOptsBuilder_iamImpl#getConditions_java_lang_String__java_lang_Object_AsMap <em>Conditions java lang String java lang Object As Map</em>}</li>
 *   <li>{@link iam.impl.ServicePrincipalOptsBuilder_iamImpl#getRegion_java_lang_String_ <em>Region java lang String </em>}</li>
 *   <li>{@link iam.impl.ServicePrincipalOptsBuilder_iamImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link iam.impl.ServicePrincipalOptsBuilder_iamImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link iam.impl.ServicePrincipalOptsBuilder_iamImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link iam.impl.ServicePrincipalOptsBuilder_iamImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ServicePrincipalOptsBuilder_iamImpl extends MinimalEObjectImpl.Container
		implements ServicePrincipalOptsBuilder_iam {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.iam.ServicePrincipalOpts";
	 ...
	 * @generated
	 */
	protected ServicePrincipalOptsBuilder_iamImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return IamPackage.Literals.SERVICE_PRINCIPAL_OPTS_BUILDER_IAM;
	}
	...
	public void setConditions_java_lang_String__java_lang_Object_AsMap(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.SERVICE_PRINCIPAL_OPTS_BUILDER_IAM__CONDITIONS_JAVA_LANG_STRING_JAVA_LANG_OBJECT_AS_MAP,
	...
	public void setRegion_java_lang_String_(String newRegion_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.SERVICE_PRINCIPAL_OPTS_BUILDER_IAM__REGION_JAVA_LANG_STRING_,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.SERVICE_PRINCIPAL_OPTS_BUILDER_IAM__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.SERVICE_PRINCIPAL_OPTS_BUILDER_IAM__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					IamPackage.SERVICE_PRINCIPAL_OPTS_BUILDER_IAM__ADDITIONAL_CODE, oldAdditionalCode, additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case IamPackage.SERVICE_PRINCIPAL_OPTS_BUILDER_IAM__CONDITIONS_JAVA_LANG_STRING_JAVA_LANG_OBJECT_AS_MAP:
			return getConditions_java_lang_String__java_lang_Object_AsMap();
		case IamPackage.SERVICE_PRINCIPAL_OPTS_BUILDER_IAM__REGION_JAVA_LANG_STRING_:
			return getRegion_java_lang_String_();
		case IamPackage.SERVICE_PRINCIPAL_OPTS_BUILDER_IAM__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case IamPackage.SERVICE_PRINCIPAL_OPTS_BUILDER_IAM__VAR_NAME:
			return getVarName();
		case IamPackage.SERVICE_PRINCIPAL_OPTS_BUILDER_IAM__IDENTIFIER:
			return getIdentifier();
		case IamPackage.SERVICE_PRINCIPAL_OPTS_BUILDER_IAM__ADDITIONAL_CODE:
...
} //ServicePrincipalOptsBuilder_iamImpl
