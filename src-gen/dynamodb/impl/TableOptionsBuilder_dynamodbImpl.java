...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Table Options Builder dynamodb</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link dynamodb.impl.TableOptionsBuilder_dynamodbImpl#getPartitionKeyWithAttribute_software_amazon_awscdk_services_dynamodb_Attribute_AsReference <em>Partition Key With Attribute software amazon awscdk services dynamodb Attribute As Reference</em>}</li>
 *   <li>{@link dynamodb.impl.TableOptionsBuilder_dynamodbImpl#getBillingMode_software_amazon_awscdk_services_dynamodb_BillingMode_ <em>Billing Mode software amazon awscdk services dynamodb Billing Mode </em>}</li>
 *   <li>{@link dynamodb.impl.TableOptionsBuilder_dynamodbImpl#getEncryption_software_amazon_awscdk_services_dynamodb_TableEncryption_ <em>Encryption software amazon awscdk services dynamodb Table Encryption </em>}</li>
 *   <li>{@link dynamodb.impl.TableOptionsBuilder_dynamodbImpl#getEncryptionKeyWithIKey_software_amazon_awscdk_services_kms_IKey_AsReference <em>Encryption Key With IKey software amazon awscdk services kms IKey As Reference</em>}</li>
 *   <li>{@link dynamodb.impl.TableOptionsBuilder_dynamodbImpl#getPointInTimeRecovery_java_lang_Boolean_ <em>Point In Time Recovery java lang Boolean </em>}</li>
 *   <li>{@link dynamodb.impl.TableOptionsBuilder_dynamodbImpl#getReadCapacity_java_lang_Number_ <em>Read Capacity java lang Number </em>}</li>
 *   <li>{@link dynamodb.impl.TableOptionsBuilder_dynamodbImpl#getRemovalPolicy_software_amazon_awscdk_core_RemovalPolicy_ <em>Removal Policy software amazon awscdk core Removal Policy </em>}</li>
 *   <li>{@link dynamodb.impl.TableOptionsBuilder_dynamodbImpl#getReplicationRegions_java_lang_String_AsList <em>Replication Regions java lang String As List</em>}</li>
 *   <li>{@link dynamodb.impl.TableOptionsBuilder_dynamodbImpl#getServerSideEncryption_java_lang_Boolean_ <em>Server Side Encryption java lang Boolean </em>}</li>
 *   <li>{@link dynamodb.impl.TableOptionsBuilder_dynamodbImpl#getSortKeyWithAttribute_software_amazon_awscdk_services_dynamodb_Attribute_AsReference <em>Sort Key With Attribute software amazon awscdk services dynamodb Attribute As Reference</em>}</li>
 *   <li>{@link dynamodb.impl.TableOptionsBuilder_dynamodbImpl#getStream_software_amazon_awscdk_services_dynamodb_StreamViewType_ <em>Stream software amazon awscdk services dynamodb Stream View Type </em>}</li>
 *   <li>{@link dynamodb.impl.TableOptionsBuilder_dynamodbImpl#getTimeToLiveAttribute_java_lang_String_ <em>Time To Live Attribute java lang String </em>}</li>
 *   <li>{@link dynamodb.impl.TableOptionsBuilder_dynamodbImpl#getWriteCapacity_java_lang_Number_ <em>Write Capacity java lang Number </em>}</li>
 *   <li>{@link dynamodb.impl.TableOptionsBuilder_dynamodbImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link dynamodb.impl.TableOptionsBuilder_dynamodbImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link dynamodb.impl.TableOptionsBuilder_dynamodbImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link dynamodb.impl.TableOptionsBuilder_dynamodbImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TableOptionsBuilder_dynamodbImpl extends MinimalEObjectImpl.Container
		implements TableOptionsBuilder_dynamodb {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.dynamodb.TableOptions";
	 ...
	 * @generated
	 */
	protected TableOptionsBuilder_dynamodbImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return DynamodbPackage.Literals.TABLE_OPTIONS_BUILDER_DYNAMODB;
	}
	...
	public void setPartitionKeyWithAttribute_software_amazon_awscdk_services_dynamodb_Attribute_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__PARTITION_KEY_WITH_ATTRIBUTE_SOFTWARE_AMAZON_AWSCDK_SERVICES_DYNAMODB_ATTRIBUTE_AS_REFERENCE,
	...
	public void setBillingMode_software_amazon_awscdk_services_dynamodb_BillingMode_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__BILLING_MODE_SOFTWARE_AMAZON_AWSCDK_SERVICES_DYNAMODB_BILLING_MODE_,
	...
	public void setEncryption_software_amazon_awscdk_services_dynamodb_TableEncryption_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__ENCRYPTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_DYNAMODB_TABLE_ENCRYPTION_,
	...
	public void setEncryptionKeyWithIKey_software_amazon_awscdk_services_kms_IKey_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__ENCRYPTION_KEY_WITH_IKEY_SOFTWARE_AMAZON_AWSCDK_SERVICES_KMS_IKEY_AS_REFERENCE,
	...
	public void setPointInTimeRecovery_java_lang_Boolean_(Boolean newPointInTimeRecovery_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__POINT_IN_TIME_RECOVERY_JAVA_LANG_BOOLEAN_,
	...
	public void setReadCapacity_java_lang_Number_(int newReadCapacity_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__READ_CAPACITY_JAVA_LANG_NUMBER_,
	...
	public void setRemovalPolicy_software_amazon_awscdk_core_RemovalPolicy_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__REMOVAL_POLICY_SOFTWARE_AMAZON_AWSCDK_CORE_REMOVAL_POLICY_,
	...
	public void setReplicationRegions_java_lang_String_AsList(String newReplicationRegions_java_lang_String_AsList) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__REPLICATION_REGIONS_JAVA_LANG_STRING_AS_LIST,
	...
	public void setServerSideEncryption_java_lang_Boolean_(Boolean newServerSideEncryption_java_lang_Boolean_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__SERVER_SIDE_ENCRYPTION_JAVA_LANG_BOOLEAN_,
	...
	public void setSortKeyWithAttribute_software_amazon_awscdk_services_dynamodb_Attribute_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__SORT_KEY_WITH_ATTRIBUTE_SOFTWARE_AMAZON_AWSCDK_SERVICES_DYNAMODB_ATTRIBUTE_AS_REFERENCE,
	...
	public void setStream_software_amazon_awscdk_services_dynamodb_StreamViewType_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__STREAM_SOFTWARE_AMAZON_AWSCDK_SERVICES_DYNAMODB_STREAM_VIEW_TYPE_,
	...
	public void setTimeToLiveAttribute_java_lang_String_(String newTimeToLiveAttribute_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__TIME_TO_LIVE_ATTRIBUTE_JAVA_LANG_STRING_,
	...
	public void setWriteCapacity_java_lang_Number_(int newWriteCapacity_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__WRITE_CAPACITY_JAVA_LANG_NUMBER_,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__PARTITION_KEY_WITH_ATTRIBUTE_SOFTWARE_AMAZON_AWSCDK_SERVICES_DYNAMODB_ATTRIBUTE_AS_REFERENCE:
			return getPartitionKeyWithAttribute_software_amazon_awscdk_services_dynamodb_Attribute_AsReference();
		case DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__BILLING_MODE_SOFTWARE_AMAZON_AWSCDK_SERVICES_DYNAMODB_BILLING_MODE_:
			return getBillingMode_software_amazon_awscdk_services_dynamodb_BillingMode_();
		case DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__ENCRYPTION_SOFTWARE_AMAZON_AWSCDK_SERVICES_DYNAMODB_TABLE_ENCRYPTION_:
			return getEncryption_software_amazon_awscdk_services_dynamodb_TableEncryption_();
		case DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__ENCRYPTION_KEY_WITH_IKEY_SOFTWARE_AMAZON_AWSCDK_SERVICES_KMS_IKEY_AS_REFERENCE:
			return getEncryptionKeyWithIKey_software_amazon_awscdk_services_kms_IKey_AsReference();
		case DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__POINT_IN_TIME_RECOVERY_JAVA_LANG_BOOLEAN_:
			return getPointInTimeRecovery_java_lang_Boolean_();
		case DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__READ_CAPACITY_JAVA_LANG_NUMBER_:
			return getReadCapacity_java_lang_Number_();
		case DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__REMOVAL_POLICY_SOFTWARE_AMAZON_AWSCDK_CORE_REMOVAL_POLICY_:
			return getRemovalPolicy_software_amazon_awscdk_core_RemovalPolicy_();
		case DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__REPLICATION_REGIONS_JAVA_LANG_STRING_AS_LIST:
			return getReplicationRegions_java_lang_String_AsList();
		case DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__SERVER_SIDE_ENCRYPTION_JAVA_LANG_BOOLEAN_:
			return getServerSideEncryption_java_lang_Boolean_();
		case DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__SORT_KEY_WITH_ATTRIBUTE_SOFTWARE_AMAZON_AWSCDK_SERVICES_DYNAMODB_ATTRIBUTE_AS_REFERENCE:
			return getSortKeyWithAttribute_software_amazon_awscdk_services_dynamodb_Attribute_AsReference();
		case DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__STREAM_SOFTWARE_AMAZON_AWSCDK_SERVICES_DYNAMODB_STREAM_VIEW_TYPE_:
			return getStream_software_amazon_awscdk_services_dynamodb_StreamViewType_();
		case DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__TIME_TO_LIVE_ATTRIBUTE_JAVA_LANG_STRING_:
			return getTimeToLiveAttribute_java_lang_String_();
		case DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__WRITE_CAPACITY_JAVA_LANG_NUMBER_:
			return getWriteCapacity_java_lang_Number_();
		case DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__VAR_NAME:
			return getVarName();
		case DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__IDENTIFIER:
			return getIdentifier();
		case DynamodbPackage.TABLE_OPTIONS_BUILDER_DYNAMODB__ADDITIONAL_CODE:
...
} //TableOptionsBuilder_dynamodbImpl
