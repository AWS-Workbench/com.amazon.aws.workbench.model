...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Network Target Props Builder patterns</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkTargetPropsBuilder_patternsImpl#getContainerPort_java_lang_Number_ <em>Container Port java lang Number </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkTargetPropsBuilder_patternsImpl#getListener_java_lang_String_ <em>Listener java lang String </em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkTargetPropsBuilder_patternsImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkTargetPropsBuilder_patternsImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkTargetPropsBuilder_patternsImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link com.amazon.aws.workbench.model.awsworkbench.impl.NetworkTargetPropsBuilder_patternsImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NetworkTargetPropsBuilder_patternsImpl extends MinimalEObjectImpl.Container
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.ecs.patterns.NetworkTargetProps";
	 ...
	 * @generated
	 */
	protected NetworkTargetPropsBuilder_patternsImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AwsworkbenchPackage.Literals.NETWORK_TARGET_PROPS_BUILDER_PATTERNS;
	}
	...
	public void setContainerPort_java_lang_Number_(int newContainerPort_java_lang_Number_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_TARGET_PROPS_BUILDER_PATTERNS__CONTAINER_PORT_JAVA_LANG_NUMBER_,
	...
	public void setListener_java_lang_String_(String newListener_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_TARGET_PROPS_BUILDER_PATTERNS__LISTENER_JAVA_LANG_STRING_,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_TARGET_PROPS_BUILDER_PATTERNS__VAR_NAME, oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_TARGET_PROPS_BUILDER_PATTERNS__IDENTIFIER, oldIdentifier, identifier));
	}
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					AwsworkbenchPackage.NETWORK_TARGET_PROPS_BUILDER_PATTERNS__ADDITIONAL_CODE, oldAdditionalCode,
					additionalCode));
	}
...
} //NetworkTargetPropsBuilder_patternsImpl
