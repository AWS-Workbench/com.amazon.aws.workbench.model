...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Dns Validated Certificate Props Builder certificatemanager</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link certificatemanager.impl.DnsValidatedCertificatePropsBuilder_certificatemanagerImpl#getHostedZoneWithIHostedZone_software_amazon_awscdk_services_route53_IHostedZone_AsReference <em>Hosted Zone With IHosted Zone software amazon awscdk services route53 IHosted Zone As Reference</em>}</li>
 *   <li>{@link certificatemanager.impl.DnsValidatedCertificatePropsBuilder_certificatemanagerImpl#getCustomResourceRoleWithIRole_software_amazon_awscdk_services_iam_IRole_AsReference <em>Custom Resource Role With IRole software amazon awscdk services iam IRole As Reference</em>}</li>
 *   <li>{@link certificatemanager.impl.DnsValidatedCertificatePropsBuilder_certificatemanagerImpl#getRegion_java_lang_String_ <em>Region java lang String </em>}</li>
 *   <li>{@link certificatemanager.impl.DnsValidatedCertificatePropsBuilder_certificatemanagerImpl#getRoute53Endpoint_java_lang_String_ <em>Route53 Endpoint java lang String </em>}</li>
 *   <li>{@link certificatemanager.impl.DnsValidatedCertificatePropsBuilder_certificatemanagerImpl#getDomainName_java_lang_String_ <em>Domain Name java lang String </em>}</li>
 *   <li>{@link certificatemanager.impl.DnsValidatedCertificatePropsBuilder_certificatemanagerImpl#getSubjectAlternativeNames_java_lang_String_AsList <em>Subject Alternative Names java lang String As List</em>}</li>
 *   <li>{@link certificatemanager.impl.DnsValidatedCertificatePropsBuilder_certificatemanagerImpl#getValidationDomains_java_lang_String__java_lang_String_AsMap <em>Validation Domains java lang String java lang String As Map</em>}</li>
 *   <li>{@link certificatemanager.impl.DnsValidatedCertificatePropsBuilder_certificatemanagerImpl#getValidationMethod_software_amazon_awscdk_services_certificatemanager_ValidationMethod_ <em>Validation Method software amazon awscdk services certificatemanager Validation Method </em>}</li>
 *   <li>{@link certificatemanager.impl.DnsValidatedCertificatePropsBuilder_certificatemanagerImpl#getGeneratedClassName <em>Generated Class Name</em>}</li>
 *   <li>{@link certificatemanager.impl.DnsValidatedCertificatePropsBuilder_certificatemanagerImpl#getVarName <em>Var Name</em>}</li>
 *   <li>{@link certificatemanager.impl.DnsValidatedCertificatePropsBuilder_certificatemanagerImpl#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link certificatemanager.impl.DnsValidatedCertificatePropsBuilder_certificatemanagerImpl#getAdditionalCode <em>Additional Code</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DnsValidatedCertificatePropsBuilder_certificatemanagerImpl extends MinimalEObjectImpl.Container
		implements DnsValidatedCertificatePropsBuilder_certificatemanager {
	/**
	 ...
	 * @ordered
	 */
	protected static final String GENERATED_CLASS_NAME_EDEFAULT = "software.amazon.awscdk.services.certificatemanager.DnsValidatedCertificateProps";
	 ...
	 * @generated
	 */
	protected DnsValidatedCertificatePropsBuilder_certificatemanagerImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CertificatemanagerPackage.Literals.DNS_VALIDATED_CERTIFICATE_PROPS_BUILDER_CERTIFICATEMANAGER;
	}
	...
	public void setHostedZoneWithIHostedZone_software_amazon_awscdk_services_route53_IHostedZone_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CertificatemanagerPackage.DNS_VALIDATED_CERTIFICATE_PROPS_BUILDER_CERTIFICATEMANAGER__HOSTED_ZONE_WITH_IHOSTED_ZONE_SOFTWARE_AMAZON_AWSCDK_SERVICES_ROUTE53_IHOSTED_ZONE_AS_REFERENCE,
	...
	public void setCustomResourceRoleWithIRole_software_amazon_awscdk_services_iam_IRole_AsReference(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CertificatemanagerPackage.DNS_VALIDATED_CERTIFICATE_PROPS_BUILDER_CERTIFICATEMANAGER__CUSTOM_RESOURCE_ROLE_WITH_IROLE_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IROLE_AS_REFERENCE,
	...
	public void setRegion_java_lang_String_(String newRegion_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CertificatemanagerPackage.DNS_VALIDATED_CERTIFICATE_PROPS_BUILDER_CERTIFICATEMANAGER__REGION_JAVA_LANG_STRING_,
	...
	public void setRoute53Endpoint_java_lang_String_(String newRoute53Endpoint_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CertificatemanagerPackage.DNS_VALIDATED_CERTIFICATE_PROPS_BUILDER_CERTIFICATEMANAGER__ROUTE53_ENDPOINT_JAVA_LANG_STRING_,
	...
	public void setDomainName_java_lang_String_(String newDomainName_java_lang_String_) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CertificatemanagerPackage.DNS_VALIDATED_CERTIFICATE_PROPS_BUILDER_CERTIFICATEMANAGER__DOMAIN_NAME_JAVA_LANG_STRING_,
	...
	public void setSubjectAlternativeNames_java_lang_String_AsList(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CertificatemanagerPackage.DNS_VALIDATED_CERTIFICATE_PROPS_BUILDER_CERTIFICATEMANAGER__SUBJECT_ALTERNATIVE_NAMES_JAVA_LANG_STRING_AS_LIST,
	...
	public void setValidationDomains_java_lang_String__java_lang_String_AsMap(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CertificatemanagerPackage.DNS_VALIDATED_CERTIFICATE_PROPS_BUILDER_CERTIFICATEMANAGER__VALIDATION_DOMAINS_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP,
	...
	public void setValidationMethod_software_amazon_awscdk_services_certificatemanager_ValidationMethod_(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CertificatemanagerPackage.DNS_VALIDATED_CERTIFICATE_PROPS_BUILDER_CERTIFICATEMANAGER__VALIDATION_METHOD_SOFTWARE_AMAZON_AWSCDK_SERVICES_CERTIFICATEMANAGER_VALIDATION_METHOD_,
	...
	public void setVarName(String newVarName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CertificatemanagerPackage.DNS_VALIDATED_CERTIFICATE_PROPS_BUILDER_CERTIFICATEMANAGER__VAR_NAME,
					oldVarName, varName));
	}
	...
	public void setIdentifier(String newIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CertificatemanagerPackage.DNS_VALIDATED_CERTIFICATE_PROPS_BUILDER_CERTIFICATEMANAGER__IDENTIFIER,
	...
	public void setAdditionalCode(String newAdditionalCode) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CertificatemanagerPackage.DNS_VALIDATED_CERTIFICATE_PROPS_BUILDER_CERTIFICATEMANAGER__ADDITIONAL_CODE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CertificatemanagerPackage.DNS_VALIDATED_CERTIFICATE_PROPS_BUILDER_CERTIFICATEMANAGER__HOSTED_ZONE_WITH_IHOSTED_ZONE_SOFTWARE_AMAZON_AWSCDK_SERVICES_ROUTE53_IHOSTED_ZONE_AS_REFERENCE:
			return getHostedZoneWithIHostedZone_software_amazon_awscdk_services_route53_IHostedZone_AsReference();
		case CertificatemanagerPackage.DNS_VALIDATED_CERTIFICATE_PROPS_BUILDER_CERTIFICATEMANAGER__CUSTOM_RESOURCE_ROLE_WITH_IROLE_SOFTWARE_AMAZON_AWSCDK_SERVICES_IAM_IROLE_AS_REFERENCE:
			return getCustomResourceRoleWithIRole_software_amazon_awscdk_services_iam_IRole_AsReference();
		case CertificatemanagerPackage.DNS_VALIDATED_CERTIFICATE_PROPS_BUILDER_CERTIFICATEMANAGER__REGION_JAVA_LANG_STRING_:
			return getRegion_java_lang_String_();
		case CertificatemanagerPackage.DNS_VALIDATED_CERTIFICATE_PROPS_BUILDER_CERTIFICATEMANAGER__ROUTE53_ENDPOINT_JAVA_LANG_STRING_:
			return getRoute53Endpoint_java_lang_String_();
		case CertificatemanagerPackage.DNS_VALIDATED_CERTIFICATE_PROPS_BUILDER_CERTIFICATEMANAGER__DOMAIN_NAME_JAVA_LANG_STRING_:
			return getDomainName_java_lang_String_();
		case CertificatemanagerPackage.DNS_VALIDATED_CERTIFICATE_PROPS_BUILDER_CERTIFICATEMANAGER__SUBJECT_ALTERNATIVE_NAMES_JAVA_LANG_STRING_AS_LIST:
			return getSubjectAlternativeNames_java_lang_String_AsList();
		case CertificatemanagerPackage.DNS_VALIDATED_CERTIFICATE_PROPS_BUILDER_CERTIFICATEMANAGER__VALIDATION_DOMAINS_JAVA_LANG_STRING_JAVA_LANG_STRING_AS_MAP:
			return getValidationDomains_java_lang_String__java_lang_String_AsMap();
		case CertificatemanagerPackage.DNS_VALIDATED_CERTIFICATE_PROPS_BUILDER_CERTIFICATEMANAGER__VALIDATION_METHOD_SOFTWARE_AMAZON_AWSCDK_SERVICES_CERTIFICATEMANAGER_VALIDATION_METHOD_:
			return getValidationMethod_software_amazon_awscdk_services_certificatemanager_ValidationMethod_();
		case CertificatemanagerPackage.DNS_VALIDATED_CERTIFICATE_PROPS_BUILDER_CERTIFICATEMANAGER__GENERATED_CLASS_NAME:
			return getGeneratedClassName();
		case CertificatemanagerPackage.DNS_VALIDATED_CERTIFICATE_PROPS_BUILDER_CERTIFICATEMANAGER__VAR_NAME:
			return getVarName();
		case CertificatemanagerPackage.DNS_VALIDATED_CERTIFICATE_PROPS_BUILDER_CERTIFICATEMANAGER__IDENTIFIER:
			return getIdentifier();
		case CertificatemanagerPackage.DNS_VALIDATED_CERTIFICATE_PROPS_BUILDER_CERTIFICATEMANAGER__ADDITIONAL_CODE:
...
} //DnsValidatedCertificatePropsBuilder_certificatemanagerImpl
